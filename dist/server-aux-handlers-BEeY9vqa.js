...
import { g as resolveSecretInputRef } from "./types.secrets-lIZQEgMF.js";
import { t as createSubsystemLogger } from "./subsystem-yNfG7O3v.js";
import { a as resolveSecretRefValue } from "./resolve-g6T_0Auy.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-DYM918bn.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-5PF3DsqB.js";
import { r as createResolverContext } from "./runtime-shared-DoAXKQzg.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-DK2S_z8g.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-BJtwkAs2.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-DnKj2WmH.js";
...
import { i as getActiveSecretsRuntimeEnv, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-DnfU3-5B.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-DjMiLYLT.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-BBe9UOEn.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-2HxDEwVG.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CiEGw50d.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-CtUjmohb.js";
...
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-D2SjRFoF.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DBBF4i61.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BtHfBeWP.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-5iHgILE0.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-BW_p9KRL.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-Nx1xD1xw.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-C5ezRSLg.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
