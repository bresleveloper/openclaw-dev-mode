...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-CkDRqDzV.js";
...
import { s as isValidEnvSecretRefId } from "./types.secrets-BEA4gMCN.js";
import { At as resolveDefaultSecretProviderAlias } from "./plugins-CjLMQbHJ.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Dxc5qfRZ.js";
...
import "./daemon-runtime-D1tp6nTC.js";
import { t as runOnboardingWizard } from "./onboarding-DMnllAyO.js";
import { n as logConfigUpdated } from "./logging-DRF_pgYm.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-v5v9KMM0.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-BbiRxt4y.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BQ3tEZaN.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BfPUwA4O.js");
