...
import { i as registerSubCliCommands, o as removeCommandByName, s as reparseProgramFromActionArgs } from "./register.subclis-B76QhaHE.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-B1ASg5kd.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DGnLi2wW.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-pfvjGAEf.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-CSs1nUNw.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-vLJ0XhQz.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-s_K3fwSj.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-BjMiQmjn.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-CzxjYwBp.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
