...
import { r as resolveCrestodianOperation } from "./dialogue-BRIBkB_w.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-DO-7bSO_.js")).runCrestodianTui;
	opts.onReady?.();
