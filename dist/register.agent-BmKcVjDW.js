...
const loadAgentsBindModule = createLazyRuntimeModule(() => import("./agents.commands.bind-DAxNZlw7.js"));
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-UeyPgg0X.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-B8Prer8A.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-FHcQKu1m.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-Bo1Ud9A_.js")).agentsListCommand;
}
