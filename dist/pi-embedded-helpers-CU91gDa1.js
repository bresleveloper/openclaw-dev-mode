...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Z5qpVTzQ.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-Z5qpVTzQ.js")).closePlaywrightBrowserConnection();
	} catch {}
}
