...
const loadMatrixSharedClientRuntimeDeps = createLazyRuntimeModule(() => Promise.all([import("./client-bS91OQq3.js"), import("./shared-08kZ-zIl.js")]).then(([clientModule, sharedModule]) => ({
