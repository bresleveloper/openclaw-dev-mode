...
import { m as restoreTerminalState } from "./subsystem-CkDRqDzV.js";
import "./boolean-DTgd5CzD.js";
import "./auth-profiles-CIqoN6FN.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BAb0j1gt.js";
import { m as pathExists, v as resolveUserPath } from "./utils-DMInpDZe.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-Dxc5qfRZ.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-kucERJ7Z.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-B4McueOi.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-B4McueOi.js");
