...
function loadAgentsBindModule() {
	return agentsBindModulePromise ??= import("./agents.commands.bind-D6d2_8NS.js");
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-B2R788RX.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-BsTifHAN.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-CvBvFUo3.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-8lcTXyI3.js")).agentsListCommand;
}
