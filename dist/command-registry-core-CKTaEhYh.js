...
import { a as defineImportedCommandGroupSpec, i as buildCommandGroupEntries, o as defineImportedProgramCommandGroupSpecs } from "./register.subclis-core-BiJ2k7ZW.js";
...
const coreEntrySpecs = [
	...withProgramOnlySpecs(defineImportedProgramCommandGroupSpecs([
		{
			...
			loadModule: () => import("./register.crestodian-71kc1Sgu.js"),
		...
		},
		{
			...
			loadModule: () => import("./register.maintenance-DlDthRAs.js"),
			exportName: "registerMaintenanceCommands"
		}
	])),
	defineImportedCommandGroupSpec(["message"], () => import("./register.message-D00-Henc.js"), (mod, { program, ctx }) => {
	...
	defineImportedCommandGroupSpec(["agent"], () => import("./register.agent-turn-ByIC6JB2.js"), (mod, { program, ctx }) => {
