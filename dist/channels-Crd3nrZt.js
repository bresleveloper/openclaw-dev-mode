...
import { t as danger } from "./globals-BWmHKFNH.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-BJfjPmGW.js";
import { a as getBundledChannelSetupPlugin } from "./bundled-rTRi0B0q.js";
import { r as replaceConfigFile } from "./config-A41fTHlt.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Ba1KQQW12.js";
...
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-Cssm6Brv.js";
...
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-F_XqecB-.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CT-6cfzY.js";
import { n as resolveLogFile } from "./log-tail-BfF7hMWx.js";
...
import { t as applyAgentBindings } from "./agents.bindings-CMgnI_zH.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-8T-WCW2i.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-CddmIy9Z.js";
import { t as channelsListCommand } from "./list-CjFqYOuP.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-CQM82L4a.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-C17dhlPZ.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-B4vWwEng.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-C4myiqDI.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BM9CxN6c.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-B3ZtWfIT.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-CNmof2Bx.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-7RQgpNFS.js");
