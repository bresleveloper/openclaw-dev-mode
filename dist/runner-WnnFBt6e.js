...
import { b as resolveModelRefFromString, i as buildModelAliasIndex, u as inferUniqueProviderFromConfiguredModels } from "./model-selection-shared-CKMggJal.js";
...
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-DPh9ARXg.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-Bij2Zf9G.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CdFDqUvQ.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-D7kPUIzQ.js";
import { n as resolveOpenAiAudioAuthModelApi } from "./openai-audio-api-BEkNYRPi.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-B3Lx6qPP.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-CTcoVG4G.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-BiBudBmg.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-IodENLup.js");
