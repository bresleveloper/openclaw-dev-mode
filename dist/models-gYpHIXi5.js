...
import { Fi as resolveAuthProfileDisplayLabel, G as readConfigFileSnapshotForWrite, Gn as setAuthProfileOrder, H as loadConfig, Kn as upsertAuthProfile, Ni as DEFAULT_MODEL, Pi as DEFAULT_PROVIDER, Sr as resolveDefaultModelForAgent, Un as listProfilesForProvider, Yn as ensureAuthProfileStore, _i as isNonSecretApiKeyMarker, _r as normalizeProviderId, di as resolveEnvApiKey, gi as shouldEnableShellEnvFallback, gt as parseDurationMs, l as resolveProfileUnusableUntilForDisplay, li as resolveApiKeyForProvider, lr as buildModelAliasIndex, mr as modelKey, n as resolveAuthProfileEligibility, nr as resolveOpenClawAgentDir, pi as getShellEnvAppliedKeys, q as setRuntimeConfigSnapshot, r as resolveAuthProfileOrder, si as getCustomProviderApiKey, tr as resolveAuthStorePathForDisplay, ui as resolveAwsSdkEnvVarName, ur as findNormalizedProviderValue, vr as parseModelRef, wr as resolveModelRefFromString, xr as resolveConfiguredModelRef, y as resolveSecretRefString } from "./auth-profiles-gyYFUuWS.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Cp0IkEKB.js";
...
import { Gt as maskApiKey, Jr as resolveModelWithRegistry, Jt as formatRemainingShort, Kt as DEFAULT_OAUTH_WARN_MS, fn as formatUsageWindowSummary, pn as resolveUsageProviderId, qt as buildAuthHealthSummary, un as loadProviderUsageSummary, ur as runEmbeddedPiAgent, wr as describeFailoverError } from "./compact-XX-hsoMs.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CUF-k9xj.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-m-ckvfYo.js";
import { t as ensureOpenClawModelsJson } from "./models-config-ZJ7RlkpC.js";
import { n as loadModelCatalog } from "./model-catalog-Cht1UAhe.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CJcKbZna.js";
import { f as openUrl } from "./onboard-helpers-BTGTJOdS.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Dnaodfgg.js";
import { r as withProgressTotals } from "./progress-Dfes2lhw.js";
import { t as createClackPrompter } from "./clack-prompter-Ci7xWqS9.js";
import { t as renderTable } from "./table-NdG_Wera.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-D84K7jgA.js";
import { n as redactSecrets } from "./format-C4DhwmBc.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-BeWngTI0.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-M_lgHWrK.js";
import { n as logConfigUpdated } from "./logging-C2FUa2rZ.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-COGffhrl.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-gyYFUuWS.js").then((n) => n.t);
