...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-DYM918bn.js";
...
import { b as resolveProviderEnvAuthLookupMaps, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-C4s6SbvA.js";
...
import { l as hasSyntheticLocalProviderAuthConfig, u as hasUsableCustomProviderApiKey } from "./model-auth-Bvz14MtI.js";
import { i as formatTokenK, m as createModelCatalogProviderAliasCanonicalizer, n as ensureFlagCompatibility, p as canonicalizeModelCatalogProviderAlias } from "./shared-ClkVsQjc.js";
import { n as loadModelsConfigWithSource } from "./load-config-QLVh8Z7c.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-fjfTv3AB.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-Bk1sDYUz.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-B8yJGM-E.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-vgV4_pkM.js"),
		import("./agent-scope-D47Q6HJs.js"),
		import("./workspace-D9K4qCwp.js")
	]);
