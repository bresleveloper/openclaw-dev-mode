...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-BXiL6bA6.js";
import { G as writeConfigFile, V as readConfigFileSnapshot, ct as resolveDefaultSecretProviderAlias } from "./auth-profiles-C39jSzPb.js";
import { t as formatCliCommand } from "./command-format-CLEQe4bk.js";
import { v as resolveUserPath } from "./utils-xLjEf_5u.js";
import { N as isValidEnvSecretRefId } from "./registry-DTmGzx3d.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-CaaiwG16.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CvZJNtQh.js";
...
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-RHUerEh1.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B2JAXun9.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Cr9bzXC8.js");
