...
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-DpFi-Ifv.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = createApprovalNativeRouteReporter({
		...
		requestGateway: async (method, params) => {
			const { callGatewayLeastPrivilege } = await import("./call-jEgftwN5.js");
