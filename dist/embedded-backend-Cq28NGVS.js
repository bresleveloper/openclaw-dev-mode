...
import { D as setEmbeddedMode } from "./openclaw-tools-VdzehAgr.js";
...
import { c as performGatewaySessionReset } from "./session-reset-service-V3Fs1nU_.js";
...
import { a as replaceOversizedChatHistoryMessages, i as enforceChatHistoryFinalBudget, t as CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES } from "./chat-CqNDpcid.js";
import { t as resolveLocalRunShutdownGraceMs } from "./local-run-shutdown-BiT-iHb_.js";
import { n as projectSessionsPatchEntry } from "./sessions-patch-DWdVObVP.js";
...
var EmbeddedTuiBackend = class {
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-Dvu1FOX0.js");
