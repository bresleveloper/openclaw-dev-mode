...
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-D-6NgVBv.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-Cx0tlNtn.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-Bo1Ud9A_.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-Df8_HFF5.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-BiViBCkK.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-DiIS2gcY.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-CTgXzLkH.js");
			...
			const { statusCommand } = await import("./status-GeHFPMeB.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-BiHfYXin.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-CrINKE39.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-DFeULjKr.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-06cYbxex.js");
