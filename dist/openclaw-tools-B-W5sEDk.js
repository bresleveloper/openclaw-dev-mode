...
import { o as resolveManifestContractOwnerPluginId } from "./plugin-registry-DPlZjBYT.js";
...
import { r as isDevMode } from "./globals-BElpud1m.js";
import { l as decodeWindowsTextFileBuffer } from "./windows-command-C7JEh9zV.js";
import { t as logDebug } from "./logger-D7QYAmug.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-DxnOT4sF.js";
...
import { s as resolveActionDeliveryTargetAlias } from "./channel-target-BYp_rGup.js";
...
import { c as callGateway } from "./call-5Sj7eTyY.js";
...
import { p as scheduleGatewaySigusr1Restart } from "./restart-BsXKx-Ww.js";
import { i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane, s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-C77NT24K.js";
import { o as normalizeChannelId } from "./registry-BUWrOy2m.js";
import { w as listRegisteredPluginAgentPromptGuidance } from "./command-registration-Bqy4xN_A.js";
import { d as listMediaGenerationProviderModels, f as synthesizeMediaGenerationCatalogEntries } from "./registry-CZzZT4dp.js";
import { g as registerAgentRunContext, i as clearAgentRunContext } from "./agent-events-CRggPZCM.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-Coa-CyIB.js";
import { o as resolveContextEngine } from "./registry-DaHwgHUl.js";
...
import { $ as parseSessionThreadInfo, S as loadSessionStore, v as updateSessionStore } from "./store-Cvp82S16.js";
...
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CWdFCyWd.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BZkf_9lB.js";
...
import { L as resolveSessionEntryCandidateTarget, w as patchSessionEntryWithKey } from "./session-accessor-CwhXEUId.js";
import { t as canonicalizeBase64 } from "./base64-hBzWwdnH.js";
import { t as extractDeliveryInfo } from "./delivery-info-C3YKGA0I.js";
import { v as normalizeProviderTransportWithPlugin } from "./provider-runtime-CIKTXkgy.js";
import "./auth-profiles-aoLBSIs2.js";
import { n as resolveApiKeyForProfile } from "./oauth-CNbgPg6s.js";
...
import { i as resolveAuthProfileOrder } from "./order-DjOYyPH4.js";
import { i as getModelProviderRequestTransport } from "./provider-request-config-DNsOe2me.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-DwnYeyqq.js";
import "./model-ref-shared-EY6njCR-.js";
import { a as normalizeModelRef, i as modelKey$1, n as findNormalizedProviderValue } from "./model-selection-normalize-Cj03z3tC.js";
import { r as ensureOpenClawModelsJson } from "./models-config-BVlG3rPj.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog, t as resolveThinkingDefault } from "./model-thinking-default-tUPEe2Ur.js";
import { c as resolveDefaultModelForAgent, d as resolvePersistedSelectedModelRef, i as normalizeStoredOverrideModel } from "./model-selection-CFL1kjzt.js";
...
import { n as loadModelCatalog } from "./model-catalog-CJwDdG-7.js";
import { f as stripInternalRuntimeContext } from "./internal-runtime-context-BW7WOTKc.js";
import { s as resolveProviderTransportSsrFPolicy, t as complete } from "./stream-rJVXLNrX.js";
import { s as unwrapSecretSentinelsForProviderEgress } from "./provider-local-service-0EmHG4yK.js";
import { Tt as writePrivateTempFile, V as createReadTool, Y as createEditTool, nt as formatFullOutputFooter, z as createWriteTool } from "./sessions-CZQw0uF9.js";
...
import { o as getApiKeyForModel, r as applySecretRefHeaderSentinels, s as getCustomProviderApiKey } from "./model-auth-Cg-0So6j.js";
...
import { n as resolveChannelDefaultBindingPlacement, r as resolveInboundConversationResolution } from "./conversation-binding-context-YQIR6IRl.js";
...
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-Bv5-Vohd.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Cl7I06QA.js";
import "./runtime-internal-OiU0x_qm.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as recordTaskRunProgressByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-BRur6lzE.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-BaGoOhG8.js";
import { r as readAcpSessionMeta } from "./session-meta-BSnnGiFM.js";
import { m as resolveActiveEmbeddedRunSessionId } from "./run-state-BZSsRYCZ.js";
import { a as formatEmbeddedAgentQueueFailureSummary, g as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-CGcPGyzc.js";
import { n as capArrayByJsonBytes } from "./session-utils.fs-CR-Ydxz0.js";
import { d as getSessionGoal, l as createSessionGoal, m as updateSessionGoalStatus, s as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-BIAJdhW6.js";
...
import { d as readSessionTitleFieldsFromTranscriptAsync } from "./session-transcript-readers-QQhnqU33.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-CnFuII5J.js";
import { H as resolveSubagentRunTimerDelayMs } from "./subagent-registry-state-CpzFPqiG.js";
import { b as resolveSessionModelIdentityRef, f as pruneLegacyStoreKeys, g as resolveGatewaySessionStoreTarget, r as deriveSessionTitle } from "./session-utils-D5cDecWw.js";
import { d as writeRestartSentinel, i as formatDoctorNonInteractiveHint, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-CXPZNLye.js";
import { u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-runtime-DGeRg_-o.js";
...
import { o as resolvePluginTools } from "./tools-D0RJIgtl.js";
import "./agent-bundle-mcp-tools-YySi1utk.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-fE_he60Y.js";
import { r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-O2vuhjLQ.js";
import { t as ensureContextEnginesInitialized } from "./init-iqdbzoxM.js";
import { n as discoverModels, t as discoverAuthStorage } from "./agent-model-discovery-B8Sf1SDS.js";
import { n as resolveModelAsync } from "./model-D8T34PHV.js";
import { c as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-DVJopZP6.js";
import { a as resolveSubagentCapabilities, c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, f as inheritedToolAllowPatch, h as normalizeInheritedToolDenylist, l as findAcpUnsupportedInheritedToolDeny, m as normalizeInheritedToolAllowlist, p as inheritedToolDenyPatch, s as getSubagentDepthFromSessionStore, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CsP4k-tO.js";
...
import { O as isEmbeddedMode, p as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-Bn4cnw4c.js";
import { a as proposeCreateSkill, d as resolvePendingSkillProposal, f as reviseSkillProposal, n as inspectSkillProposal, o as proposeUpdateSkill, r as listSkillProposals, s as quarantineSkillProposal, t as applySkillProposal, u as rejectSkillProposal } from "./service-D4pynt2I.js";
import { A as wrapToolParamValidation, D as normalizeFileToolPathParam, E as getToolParamsRecord, O as normalizeFileToolPathParamsFromKeys, S as isToolWrappedWithBeforeToolCallHook, T as assertRequiredParams, a as wrapToolWithGatewayCallerIdentity, c as setToolTerminalPresentation, d as listChannelSupportedActions, l as listAllChannelSupportedActions, n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool, w as REQUIRED_PARAM_GROUPS } from "./gateway-CmPZGwyr.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-BvfQ1me5.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-B_TbP7xZ.js";
import "./delivery-context-v0-gU4Pa.js";
import { n as createTranscriptsTool, r as resolveTranscriptsConfig } from "./transcripts-tool-HQSqlGnn.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-CmS_1rXy.js";
import { a as resolveRequesterOriginForChild, n as resolveSubagentModelAndThinkingPlan, o as resolveSubagentAllowedTargetIds, r as splitModelRef, s as resolveSubagentTargetPolicy, t as resolveConfiguredSubagentRunTimeoutSeconds } from "./subagent-spawn-plan-iBagnu51.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DAoDjTqU.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-DrKR8KMb.js";
import { t as createCrestodianTool } from "./crestodian-tool-B2jmSQIL.js";
import { r as gatewayCallOptionSchemaProperties, t as createCronTool } from "./cron-tool-Dm578Wy7.js";
import { t as normalizeConfigPatchReplacePaths } from "./patch-replace-paths-DLvXobiX.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BWaj9X3A.js";
import { a as recordCapabilityCandidateFailure, f as throwCapabilityGenerationFailure, h as resolveCapabilityModelRefForProviders, i as normalizeDurationToClosestMax, m as findCapabilityProviderById, n as buildNoCapabilityModelConfiguredMessage, o as resolveCapabilityModelCandidates, p as hasMediaNormalizationEntry, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-DLj3qmkt.js";
import { n as listRuntimeImageGenerationProviders, r as resolveImageGenerationMaxInputImages, t as generateImage } from "./runtime-CF3b_VkA.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BPBvtgol.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-D7E1O4Tn.js";
...
import { r as getDefaultLocalRoots } from "./local-media-access-Be6C1Gk2.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-CJF7B-0e.js";
import { a as loadSessionEntryByKey, d as formatAgentInternalEventsForPrompt, i as loadRequesterSessionEntry, m as mediaUrlsFromGeneratedAttachments, n as deliverSubagentAnnouncement, p as formatGeneratedAttachmentLines, t as resolveAnnounceOrigin } from "./subagent-announce-origin-COyWymGb.js";
import { i as routeToDeliveryFields, n as routeFromBindingRecord } from "./route-projection-C3O_0r9f.js";
import { i as dispatchGatewayMethodInProcess, s as hasInProcessGatewayContext } from "./server-plugins-5TViMpLp.js";
...
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-Dj_cf-ur.js";
import { a as runWithImageModelFallback, n as resolveImageFallbackCandidates, r as resolveImageFallbackDefaultProvider } from "./model-fallback-DCdP137c.js";
...
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-C_INu5Vg.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DrIIhPNn.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-D7nHkmgM.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CsRCgGrQ.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BK3bTOCE.js";
import { c as resolveTimeoutMs } from "./resolve-Dk6xzz5x.js";
import "./media-understanding-B717fhuK.js";
import { c as postJsonRequest, m as resolveProviderHttpRequestConfigWithOriginTrust } from "./shared-CZMxJ_eJ.js";
...
import { t as resolveEnabledBundledManifestContractPlugins } from "./bundled-manifest-contract-plugins-COnlSJiD.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-D69jAQ1Z.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-ChySUOBS.js";
import { o as parseInteractiveParam, s as parseJsonMessageParam } from "./message-action-dispatch-Cdo79PsN.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as stripFormattedReasoningMessage, t as getToolResult } from "./message-action-runner-BuadlhlQ.js";
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-Ver7bPHZ.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-DAkq8mUP.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-C6FasDKb.js";
import { a as writeScreenRecordToFile, c as parseCameraClipPayload, d as writeCameraPayloadToFile, i as screenSnapshotTempPath, l as parseCameraSnapPayload, n as parseScreenSnapshotPayload, o as writeScreenSnapshotToFile, r as screenRecordTempPath, s as cameraTempPath, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-5ZNPHKnk.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-ny_U_S6L.js";
import { w as extractPdfContent } from "./runner.entries-DnvoQiDP.js";
import { s as resolveAnthropicMessagesUrl, t as registerProviderStreamForModel } from "./provider-stream-DeG5lLFa.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-B-42D_SY.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-vohwTiWf.js";
...
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot, t as isRecoverableAgentWaitError } from "./run-wait-Gqzj1med.js";
import { f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-BBmpykEK.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, f as supportsAutomaticThreadBindingSpawn, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, t as formatThreadBindingDisabledError, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DuqhAvqy.js";
import { h as registerSubagentRun, i as countActiveRunsForSession } from "./subagent-registry-DJsn62YU.js";
...
import { t as forkSessionEntryFromParent } from "./session-fork-DfIJcRuB.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-Bs91RWap.js";
import { n as buildSubagentList } from "./subagent-list-DX-C9x5b.js";
import { a as listControlledSubagentRuns, o as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-CJtpDyU6.js";
import { a as wrapExternalContent, o as wrapWebContent } from "./external-content-CycSUXwl.js";
import { k as textToSpeech } from "./tts-runtime-B5YcFAvQ.js";
import "./tts-CzHppyZN.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-B3fqnExs.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-Dp0EJWZV.js";
...
import { a as runWebSearch } from "./runtime-DWDVJPjG.js";
import "./web-search-provider-common-Dl5iO48q.js";
...
async function tryDeliverMediaGenerationDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-DaB07opG.js");
		await sendMessage({
			cfg: params.config,
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-BGcdFoqH.js");
}
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-Drbpxk1T.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-jEgftwN5.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-BBxr9G5t.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-f0R6ah8D.js"));
