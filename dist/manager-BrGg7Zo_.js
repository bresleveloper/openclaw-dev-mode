...
import { Et as onSessionTranscriptUpdate, Fl as retryAsync, Gl as resolveOllamaApiBase, iu as normalizeOptionalSecretInput, ll as resolveEnvApiKey, ol as requireApiKey, sl as resolveApiKeyForProvider } from "./auth-profiles-CIqoN6FN.js";
import { a as resolveAgentDir, d as resolveAgentWorkspaceDir, i as resolveAgentConfig } from "./agent-scope-BAb0j1gt.js";
import { T as truncateUtf16Safe, i as clampNumber, r as clampInt, v as resolveUserPath } from "./utils-DMInpDZe.js";
import { a as hasConfiguredSecretInput, c as normalizeResolvedSecretInputString } from "./types.secrets-BEA4gMCN.js";
import { r as formatErrorMessage } from "./errors-D6OHuY6d.js";
...
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DmIVW9sh.js";
import { C as buildCaseInsensitiveExtensionGlob, D as normalizeMemoryMultimodalSettings, E as isMemoryMultimodalEnabled, O as supportsMemoryMultimodalEmbeddings, S as statRegularFile, T as getMemoryMultimodalExtensions, _ as hasNonTextEmbeddingParts, a as buildFileEntry, b as splitTextToUtf8ByteLimit, c as cosineSimilarity, d as isMemoryPath, f as listMemoryFiles, g as runWithConcurrency, h as remapChunkLines, i as sessionPathForFile, k as extractKeywords, l as ensureDir, m as parseEmbedding, n as buildSessionEntry, o as buildMultimodalChunkForIndexing, p as normalizeExtraMemoryPaths, r as listSessionFilesForAgent, s as chunkMarkdown, t as requireNodeSqlite, u as hashText, v as estimateStructuredEmbeddingInputBytes, w as classifyMemoryMultimodalPath, x as isFileMissingError, y as estimateUtf8Bytes } from "./sqlite-Bqsue8ZW.js";
...
var MemoryManagerEmbeddingOps = class extends MemoryManagerSyncOps {
	...
	async embedBatchInputsWithRetry(inputs) {
		...
		while (true) try {
			...
			if (!this.isRetryableEmbeddingError(message) || attempt >= EMBEDDING_RETRY_MAX_ATTEMPTS) throw err;
			const waitMs = Math.min(EMBEDDING_RETRY_MAX_DELAY_MS, Math.round(delayMs * (1 + Math.random() * .2)));
			log$1.warn(`memory embeddings rate limited; retrying structured batch in ${waitMs}ms`);
			await new Promise((resolve) => setTimeout(resolve, waitMs));
			delayMs *= 2;
			attempt += 1;
		}
...
//#endregion
export { resolveMemorySearchConfig as a, hasConfiguredMemorySecretInput as i, closeAllMemoryIndexManagers as n, DEFAULT_LOCAL_MODEL as r, MemoryIndexManager as t };
