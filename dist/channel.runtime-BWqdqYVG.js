...
import "./accounts-RiukC7wL.js";
import "./runtime-api-CVsVynVr.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-BLeNS-Pc.js";
import { t as sendMessageZalo } from "./send-DMOsNQeb.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-BcmKA8hx.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-D5-ozgP9.js");
