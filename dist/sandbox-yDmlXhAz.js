...
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-_3aaGW_c.js";
import { c as DEFAULT_USER_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DP5mE--D.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, w as SANDBOX_STATE_DIR, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-UhIe7zkb.js";
import { n as isToolAllowed } from "./tool-policy-CpCrrYL4.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-BED9GPs6.js";
...
async function syncSandboxSkillsToWorkspace(params) {
	try {
		const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
			import("./workspace-ZDGpU-mC.js"),
			import("./remote-CULvOFOE.js"),
			import("./exec-defaults-Dsm6U--j.js")
		]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-BfJ6Edi5.js")).maybePruneSandboxes(cfg);
