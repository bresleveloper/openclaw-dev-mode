...
import { i as getRuntimeConfig, r as createConfigIO } from "./io-DxnOT4sF.js";
import { r as replaceConfigFile } from "./config-Cc93keN1.js";
import { i as resolveAuthProfileDatabaseFilePaths } from "./sqlite-CvwJ2KO6.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-bOND9VJZ.js";
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-D69jAQ1Z.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-e0M1EgsC.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-DDP2-7ag.js");
