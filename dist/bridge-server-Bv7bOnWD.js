...
import { n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-Bc37Bra2.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-Bg0vWgJt.js"), import("./routes-CbuNwdyk.js")]);
