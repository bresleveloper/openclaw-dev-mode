...
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-boxSkuLJ.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-gBVG4H2O.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-C8XyqPFW.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-BMzX_BCr.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-8lcTXyI3.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-DeTYSDVT.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-CUwHIzWb.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-BUmwJDv5.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-1mMPn7md.js");
			...
			const { statusCommand } = await import("./status-BxGJUV4k.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-kJyL-F-g.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-DJ4vw_tv.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-CzYs-snr.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-DkycpPry.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-DGX06opb.js");
