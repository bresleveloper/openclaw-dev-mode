...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send2.components-bvuvd5US.js").then((module) => module.sendDiscordComponentMessage);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings--y7IEG_e.js");
