...
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-DcumsU8F.js");
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-Bd8D8bip.js");
...
async function runCoreContributionHealthRepair(ctx, checkIds) {
	...
	const { CORE_HEALTH_CHECKS } = await import("./doctor-core-checks-DcumsU8F.js");
	const { runDoctorHealthRepairs } = await import("./doctor-repair-flow-BfHI6ZCN.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-D47Q6HJs.js");
