...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-Dxc5qfRZ.js").then((n) => n.d);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-h4znknPe.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-DRF_pgYm.js").then((n) => n.r);
	...
	const { applyOnboardingLocalWorkspaceConfig } = await import("./onboard-config-BbiRxt4y.js").then((n) => n.n);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-B2U7b5cx.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-CeePUhSh.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BsbfKg1F.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-BoOpp-25.js").then((n) => n.i);
	...
	if (authChoice === "ollama") {
		const { ensureOllamaModelPulled } = await import("./ollama-setup-BCi30idW.js").then((n) => n.r);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-CMHysOWa.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-CjLMQbHJ.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-DtAw5KEI.js").then((n) => n.n);
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-B4McueOi.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-JFjSWHCg.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-BTgMjm6a.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-GxDBn9w8.js");
