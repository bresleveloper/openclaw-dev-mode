...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-D9P8rh0g.js";
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-CXgh5nx1.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-5sRoG2Yo.js"));
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-iqJBYLx8.js");
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-BQzqwP6h.js");
