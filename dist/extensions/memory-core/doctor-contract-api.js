...
import { t as resolveOpenClawAgentSqlitePath } from "../../openclaw-agent-db.paths-B1F15xt1.js";
import { t as ensureOpenClawAgentDatabaseSchema } from "../../openclaw-agent-db-ykdezOxO.js";
import "../../routing-D2F-kIi9.js";
import { a as MEMORY_EMBEDDING_CACHE_TABLE, c as MEMORY_INDEX_META_TABLE, d as MEMORY_INDEX_VECTOR_TABLE, f as ensureMemoryIndexSchema, i as loadSqliteVecExtension, l as MEMORY_INDEX_SOURCES_TABLE, o as MEMORY_INDEX_CHUNKS_TABLE, r as requireNodeSqlite, s as MEMORY_INDEX_FTS_TABLE } from "../../engine-storage-CkR0WZTF.js";
import { n as legacyStateFileExists, t as archiveLegacyStateSource } from "../../runtime-doctor-BiIPRbN0.js";
...
import { a as SHORT_TERM_STORE_RELATIVE_PATH, f as normalizeShortTermPhaseSignalStore, i as SHORT_TERM_PHASE_SIGNAL_RELATIVE_PATH, p as normalizeShortTermRecallStore } from "../../short-term-promotion-B_Tp_IBc.js";
import { a as normalizeSessionIngestionState, i as normalizeDailyIngestionState, n as SESSION_INGESTION_STATE_RELATIVE_PATH, t as DAILY_INGESTION_STATE_RELATIVE_PATH } from "../../dreaming-phases-ByKEfhjx.js";
...
var LegacyMemoryRowsConflictError = class extends Error {
...
function assertLegacyRowsCopied(db, query, tableName) {
	...
	if (Number(row?.missing ?? 0) > 0) throw new LegacyMemoryRowsConflictError(tableName);
}
