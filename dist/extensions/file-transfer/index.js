...
import { a as DIR_LIST_TOOL_DESCRIPTOR, c as FILE_FETCH_TOOL_DESCRIPTOR, d as FILE_WRITE_TOOL_DESCRIPTOR, r as DIR_FETCH_TOOL_DESCRIPTOR } from "../../descriptors-lNlRK1Me.js";
//#region extensions/file-transfer/src/shared/lazy-node-invoke-policy.ts
const loadFileTransferNodeInvokePolicy = async () => {
	const { createFileTransferNodeInvokePolicy } = await import("../../node-invoke-policy-CqLuvxIU.js");
	...
	nodeHostCommands: [
		{
			...
			handle: async (paramsJSON) => {
				const { handleFileFetch } = await import("../../file-fetch-CWqxFQEr.js");
		...
		},
		{
			...
			dangerous: true,
			handle: async (paramsJSON) => {
				const { handleDirList } = await import("../../dir-list-C4q8OpXj.js");
		...
		},
		{
			...
			dangerous: true,
			handle: async (paramsJSON) => {
				const { handleDirFetch } = await import("../../dir-fetch-u8-1plVl.js");
		...
		},
		{
			...
			dangerous: true,
			handle: async (paramsJSON) => {
				const { handleFileWrite } = await import("../../file-write-DDc9FWH5.js");
