...
import { c as updateSessionStoreEntry, r as listSessionEntries } from "../../session-store-runtime-DhRD848I.js";
...
async function migrateSource(source, candidates, params, store) {
	...
	try {
		return await withFileLock(source.sidecarPath, LEGACY_BINDING_LOCK_OPTIONS, async () => {
			...
			const [{ bindingStoreKey, createStoredCodexAppServerBinding, normalizeStoredCodexAppServerBindingFingerprints, readStoredCodexAppServerBinding }, { legacyCodexConversationBindingId }] = await Promise.all([import("../../session-binding-BJV3WnzZ.js"), import("../../conversation-binding-data-trK-Vccs.js")]);
