...
import { i as resolveMatrixCredentialsFilename, r as resolveMatrixCredentialsDir } from "../../storage-paths-CEy_n5xp.js";
...
function listMatrixCredentialPaths(_cfg, env = process.env) {
	...
	const paths = /* @__PURE__ */ new Set([resolveMatrixCredentialsFilename(), resolveMatrixCredentialsFilename("default")]);
	try {
