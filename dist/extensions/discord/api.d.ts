...
import { mt as DiscordExecApprovalConfig } from "../../types.channels-2ARZmGtj.js";
import { f as AgentToolResult } from "../../types-BoFHdU9q.js";
import { P as ChannelStatusIssue, m as ChannelGroupContext, r as ChannelAccountSnapshot, y as ChannelMessageActionContext } from "../../types.core-DDKBE3_n.js";
import { s as ChannelOutboundPayloadHint } from "../../outbound.types-BRIWiS6p.js";
import { C as OpenClawPluginApi } from "../../types-BVLQjFJF.js";
...
import { n as DiscordTokenResolution, t as DiscordCredentialStatus } from "../../token-UmRCr2g7.js";
import { n as inspectDiscordAccount, t as InspectedDiscordAccount } from "../../account-inspect-S_c4RNCv.js";
import { a as mergeDiscordAccountConfig, c as resolveDiscordAccountConfig, i as listEnabledDiscordAccounts, l as resolveDiscordMaxLinesPerMessage, n as createDiscordActionGate, o as resolveDefaultDiscordAccountId, r as listDiscordAccountIds, s as resolveDiscordAccount, t as ResolvedDiscordAccount } from "../../accounts-BzALayMx.js";
import { a as fetchDiscordApplicationId, c as probeDiscord, i as DiscordProbe, l as resolveDiscordPrivilegedIntentsFromFlags, n as DiscordPrivilegedIntentStatus, o as fetchDiscordApplicationSummary, r as DiscordPrivilegedIntentsSummary, s as parseApplicationIdFromToken, t as DiscordApplicationSummary } from "../../probe-cIwOhmWx.js";
import { t as discordPlugin } from "../../channel-CLTQ9qde.js";
import { t as discordSetupPlugin } from "../../channel.setup-DpcXr7cE.js";
import { f as ThreadBindingTargetKind } from "../../thread-bindings.manager-D9PovMxW.js";
import { a as ComponentData } from "../../components.modal-CfcqgDWd.js";
import { A as parseDiscordComponentCustomIdForInteraction, C as DiscordModalFieldSpec, D as buildDiscordComponentCustomId, E as DISCORD_MODAL_CUSTOM_ID_KEY, M as parseDiscordModalCustomIdForInteraction, O as buildDiscordModalCustomId, S as DiscordModalFieldDefinition, T as DISCORD_COMPONENT_CUSTOM_ID_KEY, _ as DiscordComponentSectionAccessory, a as DISCORD_COMPONENT_ATTACHMENT_PREFIX, b as DiscordComponentSelectType, c as buildDiscordComponentMessage, d as DiscordComponentBuildResult, f as DiscordComponentButtonSpec, g as DiscordComponentModalFieldType, h as DiscordComponentMessageSpec, i as createDiscordFormModal, j as parseDiscordModalCustomId, k as parseDiscordComponentCustomId, l as buildDiscordComponentMessageFlags, m as DiscordComponentEntry, n as buildDiscordInteractiveComponents, o as readDiscordComponentSpec, p as DiscordComponentButtonStyle, r as DiscordFormModal, s as resolveDiscordComponentAttachmentName, t as formatDiscordComponentEventText, u as DiscordComponentBlock, v as DiscordComponentSelectOption, w as DiscordModalSpec, x as DiscordModalEntry, y as DiscordComponentSelectSpec } from "../../components-C-KyGmqQ.js";
...
import { n as DiscordInteractiveHandlerRegistration, t as DiscordInteractiveHandlerContext } from "../../interactive-dispatch-DfgQpMTm.js";
...
import { t as collectDiscordSecurityAuditFindings } from "../../security-audit-oj3N1vsa.js";
...
import { v as DiscordSendResult } from "../../send.types-baZVLRXz.js";
