...
var bonjour_default = definePluginEntry({
	...
	register(api) {
		api.registerGatewayDiscoveryService({
			id: "bonjour",
			advertise: async (ctx) => {
				const [{ startGatewayBonjourAdvertiser }, { registerUncaughtExceptionHandler, registerUnhandledRejectionHandler }] = await Promise.all([import("../../advertiser-L5AX2gpP.js"), import("../../plugin-sdk/runtime.js")]);
