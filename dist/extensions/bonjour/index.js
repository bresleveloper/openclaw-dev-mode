...
var bonjour_default = definePluginEntry({
	...
	register(api) {
		api.registerGatewayDiscoveryService({
			id: "bonjour",
			advertise: async (ctx) => {
				const [{ startGatewayBonjourAdvertiser }, { registerUncaughtExceptionHandler, registerUnhandledRejectionHandler }] = await Promise.all([import("../../advertiser-DBxOtyH9.js"), import("../../plugin-sdk/runtime.js")]);
