...
import { c as getOfficialExternalPluginCatalogManifest, p as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-Dxs5EUfF.js";
...
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DNsOe2me.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-BMRrT_lG.js";
...
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-DRw0iAnV.js";
...
import { n as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-CazXRLRM.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-DSbuCFIb.js";
import { t as describeImageWithModel } from "./image-runtime-D7nHkmgM.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, n as DEFAULT_MAX_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-CsRCgGrQ.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-Dk6xzz5x.js";
...
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DbLF9APD.js";
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-r16X7Vq9.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-2dCLWyT4.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
