...
import { _ as shortenHomePath, c as isRecord } from "./utils-BApvfmPs.js";
...
import { i as openOpenClawStateDatabase, o as runOpenClawStateWriteTransaction } from "./openclaw-state-db-gblCDNfo.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-DFJoFB6-.js";
import { l as BASE_THINKING_LEVELS } from "./thinking-DxaN427I.js";
...
import { t as resolveGatewayClientBootstrap } from "./client-bootstrap-G6LMePzt.js";
import { t as readSecretFromFile } from "./secret-file-D63SxMCd.js";
import { t as resolveGatewayAuthOptions } from "./gateway-secret-options-B-gUutAl.js";
...
async function getAvailableCommandsForAcp() {
	acpCommandsModulePromise ??= import("./commands-CZwrPfLL.js");
...
var AcpGatewayAgent = class {
	...
	async prompt(params) {
		...
		if (Buffer.byteLength(message, "utf-8") > getMaxPromptBytes()) throw new Error(`Prompt exceeds maximum allowed size of ${getMaxPromptBytes()} bytes`);
