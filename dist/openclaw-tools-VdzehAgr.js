...
import { b as truncateUtf16Safe, c as isRecord$1, m as resolveUserPath } from "./utils-BApvfmPs.js";
...
import { o as resolveAgentEffectiveModelPrimary, s as resolveAgentExecutionContract, v as resolveSessionAgentId, y as resolveSessionAgentIds } from "./agent-scope-CDZXADgT.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, i as isCronSessionKey, r as isCronRunSessionKey, u as parseThreadSessionSuffix } from "./session-key-utils-C7uT9A4s.js";
import { n as normalizeAccountId } from "./account-id-5IgE9UKY.js";
import { b as toAgentStoreSessionKey, i as buildAgentMainSessionKey, l as isValidAgentId, p as resolveAgentIdFromSessionKey, t as DEFAULT_AGENT_ID, u as normalizeAgentId } from "./session-key-pTKRJb0m.js";
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-C3ijpoNo.js";
...
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-DYM918bn.js";
...
import { t as loadBundledPluginPublicArtifactModuleFromCandidatesSync } from "./public-surface-loader-Dxs7o6SG.js";
import { r as isDevMode } from "./globals-BWmHKFNH.js";
import { l as decodeWindowsTextFileBuffer } from "./windows-command-D_FPG0Kg.js";
import { t as logDebug } from "./logger-p_Dm5cGu.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-BJfjPmGW.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-CNlVI3wV.js";
import { t as getProviderEnvVars } from "./provider-env-vars-DFJoFB6-.js";
import { h as isWindowsDrivePath } from "./archive-Dcpo6Wva.js";
import { t as applyMergePatch } from "./merge-patch-C_IYaUrT.js";
...
import { n as isRestartEnabled } from "./commands.flags-BUxITaVI.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-CcqJJIan.js";
import { c as callGateway } from "./call-Du-jF5Kg.js";
import { r as GatewayClientRequestError } from "./client-C8-EgcVB.js";
...
import { p as scheduleGatewaySigusr1Restart } from "./restart-D2h2urGo.js";
import { i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane, s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-CqVcoNpy.js";
import { o as normalizeChannelId } from "./registry-B5Y8tTE-.js";
import { N as listRegisteredPluginAgentPromptGuidance } from "./command-registration-DbqkNaUv.js";
import { d as listMediaGenerationProviderModels, f as synthesizeMediaGenerationCatalogEntries } from "./registry-yozg2pVI.js";
...
import { t as getGlobalHookRunner } from "./hook-runner-global-D4fQSLSV.js";
...
import { n as assertSandboxPath } from "./sandbox-paths-_3aaGW_c.js";
import "./local-file-access-CBe_wA_B.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-bmZsBEHq.js";
import { G as parseSessionThreadInfoFast, _ as updateSessionStore, b as loadSessionStore } from "./store-DJ7wx5_V.js";
import { h as stringifyRouteThreadId } from "./channel-route-BhPKCG_0.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext } from "./delivery-context.shared-D36KNc_D.js";
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-constants-Z0pS5ykd.js";
import { a as resolveSessionFilePath, d as resolveStorePath, o as resolveSessionFilePathOptions } from "./paths-CHZBIGhF.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-Ba1KQQW12.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BLH0VcFH.js";
...
import { t as extractDeliveryInfo } from "./delivery-info-DKRHRtM6.js";
import { t as canonicalizeBase64 } from "./base64-l6yrCyHc.js";
import { _ as normalizeProviderTransportWithPlugin } from "./provider-runtime-D4NEMgBr.js";
import "./auth-profiles-DWHvUh-t.js";
import { n as resolveApiKeyForProfile } from "./oauth-De-NOeYf.js";
...
import { i as resolveAuthProfileOrder } from "./order-DO7M8GzY.js";
import { b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-CKMggJal.js";
import "./model-ref-shared-D4KabxN2.js";
import { a as normalizeModelRef, i as modelKey$1, n as findNormalizedProviderValue } from "./model-selection-normalize-Df7baLev.js";
import { r as ensureOpenClawModelsJson } from "./models-config-ChaTzZG5.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog, t as resolveThinkingDefault } from "./model-thinking-default-GwbGGXiw.js";
import { c as resolveDefaultModelForAgent, d as resolvePersistedSelectedModelRef, i as normalizeStoredOverrideModel } from "./model-selection-i8V2iTdL.js";
...
import { n as loadModelCatalog } from "./model-catalog-DD_dq4PJ.js";
import { d as stripInternalRuntimeContext } from "./internal-runtime-context-BH_40W4f.js";
import { t as complete } from "./stream-Bs1DzXcN.js";
import { V as createReadTool, Y as createEditTool, z as createWriteTool } from "./sessions-DP0wANEo.js";
import { u as saveMediaBuffer } from "./store-MjA3hYFB.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource, s as resolveMediaReferenceSandboxPath } from "./media-reference-zSHhNOuj.js";
import { s as getImageMetadata } from "./image-ops-DdUL3po0.js";
import { a as getApiKeyForModel, o as getCustomProviderApiKey } from "./model-auth-Bvz14MtI.js";
...
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-UC1XNEPo.js";
import { n as extractTextFromChatContent } from "./chat-content-BbLAEXko.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Df6f9W0E.js";
import "./runtime-internal-BgpYM7w3.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-BFt5Tdox.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-CLQRswVp.js";
import { r as readAcpSessionMeta } from "./session-meta-SVmmuxkv.js";
import { r as normalizeCronJobPatch, t as normalizeCronJobCreate } from "./normalize-BzS-Bdfc.js";
import { f as resolveActiveEmbeddedRunSessionId } from "./run-state-rO_N-hh3.js";
import { i as formatEmbeddedAgentQueueFailureSummary, m as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-DXoQzrw0.js";
import { n as capArrayByJsonBytes } from "./session-utils.fs-CuEupzWa.js";
import { d as getSessionGoal, l as createSessionGoal, p as updateSessionGoalStatus, s as MODEL_UPDATABLE_SESSION_GOAL_STATUSES } from "./sessions-gBZPP61K.js";
...
import { u as readSessionTitleFieldsFromTranscriptAsync } from "./session-transcript-readers-B1Z-s_uS.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-DjPe21q4.js";
import { V as resolveSubagentRunTimerDelayMs } from "./subagent-registry-state-Cv1s7-5K.js";
import { f as pruneLegacyStoreKeys, g as resolveGatewaySessionStoreTarget, r as deriveSessionTitle, y as resolveSessionModelIdentityRef } from "./session-utils-CWlrm3MP.js";
import { d as writeRestartSentinel, i as formatDoctorNonInteractiveHint, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-CKt0KTTM.js";
...
import { n as getSessionBindingService } from "./session-binding-service-QCvSH7Sy.js";
import { a as hasReplyPayloadContent } from "./payload-BCsfdv86.js";
import { a as resolveSubagentCapabilities, c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, f as inheritedToolAllowPatch, h as normalizeInheritedToolDenylist, l as findAcpUnsupportedInheritedToolDeny, m as normalizeInheritedToolAllowlist, p as inheritedToolDenyPatch, s as getSubagentDepthFromSessionStore, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-BHXzkIhw.js";
import { D as listChannelSupportedActions, T as listAllChannelSupportedActions, _ as setToolTerminalPresentation, c as isToolWrappedWithBeforeToolCallHook, h as wrapToolWithBeforeToolCallHook } from "./agent-tools.before-tool-call-CP6dTokt.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-zZMI7zVq.js";
import { a as resolvePluginTools } from "./tools-DG6VDQeD.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-Cssm6Brv.js";
...
import { r as sanitizeToolResultImages } from "./tool-images-BariNQM5.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BHJLRjIg.js";
...
import { u as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-runtime-BkUYqKo5.js";
import "./agent-bundle-mcp-tools-CJT5lUbs.js";
import { c as getToolParamsRecord, f as wrapToolParamValidation, l as normalizeFileToolPathParam, n as resolveNode, o as REQUIRED_PARAM_GROUPS, r as resolveNodeId, s as assertRequiredParams, u as normalizeFileToolPathParamsFromKeys } from "./nodes-utils-B5ynlPJm.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-DK0GFdj5.js";
import "./delivery-context-De41yADh.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-fE_he60Y.js";
import { r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-DnfU3-5B.js";
import { n as createTranscriptsTool, r as resolveTranscriptsConfig } from "./transcripts-tool-CGcAS0MO.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-Bmiuaekf.js";
import { a as resolveRequesterOriginForChild, d as resolveSubagentTargetPolicy, l as resolveSpawnedWorkspaceInheritance, n as resolveSubagentModelAndThinkingPlan, o as mapToolContextToSpawnedRunMetadata, r as splitModelRef, s as normalizeSpawnedRunMetadata, t as resolveConfiguredSubagentRunTimeoutSeconds, u as resolveSubagentAllowedTargetIds } from "./subagent-spawn-plan-_-imzziC.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-CW4B_GVt.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-C4SbQrlb.js";
import { t as resolveCronCreationDelivery } from "./delivery-context-CsnmcKIq.js";
...
import { r as getDefaultLocalRoots } from "./local-media-access-DrwKPfBC.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-DnX3imnL.js";
import { a as loadSessionEntryByKey, b as formatGeneratedAttachmentLines, i as loadRequesterSessionEntry, n as deliverSubagentAnnouncement, t as resolveAnnounceOrigin, v as formatAgentInternalEventsForPrompt, x as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-origin-Cm7eFq5o.js";
import { i as routeToDeliveryFields, n as routeFromBindingRecord } from "./route-projection-CXY21LPh.js";
import { a as hasInProcessGatewayContext, r as dispatchGatewayMethodInProcess } from "./server-plugins-C9ffnAIC.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-DPh9ARXg.js";
import { a as hasProviderAuthForTool, c as resolveOpenAiImageMediaCandidate, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-DuEC1jHA.js";
import { a as runWithImageModelFallback, n as resolveImageFallbackCandidates, r as resolveImageFallbackDefaultProvider } from "./model-fallback-xjR_RHVQ.js";
import { n as discoverModels, t as discoverAuthStorage } from "./agent-model-discovery-cz3KU1Ag.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-Dtvp_gIN.js";
import { n as extractAssistantText } from "./embedded-agent-utils-B9lC4_IJ.js";
import { i as readResponseBodySnippet, n as isMinimaxVlmProvider } from "./minimax-vlm-Bij2Zf9G.js";
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-B9E7Vmx0.js";
import { n as normalizeMediaProviderId } from "./provider-id-DSbuCFIb.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DBYobbdU.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BQzspu3i.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS, u as buildMediaUnderstandingRegistry } from "./defaults.constants-CdFDqUvQ.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BK3bTOCE.js";
import { c as resolveTimeoutMs } from "./resolve-D7kPUIzQ.js";
import "./media-understanding-D06kjTwz.js";
import { n as resolveModelAsync } from "./model-Cc001htM.js";
import { c as resolveBundledStaticCatalogModel, t as bundledStaticCatalogProviderUsesRuntimeAugment } from "./model.static-catalog-BxhHL979.js";
...
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-8T81-Xu7.js";
import { t as resolveMessageSecretScope } from "./message-secret-scope-CglxJANN.js";
import { o as parseInteractiveParam, s as parseJsonMessageParam } from "./message-action-dispatch-Buy2liL_.js";
import { a as SHARED_POLL_CREATION_PARAM_NAMES, i as POLL_CREATION_PARAM_DEFS, n as runMessageAction, r as stripFormattedReasoningMessage, t as getToolResult } from "./message-action-runner-DhMR7SSJ.js";
import { a as resolveAllowedMessageActions, s as shouldApplyCrossContextMarker } from "./outbound-policy-CxvT5RkW.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-pD5KdCnQ.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BV3lN8MO.js";
import { a as writeScreenRecordToFile, c as parseCameraClipPayload, d as writeCameraPayloadToFile, i as screenSnapshotTempPath, l as parseCameraSnapPayload, n as parseScreenSnapshotPayload, o as writeScreenSnapshotToFile, r as screenRecordTempPath, s as cameraTempPath, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DeJCQSZj.js";
import { T as resolveEnabledBundledManifestContractPlugins, w as extractPdfContent } from "./runner.entries-B3Lx6qPP.js";
import { c as resolveAnthropicMessagesUrl } from "./provider-stream-BSVCqT_P.js";
...
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-HQtTuEya.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-DBLJaeyE.js";
...
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DItkRKcA.js";
import { f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-BqfvjLCt.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, f as supportsAutomaticThreadBindingSpawn, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, t as formatThreadBindingDisabledError, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-YspKXCyk.js";
import { h as registerSubagentRun, i as countActiveRunsForSession } from "./subagent-registry-CY2D47cH.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-Ch4Mykew.js";
import { r as resolveInboundConversationResolution, t as resolveChannelDefaultBindingPlacement } from "./conversation-resolution-BNDeZowL.js";
import { i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText } from "./thread-bindings-messages-DAW2rZA4.js";
import { t as forkSessionEntryFromParent } from "./session-fork-ByezDFY9.js";
import { t as ensureContextEnginesInitialized } from "./init-D5KWQrGz.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-Bs91RWap.js";
import { a as proposeUpdateSkill, d as reviseSkillProposal, i as proposeCreateSkill, l as rejectSkillProposal, n as inspectSkillProposal, o as quarantineSkillProposal, r as listSkillProposals, t as applySkillProposal, u as resolvePendingSkillProposal } from "./service-DCXLp0ol.js";
import { n as buildSubagentList } from "./subagent-list-NzJMuJHj.js";
import { a as listControlledSubagentRuns, o as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-CjG58-es.js";
import { a as wrapExternalContent, o as wrapWebContent } from "./external-content-CycSUXwl.js";
import { k as textToSpeech } from "./tts-runtime-CX2QUXBY.js";
import "./tts-Bvnit7ux.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-D0QjEjym.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-BqGPjkaz.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-Da_3Al2P.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-CQo6kD9L.js";
...
import { a as runWebSearch } from "./runtime-C5yTEi2_.js";
import "./web-search-provider-common-nYY4q9uU.js";
...
function capCronAgentTurnJobToolsAllow(value, creatorToolAllowlist) {
	if (!creatorToolAllowlist || !isRecord$1(value) || !isRecord$1(value.payload)) return;
...
async function capCronAgentTurnUpdatePatchToolsAllow(params) {
	...
	const payload = isRecord$1(params.patch.payload) ? params.patch.payload : void 0;
	...
	const existingPayload = isRecord$1(existing) ? existing.payload : void 0;
	...
	capCronAgentTurnToolsAllow({
		payload: nextPayload,
		creatorToolAllowlist: params.creatorToolAllowlist,
		defaultToolsAllow: existingPayloadKind === "agentTurn" && isRecord$1(existingPayload) ? existingPayload.toolsAllow : void 0
	});
}
...
function formatCronTerminalPresentation(params, result) {
	if (!isRecord$1(params) || !isRecord$1(result) || !isRecord$1(result.details)) return;
...
async function tryDeliverMediaGenerationDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-_60ZWcMF.js");
		await sendMessage({
			cfg: params.config,
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-_tppLVTw.js");
}
...
function createSessionStatusTool(opts) {
	return {
		...
		execute: async (_toolCallId, args) => {
			...
			if (!resolved && requestedKeyInput === "current" && effectiveRequesterLookupKey) resolved = resolveSessionEntry({
				store,
			...
			if (!resolved && requestedKeyInput === "current") resolved = resolveSessionEntry({
				store,
				keyRaw: requestedKeyRaw,
				alias,
				mainKey,
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-DRT4FYnF.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-CgIJVeW0.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-5PSM9jxv.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-CT0S8XCd.js"));
...
//#endregion
export { wrapToolWorkspaceRootGuard as C, setEmbeddedMode as D, isEmbeddedMode as E, wrapToolMemoryFlushAppendOnlyWrite as S, sniffMimeFromBase64 as T, createHostWorkspaceWriteTool as _, generateMusic as a, createSandboxedReadTool as b, setBootEchoContextForSession as c, replaceWithEffectiveCronCreatorToolAllowlist as d, isStrictAgenticExecutionContractActive as f, createHostWorkspaceEditTool as g, resolveOpenClawPluginToolsForOptions as h, buildActiveMusicGenerationTaskPromptContextForSession as i, buildActiveImageGenerationTaskPromptContextForSession as l, stripProviderPrefix as m, buildActiveVideoGenerationTaskPromptContextForSession as n, listRuntimeMusicGenerationProviders as o, isStrictAgenticSupportedProviderModel as p, parseSessionLabel as r, clearBootEchoContextForSession as s, createOpenClawTools as t, findActiveSessionTask as u, createOpenClawReadTool as v, wrapToolWorkspaceRootGuardWithOptions as w, createSandboxedWriteTool as x, createSandboxedEditTool as y };
