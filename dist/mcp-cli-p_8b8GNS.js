...
import { _ as withSameOriginMcpHttpHeaders, f as resolveMcpTransportConfig, g as buildMcpHttpFetch, h as runMcpOAuthLogin, m as readMcpOAuthCredentialsStatus, n as createSessionMcpRuntime, p as clearMcpOAuthCredentials, v as withoutMcpAuthorizationHeader } from "./agent-bundle-mcp-runtime-DGeRg_-o.js";
import { t as buildBundleMcpToolsFromCatalog } from "./agent-bundle-mcp-materialize-DtIGhSS3.js";
import { a as updateConfiguredMcpServerTools, i as updateConfiguredMcpServer, n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BriuaPxs.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-Dz9o3bLg.js"),
