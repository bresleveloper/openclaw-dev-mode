...
import "./memory-embedding-provider-runtime-DNOG64F7.js";
import { d as runWithConcurrency, f as hasNonTextEmbeddingParts, h as splitTextToUtf8ByteLimit, m as estimateUtf8Bytes } from "./internal-DYu9FgcQ.js";
...
const resolveApiKeyForProvider = async (...args) => {
	return (await import("./model-auth-BiBudBmg.js")).resolveApiKeyForProvider(...args);
};
//#endregion
