...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CU9LIFzX.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DG7lxLuT.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-A97QpkoS.js";
...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-iMV_T6AZ.js";
//#region extensions/matrix/src/matrix/client/config.ts
const loadDefaultMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-Byk8SqNa.js"), import("./logging-BQZ4KOQP.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-BVCqHdsJ.js").then((credentialsReadModule) => ({
