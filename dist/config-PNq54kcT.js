import { a as normalizeAccountId, i as DEFAULT_ACCOUNT_ID, n as openVerifiedFileSync, o as normalizeOptionalAccountId, r as sameFileIdentity, s as isBlockedObjectKey } from "./secret-file-Cr5SygBE.js";
import { a as DEFAULT_AGENT_ID, i as normalizeResolvedSecretInputString, n as coerceSecretRef, o as normalizeAgentId, r as hasConfiguredSecretInput, t as resolveTelegramToken } from "./token-BA_9UjDk.js";
import { t as resolveAccountEntry } from "./account-lookup-y3UdfCFv.js";
import { A as STATE_DIR, C as resolveNodeRequireFromMeta, I as resolveRequiredHomeDir, L as resolvePreferredOpenClawTmpDir, M as resolveDefaultConfigCandidates, N as resolveOAuthDir, P as resolveStateDir, a as resolveConfigDir, c as isPlainObject$2, d as isDevMode, g as success, h as shouldLogVerbose, i as jidToE164, j as resolveConfigPath, k as DEFAULT_GATEWAY_PORT, l as danger, o as resolveUserPath, r as isRecord$1, s as sleep, u as info, v as getChildLogger } from "./utils-dNeyb1Bh.js";
import { a as logError, c as createSubsystemLogger, i as logDebug, l as stripAnsi, n as hasProxyEnvConfigured, r as isTruthyEnvValue, u as defaultRuntime } from "./proxy-env-CyeMyCNO.js";
...
const log$20 = createSubsystemLogger("agent-scope");
...
function resolveDefaultAgentId(cfg) {
	...
	if (defaults.length > 1 && !defaultAgentWarned) {
		...
		log$20.warn("Multiple agents marked default=true; using the first entry as default.");
	}
...
//#endregion
export { maxBytesForKind as $, extractErrorCode as A, formatCliCommand as B, resolveWebCredsPath as C, SafeOpenError as D, generateSecureUuid as E, closeDispatcher as F, optimizeImageToPng as G, VERSION as H, createPinnedDispatcher as I, extensionForMime as J, resizeToJpeg as K, resolvePinnedHostnameWithPolicy as L, formatUncaughtError as M, readErrorName as N, readLocalFileSafely as O, SsrFBlockedError as P, normalizeMimeType as Q, assertMediaNotDataUrl as R, resolveWebCredsBackupPath as S, INTERNAL_MESSAGE_CHANNEL as T, convertHeicToJpeg as U, loadJsonFile as V, hasAlphaChannel as W, isGifMedia as X, getFileExtension as Y, kindFromMime as Z, logoutWeb as _, mergeInboundPathRoots as a, readWebSelfId as b, normalizeChannelId as c, listTelegramAccountIds as d, createDiscordActionGate as et, resolveTelegramAccount as f, resolveWhatsAppAccount as g, resolveSignalAccount as h, DEFAULT_IMESSAGE_ATTACHMENT_ROOTS as i, normalizeDiscordToken as it, formatErrorMessage as j, collectErrorGraphCandidates as k, createTelegramActionGate as l, listEnabledSignalAccounts as m, readConfigFileSnapshotForWrite as n, mergeDiscordAccountConfig as nt, resolveRetryConfig as o, resolveTelegramPollActionGateState as p, detectMime as q, writeConfigFile as r, resolveDiscordAccount as rt, retryAsync as s, loadConfig as t, listEnabledDiscordAccounts as tt, listEnabledTelegramAccounts as u, maybeRestoreCredsFromBackup as v, webAuthExists as w, resolveDefaultWebAuthDir as x, readCredsJsonRaw as y, redactSensitiveText as z };
