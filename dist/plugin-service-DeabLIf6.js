...
import { t as callGatewayTool } from "./gateway-CmPZGwyr.js";
import { Gn as errorShape, Wn as ErrorCodes } from "./schema-BuOFpc7K.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-ny_U_S6L.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-d2eryCGb.js";
import { i as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./node-command-policy-CDDCPmwi.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-BeMwLOux.js";
import { t as describeImageFile } from "./runtime-DB7-QuF9.js";
import "./param-readers-CUm3yt9i.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-8ek_yO1m.js";
import { t as withTimeout } from "./net-BQ4UOkRH.js";
import { R as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-p581DB6o.js";
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-C25IwRz4.js";
import "./sdk-setup-tools-DPRTyPJc.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-m77oMohh.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserDownload, h as browserWaitForDownload, i as resolveRequestedBrowserProfile, l as browserAct, m as browserScreenshotAction, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserNavigate, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-BGAL8sJR.js";
import { a as getBrowserProfileCapabilities } from "./cdp-reachability-policy-CSn1wgtE.js";
import { i as normalizeBrowserScreenshot, n as DEFAULT_BROWSER_SCREENSHOT_MAX_BYTES } from "./routes-BwvviRzF.js";
import { t as createBrowserRouteDispatcher } from "./dispatcher-BkNWCulR.js";
import { n as createBrowserControlContext } from "./plugin-enabled-C7puELLN.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-BN7COBlj.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-EGBiv9-X.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-C3yMyrS-.js");
