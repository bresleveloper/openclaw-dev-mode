...
const t = (t, n = 4294967295, e = 79764919) => {
	const r = /* @__PURE__ */ new Int32Array(256);
	let o, s, i, c = n;
	for (o = 0; o < 256; o++) {
	...
	if (p && 1 === a) {
		const t = e(m);
		if (t !== l) throw console.error("`simple-yenc`\n", "Decode failed crc32 validation\n", "Expected: " + l + "; Got: " + t + "\n", "Visit https://github.com/eshaz/simple-yenc for more information"), Error("Decode failed crc32 validation");
	}
	return m;
};
//#endregion
