...
import { t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-B1-PRucg.js";
...
const channelSummaryModuleLoader = createLazyImportLoader(() => import("./channel-summary-BGzq3CTh.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-CcmcvRse.js"));
const linkChannelModuleLoader = createLazyImportLoader(() => import("./status.link-channel-CKaFyAyk.js"));
const taskRegistryMaintenanceModuleLoader = createLazyImportLoader(() => import("./task-registry.maintenance-D29NZ3Ei.js"));
const staticModelCatalogResolverLoader = createLazyImportLoader(async () => {
	const modelCatalog = await import("./model.static-catalog-DbvtrGjg.js");
	return {
