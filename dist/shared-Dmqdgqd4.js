...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-DYddD9h-.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-CSCcDGuU.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
