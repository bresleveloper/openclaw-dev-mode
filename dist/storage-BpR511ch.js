...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BCTlGWOX.js";
import "./record-shared-OfYyhRF2.js";
import { t as getMatrixRuntime } from "./runtime-CN4Os2vf.js";
import { n as resolveMatrixAccountStorageRoot, s as resolveMatrixLegacyFlatStoragePaths } from "./storage-paths-c3AexXHH.js";
import { O as resolveMatrixSqliteStateEnv, b as scoreMatrixCryptoStateInStore, g as readMatrixIdbSnapshotJson, l as migrateLegacyMatrixRecoveryKeyFileToStore, n as MATRIX_LEGACY_CRYPTO_MIGRATION_FILENAME, r as MATRIX_RECOVERY_KEY_FILENAME, s as migrateLegacyMatrixLegacyCryptoMigrationFileToStore, t as MATRIX_IDB_SNAPSHOT_FILENAME, x as writeMatrixIdbSnapshotJson } from "./crypto-state-store-q3JvdnSr.js";
...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasFlatLegacyStorageFile || hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-CIk5R_Pl.js") : null;
...
async function migrateLegacyIdbSnapshotToSqlite(params) {
	...
	const { readLegacyMatrixIdbSnapshotState } = await import("./idb-persistence-BaXmHcD8.js");
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-CIk5R_Pl.js");
