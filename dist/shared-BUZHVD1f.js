...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-B8rnzcn2.js";
...
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-gcdltRDl.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
