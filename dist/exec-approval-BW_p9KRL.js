...
import { i as detectCommandCarrierArgv, o as detectInlineEvalInSegments } from "./risks-CJwO60fG.js";
import { I as resolveExecApprovalRequestAllowedDecisions, r as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS, v as normalizeExecApprovalUnavailableDecisions } from "./exec-approvals-BQlhahST.js";
...
import { $ as validateExecApprovalGetParams, et as validateExecApprovalRequestParams, t as formatValidationErrors, tt as validateExecApprovalResolveParams } from "./src-CSp7rUPX.js";
...
import { t as analyzeCommandForPolicy } from "./policy-DykcOtFG.js";
import { a as buildSystemRunApprovalEnvBinding, i as buildSystemRunApprovalBinding } from "./system-run-command-COTte8DI.js";
import { n as resolveSystemRunApprovalRequestContext } from "./system-run-approval-context-Dhmh-A6T.js";
import { a as handleApprovalWaitDecision, c as listVisiblePendingApprovalRequests, f as resolvePendingApprovalRecord, i as handleApprovalResolve, l as registerPendingApprovalRecord, n as bindApprovalReviewerDeviceIds, o as handlePendingApprovalRequest, p as respondPendingApprovalLookupError, r as buildRequestedApprovalEvent, s as isApprovalRecordVisibleToClient, t as bindApprovalRequesterMetadata, u as resolveApprovalDecisionParams } from "./approval-shared-CmryizPz.js";
...
async function explainCommandForDisplay(command) {
	try {
		const { explainShellCommand } = await import("./extract-Cw5v9eKq.js");
