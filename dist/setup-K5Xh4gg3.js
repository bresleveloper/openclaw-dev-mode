...
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-D9K4qCwp.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-A_v9ujlt.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-ZjgVTvxr.js");
