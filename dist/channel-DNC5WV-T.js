...
import { u as parseThreadSessionSuffix } from "./session-key-utils-C7uT9A4s.js";
...
import { b as readStringParam, g as readPositiveIntegerParam, i as createActionGate, t as ToolAuthorizationError } from "./common-B2QjWqqG.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-CMg35hQR.js";
...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-BxMlPHl5.js";
import "./channel-core-BmBqa93r.js";
import "./routing-DGrdyZ4S.js";
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-VIimbh8Q.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-0snnWeh8.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-BvNam8sN.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-Ddw9uAMj.js";
import "./approval-delivery-runtime-BC8bGkG0.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-DLWtIqHq.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-DXdfhEH4.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-BQP5fMRA.js";
import "./approval-native-runtime-KhBiC_33.js";
import { w as createChannelMessageAdapterFromOutbound } from "./channel-outbound-BNKGCEf1.js";
import "./conversation-runtime-DL6fdg71.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-DNhqI-OE.js";
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DjJ0OuL_.js";
import "./channel-status-CxP0h-5H.js";
import "./channel-actions-CdLhqkfP.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-BhZI8NmU.js";
import { t as extractToolSend } from "./tool-send-DlIp2cBO.js";
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-BCTlGWOX.js";
import { a as resolveMatrixAccountConfig } from "./account-config-BI-sdJxb.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CLwXLqXa.js";
import { n as normalizeMatrixUserId } from "./allowlist-B4NW92_F.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-Dk0dJRSl.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-BBfcoHXx.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-9-AxdTFr.js";
import { t as formatMatrixErrorMessage } from "./errors-CvSDN3fI.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-CO63ymx7.js";
...
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-Bt3rAE_R.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-tLCCJ8D5.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-B_ztXK6D.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-ClcCgosP.js";
...
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-B3d0w5wb.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DmG5tm_K.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-B-tklA_d.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CmAqvnxg.js"), "matrixChannelRuntime");
let matrixDoctorModulePromise = null;
const loadMatrixDoctorModule = async () => {
	matrixDoctorModulePromise ??= import("./doctor-DDtm0-cU.js");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DM9S0pGY.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
