...
import { n as installBrowserAuthMiddleware, r as installBrowserCommonMiddleware, t as hasVerifiedBrowserAuth } from "./server-middleware-sIh3aLnC.js";
...
async function startBrowserBridgeServer(params) {
	...
	if (params.skipRouteRegistrationForTest) app.get("/", (_req, res) => {
		...
		const [{ createBrowserRouteContext }, { registerBrowserRoutes }] = await Promise.all([import("./server-context-BFMShWM5.js"), import("./routes-CVeK_z7L.js")]);
