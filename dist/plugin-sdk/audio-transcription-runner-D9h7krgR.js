import { O as runExec, mt as resolveAgentModelPrimaryValue, pt as resolveAgentModelFallbackValues } from "./run-with-concurrency-Do_Mn3XJ.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-jRwfXfR1.js";
import { B as resolveIMessageAttachmentRoots, E as loadConfig, En as normalizeProviderId, L as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Nn as normalizeGoogleModelId, R as isInboundPathAllowed, i as resolveApiKeyForProvider, mn as resolveOpenClawAgentDir, r as requireApiKey, z as mergeInboundPathRoots } from "./model-auth-B8ugbJXc.js";
import { y as normalizeChatType } from "./plugins-CvsECvRM.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CNgeVGLz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DvUQDdzE.js";
import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./message-channel-CFGJ-htG.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-B7KvdGPO.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-OUryi-wd.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Dgnf7urJ.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-C-cD3Yym.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DHTwzem5.js").then((n) => n.r);
