import { I as danger, O as createSubsystemLogger, R as isDevMode, V as shouldLogVerbose, Y as resolveNodeRequireFromMeta, g as pathExists$1, i as logWarn, n as logError, t as logDebug, y as resolveUserPath } from "./logger-DcprVJ1_.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix } from "./paths-CtOdJffQ.js";
...
async function ensureAgentWorkspace(params) {
	...
	if (isDevMode()) await writeFileIfMissing(path.join(dir, DEFAULT_MEMORY_FILENAME), "# Memory\n");
...
//#endregion
export { DEFAULT_HEARTBEAT_FILENAME as $, resolveThreadParentSessionKey as $t, PATH_ALIAS_POLICIES as A, DEFAULT_AGENT_ID as At, resolveAgentConfig as B, resolveThreadSessionKeys as Bt, copyFileWithinRoot as C, normalizeHyphenSlug as Ct, readLocalFileSafely as D, resolveAgentModelPrimaryValue as Dt, readFileWithinRoot as E, resolveAgentModelFallbackValues as Et, compileSafeRegex as F, classifySessionKeyShape as Ft, resolveDefaultAgentId as G, normalizeOptionalAccountId as Gt, resolveAgentEffectiveModelPrimary as H, scopedHeartbeatWakeOptions as Ht, testRegexWithBoundedInput as I, isValidAgentId as It, resolveSessionAgentId as J, getSubagentDepth as Jt, resolveEffectiveModelFallbacks as K, isBlockedObjectKey as Kt, runTasksWithConcurrency as L, normalizeAgentId as Lt, getDefaultRedactPatterns as M, buildAgentMainSessionKey as Mt, redactSensitiveText as N, buildAgentPeerSessionKey as Nt, writeFileFromPathWithinRoot as O, toAgentModelListLike as Ot, redactToolDetail as P, buildGroupHistoryKey as Pt, DEFAULT_BOOTSTRAP_FILENAME as Q, parseAgentSessionKey as Qt, hasConfiguredModelFallbacks as R, normalizeMainKey as Rt, appendFileWithinRoot as S, normalizeAtHashSlug as St, openFileWithinRoot as T, normalizeStringEntriesLower as Tt, resolveAgentSkillsFilter as U, DEFAULT_ACCOUNT_ID as Ut, resolveAgentDir as V, sanitizeAgentId as Vt, resolveAgentWorkspaceDir as W, normalizeAccountId as Wt, DEFAULT_AGENTS_FILENAME as X, isCronSessionKey as Xt, resolveSessionAgentIds as Y, isAcpSessionKey as Yt, DEFAULT_AGENT_WORKSPACE_DIR as Z, isSubagentSessionKey as Zt, normalizeMimeType as _, resolvePathViaExistingAncestorSync as _t, resolveSessionTranscriptPathInDir as a, filterBootstrapFilesForSession as at, mediaKindFromMime as b, normalizeWindowsPathForComparison as bt, materializeWindowsSpawnProgram as c, resolveOpenClawPackageRootSync as ct, extensionForMime as d, resolveWindowsCommandShim as dt, DEFAULT_IDENTITY_FILENAME as et, getFileExtension as f, spawnWithFallback as ft, kindFromMime as g, openVerifiedFileSync as gt, isGifMedia as h, openBoundaryFileSync as ht, resolveSessionTranscriptPath as i, ensureAgentWorkspace as it, assertNoPathAliasEscape as j, DEFAULT_MAIN_KEY as jt, writeFileWithinRoot as k, markOpenClawExecEnv as kt, resolveWindowsSpawnProgram as l, runCommandWithTimeout as lt, isAudioFileName as m, openBoundaryFile as mt, resolveSessionFilePath as n, DEFAULT_TOOLS_FILENAME as nt, resolveSessionTranscriptsDirForAgent as o, loadWorkspaceBootstrapFiles as ot, imageMimeFromFormat as p, canUseBoundaryFileOpen as pt, resolveRunModelFallbacksOverride as q, deriveSessionChatType as qt, resolveSessionFilePathOptions as r, DEFAULT_USER_FILENAME as rt, resolveStorePath as s, resolveOpenClawPackageRoot as st, resolveDefaultSessionStorePath as t, DEFAULT_SOUL_FILENAME as tt, detectMime as u, runExec as ut, MAX_IMAGE_BYTES as v, isNotFoundPathError as vt, createRootScopedReadFile as w, normalizeStringEntries as wt, SafeOpenError as x, normalizeSkillFilter as xt, maxBytesForKind as y, isPathInside as yt, listAgentIds as z, resolveAgentIdFromSessionKey as zt };
