import { ot as normalizeAccountId, st as normalizeOptionalAccountId } from "./run-with-concurrency-CWh7CuJZ.js";
import { c as resolveStateDir } from "./paths-eFexkPEh.js";
import { Bt as triggerInternalHook, Dt as getActivePluginRegistry, kt as getActivePluginRegistryVersion, zt as createInternalHookEvent } from "./config-DsOWzWmU.js";
import { R as logVerbose, a as createSubsystemLogger } from "./logger-IRKETRMd.js";
import { d as getChannelDock } from "./thinking-CDxrqekX.js";
import { It as parseInlineDirectives, ht as resolveMirroredTranscriptText, i as isMessagingToolDuplicate, mt as appendAssistantMessageToSessionTranscript } from "./pi-embedded-helpers-aohswcEW.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-Dz9iIawy.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-CnA7RwU3.js";
import { c as chunkMarkdownTextWithMode, d as resolveChunkMode, f as resolveTextChunkLimit, g as parseFenceSpans, i as resolveMarkdownTableMode, o as chunkByParagraph } from "./ir-E4GckxPv.js";
import { n as generateSecureUuid } from "./secure-random-uh3kxOVx.js";
import { i as isSilentReplyText } from "./tokens-ijjekxV2.js";
import { r as parseTelegramTarget } from "./targets-B6NBgHav.js";
import { i as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-KN2tGbsG.js";
...
//#endregion
export { toPluginMessageReceivedEvent as A, initializeGlobalHookRunner as C, toInternalMessageReceivedContext as D, toInternalMessagePreprocessedContext as E, toInternalMessageTranscribedContext as O, getGlobalHookRunner as S, deriveInboundMessageHookContext as T, normalizeTargetForProvider as _, normalizeReplyPayloadsForDelivery as a, throwIfAborted as b, filterMessagingToolDuplicates as c, shouldSuppressMessagingToolReplies as d, shouldSuppressReasoningPayload as f, normalizeChannelTargetInput as g, buildTargetResolverSignature as h, normalizeOutboundPayloadsForJson as i, fireAndForgetHook as j, toPluginMessageContext as k, filterMessagingToolMediaDuplicates as l, resolveReplyToMode as m, formatOutboundPayloadLog as n, applyReplyTagsToPayload as o, createReplyToModeFilterForChannel as p, normalizeOutboundPayloads as r, applyReplyThreading as s, deliverOutboundPayloads as t, isRenderablePayload as u, parseReplyDirectives as v, joinPresentTextSegments as w, resolveChannelMediaMaxBytes as x, splitMediaFromOutput as y };
