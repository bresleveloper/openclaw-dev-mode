...
export declare const AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL = "node-reapproval";
...
export declare function buildRateLimitIdentityKey(namespace: string, identity: string): string;
