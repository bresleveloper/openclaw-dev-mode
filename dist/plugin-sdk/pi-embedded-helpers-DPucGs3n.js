import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-DhMKNVpI.js";
import { $ as parseDurationMs, Br as parseBooleanValue, C as createConfigIO, E as loadConfig, Jn as isPidAlive, Kn as resolveProcessScopedMap, Or as resolveSecretInputRef, Ot as CHANNEL_IDS, Q as getBlockedNetworkModeReason, Tr as hasConfiguredSecretInput, Vr as formatCliCommand, Z as secretRefKey, et as parseByteSize, j as writeConfigFile, qn as getProcessStartTime, v as resolveSecretRefValues } from "./model-auth-CaxBuigV.js";
import { E as truncateUtf16Safe, L as isDevMode, O as createSubsystemLogger, h as normalizeE164, j as defaultRuntime, y as resolveUserPath } from "./logger-CQsSB0EM.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-CtOdJffQ.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-BgYk8jDi.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-DMOsoNVq.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-NtjFUSGE.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-D7EC9-0o.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-DWdzjQje.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CuLcdAb2.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-CylXZHex.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-yHFjxVF7.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-kkFDc18i.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-C8ZgIUby.js";
import { n as SsrFBlockedError } from "./proxy-env-DPgqVcba.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-C48zY6ZZ.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-CAwqV3qH.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CJpVGcrh.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-CJpVGcrh.js")).closePlaywrightBrowserConnection();
	} catch {}
}
