import { N as redactSensitiveText, Wt as normalizeAccountId, _ as normalizeMimeType, f as getFileExtension, g as kindFromMime, h as isGifMedia } from "./paths-Su3o8IWz.js";
import { Ai as formatUncaughtError, Di as collectErrorGraphCandidates, Oi as extractErrorCode, Q as readConfigFileSnapshotForWrite, Qr as writeJsonAtomic, Xa as withFileLock$1, Y as loadConfig, Yo as resolveTelegramAccount, do as getChannelPlugin, fo as listChannelPlugins, ji as readErrorName, ki as formatErrorMessage, nn as resolveTelegramPreviewStreamMode, tt as writeConfigFile } from "./sessions-IKHgc4YL.js";
import { I as danger, O as createSubsystemLogger, a as CONFIG_DIR, b as safeParseJson, z as logVerbose } from "./logger-BlQvwwda.js";
...
import { n as makeProxyFetch } from "./proxy-fetch-B4DWbXI5.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-2V_OOyTj.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-BpLZsbM6.js";
import { t as renderMarkdownWithMarkers } from "./render-CypHTXnD.js";
import { n as normalizePollInput } from "./polls-xSR4qRd_.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-9-C7C5wO.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-PH2eZEQk.js";
import { t as resolveTelegramFetch } from "./fetch-DsGM-FBt.js";
...
//#endregion
export { formatLocationText as $, buildTelegramThreadParams as A, resolveTelegramGroupAllowFromContext as B, withTelegramApiErrorLogging as C, buildTelegramGroupFrom as D, buildSenderName as E, getTelegramTextParts as F, isSenderAllowed as G, resolveTelegramReplyId as H, hasBotMention as I, resolveSenderAllowMatch as J, normalizeAllowFrom as K, normalizeForwardedContext as L, describeReplyTarget as M, expandTextLinks as N, buildTelegramGroupPeerId as O, extractTelegramLocation as P, resolveGroupAllowFromSources as Q, resolveTelegramDirectPeerId as R, splitTelegramCaption as S, buildSenderLabel as T, resolveTelegramStreamMode as U, resolveTelegramMediaPlaceholder as V, resolveTelegramThreadSpec as W, isSenderIdAllowed as X, firstDefined as Y, mergeDmAllowFromSources as Z, isTelegramClientRejection as _, editMessageTelegram as a, removeChannelAllowFromStoreEntry as at, renderTelegramHtmlText as b, sendPollTelegram as c, writeJsonFileAtomically as ct, resolveTelegramVoiceSend as d, toLocationContext as et, loadCronStore as f, isSafeToRetrySendError as g, isRecoverableTelegramNetworkError as h, editMessageReplyMarkupTelegram as i, readChannelAllowFromStoreSync as it, buildTypingThreadParams as j, buildTelegramParentPeer as k, sendStickerTelegram as l, getPairingAdapter as lt, wasSentByBot as m, createForumTopicTelegram as n, addChannelAllowFromStoreEntry as nt, reactMessageTelegram as o, upsertChannelPairingRequest as ot, resolveCronStorePath as p, normalizeDmAllowFromWithStore as q, deleteMessageTelegram as r, readChannelAllowFromStore as rt, sendMessageTelegram as s, readJsonFileWithFallback as st, buildInlineKeyboard as t, isVoiceCompatibleAudio as tt, sendTypingTelegram as u, listPairingChannels as ut, markdownToTelegramChunks as v, buildGroupLabel as w, wrapFileReferencesInHtml as x, markdownToTelegramHtml as y, resolveTelegramForumThreadId as z };
