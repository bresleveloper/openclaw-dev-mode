import { gt as buildAgentMainSessionKey, ht as DEFAULT_MAIN_KEY, s as resolveStorePath, vt as buildGroupHistoryKey, xt as normalizeAgentId } from "./paths-BSu400id.js";
import { M as defaultRuntime, O as createSubsystemLogger, V as shouldLogVerbose, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, q as getChildLogger, u as jidToE164, x as toWhatsappJid, y as sleep, z as logVerbose } from "./utils-2wfSfzP2.js";
import "./paths-Dmn791zP.js";
import { Bn as resolveChannelGroupPolicy, Er as saveMediaBuffer, Gn as resolveGroupSessionKey, Gs as getWebAuthAgeMs, Hi as loadConfig, Hs as resolveWhatsAppAccount, Ks as logWebSelfId, St as recordSessionMetaFromInbound, Us as resolveWhatsAppMediaMaxBytes, Vn as resolveChannelGroupRequireMention, Ws as WA_WEB_AUTH_DIR, Ys as pickWebChannel, Zs as readWebSelfId, bt as loadSessionStore, cc as formatCliCommand, tc as webAuthExists, wt as updateLastRoute } from "./model-auth-BiXqAMvR.js";
import "./target-errors-B60ETWmE.js";
import { A as computeBackoff, B as resolveInboundLastRouteSessionKey, C as resolveInboundDebounceMs, D as buildMentionRegexes, E as shouldComputeCommandAuthorized, F as formatDurationPrecise, G as resolveDmGroupAccessWithLists, I as enqueueSystemEvent, K as resolvePinnedMainDmOwnerFromAllowlist, L as buildAgentSessionKey, M as createDedupeCache, N as normalizeGroupActivation, O as normalizeMentionText, P as parseActivationCommand, R as deriveLastRoutePolicy, S as createInboundDebouncer, T as hasControlCommand, U as readStoreAllowFromForDmPolicy, V as finalizeInboundContext, W as resolveDmGroupAccessWithCommandGate, X as resolveIdentityNamePrefix, Y as createReplyPrefixOptions, Z as resolveMessagePrefix, _ as buildHistoryContextFromEntries, b as dispatchReplyWithBufferedBlockDispatcher, g as resolveMentionGating, h as createConnectedChannelStatusPatch, j as sleepWithAbort, m as resolveInboundSessionEnvelopeContext, q as issuePairingChallenge, r as getReplyFromConfig, v as recordPendingHistoryEntryIfEnabled, w as formatInboundEnvelope, y as shouldAckReactionForWhatsApp, z as resolveAgentRoute } from "./dispatch-C7mt_1Kn.js";
import { $ as upsertChannelPairingRequest, ct as formatLocationText, lt as toLocationContext } from "./send-CFGvXb-B.js";
import { Mt as resolveDefaultGroupPolicy, Nt as resolveOpenProviderRuntimeGroupPolicy, Pt as warnMissingProviderGroupPolicyFallbackOnce } from "./send-DdB6pkjY.js";
...
import { f as registerUnhandledRejectionHandler } from "./audio-transcription-runner-ClUWvcV8.js";
import "./image-C0DW3Bk7.js";
import "./api-key-rotation-BoVePWpE.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-BCE0SiXE.js";
import "./proxy-fetch-BG3pWP64.js";
import "./tokens-D_oani7z.js";
import "./commands-registry-N8oj2MuM.js";
import { a as loadWebMedia, d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, m as resolveChunkMode, s as resolveMarkdownTableMode } from "./ir-BqK8pwYd.js";
...
import { n as recordChannelActivity } from "./channel-activity-BT_BT-JU.js";
import { t as convertMarkdownTables } from "./tables-DK_A-pJg.js";
import "./fetch-CUOSMRF9.js";
import "./skill-commands-DKirpr1e.js";
import { r as setActiveWebListener } from "./active-listener-Ca4ucjTh.js";
import "./manager-Cz5nfKVs.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-C-e8HKkg.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BH9pvv6W.js";
import { t as loginWeb } from "./login-Cu17iVlh.js";
