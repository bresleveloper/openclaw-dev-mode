import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-CWh7CuJZ.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-eFexkPEh.js";
import { $r as resolveSecretInputRef, Br as isPidAlive, Dr as secretRefKey, G as parseDurationMs, Jr as hasConfiguredSecretInput, K as parseByteSize, Rr as resolveProcessScopedMap, Vr as formatCliCommand, W as getBlockedNetworkModeReason, br as resolveSecretRefValues, bt as CHANNEL_IDS, i as loadConfig, l as writeConfigFile, li as parseBooleanValue, t as createConfigIO, zr as getProcessStartTime } from "./config-DsOWzWmU.js";
import { E as resolveUserPath, L as isDevMode, N as truncateUtf16Safe, S as normalizeE164, a as createSubsystemLogger, c as defaultRuntime } from "./logger-IRKETRMd.js";
import { J as normalizeHyphenSlug, d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CDxrqekX.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-DAAtPyza.js";
import { Y as normalizeChatType, r as normalizeChannelId } from "./plugins-Dz9iIawy.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BZxNY0wq.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-lXyL3UTt.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-lXyL3UTt.js")).closePlaywrightBrowserConnection();
	} catch {}
}
