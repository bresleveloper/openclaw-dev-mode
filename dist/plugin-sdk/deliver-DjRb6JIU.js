import { Gt as normalizeOptionalAccountId, Wt as normalizeAccountId } from "./paths-Su3o8IWz.js";
import { O as parseInlineDirectives, Ys as getActivePluginRegistry, Zs as getActivePluginRegistryVersion, cc as createInternalHookEvent, cr as isMessagingToolDuplicate, do as getChannelPlugin, lc as triggerInternalHook, mo as getChannelDock, n as resolveMirroredTranscriptText, pi as generateSecureUuid, po as normalizeChannelId, t as appendAssistantMessageToSessionTranscript } from "./sessions-IKHgc4YL.js";
import { O as createSubsystemLogger, z as logVerbose } from "./logger-BlQvwwda.js";
import { c as resolveStateDir } from "./paths-D6tDENa_.js";
import { i as isSilentReplyText } from "./tokens-GU_qmEbP.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-DHnjkpBt.js";
import { r as parseTelegramTarget } from "./targets-2V_OOyTj.js";
import { d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, l as chunkByParagraph, m as resolveChunkMode, s as resolveMarkdownTableMode, v as parseFenceSpans } from "./ir-BpLZsbM6.js";
import { c as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-n-q2SA5v.js";
...
//#endregion
export { splitMediaFromOutput as A, toPluginMessageSentEvent as C, normalizeTargetForProvider as D, normalizeChannelTargetInput as E, initializeGlobalHookRunner as M, joinPresentTextSegments as N, throwIfAborted as O, toPluginMessageReceivedEvent as S, buildTargetResolverSignature as T, toInternalMessagePreprocessedContext as _, normalizeReplyPayloadsForDelivery as a, toInternalMessageTranscribedContext as b, filterMessagingToolDuplicates as c, shouldSuppressMessagingToolReplies as d, shouldSuppressReasoningPayload as f, deriveInboundMessageHookContext as g, buildCanonicalSentMessageHookContext as h, normalizeOutboundPayloadsForJson as i, getGlobalHookRunner as j, parseReplyDirectives as k, filterMessagingToolMediaDuplicates as l, resolveReplyToMode as m, formatOutboundPayloadLog as n, applyReplyTagsToPayload as o, createReplyToModeFilterForChannel as p, normalizeOutboundPayloads as r, applyReplyThreading as s, deliverOutboundPayloads as t, isRenderablePayload as u, toInternalMessageReceivedContext as v, fireAndForgetHook as w, toPluginMessageContext as x, toInternalMessageSentContext as y };
