import { O as runExec, U as resolveAgentModelFallbackValues, W as resolveAgentModelPrimaryValue } from "./run-with-concurrency-DhMKNVpI.js";
import { E as loadConfig, I as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, L as isInboundPathAllowed, R as mergeInboundPathRoots, Wn as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, lr as normalizeGoogleModelId, nr as normalizeProviderId, r as requireApiKey, z as resolveIMessageAttachmentRoots } from "./model-auth-CaxBuigV.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-CQsSB0EM.js";
import { x as normalizeChatType } from "./plugins-DMOsoNVq.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-D7EC9-0o.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-DM0Xrq3C.js";
import { n as fetchWithTimeout } from "./fetch-timeout-UxR1blUr.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BTR8Vwye.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BoqKs7Xr.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DgO10kgA.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-WQDr4H8_.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DldvNprI.js").then((n) => n.r);
