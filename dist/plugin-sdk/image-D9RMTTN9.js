import { Dt as resolveAgentModelPrimaryValue, Et as resolveAgentModelFallbackValues, P as redactToolDetail } from "./paths-DS13uuuA.js";
import { Fs as resolveImplicitProviders, Ps as normalizeProviders, Qs as normalizeSecretInput, Sa as projectConfigOntoRuntimeSourceSnapshot, Ts as normalizeModelRef, Ws as isNonSecretApiKeyMarker, _s as resolveOpenClawAgentDir, ba as getRuntimeConfigSourceSnapshot, ft as sanitizeUserFacingText, n as requireApiKey, ss as createConfigRuntimeEnv, t as getApiKeyForModel, xa as loadConfig } from "./model-auth-CMFG2SyH.js";
import { f as isRecord, x as shortenHomeInString } from "./logger-BpQI0P1g.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-DsFSN0ma.js");
