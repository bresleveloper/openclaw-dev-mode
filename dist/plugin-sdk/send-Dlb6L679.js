import { D as normalizeMimeType, E as kindFromMime, S as getFileExtension, T as isGifMedia } from "./message-channel-DMQTmTNv.js";
import { F as danger, O as createSubsystemLogger, R as logVerbose, g as safeParseJson, t as CONFIG_DIR } from "./utils-CmwgRR7I.js";
...
import { An as resolveTelegramPreviewStreamMode, D as loadConfig, Hn as withFileLock$1, Lr as isTruthyEnvValue, M as writeConfigFile, k as readConfigFileSnapshotForWrite } from "./model-auth-C8GM6p1v.js";
import { c as hasProxyEnvConfigured } from "./ssrf-mrymR-Zp.js";
import { n as listChannelPlugins, t as getChannelPlugin, u as resolveTelegramAccount } from "./plugins-m91qhrBY.js";
import { r as writeJsonAtomic } from "./json-files-D5o1S-NW.js";
import { t as redactSensitiveText } from "./redact-CWtNHp3v.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-BIx1iMro.js";
import { t as makeProxyFetch } from "./proxy-fetch-DiAKaO-h.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-ByB5-FPs.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-Db-Y8cut.js";
...
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BKK6XwHm.js";
...
//#endregion
export { listPairingChannels as $, extractTelegramLocation as A, isSenderAllowed as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramGroupAllowFromContext as F, isVoiceCompatibleAudio as G, normalizeDmAllowFromWithStore as H, resolveTelegramMediaPlaceholder as I, removeChannelAllowFromStoreEntry as J, addChannelAllowFromStoreEntry as K, resolveTelegramReplyId as L, normalizeForwardedContext as M, resolveTelegramDirectPeerId as N, describeReplyTarget as O, resolveTelegramForumThreadId as P, getPairingAdapter as Q, resolveTelegramStreamMode as R, buildSenderName as S, buildTelegramParentPeer as T, resolveSenderAllowMatch as U, normalizeAllowFrom as V, withTelegramApiErrorLogging as W, readJsonFileWithFallback as X, upsertChannelPairingRequest as Y, writeJsonFileAtomically as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, toLocationContext as at, buildGroupLabel as b, sendStickerTelegram as c, resolveCronStorePath as d, firstDefined as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, formatLocationText as it, hasBotMention as j, expandTextLinks as k, resolveTelegramVoiceSend as l, markdownToTelegramChunks as m, createForumTopicTelegram as n, mergeDmAllowFromSources as nt, sendMessageTelegram as o, isRecoverableTelegramNetworkError as p, readChannelAllowFromStore as q, deleteMessageTelegram as r, resolveGroupAllowFromSources as rt, sendPollTelegram as s, buildInlineKeyboard as t, isSenderIdAllowed as tt, loadCronStore as u, resolveTelegramFetch as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, splitTelegramCaption as y, resolveTelegramThreadSpec as z };
