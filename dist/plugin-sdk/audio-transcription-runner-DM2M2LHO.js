import { Ct as resolveAgentModelPrimaryValue, St as resolveAgentModelFallbackValues, f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime, ut as runExec } from "./paths-Su3o8IWz.js";
import { Cn as requireApiKey, Y as loadConfig, Ya as resolveOpenClawAgentDir, ct as isInboundPathAllowed, fn as normalizeProviderId, lt as mergeInboundPathRoots, ss as normalizeChatType, st as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, ut as resolveIMessageAttachmentRoots, wn as resolveApiKeyForProvider, yn as normalizeGoogleModelId } from "./sessions-IKHgc4YL.js";
import { O as createSubsystemLogger, Q as resolvePreferredOpenClawTmpDir, V as shouldLogVerbose, z as logVerbose } from "./logger-BlQvwwda.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-CUG-eamj.js";
import { n as fetchWithTimeout } from "./fetch-timeout-poCDPIae.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Dm6vpPzM.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-uPQnE4Qn.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DHnjkpBt.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-B4DWbXI5.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DBJmBb0m.js").then((n) => n.r);
