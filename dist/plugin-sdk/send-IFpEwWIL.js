...
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-B9fwHuf0.js";
import { F as danger, O as createSubsystemLogger, R as logVerbose, a as CONFIG_DIR, b as safeParseJson } from "./logger-jRwfXfR1.js";
import { E as loadConfig, O as readConfigFileSnapshotForWrite, dr as isTruthyEnvValue, hn as withFileLock$1, j as writeConfigFile, rn as resolveTelegramPreviewStreamMode } from "./model-auth-B8ugbJXc.js";
import { c as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-CvsECvRM.js";
import { l as hasProxyEnvConfigured } from "./ssrf-CwSOAd1A.js";
import { D as normalizeMimeType, E as kindFromMime, S as getFileExtension, T as isGifMedia } from "./message-channel-CFGJ-htG.js";
import { r as writeJsonAtomic } from "./json-files-D-3S0Vvs.js";
import { _ as loadWebMedia, i as resolveMarkdownTableMode, n as markdownToIR, t as chunkMarkdownIR } from "./ir-CeAesa9r.js";
import { t as redactSensitiveText } from "./redact-oygOkZ9l.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-CegfyFZB.js";
import { t as makeProxyFetch } from "./proxy-fetch-C-cD3Yym.js";
...
import { n as normalizePollInput } from "./polls-DeSCzM2g.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-CBdS4PQp.js";
...
//#endregion
export { writeJsonFileAtomically as $, extractTelegramLocation as A, isSenderAllowed as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramGroupAllowFromContext as F, toLocationContext as G, normalizeDmAllowFromWithStore as H, resolveTelegramMediaPlaceholder as I, addChannelAllowFromStoreEntry as J, withTelegramApiErrorLogging as K, resolveTelegramReplyId as L, normalizeForwardedContext as M, resolveTelegramDirectPeerId as N, describeReplyTarget as O, resolveTelegramForumThreadId as P, readJsonFileWithFallback as Q, resolveTelegramStreamMode as R, buildSenderName as S, buildTelegramParentPeer as T, resolveSenderAllowMatch as U, normalizeAllowFrom as V, formatLocationText as W, removeChannelAllowFromStoreEntry as X, readChannelAllowFromStore as Y, upsertChannelPairingRequest as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, resolveGroupAllowFromSources as at, buildGroupLabel as b, sendStickerTelegram as c, resolveCronStorePath as d, getPairingAdapter as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, mergeDmAllowFromSources as it, hasBotMention as j, expandTextLinks as k, resolveTelegramVoiceSend as l, markdownToTelegramChunks as m, createForumTopicTelegram as n, firstDefined as nt, sendMessageTelegram as o, isRecoverableTelegramNetworkError as p, isVoiceCompatibleAudio as q, deleteMessageTelegram as r, isSenderIdAllowed as rt, sendPollTelegram as s, buildInlineKeyboard as t, listPairingChannels as tt, loadCronStore as u, resolveTelegramFetch as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, splitTelegramCaption as y, resolveTelegramThreadSpec as z };
