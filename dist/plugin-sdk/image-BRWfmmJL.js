import { U as resolveAgentModelFallbackValues, W as resolveAgentModelPrimaryValue } from "./run-with-concurrency-CWh7CuJZ.js";
import { En as applyConfigEnvVars, Fr as resolveOpenClawAgentDir, Gn as resolveImplicitCopilotProvider, Gr as normalizeSecretInput, Kn as resolveImplicitProviders, Un as normalizeProviders, Wn as resolveImplicitBedrockProvider, i as loadConfig, n as getRuntimeConfigSnapshot, r as getRuntimeConfigSourceSnapshot, rr as requireApiKey, sr as isNonSecretApiKeyMarker, tr as getApiKeyForModel } from "./config-DsOWzWmU.js";
import { O as shortenHomeInString, y as isRecord } from "./logger-IRKETRMd.js";
import { P as sanitizeUserFacingText } from "./pi-embedded-helpers-aohswcEW.js";
import { n as redactToolDetail } from "./redact-BDiKSVX1.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-FkIHyYbE.js");
