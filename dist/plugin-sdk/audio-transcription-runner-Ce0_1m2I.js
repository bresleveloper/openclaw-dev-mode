import { Dt as resolveAgentModelPrimaryValue, Et as resolveAgentModelFallbackValues, f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime, ut as runExec } from "./paths-BosfUIb7.js";
import { Aa as mergeInboundPathRoots, Oa as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Ss as normalizeProviderId, _a as loadConfig, hr as normalizeChatType, ja as resolveIMessageAttachmentRoots, ka as isInboundPathAllowed, ks as normalizeGoogleModelId, n as requireApiKey, ps as resolveOpenClawAgentDir, r as resolveApiKeyForProvider } from "./model-auth-DCZchpVh.js";
import { O as createSubsystemLogger, Q as resolvePreferredOpenClawTmpDir, V as shouldLogVerbose, z as logVerbose } from "./logger-DcprVJ1_.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-C_bqfGL0.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-CKm0aD_L.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-BdMU9PCX.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-PDIejh-G.js").then((n) => n.r);
