import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-DMQTmTNv.js";
import { L as isDevMode, O as createSubsystemLogger, S as truncateUtf16Safe, d as normalizeE164, h as resolveUserPath, j as defaultRuntime } from "./utils-CmwgRR7I.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-Dmn791zP.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Gov9-Ds7.js";
import { G as buildAgentMainSessionKey, N as resolvePathViaExistingAncestorSync, O as openBoundaryFile, Q as resolveAgentIdFromSessionKey, S as ensureAgentWorkspace, U as DEFAULT_AGENT_ID, X as normalizeAgentId, Z as normalizeMainKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeOptionalAccountId, m as DEFAULT_AGENTS_FILENAME, mt as runExec, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-Ddb9i3yy.js";
import { D as loadConfig, Er as resolveSecretInputRef, Gn as isPidAlive, J as secretRefKey, M as writeConfigFile, Rr as parseBooleanValue, Sr as hasConfiguredSecretInput, Tt as CHANNEL_IDS, Un as resolveProcessScopedMap, Wn as getProcessStartTime, X as parseDurationMs, Y as getBlockedNetworkModeReason, Z as parseByteSize, v as resolveSecretRefValues, w as createConfigIO, zr as formatCliCommand } from "./model-auth-C8GM6p1v.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-jnF5z1KQ.js";
import { t as SsrFBlockedError } from "./ssrf-mrymR-Zp.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-m91qhrBY.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D5o1S-NW.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-9_9za37f.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CcZSZF4e.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-DozFCXXR.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-CuSS3AV5.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DwMIkr-Z.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-BIx1iMro.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-yib8PDfu.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-D6HkLgNn.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-D6HkLgNn.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { mergeAlsoAllowPolicy as $, setSessionRuntimeModel as $t, isRawApiErrorPayload as A, normalizeSessionDeliveryFields as At, registerBrowserRoutes as B, normalizeInputProvenance as Bt, isCloudCodeAssistFormatError as C, updateSessionStoreEntry as Ct, isFailoverErrorMessage as D, deliveryContextKey as Dt, isFailoverAssistantError as E, deliveryContextFromSession as Et, isTimeoutErrorMessage as F, extractToolCallNames as Ft, resolveBrowserControlAuth as G, evaluateSessionFreshness as Gt, resolveProfile as H, acquireSessionWriteLock as Ht, ensureSandboxWorkspaceForSession as I, parseInlineDirectives as It, resolveSandboxConfigForAgent as J, resolveSessionResetType as Jt, resolveGatewayCredentialsFromConfig as K, resolveChannelResetConfig as Kt, resolveSandboxContext as L, INPUT_PROVENANCE_KIND_VALUES as Lt, parseImageDimensionError as M, archiveSessionTranscripts as Mt, parseImageSizeError as N, capArrayByJsonBytes as Nt, isLikelyContextOverflowError as O, mergeDeliveryContext as Ot, sanitizeUserFacingText as P, countToolResults as Pt, expandPolicyWithPluginGroups as Q, resolveFreshSessionTotalTokens as Qt, resolveSandboxRuntimeStatus as R, applyInputProvenanceToUserMessage as Rt, isBillingAssistantError as S, updateSessionStore as St, isContextOverflowError as T, resolveCacheTtlMs as Tt, getBridgeAuthForPort as U, resolveSessionLockMaxHoldFromTimeout as Ut, resolveBrowserConfig as V, jsonUtf8Bytes as Vt, ensureBrowserControlAuth as W, resolveSessionKey as Wt, buildPluginToolGroups as X, DEFAULT_RESET_TRIGGERS as Xt, applyOwnerOnlyToolPolicy as Y, resolveThreadFlag as Yt, collectExplicitAllowlist as Z, mergeSessionEntry as Zt, formatAssistantErrorText as _, loadSessionStore as _t, isMessagingToolDuplicateNormalized as a, resolveGroupSessionKey as an, matchesAnyGlobPattern as at, getApiErrorPayloadFingerprint as b, resolveSessionStoreEntry as bt, extractToolCallsFromAssistant as c, resolveBootstrapMaxChars as ct, downgradeOpenAIFunctionCallReasoningPairs as d, sanitizeGoogleTurnOrdering as dt, canonicalizeMainSessionAlias as en, stripPluginOnlyAllowlist as et, downgradeOpenAIReasoningBlocks as f, extractDeliveryInfo as ft, classifyFailoverReasonFromHttpStatus as g, resolveAndPersistSessionFile as gt, classifyFailoverReason as h, resolveMirroredTranscriptText as ht, isMessagingToolDuplicate as i, resolveConversationLabel as in, compileGlobPatterns as it, isTransientHttpError as j, normalizeAccountId as jt, isRateLimitAssistantError as k, normalizeDeliveryContext as kt, extractToolResultId as l, resolveBootstrapPromptTruncationWarningMode as lt, BILLING_ERROR_USER_MESSAGE as m, appendAssistantMessageToSessionTranscript as mt, validateGeminiTurns as n, resolveMainSessionKey as nn, normalizeToolName as nt, normalizeTextForComparison as o, buildBootstrapContextFiles as ot, isGoogleModelApi as p, parseSessionThreadInfo as pt, trimToUndefined as q, resolveSessionResetPolicy as qt, pickFallbackThinkingLevel as r, deriveSessionMetaPatch as rn, resolveToolProfilePolicy as rt, sanitizeSessionMessagesImages as s, ensureSessionHeader as st, validateAnthropicTurns as t, resolveExplicitAgentSessionKey as tn, expandToolGroups as tt, sanitizeToolCallIdsForCloudCodeAssist as u, resolveBootstrapTotalMaxChars as ut, formatBillingErrorMessage as v, readSessionUpdatedAt as vt, isCompactionFailureError as w, isCacheEnabled as wt, isAuthAssistantError as x, updateLastRoute as xt, formatRawAssistantErrorForUi as y, recordSessionMetaFromInbound as yt, createBrowserRouteContext as z, hasInterSessionUserProvenance as zt };
