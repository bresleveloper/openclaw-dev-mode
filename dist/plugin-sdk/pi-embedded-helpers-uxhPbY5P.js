import { G as buildAgentMainSessionKey, I as resolvePathViaExistingAncestorSync, O as runExec, Q as resolveAgentIdFromSessionKey, S as ensureAgentWorkspace, U as DEFAULT_AGENT_ID, X as normalizeAgentId, Z as normalizeMainKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeOptionalAccountId, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-Do_Mn3XJ.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-B9fwHuf0.js";
import { E as truncateUtf16Safe, L as isDevMode, O as createSubsystemLogger, h as normalizeE164, j as defaultRuntime, y as resolveUserPath } from "./logger-jRwfXfR1.js";
import { d as getChannelDock, h as normalizeHyphenSlug, o as normalizeThinkLevel } from "./thinking-C_2FZt-A.js";
import { C as createConfigIO, E as loadConfig, Fr as resolveSecretInputRef, G as getBlockedNetworkModeReason, K as parseDurationMs, Mr as hasConfiguredSecretInput, W as secretRefKey, _n as getProcessStartTime, fr as parseBooleanValue, gn as resolveProcessScopedMap, ir as CHANNEL_IDS, j as writeConfigFile, kr as formatCliCommand, q as parseByteSize, v as resolveSecretRefValues, vn as isPidAlive } from "./model-auth-B8ugbJXc.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-CvsECvRM.js";
import { t as SsrFBlockedError } from "./ssrf-CwSOAd1A.js";
import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-CFGJ-htG.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-RlW5D-tr.js";
import { a as saveMediaBuffer, n as ensureMediaDir } from "./store-DVjcJNfv.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D-3S0Vvs.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BGxsuUSa.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DutjVURS.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-BwCaKFTM.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-4FOtj1d1.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-CegfyFZB.js";
import { t as generateSecureToken } from "./secure-random-CaLg2Lm4.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-UugxEUCD.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Bj5YTmU7.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B4qxfV2Y.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-B4qxfV2Y.js")).closePlaywrightBrowserConnection();
	} catch {}
}
