import { E as resolveOpenClawPackageRootSync, H as normalizeSkillFilter, z as isPathInside } from "./run-with-concurrency-CH079TNZ.js";
import { Fn as isPathInsideWithRealpath, H as loadPluginManifestRegistry, K as LEGACY_MANIFEST_KEYS, X as resolveEffectiveEnableState, Y as normalizePluginsConfig, Z as resolveMemorySlotDecision, ar as parseBooleanValue, cr as normalizeResolvedSecretInputString, nr as isDangerousHostEnvVarName, q as MANIFEST_KEY } from "./config-YEY6TI-H.js";
import { O as createSubsystemLogger, X as resolvePreferredOpenClawTmpDir, a as CONFIG_DIR, y as resolveUserPath } from "./logger-CIGDGtYY.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-Dywum8G4.js";
