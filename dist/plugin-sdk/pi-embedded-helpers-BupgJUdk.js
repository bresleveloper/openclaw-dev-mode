import { $ as normalizeAgentId, I as resolvePathViaExistingAncestorSync, J as buildAgentMainSessionKey, K as DEFAULT_AGENT_ID, O as runExec, S as ensureAgentWorkspace, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, et as normalizeMainKey, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, st as normalizeOptionalAccountId, tt as resolveAgentIdFromSessionKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-CagkUg6Q.js";
import { D as loadConfig, Gr as formatCliCommand, M as writeConfigFile, Mr as resolveSecretInputRef, Or as hasConfiguredSecretInput, Wr as parseBooleanValue, Xn as getProcessStartTime, Yn as resolveProcessScopedMap, Zn as isPidAlive, et as secretRefKey, jt as CHANNEL_IDS, nt as parseDurationMs, rt as parseByteSize, tt as getBlockedNetworkModeReason, v as resolveSecretRefValues, w as createConfigIO } from "./model-auth-B04m8qGj.js";
import { E as truncateUtf16Safe, L as isDevMode, O as createSubsystemLogger, h as normalizeE164, j as defaultRuntime, y as resolveUserPath } from "./logger-BBZgPX6j.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-akVZbnot.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-BI0IBIGa.js";
import { t as SsrFBlockedError } from "./ssrf-C2awOn_i.js";
import { C as normalizeChatType, r as normalizeChannelId } from "./plugins-DaSsW_u1.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-CPqtW_nx.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-ruHe4odZ.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Cfsz2AMI.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-EfXQPW7F.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-Bfjt9LC3.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DKf-tH5e.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-vW-Cy1pv.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-rkr2phrh.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-BHBj7GL1.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-CW2xzz3T.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B392pYfe.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-B392pYfe.js")).closePlaywrightBrowserConnection();
	} catch {}
}
