import { mt as resolveAgentModelPrimaryValue, pt as resolveAgentModelFallbackValues } from "./run-with-concurrency-Do_Mn3XJ.js";
import { f as isRecord, x as shortenHomeInString } from "./logger-jRwfXfR1.js";
import { E as loadConfig, Fn as resolveImplicitBedrockProvider, In as resolveImplicitCopilotProvider, Kn as isNonSecretApiKeyMarker, Ln as resolveImplicitProviders, Pn as normalizeProviders, T as getRuntimeConfigSourceSnapshot, an as applyConfigEnvVars, er as normalizeSecretInput, mn as resolveOpenClawAgentDir, r as requireApiKey, t as getApiKeyForModel, w as getRuntimeConfigSnapshot } from "./model-auth-B8ugbJXc.js";
import { P as sanitizeUserFacingText } from "./pi-embedded-helpers-uxhPbY5P.js";
import { n as redactToolDetail } from "./redact-oygOkZ9l.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-BzWybZaC.js");
