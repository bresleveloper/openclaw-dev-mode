import { Gt as getFileExtension, Jt as isGifMedia, Ot as normalizeAccountId, S as redactSensitiveText, Xt as normalizeMimeType, Yt as kindFromMime } from "./paths-BSu400id.js";
import { I as danger, O as createSubsystemLogger, g as safeParseJson, t as CONFIG_DIR, z as logVerbose } from "./utils-2wfSfzP2.js";
...
import { Do as resolveTelegramPreviewStreamMode, Fr as readErrorName, Gi as readConfigFileSnapshotForWrite, Hi as loadConfig, Ji as writeConfigFile, Mr as extractErrorCode, Nr as formatErrorMessage, Pr as formatUncaughtError, jr as collectErrorGraphCandidates, on as getChannelPlugin, sn as listChannelPlugins, sr as writeJsonAtomic, vn as resolveTelegramAccount, zo as withFileLock$1 } from "./model-auth-BiXqAMvR.js";
import { n as makeProxyFetch } from "./proxy-fetch-BG3pWP64.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-2V_OOyTj.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-BqK8pwYd.js";
import { t as renderMarkdownWithMarkers } from "./render-CDecAPNW.js";
import { n as normalizePollInput } from "./polls-DzNNZ5W5.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-D6JP2MBC.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BT_BT-JU.js";
import { t as resolveTelegramFetch } from "./fetch-CUOSMRF9.js";
...
//#endregion
export { upsertChannelPairingRequest as $, buildTelegramThreadParams as A, resolveTelegramGroupAllowFromContext as B, withTelegramApiErrorLogging as C, buildTelegramGroupFrom as D, buildSenderName as E, getTelegramTextParts as F, isSenderAllowed as G, resolveTelegramReplyId as H, hasBotMention as I, resolveSenderAllowMatch as J, normalizeAllowFrom as K, normalizeForwardedContext as L, describeReplyTarget as M, expandTextLinks as N, buildTelegramGroupPeerId as O, extractTelegramLocation as P, removeChannelAllowFromStoreEntry as Q, resolveTelegramDirectPeerId as R, splitTelegramCaption as S, buildSenderLabel as T, resolveTelegramStreamMode as U, resolveTelegramMediaPlaceholder as V, resolveTelegramThreadSpec as W, addChannelAllowFromStoreEntry as X, isVoiceCompatibleAudio as Y, readChannelAllowFromStore as Z, isTelegramClientRejection as _, editMessageTelegram as a, isSenderIdAllowed as at, renderTelegramHtmlText as b, sendPollTelegram as c, formatLocationText as ct, resolveTelegramVoiceSend as d, readJsonFileWithFallback as et, loadCronStore as f, isSafeToRetrySendError as g, isRecoverableTelegramNetworkError as h, editMessageReplyMarkupTelegram as i, firstDefined as it, buildTypingThreadParams as j, buildTelegramParentPeer as k, sendStickerTelegram as l, toLocationContext as lt, wasSentByBot as m, createForumTopicTelegram as n, getPairingAdapter as nt, reactMessageTelegram as o, mergeDmAllowFromSources as ot, resolveCronStorePath as p, normalizeDmAllowFromWithStore as q, deleteMessageTelegram as r, listPairingChannels as rt, sendMessageTelegram as s, resolveGroupAllowFromSources as st, buildInlineKeyboard as t, writeJsonFileAtomically as tt, sendTypingTelegram as u, markdownToTelegramChunks as v, buildGroupLabel as w, wrapFileReferencesInHtml as x, markdownToTelegramHtml as y, resolveTelegramForumThreadId as z };
