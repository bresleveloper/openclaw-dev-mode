import { Dt as resolveAgentModelPrimaryValue, Et as resolveAgentModelFallbackValues, P as redactToolDetail } from "./paths-BosfUIb7.js";
import { As as normalizeProviders, Bs as isNonSecretApiKeyMarker, Js as normalizeSecretInput, _a as loadConfig, ft as sanitizeUserFacingText, ga as getRuntimeConfigSourceSnapshot, js as resolveImplicitProviders, n as requireApiKey, ps as resolveOpenClawAgentDir, rs as createConfigRuntimeEnv, t as getApiKeyForModel, va as projectConfigOntoRuntimeSourceSnapshot, xs as normalizeModelRef } from "./model-auth-DCZchpVh.js";
import { f as isRecord, x as shortenHomeInString } from "./logger-DcprVJ1_.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-Bhk44qPB.js");
