import { o as ChannelAgentTool } from "./types.core-BBGk7pBn.js";
...
import { a as SourceReplyDeliveryMode, s as PromptImageOrderEntry } from "./types-DNy-f8Hr.js";
import { g as InboundEventKind, m as PluginHookChannelContext } from "./templating-KsALmYhy.js";
...
import { s as AuthProfileStore } from "./types-nLOnyeRM.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmInputEvent, Z as PluginHookLlmOutputEvent, d as PluginHookAgentEndEvent, f as PluginHookBeforeAgentFinalizeEvent, ln as PluginHookBeforeAgentStartResult, u as PluginHookAgentContext } from "./hook-types-D7oQwM1Q.js";
import { Ba as PreemptiveCompactionRoute, Ei as CodexAppServerExtensionFactory, Ga as BuildAgentRuntimePlanParams, Gi as AgentToolResultMiddlewareContext, Gl as EmbeddedRunTrigger, Jd as ProviderRuntimePluginHandle, Js as CompactResult, Ki as AgentToolResultMiddlewareEvent, Ks as AssembleResult, Oi as CodexAppServerToolResultEvent, Ra as EmbeddedRunAttemptParams, Ti as CodexAppServerExtensionContext, Va as NormalizedUsage, Wa as AgentRuntimePlan, Wi as AgentToolResultMiddleware, Ya as ToolOutcomeObserver, Ys as ContextEngine, Zi as OpenClawAgentToolResult, _u as ModelAuthMode, cu as ExecToolDefaults, ei as ProcessToolDefaults, eo as requestDeferredPluginToolApproval, gc as TranscriptRewriteResult, if as MessagingToolSend, nc as ContextEnginePromptCacheInfo, oc as ContextEngineRuntimeSettings, qd as ProviderRuntimeModel, rc as ContextEngineRuntimeContext, za as EmbeddedRunAttemptResult } from "./types-CXLy55Xw.js";
...
import { s as EmbeddedAgentQueueMessageOptions } from "./runs-C12eVb25.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-D0n0-eba.js";
import { P as SandboxContext } from "./sandbox-DRzEQ5YS.js";
import { n as ToolSearchCatalogToolExecutor, t as ToolSearchCatalogRef } from "./tool-search-B1e42amb.js";
import { n as ContextEngineHostSupport } from "./host-compat-CcLsuElO.js";
...
//#endregion
export { normalizeProviderToolSchemas as $, AgentHarnessUserInputQuestion as $t, assembleHarnessContextEngine as A, listNodes as At, runAgentHarnessAfterCompactionHook as B, NativeHookRelayEvent as Bt, PreemptiveCompactionDecision as C, extractToolResultMediaArtifact as Ct, compactContextEngineWithSafetyTimeout as D, isMessagingTool as Dt, shouldPreemptivelyCompactBeforePrompt as E, isToolResultError as Et, isActiveHarnessContextEngine as F, classifyEmbeddedAgentRunResultForModelFallback as Ft, resolveSessionWriteLockAcquireTimeoutMs as G, hasNativeHookRelayInvocation as Gt, appendSessionTranscriptMessage as H, NativeHookRelayProvider as Ht, runHarnessContextEngineMaintenance as I, buildAgentRuntimePlan as It, resolveBootstrapContextForRun as J, resolveNativeHookRelayDeferredToolApproval as Jt, resolveSessionWriteLockOptions as K, invokeNativeHookRelay as Kt, createAgentToolResultMiddlewareRunner as L, log as Lt, buildHarnessContextEngineRuntimeContext as M, selectDefaultNodeFromList as Mt, buildHarnessContextEngineRuntimeContextFromUsage as N, NodeListNode as Nt, compactWithSafetyTimeout as O, isMessagingToolSendAction as Ot, finalizeHarnessContextEngineTurn as P, callGatewayTool as Pt, resolveWritableSandboxBindHostRoots as Q, AgentHarnessUserInputPromptOptions as Qt, createCodexAppServerToolResultExtensionRunner as R, runAgentCleanupStep as Rt, PREEMPTIVE_OVERFLOW_ERROR_TEXT as S, extractToolErrorMessage as St, formatPrePromptPrecheckLog as T, sanitizeToolResult as Tt, SessionWriteLockAcquireTimeoutConfig as U, NativeHookRelayRegistrationHandle as Ut, runAgentHarnessBeforeCompactionHook as V, NativeHookRelayProcessResponse as Vt, acquireSessionWriteLock as W, buildNativeHookRelayCommand as Wt, hasSandboxBindContainerPathAliases as X, AgentHarnessUserInputAnswers as Xt, resolveBootstrapFilesForRun as Y, testing as Yt, hasSandboxBindReadonlyHostShadows as Z, AgentHarnessUserInputOption as Zt, runAgentHarnessLlmInputHook as _, getChannelAgentToolMeta as _t, classifyAgentHarnessTerminalOutcome as a, CodexBundleMcpThreadConfig as an, RuntimeToolInputSchemaJson as at, runAgentHarnessBeforeMessageWriteHook as b, extractMessagingToolSend as bt, inferToolMetaFromArgs as c, disposeRegisteredAgentHarnesses as ct, awaitAgentEndSideEffects as d, createOpenClawCodingTools as dt, buildAgentHarnessUserInputAnswers as en, logAgentRuntimeToolDiagnostics as et, runAgentEndSideEffects as f, buildEmbeddedAttemptToolRunContext as ft, runAgentHarnessBeforeAgentFinalizeHook as g, buildSkillWorkshopPromptSection as gt, runAgentHarnessAgentEndHook as h, SKILL_WORKSHOP_TOOL_NAME as ht, ToolProgressDetailMode as i, normalizeAgentHarnessUserInputAnswer as in, inspectRuntimeToolInputSchemas as it, bootstrapHarnessContextEngine as j, resolveNodeIdFromList as jt, resolveCompactionTimeoutMs as k, formatToolAggregate as kt, loadCodexBundleMcpThreadConfig as l, applyEmbeddedAttemptToolsAllow as lt, getAgentHarnessHookRunner as m, resolveAttemptFsWorkspaceOnly as mt, AgentHarnessTerminalOutcomeInput as n, emptyAgentHarnessUserInputAnswers as nn, RuntimeToolSchemaDiagnostic as nt, detectAndLoadAgentHarnessPromptImages as o, LoadCodexBundleMcpThreadConfigParams as on, RuntimeToolInputSchemaProjection as ot, awaitAgentHarnessAgentEndHook as p, resolveAttemptSpawnWorkspaceDir as pt, buildBootstrapContextForFiles as q, registerNativeHookRelay as qt, TOOL_PROGRESS_OUTPUT_MAX_CHARS as r, formatAgentHarnessUserInputPrompt as rn, filterProviderNormalizableTools as rt, formatToolProgressOutput as s, projectRuntimeToolInputSchema as st, AgentHarnessTerminalOutcomeClassification as t, deliverAgentHarnessUserInputPrompt as tn, normalizeAgentRuntimeTools as tt, queueAgentHarnessMessage as u, resolveEmbeddedAttemptToolConstructionPlan as ut, runAgentHarnessLlmOutputHook as v, isAgentToolReplaySafe as vt, estimateRenderedLlmBoundaryTokenPressure as w, filterToolResultMediaUrls as wt, LlmBoundaryTokenPressure as x, extractMessagingToolSendResult as xt, runAgentHarnessAfterToolCallHook as y, supportsModelTools as yt, resolveAgentHarnessBeforePromptBuildResult as z, buildAgentHookContextChannelFields as zt };