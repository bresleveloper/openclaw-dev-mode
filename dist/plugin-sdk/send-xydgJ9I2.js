import { ot as normalizeAccountId } from "./run-with-concurrency-CWh7CuJZ.js";
...
import { Lr as withFileLock$1, Tn as resolveTelegramPreviewStreamMode, ci as isTruthyEnvValue, i as loadConfig, l as writeConfigFile, o as readConfigFileSnapshotForWrite } from "./config-DsOWzWmU.js";
import { D as safeParseJson, F as danger, R as logVerbose, a as createSubsystemLogger, f as CONFIG_DIR } from "./logger-IRKETRMd.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-DAAtPyza.js";
import { n as listChannelPlugins, t as getChannelPlugin, w as resolveTelegramAccount } from "./plugins-Dz9iIawy.js";
...
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-Cr8axI0N.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BxG-nq2R.js";
...
import { u as hasProxyEnvConfigured } from "./ssrf-COC0PzR6.js";
import { i as resolveMarkdownTableMode, n as markdownToIR, t as chunkMarkdownIR, v as loadWebMedia } from "./ir-E4GckxPv.js";
import { t as renderMarkdownWithMarkers } from "./render-C15_5JiR.js";
import { t as makeProxyFetch } from "./proxy-fetch-BTfwqmaA.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-B6NBgHav.js";
...
//#endregion
export { readChannelAllowFromStoreSync as $, buildTypingThreadParams as A, resolveTelegramReplyId as B, buildGroupLabel as C, buildTelegramGroupPeerId as D, buildTelegramGroupFrom as E, normalizeForwardedContext as F, normalizeDmAllowFromWithStore as G, resolveTelegramThreadSpec as H, resolveTelegramDirectPeerId as I, toLocationContext as J, resolveSenderAllowMatch as K, resolveTelegramForumThreadId as L, expandTextLinks as M, extractTelegramLocation as N, buildTelegramParentPeer as O, hasBotMention as P, readChannelAllowFromStore as Q, resolveTelegramGroupAllowFromContext as R, splitTelegramCaption as S, buildSenderName as T, isSenderAllowed as U, resolveTelegramStreamMode as V, normalizeAllowFrom as W, isVoiceCompatibleAudio as X, withTelegramApiErrorLogging as Y, addChannelAllowFromStoreEntry as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, listPairingChannels as at, isWSLEnv as b, sendStickerTelegram as c, mergeDmAllowFromSources as ct, resolveCronStorePath as d, removeChannelAllowFromStoreEntry as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, getPairingAdapter as it, describeReplyTarget as j, buildTelegramThreadParams as k, resolveTelegramVoiceSend as l, resolveGroupAllowFromSources as lt, markdownToTelegramChunks as m, createForumTopicTelegram as n, readJsonFileWithFallback as nt, sendMessageTelegram as o, firstDefined as ot, isRecoverableTelegramNetworkError as p, formatLocationText as q, deleteMessageTelegram as r, writeJsonFileAtomically as rt, sendPollTelegram as s, isSenderIdAllowed as st, buildInlineKeyboard as t, upsertChannelPairingRequest as tt, loadCronStore as u, resolveTelegramFetch as v, buildSenderLabel as w, isWSLSync as x, isWSL2Sync as y, resolveTelegramMediaPlaceholder as z };
