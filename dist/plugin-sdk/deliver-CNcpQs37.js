import { Gt as normalizeOptionalAccountId, Wt as normalizeAccountId } from "./paths-BosfUIb7.js";
import { Gt as parseInlineDirectives, _o as createInternalHookEvent, dn as getChannelPlugin, io as getActivePluginRegistry, j as isMessagingToolDuplicate, mn as getChannelDock, oo as getActivePluginRegistryVersion, pn as normalizeChannelId, qr as generateSecureUuid, vo as triggerInternalHook, vt as appendAssistantMessageToSessionTranscript, yt as resolveMirroredTranscriptText } from "./model-auth-DCZchpVh.js";
import { O as createSubsystemLogger, z as logVerbose } from "./logger-DcprVJ1_.js";
import { c as resolveStateDir } from "./paths-CtOdJffQ.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-CKm0aD_L.js";
import { i as isSilentReplyText } from "./tokens-5ACSdtYj.js";
import { r as parseTelegramTarget } from "./targets-j8F92loj.js";
import { d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, l as chunkByParagraph, m as resolveChunkMode, s as resolveMarkdownTableMode, v as parseFenceSpans } from "./ir-CGZK3483.js";
import { c as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-9Oy8KPju.js";
...
//#endregion
export { toPluginMessageContext as A, joinPresentTextSegments as C, toInternalMessageReceivedContext as D, toInternalMessagePreprocessedContext as E, toPluginMessageSentEvent as M, fireAndForgetHook as N, toInternalMessageSentContext as O, initializeGlobalHookRunner as S, deriveInboundMessageHookContext as T, normalizeTargetForProvider as _, normalizeReplyPayloadsForDelivery as a, splitMediaFromOutput as b, filterMessagingToolDuplicates as c, shouldSuppressMessagingToolReplies as d, shouldSuppressReasoningPayload as f, normalizeChannelTargetInput as g, buildTargetResolverSignature as h, normalizeOutboundPayloadsForJson as i, toPluginMessageReceivedEvent as j, toInternalMessageTranscribedContext as k, filterMessagingToolMediaDuplicates as l, resolveReplyToMode as m, formatOutboundPayloadLog as n, applyReplyTagsToPayload as o, createReplyToModeFilterForChannel as p, normalizeOutboundPayloads as r, applyReplyThreading as s, deliverOutboundPayloads as t, isRenderablePayload as u, throwIfAborted as v, buildCanonicalSentMessageHookContext as w, getGlobalHookRunner as x, parseReplyDirectives as y };
