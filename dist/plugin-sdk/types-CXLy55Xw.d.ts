...
import { T as StreamFn, f as AgentToolResult, l as AgentTool, s as AgentMessage } from "./types-BoFHdU9q.js";
import { t as ChatType } from "./chat-type-B6XXSSnm.js";
import { O as SessionMaintenanceMode, d as ContextVisibilityMode, j as SessionScope, v as HumanDelayConfig } from "./types.base-DmKdGokm.js";
import { a as SourceReplyDeliveryMode, c as InputProvenance, d as ReplyPayload, n as GetReplyOptions, o as UserTurnTranscriptRecorder, r as PartialReplyPayload, s as PromptImageOrderEntry } from "./types-DNy-f8Hr.js";
import { a as SupplementalContextFacts, g as InboundEventKind, i as MsgContext, m as PluginHookChannelContext, n as InboundSourceModality, o as CommandTurnContext, r as MentionSource, s as CommandTurnKind, t as FinalizedMsgContext } from "./templating-KsALmYhy.js";
import { In as SilentReplyConversationType, i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot } from "./types.openclaw-R57aE8ho.js";
...
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-tYxTcHXF.js";
import { G as TtsAutoMode, K as TtsConfig, Q as TtsProvider, W as ResolvedTtsPersona, q as TtsMode } from "./types.slack-C0xxLbhi.js";
...
import { a as AuthProfileFailureReason, c as OAuthCredential, i as AuthProfileCredential, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential } from "./types-nLOnyeRM.js";
import { f as MediaUnderstandingProvider } from "./types-CHktwrqj.js";
...
import { C as ExecTarget, S as ExecSecurity, x as ExecMode, y as ExecAsk } from "./exec-approvals-bouecjdj.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, h as PluginConfigUiHint, u as PluginKind } from "./manifest-registry-B03IrHXx.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { P as MessageReceipt } from "./types-DBaup9wG.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-B8rjITVv.js";
import { i as WizardPrompter } from "./prompts-DgKIGa-v.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin$1 } from "./types.plugin-CfTU_bVj.js";
import { n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-DJKUP8I2.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-BEf9DzmM.js";
import { n as ConfigReplaceResult, t as ConfigMutationBase } from "./config-B8KaCONr.js";
import { i as resolveStateDir } from "./paths-BrMQAmyZ.js";
...
import { a as SessionEntry, i as SessionContextBudgetStatus, n as GroupKeyResolution, s as SessionSystemPromptReport, t as CliSessionBinding } from "./types-CmP2mjUp.js";
...
import { b as ResolvedSessionMaintenanceConfig, f as onSessionTranscriptUpdate, g as updateSessionStore, v as loadSessionStore } from "./transcript-B5JEOgTb.js";
import { d as ReasoningLevel, f as ThinkLevel, m as VerboseLevel, p as ThinkingCatalogEntry, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-PmUlyXxc.js";
import { Dt as PluginHookToolKind, Et as PluginHookToolInputKind, Gt as PluginNextTurnInjectionEnqueueResult, J as PluginHookHandlerMap, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolContext, Wt as PluginNextTurnInjection, _n as ReplyDispatchKind, an as PluginHookBeforeToolCallResult, bn as ReplyFollowupAdmissionBarrierTimeoutPolicy, gn as ReplyDispatchBeforeDeliver, ln as PluginHookBeforeAgentStartResult, qt as PluginJsonValue, rn as PluginApprovalResolution, tt as PluginHookName, vn as ReplyDispatchRuntimeInfo, yn as ReplyDispatcher } from "./hook-types-D7oQwM1Q.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-c5mRZYEt.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-A1VoWklm.js";
import { i as SkillTelemetrySource, r as SkillSnapshot } from "./types-B7pcFEbF.js";
...
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-DuSCzBZB.js";
import { s as LogLevel } from "./subsystem-Boo2DQIV.js";
import { t as OpenClawAgentDatabase } from "./openclaw-agent-db-B-F-AnOy.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-hRQuBoEz.js";
import { o as resolveStorePath, r as resolveSessionFilePath } from "./sessions-BvW5Smbp.js";
import { c as EmbeddedAgentExecutionPhase } from "./store-DDNXK4HG.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-6FEupg54.js";
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-BAv_on9b.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-B81WyFEh.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-CE_V9G1S.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-DOMhfYsC.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-BvsXIKP5.js";
import { n as RuntimeWebFetchMetadata, r as RuntimeWebSearchMetadata } from "./command-secret-gateway-Ci1QGA2-.js";
import { C as SecretInputMode, n as GatewayRequestHandler, v as AgentEventPayload, x as onAgentEvent, y as AgentEventStream } from "./types-Bk57zmpP.js";
...
import { a as MediaUnderstandingRuntime } from "./runtime-types-mmgZqmP6.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-4X4760Uw.js";
import { d as MemoryPromptSectionBuilder, o as MemoryFlushPlanResolver, r as MemoryCorpusSupplement, s as MemoryPluginCapability, u as MemoryPluginRuntime } from "./memory-state-DUeMsJ8-.js";
...
import { Zt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-B93hMYj1.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-CmtVOB-u.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-CSsQCIM3.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-BoZulJ8-.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-CqZmgAHh.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-Bu2N2V3L.js";
import { t as hasControlCommand } from "./command-detection-Q38CGAVH.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-DM3wTJzW.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-lbgjeqKd.js";
import { t as buildPairingReply } from "./pairing-messages-Bg1taZel.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-CwP2csrc.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-CQqct7DU.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-BvKw5JrY.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-BweDpJQ1.js";
...
type InternalGetReplyOptions = GetReplyOptions & InternalReplySessionOptions;
...
//#endregion
export { OpenClawPluginService as $, isToolWrappedWithBeforeToolCallHook as $a, SpeechProviderResolveConfigContext as $c, ProviderResolveExternalOAuthProfilesContext as $d, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $i, formatFastModeCurrentStatus as $l, PluginRuntime as $n, normalizeBatchBaseUrl as $o, CommandSessionMetadataChange as $r, ContextEngineMaintenanceResult as $s, ProviderModelSelectedContext as $t, resolveProfilesUnavailableReason as $u, OpenClawPluginDefinition as A, AgentHarnessDeliveryDefaults as Aa, DetachedTaskLifecycleRuntime as Ac, AuthProfileEligibilityReasonCode as Ad, CliBackendAuthEpochMode as Ai, WebFetchProviderPlugin as Al, ProviderResolvePromptOverlayContext as An, normalizeEmbeddingModelWithPrefixes as Ao, ConversationFacts as Ar, DEFAULT_HEARTBEAT_ACK_MAX_CHARS as As, ProviderAuthOptionBag as At, hasUsableCustomProviderApiKey as Au, OpenClawPluginModule as B, PreemptiveCompactionRoute as Ba, resolveEffectiveTtsConfig as Bc, hasUsableOAuthCredential as Bd, CliBackendThinkingLevel as Bi, WebSearchRuntimeMetadataContext as Bl, ProviderTransportTurnState as Bn, buildMultimodalChunkForIndexing as Bo, formatInboundFromLabel as Br, appendCronStyleCurrentTimeLine as Bs, ProviderCatalogResult as Bt, formatMissingAuthError as Bu, OpenClawPluginApi as C, RealtimeTranscriptionSessionCallbacks as Ca, RuntimeLogger as Cc, dedupeProfileIds as Cd, PluginToolMetadataRegistration as Ci, ChannelIngressQueuePruneOptions as Cl, ProviderReplaySanitizeMode as Cn, estimateUtf8Bytes as Co, AccessFacts as Cr, emptyPluginConfigSchema as Cs, PluginTranscriptsSourceProviderEntry as Ct, canUseProfileAsProviderEntryApiKey as Cu, OpenClawPluginCliRegistrar as D, AgentHarnessAttemptResult as Da, PluginRuntimeTaskRuns as Dc, ExternalCliAuthDiscovery as Dd, CodexAppServerExtensionRuntime as Di, WebFetchCredentialResolutionSource as Dl, ProviderResolveAuthProfileIdContext as Dn, resolveRemoteEmbeddingClient as Do, ChannelTurnRecordOptions as Dr, parseNonNegativeByteSize as Ds, ProviderAuthKind as Dt, hasAvailableAuthForProvider as Du, OpenClawPluginCliContext as E, AgentHarnessAttemptParams as Ea, PluginRuntimeTaskFlows as Ec, resolveApiKeyForProfile as Ed, CodexAppServerExtensionFactory as Ei, PluginWebSearchProviderEntry as El, ProviderReplayToolCallIdMode as En, createRemoteEmbeddingProvider as Eo, ChannelTurnDroppedHistoryOptions as Er, listRegisteredMemoryEmbeddingProviderAdapters as Es, ProviderAuthDoctorHintContext as Et, getCustomProviderApiKey as Eu, OpenClawPluginHttpRouteHandler as F, AgentHarnessSupport as Fa, TaskRunDetail as Fc, resolveProviderAuthAliasMap as Fd, CliBackendPrepareExecutionContext as Fi, WebSearchProviderId as Fl, ProviderRuntimeProviderConfig as Fn, sanitizeEmbeddingCacheHeaders as Fo, ChannelBotLoopProtectionFacts as Fr, ResolvedMemorySearchSyncConfig as Fs, ProviderBuiltInModelSuppressionResult as Ft, resolveUsableCustomProviderApiKey as Fu, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, BuildAgentRuntimePlanParams as Ga, SpeechListVoicesRequest as Gc, ProviderThinkingPolicyContext as Gd, AgentToolResultMiddlewareContext as Gi, EmbeddedRunTrigger as Gl, RealtimeTranscriptionProviderPlugin as Gn, normalizeExtraMemoryPaths as Go, DispatchReplyWithDispatcher as Gr, resolveContextEngineOwnerPluginId as Gs, ProviderDiscoveryOrder as Gt, EnvApiKeyResult as Gu, OpenClawPluginNodeHostCommand as H, normalizeUsage as Ha, normalizeTtsAutoMode as Hc, CODEX_CLI_PROFILE_ID as Hd, PluginTextReplacement as Hi, GenerateVideoRuntimeResult as Hl, ProviderValidateReplayTurnsContext as Hn, cosineSimilarity as Ho, finalizeInboundContext as Hr, ContextEngineFactory as Hs, ProviderCreateStreamFnContext as Ht, isProviderAuthError as Hu, OpenClawPluginHttpRouteMatch as I, AgentHarnessSupportContext as Ia, TaskRunView as Ic, resolveProviderIdForAuth as Id, CliBackendPreparedExecution as Ii, WebSearchProviderPlugin as Il, ProviderSanitizeReplayHistoryContext as In, enforceEmbeddingMaxInputTokens as Io, recordChannelBotPairLoopAndCheckSuppression as Ir, resolveMemorySearchConfig as Is, ProviderCacheTtlEligibilityContext as It, shouldPreferExplicitConfigApiKeyAuth as Iu, OpenClawPluginNodeInvokeTransportResult as J, HookContext as Ja, SpeechProviderConfiguredContext as Jc, ProviderRuntimePluginHandle as Jd, AgentToolResultMiddlewareOptions as Ji, AgentInternalEvent as Jl, TranscriptSourceProvider as Jn, runWithConcurrency as Jo, createReplyDispatcher as Jr, CompactResult as Js, ProviderExtraParamsForTransportResult as Jt, clearAuthProfileCooldown as Ju, OpenClawPluginNodeInvokePolicyContext as K, BeforeToolCallPolicyDiagnosticState as Ka, SpeechModelOverridePolicy as Kc, ProviderThinkingProfile as Kd, AgentToolResultMiddlewareEvent as Ki, RunEmbeddedAgentParams as Kl, RealtimeVoiceProviderPlugin as Kn, parseEmbedding as Ko, ReplyDispatcherOptions as Kr, AssembleResult as Ks, ProviderDiscoveryResult as Kt, resolveEnvApiKey as Ku, OpenClawPluginHttpRouteParams as L, CompactEmbeddedAgentSessionParams as La, ResolvedTtsConfig as Lc, AuthCredentialReasonCode as Ld, CliBackendResolveExecutionArgs as Li, WebSearchProviderSetupContext as Ll, ProviderSystemPromptContributionContext as Ln, MemoryChunk as Lo, EnvelopeFormatOptions as Lr, resolveMemorySearchSyncConfig as Ls, ProviderCapabilities as Lt, MissingProviderAuthError as Lu, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessResultClassification as Ma, TaskFlowView as Mc, resolveAuthProfileOrder as Md, CliBackendNativeToolMode as Mi, WebFetchRuntimeMetadataContext as Ml, ProviderResolveUsageAuthContext as Mn, sanitizeAndNormalizeEmbedding as Mo, InboundMediaFacts as Mr, resolveHeartbeatPrompt as Ms, ProviderBuildMissingAuthMessageContext as Mt, resolveModelAuthMode as Mu, OpenClawPluginHostedMediaResolver as N, AgentHarnessSideQuestionParams as Na, TaskRunAggregateSummary as Nc, ProviderAuthAliasLookupParams as Nd, CliBackendNormalizeConfigContext as Ni, WebSearchCredentialResolutionSource as Nl, ProviderResolveWebSocketSessionPolicyContext as Nn, isMissingEmbeddingApiKeyError as No, PreparedChannelTurn as Nr, stripHeartbeatToken as Ns, ProviderBuildUnknownModelHintContext as Nt, resolveProviderEntryApiKeyBinding as Nu, OpenClawPluginCommandDefinition as O, AgentHarnessCompactParams as Oa, PluginRuntimeTasks as Oc, formatAuthDoctorHint as Od, CodexAppServerToolResultEvent as Oi, WebFetchProviderContext as Ol, ProviderResolveDynamicModelContext as On, RemoteEmbeddingProviderId as Oo, ChannelTurnResult as Or, withProgress as Os, ProviderAuthMethod as Ot, hasRuntimeAvailableProviderAuth as Ou, OpenClawPluginHttpRouteAuth as P, AgentHarnessSideQuestionResult as Pa, TaskRunCancelResult as Pc, resetProviderAuthAliasMapCacheForTest as Pd, CliBackendPlugin as Pi, WebSearchProviderContext as Pl, ProviderResolvedUsageAuth as Pn, mapBatchEmbeddingsByIndex as Po, RunChannelTurnParams as Pr, ResolvedMemorySearchConfig as Ps, ProviderBuiltInModelSuppressionContext as Pt, resolveProviderEntryApiKeyProfileReference as Pu, OpenClawPluginSecurityAuditContext as Q, hasBeforeToolCallPolicy as Qa, SpeechProviderPreparedSynthesis as Qc, ProviderResolveExternalAuthProfilesContext as Qd, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qi, formatFastModeCommandOptions as Ql, CreatePluginRuntimeOptions as Qn, buildBatchHeaders as Qo, InternalGetReplyOptions as Qr, ContextEngineInfo as Qs, ProviderFollowupFallbackRouteResult as Qt, resolveProfileUnusableUntilForDisplay as Qu, OpenClawPluginHttpRouteUpgradeHandler as R, EmbeddedRunAttemptParams as Ra, ResolvedTtsModelOverrides as Rc, DEFAULT_OAUTH_REFRESH_MARGIN_MS as Rd, CliBackendResolveExecutionArgsContext as Ri, WebSearchProviderToolDefinition as Rl, ProviderToolSchemaDiagnostic as Rn, MemoryFileEntry as Ro, formatAgentEnvelope as Rr, DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR as Rs, ProviderCatalogContext as Rt, ProviderAuthError as Ru, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionSession as Sa, PluginRuntimeCore as Sc, upsertAuthProfileWithLock as Sd, PluginSessionTurnUnscheduleByTagResult as Si, ChannelIngressQueueFailedRecord as Sl, ProviderReplayPolicyContext as Sn, estimateStructuredEmbeddingInputBytes as So, resolveChannelInboundSupplementalContext as Sr, buildPluginConfigSchema as Ss, PluginTextTransformRegistration as St, applyLocalNoAuthHeaderOverride as Su, OpenClawPluginCliCommandDescriptor as T, AgentHarness as Ta, BoundTaskRunsRuntime as Tc, refreshOAuthCredentialForRuntime as Td, CodexAppServerExtensionContext as Ti, PluginWebFetchProviderEntry as Tl, ProviderReplaySessionState as Tn, RemoteEmbeddingClient as To, ChannelTurnAdmission as Tr, listMemoryEmbeddingProviders as Ts, ProviderAuthContext as Tt, getApiKeyForModel as Tu, OpenClawPluginNodeInvokeApprovalDecision as U, isReplaySafeToolCall as Ua, SpeechDirectiveTokenParseContext as Uc, augmentModelCatalogWithProviderPlugins as Ud, PluginTextTransforms as Ui, GenerateImageParams as Ul, ProviderWebSocketSessionPolicy as Un, ensureDir as Uo, settleReplyDispatcher as Ur, ContextEngineFactoryContext as Us, ProviderDeferSyntheticProfileAuthContext as Ut, requireApiKey as Uu, OpenClawPluginNodeCliFeatureOptions as V, NormalizedUsage as Va, TTS_AUTO_MODES as Vc, CLAUDE_CLI_PROFILE_ID as Vd, CliBundleMcpMode as Vi, GenerateVideoParams as Vl, ProviderUsageAuthToken as Vn, chunkMarkdown as Vo, resolveEnvelopeFormatOptions as Vr, resolveCronStyleNow as Vs, ProviderCreateEmbeddingProviderContext as Vt, isMissingProviderAuthError as Vu, OpenClawPluginNodeInvokePolicy as W, AgentRuntimePlan as Wa, SpeechDirectiveTokenParseResult as Wc, ProviderDefaultThinkingPolicyContext as Wd, AgentToolResultMiddleware as Wi, GenerateImageRuntimeResult as Wl, ProviderWrapStreamFnContext as Wn, listMemoryFiles as Wo, DispatchReplyWithBufferedBlockDispatcher$1 as Wr, registerContextEngine as Ws, ProviderDiscoveryContext as Wt, resolveAwsSdkEnvVarName as Wu, OpenClawPluginRunContextApi as X, finalizeToolTerminalPresentation as Xa, SpeechProviderOverrides as Xc, ProviderExternalAuthProfile as Xd, AgentToolResultMiddlewareRuntime as Xi, FastModeAutoProgressState as Xl, UnifiedModelCatalogProviderPlugin as Xn, uploadBatchJsonlFile as Xo, DispatchFromConfigResult as Xr, ContextEngineHostCapability as Xs, ProviderFetchUsageSnapshotContext as Xt, markAuthProfileCooldown as Xu, OpenClawPluginReloadRegistration as Y, ToolOutcomeObserver as Ya, SpeechProviderId as Yc, ProviderSystemPromptContribution as Yd, AgentToolResultMiddlewareResult as Yi, resolveFastModeState as Yl, UnifiedModelCatalogProviderContext as Yn, hashText as Yo, createReplyDispatcherWithTyping as Yr, ContextEngine as Ys, ProviderFailoverErrorContext as Yt, markAuthProfileBlockedUntil as Yu, OpenClawPluginSecurityAuditCollector as Z, getBeforeToolCallPolicyDiagnosticState as Za, SpeechProviderPrepareSynthesisContext as Zc, ProviderExternalOAuthProfile as Zd, OpenClawAgentToolResult as Zi, formatFastModeAutoProgressText as Zl, VideoGenerationProviderPlugin as Zn, BatchHttpClientConfig as Zo, InternalGetReplyFromConfig as Zr, ContextEngineHostRequirements as Zs, ProviderFollowupFallbackRouteContext as Zt, markAuthProfileFailure as Zu, MigrationSummary as _, RealtimeVoiceToolResultOptions as _a, LlmCompleteCaller as _c, suggestOAuthProfileIdForLegacyDefault as _d, PluginSessionExtensionRegistration as _i, ChannelIngressQueue as _l, ProviderPrepareRuntimeAuthContext as _n, clearMemoryEmbeddingProviders as _o, FinalizeChannelInboundContextResult as _r, isFileMissingError as _s, PluginRealtimeVoiceProviderEntry as _t, ModelAuthMode as _u, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeEvent as aa, ContextEngineRuntimeReasonCode as ac, ensureAuthProfileStoreForLocalUpdate as ad, MessagingToolSourceReplyPayload as af, PluginAgentEventEmitResult as ai, SpeechSynthesisTarget as al, ProviderNormalizeToolSchemasContext as an, consumePreExecutionBlockedToolCall as ao, hasVisibleChannelTurnDispatch as ar, buildEmbeddingBatchGroupOptions as as, PluginCommandContext as at, AgentStreamParams as au, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderId as ba, LlmCompleteResult as bc, setAuthProfileOrder as bd, PluginSessionTurnScheduleParams as bi, ChannelIngressQueueCompletedRecord as bl, ProviderReasoningOutputModeContext as bn, buildRemoteBaseUrlPolicy as bo, filterChannelInboundSupplementalContext as br, splitShellArgs as bs, PluginSetupAutoEnableProbe as bt, RuntimeProviderAuthLookup as bu, MigrationDetection as c, RealtimeVoiceCloseReason as ca, ContextEngineRuntimeSettingsUnsupportedError as cc, loadAuthProfileStore as cd, normalizeHeartbeatToolResponse as cf, PluginRunContextGetParams as ci, TtsDirectiveOverrides as cl, ProviderPlugin as cn, MemoryEmbeddingBatchChunk as co, DurableInboundReplyDeliveryParams as cr, ProviderBatchOutputLine as cs, PluginCommandResult as ct, ExecToolDefaults as cu, MigrationItemKind as d, RealtimeVoiceProviderConfiguredContext as da, IngestResult as dc, loadAuthProfileStoreWithoutExternalProfiles as dd, PluginSessionActionContext as di, OpenClawPluginActiveModelContext as dl, ProviderPluginWizard as dn, MemoryEmbeddingProviderAdapter as do, BuildChannelInboundEventContextAsyncParams as dr, extractBatchErrorMessage as ds, PluginEmbeddingProvider as dt, PreparedSimpleCompletionModelForAgent as du, RealtimeVoiceAudioFormat as ea, ContextEngineOperation as ec, clearExpiredCooldowns as ed, ProviderResolveSyntheticAuthContext as ef, ProcessToolDefaults as ei, SpeechProviderResolveTalkConfigContext as el, ProviderModernModelPolicyContext as en, requestDeferredPluginToolApproval as eo, SubagentRunParams as er, BatchCompletionResult as es, OpenClawPluginServiceContext as et, formatFastModeSourceSuffix as eu, MigrationItemStatus as f, RealtimeVoiceProviderId as fa, SubagentEndReason as fc, replaceRuntimeAuthProfileStoreSnapshots as fd, PluginSessionActionRegistration as fi, OpenClawPluginHookOptions as fl, ProviderPluginWizardModelPicker as fn, MemoryEmbeddingProviderCallOptions as fo, BuildChannelInboundEventContextParams as fr, formatUnavailableBatchError as fs, PluginInteractiveHandlerRegistration as ft, SimpleCompletionModelOptions as fu, MigrationProviderPreparation as g, RealtimeVoiceToolCallEvent as ga, TranscriptRewriteResult as gc, repairOAuthProfileIdMismatch as gd, PluginSessionExtensionProjection as gi, TaskRecord as gl, ProviderPrepareExtraParamsContext as gn, MemoryEmbeddingProviderRuntime as go, FinalizeChannelInboundContextParams as gr, hasNonTextEmbeddingParts as gs, PluginRealtimeTranscriptionProviderEntry as gt, resolveSimpleCompletionSelectionForAgent as gu, MigrationProviderPlugin as h, RealtimeVoiceTool as ha, TranscriptRewriteRequest as hc, updateAuthProfileStoreWithLock as hd, PluginSessionAttachmentResult as hi, OpenClawPluginToolOptions as hl, ProviderPrepareDynamicModelContext as hn, MemoryEmbeddingProviderIndexIdentity as ho, FinalizeChannelInboundContextAsyncParams as hr, EmbeddingInput as hs, PluginLogger as ht, prepareSimpleCompletionModelForAgent as hu, AgentPromptSurfaceKind as i, RealtimeVoiceBridgeCreateRequest as ia, ContextEngineRuntimeMode as ic, ensureAuthProfileStore as id, MessagingToolSend as if, PluginAgentEventEmitParams as ii, SpeechSynthesisStreamResult as il, ProviderNormalizeResolvedModelContext as in, consumeAdjustedParamsForToolCall as io, hasFinalChannelTurnDispatch as ir, EmbeddingBatchExecutionParams as is, OpenClawPluginSessionWorkflowApi as it, EmbeddedBlockChunker as iu, OpenClawPluginGatewayMethod as j, AgentHarnessResetParams as ja, TaskFlowDetail as jc, resolveAuthProfileEligibility as jd, CliBackendExecutionMode as ji, WebFetchProviderToolDefinition as jl, ProviderResolveTransportTurnStateContext as jn, debugEmbeddingsLog as jo, DispatchedChannelTurnResult as jr, HEARTBEAT_PROMPT as js, ProviderAuthResult as jt, resolveApiKeyForProvider as ju, OpenClawPluginConfigSchema as k, AgentHarnessCompactResult as ka, DetachedTaskFinalizeParams as kc, resolveAuthProfileDisplayLabel as kd, CodexAppServerToolResultHandlerResult as ki, WebFetchProviderId as kl, ProviderResolveNonInteractiveApiKeyParams as kn, resolveRemoteEmbeddingBearerClient as ko, CommandFacts as kr, withProgressTotals as ks, ProviderAuthMethodNonInteractiveContext as kt, hasSyntheticLocalProviderAuthConfig as ku, MigrationItem as l, RealtimeVoiceProviderCapabilities as la, ContextEngineSelectionSource as lc, loadAuthProfileStoreForRuntime as ld, PluginRunContextPatch as li, TtsDirectiveParseResult as ll, ProviderPluginCatalog as ln, MemoryEmbeddingBatchOptions as lo, DurableInboundReplyDeliveryResult as lr, applyEmbeddingBatchOutputLine as ls, PluginConfigMigration as lt, AgentSimpleCompletionSelection as lu, MigrationProviderContext as m, RealtimeVoiceRole as ma, TranscriptRewriteReplacement as mc, saveAuthProfileStore as md, PluginSessionAttachmentParams as mi, OpenClawPluginToolFactory as ml, ProviderPreferRuntimeResolvedModelContext as mn, MemoryEmbeddingProviderCreateResult as mo, ChannelInboundSupplementalResolutionOptions as mr, DEFAULT_LOCAL_MODEL as ms, PluginInteractiveRegistration as mt, prepareSimpleCompletionModel as mu, AgentPromptGuidance as n, RealtimeVoiceBridge as na, ContextEnginePromptCacheInfo as nc, isProfileInCooldown as nd, EmbeddedAgentCompactResult as nf, ProviderNormalizeConfigContext as ni, SpeechSynthesisRequest as nl, ProviderNonInteractiveApiKeyResult as nn, setBeforeToolCallDiagnosticsEnabled as no, kernel_d_exports as nr, resolveCompletedBatchResult as ns, OpenClawPluginSessionControlsApi as nt, resolveFastModeForElapsed as nu, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBrowserSession as oa, ContextEngineRuntimeSettings as oc, ensureAuthProfileStoreWithoutExternalProfiles as od, HEARTBEAT_RESPONSE_TOOL_NAME as of, PluginAgentEventSubscriptionRegistration as oi, SpeechTelephonySynthesisRequest as ol, ProviderNormalizeTransportContext as on, AgentHarnessTaskRuntimeScope as oo, resolveChannelTurnDispatchCounts as or, runEmbeddingBatchGroups as os, PluginCommandDiagnosticsSession as ot, ClientToolDefinition as ou, MigrationPlan as p, RealtimeVoiceProviderResolveConfigContext as pa, SubagentSpawnPreparation as pc, resolvePersistedAuthProfileOwnerAgentDir as pd, PluginSessionActionResult as pi, OpenClawPluginToolContext as pl, ProviderPluginWizardSetup as pn, MemoryEmbeddingProviderCreateOptions as po, BuiltChannelInboundEventContext as pr, createLocalEmbeddingProvider as ps, PluginInteractiveHandlerResult as pt, completeWithPreparedSimpleCompletionModel as pu, OpenClawPluginNodeInvokePolicyResult as q, DeferredPluginToolApproval as qa, SpeechProviderConfig as qc, ProviderRuntimeModel as qd, AgentToolResultMiddlewareHarness as qi, PromptMode as ql, SpeechProviderPlugin as qn, remapChunkLines as qo, ReplyDispatcherWithTypingOptions as qr, BootstrapResult as qs, ProviderExtraParamsForTransportContext as qt, calculateAuthProfileCooldownMs as qu, AgentPromptGuidanceEntry as r, RealtimeVoiceBridgeCallbacks as ra, ContextEngineRuntimeContext as rc, clearRuntimeAuthProfileStoreSnapshots as rd, EmbeddedAgentRunMeta as rf, ProviderResolveConfigApiKeyContext as ri, SpeechSynthesisStreamRequest as rl, ProviderNormalizeModelIdContext as rn, wrapToolWithBeforeToolCallHook as ro, recordDroppedChannelInboundHistory as rr, throwIfBatchTerminalFailure as rs, OpenClawPluginSessionStateApi as rt, BlockReplyChunking as ru, MigrationApplyResult as s, RealtimeVoiceBrowserSessionCreateRequest as sa, ContextEngineRuntimeSettingsUnavailableError as sc, findPersistedAuthProfileCredential as sd, HeartbeatToolResponse as sf, PluginControlUiDescriptor as si, SpeechVoiceOption as sl, ProviderOAuthProfileIdRepair as sn, resolveEmbeddedAgentRuntime as so, DurableInboundReplyDeliveryOptions as sr, EMBEDDING_BATCH_ENDPOINT as ss, PluginCommandHandler as st, ExecElevatedDefaults as su, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeVoiceBargeInOptions as ta, ContextEngineProjection as tc, getSoonestCooldownExpiry as td, ProviderSyntheticAuthResult as tf, ProviderApplyConfigDefaultsContext as ti, SpeechProviderResolveTalkOverridesContext as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, runBeforeToolCallHook as to, SubagentRunResult as tr, resolveBatchCompletionFromStatus as ts, OpenClawPluginSessionApi as tt, formatFastModeStatusValue as tu, MigrationItemAction as u, RealtimeVoiceProviderConfig as ua, IngestBatchResult as uc, loadAuthProfileStoreForSecretsRuntime as ud, PluginRuntimeLifecycleRegistration as ui, ResolvedProviderRuntimeAuth as ul, ProviderPluginDiscovery as un, MemoryEmbeddingProvider as uo, deliverInboundReplyWithMessageSendContext as ur, postJsonWithRetry as us, PluginConfigValidation as ut, PreparedSimpleCompletionModel as uu, MusicGenerationProviderPlugin as v, RealtimeTranscriptionProviderConfig as va, LlmCompleteMessage as vc, markAuthProfileSuccess as vd, PluginSessionSchedulerJobHandle as vi, ChannelIngressQueueClaim as vl, ProviderPreparedRuntimeAuth as vn, listRegisteredMemoryEmbeddingProviders as vo, buildChannelInboundEventContext as vr, isPathInside as vs, PluginRegistrationMode as vt, ProviderCredentialPrecedence as vu, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSessionCreateRequest as wa, BoundTaskFlowsRuntime as wc, listProfilesForProvider as wd, PluginTrustedToolPolicyRegistration as wi, ChannelIngressQueueRecord as wl, ProviderReplaySessionEntry as wn, fetchRemoteEmbeddingVectors as wo, AssembledChannelTurn as wr, getMemoryEmbeddingProvider as ws, ProviderAugmentModelCatalogContext as wt, createRuntimeProviderAuthLookup as wu, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderResolveConfigContext as xa, LlmCompleteUsage as xc, upsertAuthProfile as xd, PluginSessionTurnUnscheduleByTagParams as xi, ChannelIngressQueueEnqueueResult as xl, ProviderReplayPolicy as xn, withRemoteHttpResponse as xo, finalizeChannelInboundContext as xr, buildJsonPluginConfigSchema as xs, PluginSpeechProviderEntry as xt, applyAuthHeaderOverride as xu, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeTranscriptionProviderConfiguredContext as ya, LlmCompleteParams as yc, removeProviderAuthProfilesWithLock as yd, PluginSessionSchedulerJobRegistration as yi, ChannelIngressQueueClaimRef as yl, ProviderReasoningOutputMode as yn, registerMemoryEmbeddingProvider as yo, filterChannelInboundQuoteContext as yr, statRegularFile as ys, PluginSetupAutoEnableContext as yt, ProviderEntryApiKeyBindingResolution as yu, OpenClawPluginLifecycleApi as z, EmbeddedRunAttemptResult as za, TtsConfigResolutionContext as zc, TokenExpiryState as zd, CliBackendSideQuestionToolMode as zi, WebSearchProviderToolExecutionContext as zl, ProviderTransformSystemPromptContext as zn, buildFileEntry as zo, formatInboundEnvelope as zr, CronStyleNow as zs, ProviderCatalogOrder as zt, ResolvedProviderAuth as zu };