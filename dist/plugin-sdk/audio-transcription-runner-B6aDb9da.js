import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./message-channel-DMQTmTNv.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./utils-CmwgRR7I.js";
import { B as resolveAgentModelFallbackValues, V as resolveAgentModelPrimaryValue, mt as runExec } from "./run-with-concurrency-Ddb9i3yy.js";
import { $n as normalizeProviderId, B as resolveIMessageAttachmentRoots, D as loadConfig, L as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, R as isInboundPathAllowed, Vn as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, or as normalizeGoogleModelId, r as requireApiKey, z as mergeInboundPathRoots } from "./model-auth-C8GM6p1v.js";
import { n as fetchWithTimeout } from "./fetch-timeout-csbOmT9G.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-oY8J6M9d.js";
import { x as normalizeChatType } from "./plugins-m91qhrBY.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-Cr7RUzR_.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-tM-GKc-Y.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DT1XnjvV.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-DiAKaO-h.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-BD20sFiy.js").then((n) => n.r);
