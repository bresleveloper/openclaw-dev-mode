...
import { a as LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES, d as resolveGatewayProfileSuffix, f as resolveGatewayServiceDescription, p as resolveGatewaySystemdServiceName, t as splitArgsPreservingQuotes } from "./arg-split-Co_4JYiE.js";
...
async function isSystemdServiceEnabled(args) {
	...
	try {
		await fsPromises.access(resolveSystemdUnitPath(env));
	} catch (error) {
