import { i as OpenClawConfig$1 } from "./types.openclaw-B5gtuEn_.js";
...
import { y as BackoffPolicy } from "./wsl-y_jDMOeX.js";
import { t as getReplyFromConfig } from "./get-reply-2B-HE76k.js";
import { i as WASocket, l as GroupMetadata, u as proto } from "./identity-DCTSP_rK.js";
import { c as WebListenerCloseReason, n as ActiveWebSendOptions, o as WebInboundMessage, r as AdmittedWebInboundMessage, s as WebInboundMessageInput, u as WhatsAppSendResult } from "./types-DMofNBEx.js";
import { a as waitForWaConnection, u as WhatsAppSocketTimingOptions } from "./login-qr-runtime-N-a5ubNN.js";
...
type WebMonitorTuning = {
  ...
  channelRuntime?: ChannelRuntimeSurface; /** WhatsApp account id. Default: "default". */
...
type WhatsAppBaileysMessageCache = Map<string, WhatsAppBaileysCacheEntry<proto.IMessage>>;
type WhatsAppBaileysGroupMetadataCache = Map<string, WhatsAppBaileysCacheEntry<GroupMetadata>>;
...
type MonitorWebInboxOptions = {
  ...
  debounceMs?: number; /** Bounded reconnect window for offline append auto-replies. */
  appendReplyWindow?: AppendReplyWindow; /** Optional debounce gating predicate. */
  shouldDebounce?: (msg: AdmittedWebInboundCallbackMessage) => boolean; /** Optional shared socket reference so reply closures can follow reconnects. */
  socketRef?: {
...
type AttachWebInboxToSocketOptions = Omit<MonitorWebInboxOptions, "onMessage" | "shouldDebounce" | "socketTiming"> & {
  socketTiming: Required<WhatsAppSocketTimingOptions>;
  onMessage: (msg: WebInboundMessageInput) => Promise<void>;
  shouldDebounce?: (msg: WebInboundMessageInput) => boolean;
};
declare function attachWebInboxToSocket(options: AttachWebInboxToSocketOptions & {
  sock: WASocket;
}): Promise<{
  readonly close: () => Promise<void>;
  readonly onClose: Promise<WebListenerCloseReason>;
  readonly signalClose: (reason?: WebListenerCloseReason) => void;
  readonly assertSendReady: (to: string) => Promise<void>;
  readonly sendComposingTo: (to: string) => Promise<void>;
  readonly sendMessage: (to: string, text: string, mediaBuffer?: Buffer, mediaTypeInput?: string, sendOptions?: ActiveWebSendOptions) => Promise<WhatsAppSendResult>;
