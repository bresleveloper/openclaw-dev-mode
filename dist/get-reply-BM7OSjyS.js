...
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-fqwcFyP9.js";
...
import { n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-BcvxxriC.js";
...
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-Coa-CyIB.js";
...
import { P as resolveSessionStoreEntry, R as deriveSessionMetaPatch, V as resolveGroupSessionKey, X as resolveMaintenanceConfigFromInput, b as runExclusiveSessionStoreWrite, et as parseSessionThreadInfoFast } from "./store-Cvp82S16.js";
...
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-CWdFCyWd.js";
...
import { u as commitReplySessionInitialization, v as loadReplySessionInitializationSnapshot, y as loadSessionEntry } from "./session-accessor-CwhXEUId.js";
import { b as resolveModelRefFromString } from "./model-selection-shared-DwnYeyqq.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-tUPEe2Ur.js";
...
import { d as ensureAgentWorkspace, p as isWorkspaceBootstrapPending } from "./workspace-BJm9kqLw.js";
...
import { r as normalizeCommandBody } from "./commands-registry-normalize-fZe-I4O7.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-Cf94Tshy.js";
import { t as hasControlCommand } from "./command-detection-ytcEDGX4.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-BiyQJ-ls.js";
import { a as enqueueSystemEvent } from "./system-events-BfmWSF2P.js";
import { n as resolveAgentTimeoutMs } from "./timeout-0Cw4kcol.js";
import { C as waitForReplyRunEndBySessionId, _ as replyRunRegistry, a as abortReplyRunBySessionId, f as isReplyRunActiveForSessionId, p as isReplyRunStreamingForSessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, v as resolveActiveReplyRunSessionId, y as resolveActiveReplyRunThreadId } from "./reply-run-registry-CioKebTS.js";
...
import { l as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-DGeRg_-o.js";
...
import { f as extractQueueDirective, m as takeDirectiveToken, p as skipDirectiveArgPrefix, t as resolveQueueSettings } from "./queue-D4SO3sXg.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-BC4gM9s_.js";
import { o as resolvePersistedUserTurnText, r as createUserTurnTranscriptRecorder, t as buildPersistedUserTurnMediaInputsFromFields } from "./user-turn-transcript-x7xWBohS.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BK8VuspZ.js";
import { t as getCliSessionBinding } from "./cli-session-binding-BGrfRBGB.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-BQ7ebKvJ.js";
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-QGy9i1y8.js";
import { n as forkSessionFromParent, r as resolveParentForkDecision } from "./session-fork-DfIJcRuB.js";
...
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-DJBk8Oru.js";
...
import { t as resolveDefaultModel } from "./directive-handling.defaults-C-v7L7T6.js";
...
import { n as shouldUseFromAsSenderFallback, t as resolveCommandAuthorization } from "./command-auth-De19E7rf.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-DYlgGzPp.js";
import "./commands-registry-B7Y472iL.js";
import { c as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-q-tfEwnt.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-CpcHDFh9.js";
...
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-BiSsatSn.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-C4VjflNp.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-BOGFz20c.js";
...
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-CZ3Swu5p.js";
import { a as resolveEnvelopeFormatOptions } from "./envelope-CXHEh-mU.js";
import { r as updateAmbientTranscriptWatermark } from "./ambient-transcript-watermark-DEI95aA_.js";
import { t as normalizeGroupActivation } from "./group-activation-MKTJBUwi.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-DSt2ysMe.js";
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-C7g9ePKl.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-96eyd_gz.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-DYm2AHoO.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-BXceaoW0.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-CR1rLeuc.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-B0SsKZCD.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-C59uSNro.js";
import { n as consumeSessionSkillSuggestion } from "./skill-suggestions-BdImgpcI.js";
import { a as buildInboundUserContextPrefix, c as resolveInboundUserContextPromptJoiner, d as resolveSilentReplySettings, i as buildInboundMetaSystemPrompt, l as resolveCurrentTurnImages, n as resolveTypingMode, o as formatActiveGoalContext, r as resolveActiveRunQueueAction } from "./typing-mode-idw7CClA.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-C_3X3cCQ.js";
import { n as resolveEffectiveToolInventory } from "./tools-effective-inventory-dXkkjdEN.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-B2B3qt0o.js";
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-8mSxAjEi.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-BCX8jrkp.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-B8AELH_3.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-CZbVPEkl.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-B1UFtots.js"));
...
const sessionAccessorRuntimeLoader = createLazyImportLoader(() => import("./session-accessor-BaLWwJuD.js"));
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-DSSb_Xo0.js"), { cacheRejections: true }).load;
...
const DEV_MODE_AUTO_COMPACT_DEFAULT_PROMPT = "this is auto compact, so try to remember everything the user talked with you other than daily news or security or hub notifications";
function resolveDevModeAutoCompactPrompt() {
	return normalizeOptionalString(process.env.OPENCLAW_DEV_MODE_AUTO_COMPACT_PROMPT) ?? DEV_MODE_AUTO_COMPACT_DEFAULT_PROMPT;
}
...
async function initSessionStateAttemptLocked(params, attemptContext, staleSnapshotRetried, lifecycleMutationIdentity) {
	...
	const devModeAutoCompactEligible = isDevMode() && resetPolicy.configured !== true && !hasProviderOwnedSession(entry) && !resetTriggered && !softReset.matched && !isSystemEvent && canReuseExistingEntry && entryFreshness?.fresh === false && entryFreshness.staleReason === "daily" && !terminalMainTranscriptNewerThanRegistry;
	const devModeAutoCompact = devModeAutoCompactEligible && resolveCommandAuthorization({
		ctx,
		cfg,
		commandAuthorized
	}).isAuthorizedSender;
	if (devModeAutoCompact) triggerBodyNormalized = `/compact ${resolveDevModeAutoCompactPrompt()}`;
	const freshEntry = isSystemEvent && canReuseExistingEntry || (reconnectResumeRequested && canReuseExistingEntry || recoverTerminalVisibleEntry || (entryFreshness?.fresh ?? false) || devModeAutoCompactEligible || softResetAllowed && canReuseExistingEntry) && !terminalMainTranscriptNewerThanRegistry;
	...
	sessionEntry = {
		...
		sessionId,
		updatedAt: Date.now(),
		sessionStartedAt: isNewSession ? now : devModeAutoCompact ? now : baseEntry?.sessionStartedAt ?? lifecycleTimestamps.sessionStartedAt,
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-BaLWwJuD.js");
