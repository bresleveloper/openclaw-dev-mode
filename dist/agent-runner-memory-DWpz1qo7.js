...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent-B7B7RM-D.js"));
...
async function runMemoryFlushIfNeeded(params) {
	...
	}) || (shouldForceFlushByTranscriptSize || isDevMode()) && entry != null && !hasAlreadyFlushedForCurrentCompaction(entry))) return entry ?? params.sessionEntry;
