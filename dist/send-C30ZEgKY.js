import { o as logVerbose, t as danger } from "./globals-DtwqVhkV.js";
import { _ as expandHomePrefix } from "./paths-BfR2LXbA.js";
import { t as createSubsystemLogger } from "./subsystem-CkDRqDzV.js";
import { Lo as writeConfigFile, No as readConfigFileSnapshotForWrite, Oo as loadConfig, ic as resolveTelegramPreviewStreamMode } from "./auth-profiles-CIqoN6FN.js";
import { _ as normalizeAccountId } from "./session-key-DmlQCuju.js";
import { t as CONFIG_DIR } from "./utils-DMInpDZe.js";
import { u as resolveTelegramAccount } from "./plugins-CjLMQbHJ.js";
import { a as getFileExtension, c as isGifMedia, l as kindFromMime, u as normalizeMimeType } from "./windows-spawn-D2jCT_tt.js";
import { n as redactSensitiveText } from "./redact-DnTfDLlu.js";
import { i as formatUncaughtError, n as extractErrorCode, r as formatErrorMessage, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-D6OHuY6d.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-DWnUscwy.js";
import { n as makeProxyFetch } from "./proxy-fetch-wuVrlEmU.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-D7O7NHen.js";
import { t as renderMarkdownWithMarkers } from "./render-DIsvUmKZ.js";
import { i as readChannelAllowFromStore } from "./pairing-store-afyqjg4D.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-5EA8FJ8k.js";
...
import { n as isSenderIdAllowed, r as mergeDmAllowFromSources, t as firstDefined } from "./allow-from-B8u3j6-m.js";
import { t as resolveTelegramFetch } from "./fetch-BXEZfVK2.js";
...
//#endregion
export { buildTelegramParentPeer as A, resolveTelegramForumThreadId as B, resolveCronStorePath as C, buildSenderName as D, buildSenderLabel as E, extractTelegramLocation as F, resolveTelegramThreadSpec as G, resolveTelegramMediaPlaceholder as H, getTelegramTextParts as I, normalizeDmAllowFromWithStore as J, isSenderAllowed as K, hasBotMention as L, buildTypingThreadParams as M, describeReplyTarget as N, buildTelegramGroupFrom as O, expandTextLinks as P, isVoiceCompatibleAudio as Q, normalizeForwardedContext as R, loadCronStore as S, buildGroupLabel as T, resolveTelegramReplyId as U, resolveTelegramGroupAllowFromContext as V, resolveTelegramStreamMode as W, formatLocationText as X, resolveSenderAllowMatch as Y, toLocationContext as Z, markdownToTelegramHtml as _, editMessageTelegram as a, splitTelegramCaption as b, sendPollTelegram as c, resolveTelegramVoiceSend as d, wasSentByBot as f, markdownToTelegramChunks as g, isTelegramClientRejection as h, editMessageReplyMarkupTelegram as i, buildTelegramThreadParams as j, buildTelegramGroupPeerId as k, sendStickerTelegram as l, isSafeToRetrySendError as m, createForumTopicTelegram as n, reactMessageTelegram as o, isRecoverableTelegramNetworkError as p, normalizeAllowFrom as q, deleteMessageTelegram as r, sendMessageTelegram as s, buildInlineKeyboard as t, sendTypingTelegram as u, renderTelegramHtmlText as v, saveCronStore as w, withTelegramApiErrorLogging as x, wrapFileReferencesInHtml as y, resolveTelegramDirectPeerId as z };
