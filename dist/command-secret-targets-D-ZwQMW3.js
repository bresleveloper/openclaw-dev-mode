import { ao as resolveSecretRefValue, or as GATEWAY_CLIENT_MODES, so as describeUnknownError, sr as GATEWAY_CLIENT_NAMES } from "./auth-profiles-CIqoN6FN.js";
import { d as resolveSecretInputRef } from "./types.secrets-BEA4gMCN.js";
import { Dt as validateSecretsResolveResult, n as callGateway } from "./call-B28h9L2b.js";
import { C as getPath, T as setPathExistingStrict, _ as listSecretTargetRegistryEntries, l as analyzeCommandSecretAssignmentsFromSnapshot, n as collectConfigAssignments, o as createResolverContext, p as discoverConfigSecretTargetsByIds, t as resolveRuntimeWebTools, y as assertExpectedResolvedSecretValue } from "./runtime-web-tools-BLhk2bwq.js";
//#region src/cli/command-secret-gateway.ts
const WEB_RUNTIME_SECRET_TARGET_ID_PREFIXES = ["tools.web.search", "tools.web.fetch.firecrawl"];
const WEB_RUNTIME_SECRET_PATH_PREFIXES = ["tools.web.search.", "tools.web.fetch.firecrawl."];
...
async function resolveCommandSecretRefsLocally(params) {
	...
	if (targetsRuntimeWebResolution({
		...
		if (params.mode === "strict") throw error;
