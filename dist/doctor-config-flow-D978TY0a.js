...
import { n as discoverConfigSecretTargets } from "./target-registry-DK813Vii.js";
import { z as resolveNormalizedProviderModelMaxTokens } from "./io-DxnOT4sF.js";
import { d as collectConfiguredModelRefs } from "./gateway-startup-speech-providers-tDMeTcRJ.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-CmSYSZ_c.js";
import { n as formatConfigIssueLines } from "./issue-format-fzg0yJxc.js";
import { r as normalizeTalkSection } from "./talk-Btm6omkA.js";
import { c as callGateway } from "./call-5Sj7eTyY.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BbNqZjEi.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-Bi_Hs3OY.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-B8nS9DTj.js";
...
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-DXn22J24.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-BSeAVsQq.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-ccZBfhZG.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-_Owkn67A.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DnEwKZj7.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-B9RKUBa_.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-xGi8DOw9.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CpuLM1fh.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-Bw0TKkGF.js");
