...
const entries = [
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-DIQaBLc_.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-BdCBWxJB.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-Ce2n5eCg.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-CjU3_Kv_.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-C1JbhQ8D.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-BrhO1VUT.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-DUcNaOci.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-Kiw9WK0h.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-DOYmmRbI.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-BngjcHkr.js")).registerSecurityCli(program);
		}
	},
	{
		name: "secrets",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-BDX36UO2.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-CfN_acM4.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
