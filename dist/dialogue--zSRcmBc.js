import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-sxKznhML.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-43nSY_BT.js")).planCrestodianCommand)({
		input,
		overview
	});
