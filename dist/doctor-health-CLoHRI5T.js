...
async function doctorCommand(runtime, options = {}) {
	...
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-JYP3LFdj.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-C91BghpK.js");
