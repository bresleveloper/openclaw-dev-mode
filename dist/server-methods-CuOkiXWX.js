...
const loadAgentHandlers = lazyHandlerModule(() => import("./agent-Dr3YqDYy.js"), (module) => module.agentHandlers);
...
const loadChatHandlers = lazyHandlerModule(() => import("./chat-DETtgxBj.js"), (module) => module.chatHandlers);
...
const loadNodePendingHandlers = lazyHandlerModule(() => import("./nodes-pending-BFCFo66T.js"), (module) => module.nodePendingHandlers);
const loadNodeHandlers = lazyHandlerModule(() => import("./nodes-CllCRiIE.js"), (module) => module.nodeHandlers);
...
const loadSessionsHandlers = lazyHandlerModule(() => import("./sessions-CUfxNZ61.js"), (module) => module.sessionsHandlers);
const loadSkillsHandlers = lazyHandlerModule(() => import("./skills-ChQ0P_J9.js"), (module) => module.skillsHandlers);
const loadSystemHandlers = lazyHandlerModule(() => import("./system-Vvuai2BP.js"), (module) => module.systemHandlers);
const loadTalkHandlers = lazyHandlerModule(() => import("./talk-B1Bt5S7K.js"), (module) => module.talkHandlers);
...
const loadToolsEffectiveHandlers = lazyHandlerModule(() => import("./tools-effective-BlOu7y77.js"), (module) => module.toolsEffectiveHandlers);
const loadToolsInvokeHandlers = lazyHandlerModule(() => import("./tools-invoke-DSOG-E28.js"), (module) => module.toolsInvokeHandlers);
const loadTtsHandlers = lazyHandlerModule(() => import("./tts-CZYY8DhX.js"), (module) => module.ttsHandlers);
const loadUpdateHandlers = lazyHandlerModule(() => import("./update-CKhz0yAZ.js"), (module) => module.updateHandlers);
