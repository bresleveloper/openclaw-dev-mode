...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-DxW5Gwqe.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DivqHKD0.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-p8e0Sk4g.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-DK0weEcl.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-CJa9KaEO.js"),
		...
		{
			commandNames: ["hooks"],
			loadModule: () => import("./hooks-cli-Cr_5yy3E.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-itALZH9h.js"),
