import { f as colorize, m as theme, p as isRich$1 } from "./globals-DtwqVhkV.js";
import "./paths-BfR2LXbA.js";
import "./subsystem-CkDRqDzV.js";
import "./boolean-DTgd5CzD.js";
import { Fc as findNormalizedProviderValue, Fo as setRuntimeConfigSnapshot, Hc as normalizeProviderId, Kc as resolveConfiguredModelRef, No as readConfigFileSnapshotForWrite, Oc as resolveAuthStorePathForDisplay, Oo as loadConfig, Pc as buildModelAliasIndex, Sc as ensureAuthProfileStore, To as createConfigIO, Uc as parseModelRef, Yc as resolveModelRefFromString, Zl as isNonSecretApiKeyMarker, al as hasUsableCustomProviderApiKey, cl as resolveAwsSdkEnvVarName, cu as DEFAULT_MODEL, dl as resolveUsableCustomProviderApiKey, fl as getShellEnvAppliedKeys, gc as listProfilesForProvider, hl as shouldEnableShellEnvFallback, il as getCustomProviderApiKey, io as resolveSecretRefString, kc as resolveOpenClawAgentDir, l as resolveProfileUnusableUntilForDisplay, ll as resolveEnvApiKey, lu as DEFAULT_PROVIDER, n as resolveAuthProfileEligibility, qc as resolveDefaultModelForAgent, r as resolveAuthProfileOrder, sl as resolveApiKeyForProvider, uu as resolveAuthProfileDisplayLabel, vc as setAuthProfileOrder, yc as upsertAuthProfile, zc as modelKey } from "./auth-profiles-CIqoN6FN.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-BAb0j1gt.js";
import { x as shortenHomePath } from "./utils-DMInpDZe.js";
import { r as normalizeStringEntries } from "./string-normalization-C37X3fMr.js";
...
import { Cr as describeFailoverError, Gt as DEFAULT_OAUTH_WARN_MS, Jr as resolveModelWithRegistry, Kt as buildAuthHealthSummary, Wt as maskApiKey, an as resolveUsageProviderId, in as formatUsageWindowSummary, nn as loadProviderUsageSummary, or as runEmbeddedPiAgent, qt as formatRemainingShort } from "./compact-D7FmBOIi.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-B52CESY4.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-N8VeGFSt.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-D-ZwQMW3.js";
...
import { r as withProgressTotals } from "./progress-DD4pMDZr.js";
import "./provider-env-vars-CYUhIc-v.js";
import "./note-V9Ncupme.js";
import { t as createClackPrompter } from "./clack-prompter-JFLI0HS7.js";
import "./issue-format-CBixuceM.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-B-ecKEFu.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-CZgu85yQ.js";
import { n as redactSecrets } from "./format-DITNx47Y.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-De4D22mU.js";
import { Mt as writeOAuthCredentials, h as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BkREJmad.js";
import { t as isRemoteEnvironment } from "./oauth-env-CPqoSAUI.js";
import { n as logConfigUpdated } from "./logging-DRF_pgYm.js";
import { a as loginOpenAICodexOAuth, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-CDemEPmW.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-CIqoN6FN.js").then((n) => n.t);
	const { ensureOpenClawModelsJson } = await import("./models-config-CgYIAjpL.js").then((n) => n.n);
