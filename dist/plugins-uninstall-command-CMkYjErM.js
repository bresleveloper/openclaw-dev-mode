...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-D5cTuwv4.js");
	const { buildPluginSnapshotReport } = await import("./status-CB55zR68.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-m6em8cdU.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-CMDV1kwr.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-B-dXYMum.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-AqMIlO11.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-CktuI2gd.js");
