...
import { a as isPluginIntegrationSecretProviderConfig, r as resolveSecretRefValue, s as resolveSecretProviderIntegrationConfig } from "./resolve-C6EqbbNq.js";
...
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-DK813Vii.js";
import { c as warn, n as info, r as isDevMode, s as success, t as danger } from "./globals-BElpud1m.js";
import { J as AUTO_MANAGED_CONFIG_META_PATHS, S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, u as readConfigFileSnapshot } from "./io-DxnOT4sF.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-D5cQQbIL.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CxA82wnB.js");
