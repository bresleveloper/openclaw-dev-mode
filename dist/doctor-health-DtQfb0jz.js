...
async function doctorCommand(runtime, options = {}) {
	...
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-qjrY-cit.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-ByNQvrn5.js");
