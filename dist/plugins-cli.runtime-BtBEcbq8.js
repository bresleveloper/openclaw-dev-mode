...
import { s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-fqwcFyP9.js";
...
const loadPluginsStatus = createModuleLoader(() => import("./status-CB55zR68.js"));
const loadPluginsCommandHelpers = createModuleLoader(() => import("./plugins-command-helpers-C3iZ-hDU.js"));
const loadPluginsRegistryRefresh = createModuleLoader(() => import("./plugins-registry-refresh-B-dXYMum.js"));
...
async function runPluginsRegistryCommand(opts) {
	const { inspectPluginRegistry, refreshPluginRegistry } = await import("./plugin-registry-PA9z1XMS.js");
...
async function runPluginMarketplaceEntriesCommand(opts) {
	const catalog = await import("./official-external-plugin-catalog-DJQYx0t3.js");
	const cfg = getRuntimeConfig();
...
async function runPluginMarketplaceRefreshCommand(opts) {
	const { loadConfiguredHostedOfficialExternalPluginCatalogEntries } = await import("./official-external-plugin-catalog-DJQYx0t3.js");
	const cfg = getRuntimeConfig();
...
async function runPluginMarketplaceListCommand(source, opts) {
	const { listMarketplacePlugins } = await import("./marketplace-DIv4QFU1.js");
