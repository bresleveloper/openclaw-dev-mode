import { N as redactSensitiveText, Vt as normalizeAccountId, _ as normalizeMimeType, f as getFileExtension, g as kindFromMime, h as isGifMedia } from "./paths-BPFh8Kvv.js";
...
import { I as danger, O as createSubsystemLogger, a as CONFIG_DIR, b as safeParseJson, z as logVerbose } from "./logger-J22gODrQ.js";
import { Bn as listChannelPlugins, Fi as collectErrorGraphCandidates, Ga as loadConfig, Ii as extractErrorCode, Ja as readConfigFileSnapshotForWrite, Li as formatErrorMessage, Ps as resolveTelegramPreviewStreamMode, Ri as formatUncaughtError, Ys as withFileLock$1, Za as writeConfigFile, Zn as resolveTelegramAccount, oi as writeJsonAtomic, zi as readErrorName, zn as getChannelPlugin } from "./model-selection-JGO58U_j.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-pxSemjXK.js";
import { n as makeProxyFetch } from "./proxy-fetch-DdXVmDV2.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-BWMK5Aho.js";
import { t as renderMarkdownWithMarkers } from "./render-B3FAGFtB.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-Smt5rHMT.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-DzwsFA2D.js";
import { n as normalizePollInput } from "./polls-D0zhL5wU.js";
import { t as resolveTelegramFetch } from "./fetch-CyzgVs2K.js";
...
//#endregion
export { formatLocationText as $, buildTelegramThreadParams as A, resolveTelegramGroupAllowFromContext as B, resolveCronStorePath as C, buildTelegramGroupFrom as D, buildSenderName as E, getTelegramTextParts as F, isSenderAllowed as G, resolveTelegramReplyId as H, hasBotMention as I, resolveSenderAllowMatch as J, normalizeAllowFrom as K, normalizeForwardedContext as L, describeReplyTarget as M, expandTextLinks as N, buildTelegramGroupPeerId as O, extractTelegramLocation as P, resolveGroupAllowFromSources as Q, resolveTelegramDirectPeerId as R, loadCronStore as S, buildSenderLabel as T, resolveTelegramStreamMode as U, resolveTelegramMediaPlaceholder as V, resolveTelegramThreadSpec as W, isSenderIdAllowed as X, firstDefined as Y, mergeDmAllowFromSources as Z, markdownToTelegramHtml as _, editMessageTelegram as a, readJsonFileWithFallback as at, splitTelegramCaption as b, sendPollTelegram as c, listPairingChannels as ct, resolveTelegramVoiceSend as d, toLocationContext as et, wasSentByBot as f, markdownToTelegramChunks as g, isTelegramClientRejection as h, editMessageReplyMarkupTelegram as i, upsertChannelPairingRequest as it, buildTypingThreadParams as j, buildTelegramParentPeer as k, sendStickerTelegram as l, isVoiceCompatibleAudio as lt, isSafeToRetrySendError as m, createForumTopicTelegram as n, readChannelAllowFromStore as nt, reactMessageTelegram as o, writeJsonFileAtomically as ot, isRecoverableTelegramNetworkError as p, normalizeDmAllowFromWithStore as q, deleteMessageTelegram as r, removeChannelAllowFromStoreEntry as rt, sendMessageTelegram as s, getPairingAdapter as st, buildInlineKeyboard as t, addChannelAllowFromStoreEntry as tt, sendTypingTelegram as u, renderTelegramHtmlText as v, buildGroupLabel as w, withTelegramApiErrorLogging as x, wrapFileReferencesInHtml as y, resolveTelegramForumThreadId as z };
