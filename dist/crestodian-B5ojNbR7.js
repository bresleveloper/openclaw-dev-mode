...
import { r as resolveCrestodianOperation } from "./dialogue--zSRcmBc.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-BAFqz62o.js")).runCrestodianTui;
	opts.onReady?.();
