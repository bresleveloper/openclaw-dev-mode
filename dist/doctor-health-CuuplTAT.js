...
async function doctorCommand(runtime, options = {}) {
	...
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-BpUEheFj.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-Bt0OsH0z.js");
