...
import { n as sweepTrackedBrowserTabs } from "./session-tab-registry-m77oMohh.js";
import { i as getPwAiModule } from "./cdp-reachability-policy-CSn1wgtE.js";
import { n as listKnownProfileNames, r as getExtensionRelayModule, t as createBrowserRouteContext } from "./server-context-Cghc1sGT.js";
import { o as stopOpenClawChrome } from "./chrome-CF7ZQzqs.js";
...
async function stopBrowserRuntime(params) {
	...
	try {
		...
		if (params.current.extensionRelays?.size) {
			...
			const { disposeGatewayExtensionRelay } = await import("./gateway-relay-route-BKNAmxaL.js");
