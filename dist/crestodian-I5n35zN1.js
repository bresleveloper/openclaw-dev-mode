...
import { r as resolveCrestodianOperation } from "./dialogue-BxI_6XVO.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-DkdMjtc9.js")).runCrestodianTui;
	opts.onReady?.();
