...
import { i as createChatChannelPlugin } from "./core-BzY68X-a.js";
...
import { c as resolveDiscordAccountAllowFrom, r as listDiscordAccountIds, s as resolveDiscordAccount } from "./accounts-CVlMm9zG.js";
import "./channel-api-cdHcvbiG.js";
import { t as parseDiscordTarget } from "./target-parsing-Bxj17zVO.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-Dszs10jN.js";
import { n as looksLikeDiscordTargetId, r as normalizeDiscordMessagingTarget } from "./normalize-cNeUZu3U.js";
import { t as getDiscordRuntime } from "./runtime-n11XewvP.js";
import { a as shouldSuppressLocalDiscordExecApprovalPrompt } from "./approval-shared-WlNPrdPI.js";
import { t as getDiscordApprovalCapability } from "./approval-native-CwgJjwcs.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-BTmRG5YZ.js";
import { t as discordMessageActions$1 } from "./channel-actions-D22H4TkD.js";
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-j3wJOmec.js";
import { n as setThreadBindingMaxAgeBySessionKey, t as setThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings.session-updates-YKgIEvl3.js";
import { d as withAbortTimeout } from "./timeouts-BG9tJyKJ.js";
import { n as discordOutbound } from "./outbound-adapter-CRc1drq0.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-DhgTeADX.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-dz_8RO8l.js";
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-qJhMoh8g.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-P-PiAuAK.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-DchH0szL.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-B_nKUDXF.js"));
const loadDiscordTargetResolverModule = createLazyRuntimeModule(() => import("./target-resolver-NdsFJTzz.js"));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-Bu2fEmdS.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-DFb65cqs.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-BRQeKUr6.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-BCxNtCbI.js");
