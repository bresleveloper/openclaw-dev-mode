...
async function collectDoctorPreviewNotes(params) {
	...
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-CFR4eZoq.js");
	...
	if (hasPluginConfig) {
		...
		const { collectContextEngineHostCompatibilityWarnings } = await import("./context-engine-host-compat-BDxz5___.js");
