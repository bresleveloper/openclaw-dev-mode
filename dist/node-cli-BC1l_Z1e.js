...
import { Hc as resolvePlannedSegmentArgv, Jc as resolveExecutableFromPathEnv, Ji as startBrowserControlServiceFromConfig, Ki as createBrowserRouteDispatcher, Rc as analyzeArgvCommand, Ws as loadConfig, Yc as POSIX_SHELL_WRAPPERS, al as POSIX_INLINE_COMMAND_FLAGS, il as unwrapKnownShellMultiplexerInvocation, ki as writeJsonAtomic, kl as VERSION, qc as resolveCommandResolutionFromArgv, qi as createBrowserControlContext, rl as unwrapKnownDispatchWrapperInvocation, sl as resolveInlineCommandMatch, tl as normalizeExecutableToken, ua as resolveBrowserConfig, vi as GATEWAY_CLIENT_MODES, yi as GATEWAY_CLIENT_NAMES } from "./model-selection-BRhJAUKb.js";
import { i as resolveAgentConfig } from "./agent-scope-Dx6t10xJ.js";
import { p as defaultRuntime } from "./subsystem-NSiOA8hi.js";
import { s as sameFileIdentity } from "./openclaw-root-BgG4cyU3.js";
import { i as logWarn } from "./logger-CX3t1bKz.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-C_5dHP8H.js";
...
import { r as detectMime } from "./windows-spawn-BAKAvVI9.js";
...
import { dn as loadOrCreateDeviceIdentity, g as GatewayClient } from "./call-CGmUC45G.js";
import { n as getMachineDisplayName, t as withTimeout } from "./with-timeout-ojFtnVc9.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-DIMuKva2.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-oIkOeHmm.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as requestJsonlSocket } from "./exec-approvals-Dmpxx9a7.js";
import { n as resolveSystemRunCommandRequest, o as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-DM5s0YZ1.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./arg-split-BDgZqnmL.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DI-T0p2K.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-CYN5AepX.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-PDKGe0fy.js";
import "./systemd-DTFIsPDY.js";
import "./service-CjQa65BD.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-C668UdKH.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CaCmDPHE.js";
import { t as parsePort } from "./parse-port-hKWRqMkX.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-CtEeTxCg.js";
