...
import { H as loadConfig, J as writeConfigFile, W as readConfigFileSnapshot, Yn as ensureAuthProfileStore, dt as resolveDefaultSecretProviderAlias } from "./auth-profiles-gyYFUuWS.js";
...
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-BlxnRrWB.js";
import { a as findTailscaleBinary } from "./tailscale-DUAiX-L-.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, g as resolveControlUiLinks, h as randomToken, m as probeGatewayReachable, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as summarizeExistingConfig, y as validateGatewayPasswordInput } from "./onboard-helpers-BTGTJOdS.js";
...
import { r as setupChannels, t as noteChannelStatus } from "./onboard-channels-kd_nFr_N.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BDr8SzIl.js";
import { t as resolveOnboardingSecretInputString } from "./onboarding.secret-input-CRUZgOmd.js";
import { n as logConfigUpdated } from "./logging-C2FUa2rZ.js";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-CWfEyMMl.js";
import { i as applyAuthChoice, n as resolvePreferredProviderForAuthChoice } from "./auth-choice-CB_DdXzY.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-Du14sPWg.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DMutfzjg.js";
import { a as promptCustomApiConfig } from "./onboard-custom-CGpPkLde.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-Crmt4obX.js";
import { t as formatHealthCheckFailure } from "./health-format-BZVLLayG.js";
import { n as promptRemoteGatewayConfig } from "./onboard-remote-BgjHXzX7.js";
import { n as setupSkills } from "./onboard-skills-DBmJMOi1.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-BvhvIeLN.js");
