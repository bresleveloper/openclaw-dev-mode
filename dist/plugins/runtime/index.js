...
import { o as shouldLogVerbose } from "../../globals-BElpud1m.js";
import { a as logWarn } from "../../logger-D7QYAmug.js";
import { r as runCommandWithTimeout } from "../../exec-Dj7k1ich.js";
...
import { c as resolveThinkingProfile } from "../../thinking-BcvxxriC.js";
...
import { S as loadSessionStore, g as saveSessionStore, q as normalizeResolvedMaintenanceConfigInput, v as updateSessionStore } from "../../store-Cvp82S16.js";
...
import { C as patchSessionEntry$1, N as replaceSessionEntry, W as updateSessionEntry, _ as listSessionEntries$1, y as loadSessionEntry } from "../../session-accessor-CwhXEUId.js";
import { t as getPluginRuntimeGatewayRequestScope } from "../../gateway-request-scope-CiIBNuZX.js";
import "../../logging-DBHEcFUB.js";
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-DwnYeyqq.js";
...
import { B as resumeFlow, N as finishFlow, O as createManagedTaskFlow, R as requestFlowCancel, V as setFlowWaiting, j as failFlow, m as listTasksForFlowId } from "../../task-registry-Bv5-Vohd.js";
import "../../runtime-internal-OiU0x_qm.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, d as runTaskInFlowForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-DskL6qp9.js";
...
import { r as resolveEffectiveAgentRuntime, t as concretizeAgentRuntime } from "../../thinking-runtime-DHKmmAgL.js";
import { a as generateMusic, o as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-B-W5sEDk.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "../../runtime-CF3b_VkA.js";
import { n as loadWebMedia } from "../../web-media-CJF7B-0e.js";
import { n as resolveAgentIdentity } from "../../identity-BfKoTsep.js";
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-B-42D_SY.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-CDUW9C58.js";
import { f as isVoiceCompatibleAudio } from "../../media-runtime-DIRKCpVy.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-B3fqnExs.js";
import { a as runWebSearch, r as listWebSearchProviders } from "../../runtime-DWDVJPjG.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-Bg6TBlOd.js";
...
const loadEmbeddedAgentRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-agent.runtime-B-FyxFrn.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-CP1mlM7e.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-BV4YXXsA.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-DyT1GCJq.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-euPwPy05.js"));
const loadGatewayPluginRuntime = createLazyRuntimeModule(() => import("../../server-plugins-CIU15kUH.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-Cq9gTUEn.js"), (m) => m.createRuntimeLlm({
...
function createRuntimeWorktrees() {
	const loadService = () => import("../../service-D6Q1iKFE.js");
	return {
		async create(params) {
