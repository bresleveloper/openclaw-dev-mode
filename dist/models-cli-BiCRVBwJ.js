...
import { f as colorize, m as theme, p as isRich$1 } from "./globals-BozXJ-QJ.js";
import { S as shortenHomePath } from "./utils-BzWe_IKB.js";
import { $l as resolveOpenClawAgentDir, A as resolveApiKeyForProvider, Bl as listProfilesForProvider, D as getCustomProviderApiKey, Fl as shouldEnableShellEnvFallback, Hl as setAuthProfileOrder, Kl as ensureAuthProfileStore, M as resolveEnvApiKey, Ml as getShellEnvAppliedKeys, O as hasUsableCustomProviderApiKey, P as resolveUsableCustomProviderApiKey, Ql as resolveAuthStorePathForDisplay, Tt as resolveAuthProfileOrder, Ul as upsertAuthProfile, Vs as createConfigIO, Ws as loadConfig, Ys as readConfigFileSnapshotForWrite, Zs as setRuntimeConfigSnapshot, bs as resolveSecretRefString, c as modelKey, d as normalizeProviderId, f as parseModelRef, g as resolveDefaultModelForAgent, gc as parseDurationMs, gt as isNonSecretApiKeyMarker, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, j as resolveAwsSdkEnvVarName, jt as resolveProfileUnusableUntilForDisplay, lu as DEFAULT_MODEL, nu as resolveAuthProfileDisplayLabel, r as buildModelAliasIndex, uu as DEFAULT_PROVIDER, v as resolveModelRefFromString, wt as resolveAuthProfileEligibility } from "./model-selection-BRhJAUKb.js";
import { Et as runEmbeddedPiAgent, Qr as resolveModelWithRegistry, Qt as resolveUsageProviderId, Yt as loadProviderUsageSummary, Zt as formatUsageWindowSummary, a as buildAuthHealthSummary, i as DEFAULT_OAUTH_WARN_MS, jn as describeFailoverError, o as formatRemainingShort, r as maskApiKey } from "./reply-CCXYDkRB.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-Dx6t10xJ.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-B3fM69Ic.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DqLk9GdO.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-CGUoVJF5.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-B9eWuDii.js";
import "./help-format-Cj82FtTx.js";
import { r as withProgressTotals } from "./progress-DFpY5mr6.js";
import "./provider-env-vars-YikeCwQK.js";
import "./note-DUZmkXUD.js";
import { t as createClackPrompter } from "./clack-prompter-4QAkYKtM.js";
import "./issue-format-BY96Fvm5.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-Dowyo4w7.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BkVLE2yg.js";
import { n as redactSecrets } from "./format-rX20TUIY.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-D_5N6ZnF.js";
import { Mt as writeOAuthCredentials, h as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DdQ_1a8w.js";
import { t as isRemoteEnvironment } from "./oauth-env-CNiRxlZf.js";
...
import "./oauth-tls-preflight-rax554Zx.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-BRhJAUKb.js").then((n) => n.Ct);
	const { ensureOpenClawModelsJson } = await import("./models-config-SmFayixR.js").then((n) => n.n);
