...
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DuSFI1Y4.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-Dw42w_cH.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-BBrr0VtV.js";
import { l as toRatio, n as decodeString } from "./Util-DlfrANcS.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DarsEOzX.js";
import { t as APEv2Parser } from "./APEv2Parser-DGhOtx3l.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BgIkzHKg.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DEKUL40v.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DRufQ43L.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Qm04moYA.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DkHjz_E5.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BFbQCCdQ.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DCjB7wy7.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CxOGKj-D.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-xx8bKkT9.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Cw-GV6AR.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-5StVFMUX.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BGI0AttV.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DzxpPWVN.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-etaUQKkq.js")).WaveParser;
	}
};
//#endregion
