...
async function doctorCommand(runtime, options = {}) {
	...
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-Bs5JAaqM.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-Bcv-6aNe.js");
