...
function normalizePathAccountId(accountId) {
	return typeof accountId === "string" ? accountId.trim() || "default" : DEFAULT_ACCOUNT_ID;
}
...
function resolveSpecificFieldBasePath(params) {
	...
	if (accountId !== "default" && hasConfiguredField(defaultAccountConfig, params.field)) return `channels.whatsapp.accounts.${defaultAccountKey}`;
