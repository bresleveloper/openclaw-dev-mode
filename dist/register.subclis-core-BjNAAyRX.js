...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-DC5xSJQK.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-DG23mIzA.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-CQKaO-Go.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-s7wR5mD8.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-BPAY5X2G.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-yBfQpaKj.js"),
