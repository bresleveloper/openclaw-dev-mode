...
const loadAgentHandlers = lazyHandlerModule(() => import("./agent-Cn9CCIYh.js"), (module) => module.agentHandlers);
...
const loadChatHandlers = lazyHandlerModule(() => import("./chat-D1jCkJcm.js"), (module) => module.chatHandlers);
...
const loadNodePendingHandlers = lazyHandlerModule(() => import("./nodes-pending-Bt_o0YUc.js"), (module) => module.nodePendingHandlers);
const loadNodeHandlers = lazyHandlerModule(() => import("./nodes-DdahcU8y.js"), (module) => module.nodeHandlers);
...
const loadSessionsHandlers = lazyHandlerModule(() => import("./sessions-BZIBgh1-.js"), (module) => module.sessionsHandlers);
const loadSkillsHandlers = lazyHandlerModule(() => import("./skills-OTqWi366.js"), (module) => module.skillsHandlers);
const loadSystemHandlers = lazyHandlerModule(() => import("./system-CApo5bsM.js"), (module) => module.systemHandlers);
const loadTalkHandlers = lazyHandlerModule(() => import("./talk-ZbSwwwcT.js"), (module) => module.talkHandlers);
...
const loadToolsEffectiveHandlers = lazyHandlerModule(() => import("./tools-effective-CxBJwPeO.js"), (module) => module.toolsEffectiveHandlers);
const loadToolsInvokeHandlers = lazyHandlerModule(() => import("./tools-invoke-BktfpmBG.js"), (module) => module.toolsInvokeHandlers);
const loadTtsHandlers = lazyHandlerModule(() => import("./tts-CZYY8DhX.js"), (module) => module.ttsHandlers);
const loadUpdateHandlers = lazyHandlerModule(() => import("./update-BhVHZcxA.js"), (module) => module.updateHandlers);
