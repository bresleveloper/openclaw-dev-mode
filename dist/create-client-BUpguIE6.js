...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-D73WyWDP.js";
import "./config-BBFBSv9s.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-D6gArM8P.js"), import("./logging-DjXFNfnd.js")]).then(([sdkModule, loggingModule]) => ({
