...
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-Drc6MvpQ.js";
import { i as DEFAULT_RELAYS } from "./setup-adapter-Q7fghBnG.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta) => {
					...
					const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-C8r6wgTh.js");
