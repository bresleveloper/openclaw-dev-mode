import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Cw5DuNhi.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-BJNdy017.js")).planCrestodianCommand)({
		input,
		overview
	});
