...
import { Kl as ensureAuthProfileStore, M as resolveEnvApiKey, Tt as resolveAuthProfileOrder, Ul as upsertAuthProfile, au as normalizeOptionalSecretInput, d as normalizeProviderId, fs as resolveApiKeyForProfile, gc as parseDurationMs, ou as normalizeSecretInput } from "./model-selection-BRhJAUKb.js";
...
import { At as resolveDefaultSecretProviderAlias } from "./plugins-7t5A5YJP.js";
...
import { a as normalizeSecretInputModeInput } from "./auth-choice.apply-helpers-De4NYiI7.js";
import "./issue-format-BY96Fvm5.js";
import "./openai-codex-model-default-D_5N6ZnF.js";
import { At as setXiaomiApiKey, B as applyVeniceConfig, Ct as setQianfanApiKey, Dt as setVercelAiGatewayApiKey, Et as setVeniceApiKey, H as applyXaiConfig, I as applySyntheticConfig, J as applyLitellmConfig, K as applyZaiConfig, M as applyOpenrouterConfig, O as applyMoonshotConfig, Ot as setVolcengineApiKey, P as applyQianfanConfig, Q as applyVercelAiGatewayConfig, R as applyTogetherConfig, S as applyMistralConfig, St as setOpenrouterApiKey, T as applyModelStudioConfigCn, Tt as setTogetherApiKey, W as applyXiaomiConfig, X as applyCloudflareAiGatewayConfig, _t as setModelStudioApiKey, b as applyKimiCodeConfig, bt as setOpencodeGoApiKey, ct as setByteplusApiKey, dt as setHuggingfaceApiKey, ft as setKilocodeApiKey, g as applyHuggingfaceConfig, gt as setMistralApiKey, h as applyAuthProfileConfig, ht as setMinimaxApiKey, jt as setZaiApiKey, k as applyMoonshotConfigCn, kt as setXaiApiKey, l as applyMinimaxApiConfig, lt as setCloudflareAiGatewayConfig, mt as setLitellmApiKey, n as validateAnthropicSetupToken, p as applyMinimaxConfig, pt as setKimiCodingApiKey, r as applyOpencodeGoConfig, s as applyOpencodeZenConfig, st as setAnthropicApiKey, t as buildTokenProfileId, u as applyMinimaxApiConfigCn, ut as setGeminiApiKey, v as applyKilocodeConfig, vt as setMoonshotApiKey, w as applyModelStudioConfig, wt as setSyntheticApiKey, xt as setOpencodeZenApiKey, yt as setOpenaiApiKey } from "./auth-token-DdQ_1a8w.js";
import { i as detectZaiEndpoint, n as applyOpenAIConfig, o as applyGoogleGeminiModelDefault } from "./openai-model-default-DOagIr4x.js";
import { r as applyPrimaryModel } from "./model-picker-DCl8qtjE.js";
import { t as configureOllamaNonInteractive } from "./ollama-setup-B90MXDHs.js";
import { i as parseNonInteractiveCustomApiFlags, n as applyCustomApiConfig, o as resolveCustomProviderId, t as CustomApiError } from "./onboard-custom-DEE6NPih.js";
...
async function applyNonInteractiveAuthChoice(params) {
	...
	if (authChoice === "ollama") return configureOllamaNonInteractive({
		nextConfig,
		opts,
		runtime
	});
	...
	if (authChoice === "modelstudio-api-key-cn") {
		...
		if (!resolved) return null;
		if (!await maybeSetResolvedApiKey(resolved, (value) => setModelStudioApiKey(value, void 0, apiKeyStorageOptions))) return null;
		nextConfig = applyAuthProfileConfig(nextConfig, {
	...
	if (authChoice === "opencode-go") {
		...
		if (!resolved) return null;
		if (!await maybeSetResolvedApiKey(resolved, (value) => setOpencodeGoApiKey(value, void 0, apiKeyStorageOptions))) return null;
		nextConfig = applyAuthProfileConfig(nextConfig, {
