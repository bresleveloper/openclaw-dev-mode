...
import { Kc as resolveConfiguredModelRef, Mo as readConfigFileSnapshot, Oo as loadConfig, Ot as loadSessionStore, Tn as resolveMainSessionKey, Ur as inspectPortUsage, Ya as sha256HexPrefix, _a as readTailscaleStatusJson, bn as resolveFreshSessionTotalTokens, cu as DEFAULT_MODEL, ga as getTailnetHostname, jo as readBestEffortConfig, lu as DEFAULT_PROVIDER, qr as formatPortDiagnostics } from "./auth-profiles-CIqoN6FN.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { d as resolveAgentWorkspaceDir } from "./agent-scope-BAb0j1gt.js";
import { T as parseAgentSessionKey } from "./session-key-DmlQCuju.js";
import { n as runExec } from "./exec-DDBrWr4H.js";
...
import { lt as resolveChannelDefaultAccountId, n as listChannelPlugins } from "./plugins-CjLMQbHJ.js";
import { _n as peekSystemEvents, bt as summarizeRestartSentinel, cn as buildChannelAccountSnapshot, dn as resolveChannelAccountEnabled, ln as formatChannelAllowFrom, nn as loadProviderUsageSummary, rn as formatUsageReportLines, sn as buildChannelSummary, un as resolveChannelAccountConfigured, yt as readRestartSentinel } from "./compact-D7FmBOIi.js";
import { c as resolveStorePath } from "./paths-B52CESY4.js";
import { d as resolveContextTokensForModel, l as resolveSessionModelRef, n as classifySessionKey, r as listAgentsForGateway } from "./session-utils-Byo4TGCQ.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-B28h9L2b.js";
import { _ as hasConfiguredUnavailableCredentialStatus, g as inspectReadOnlyChannelAccount, v as hasResolvedCredentialValue } from "./pi-tools.policy-BakY2muG.js";
import { n as formatTimeAgo } from "./format-relative-wlb6Ba6C.js";
import { r as formatDurationPrecise } from "./format-duration-D_oqO5zg.js";
import { a as getRemoteSkillEligibility } from "./skill-commands-3lKJ1bA0.js";
import { o as getStatusCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-D-ZwQMW3.js";
import { C as normalizeControlUiBasePath, g as resolveControlUiLinks } from "./onboard-helpers-Dxc5qfRZ.js";
import { t as getMemorySearchManager } from "./search-manager-1h3uBAK6.js";
import { n as withProgress } from "./progress-DD4pMDZr.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C1_d6sO6.js";
import { t as formatConfigIssueLine } from "./issue-format-CBixuceM.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-PQD9C42e.js";
import { c as resolveGatewayLogPaths, n as resolveGatewayService } from "./service-D6xYLXBx.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-BjXnogj9.js";
import { r as probeGateway, t as resolveGatewayProbeAuthSafe } from "./probe-auth-DUVIfe-o.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-Cam18og1.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-B-ecKEFu.js";
import { o as resolveHeartbeatSummaryForAgent, t as formatHealthChannelLines } from "./health-CNnkhoU1.js";
import { a as formatGitInstallLabel, g as resolveUpdateChannelDisplay, m as normalizeUpdateChannel, n as checkUpdateStatus, t as resolveDefaultChannelAccountContext } from "./channel-account-context-Bz1he1q8.js";
import { t as runSecurityAudit } from "./audit-ECqCgB1z.js";
import { t as resolveNodeService } from "./node-service-Flmmt8on.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-DITNx47Y.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-4V4R32qg.js";
import { t as shortenText } from "./text-format-D2Z92S2W.js";
