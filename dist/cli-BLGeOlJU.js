...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-7gTv6kum.js";
import { n as matrixSetupAdapter } from "./setup-core-DFGjTJZ7.js";
import { t as withResolvedActionClient } from "./client-CpO03sw5.js";
import { r as resolveMatrixAuthContext } from "./config-B8rnzcn2.js";
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-BkAZImTE.js"));
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DLlmMngQ.js");
