...
import { r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-BcvxxriC.js";
...
import { n as shouldForwardModelCommandToServer } from "./commands-registry.data-BocP0_lr.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-CGJ_3a5-.js";
import { i as resolveTextCommand } from "./commands-registry-normalize-fZe-I4O7.js";
...
import "./usage-format-CyE-btXR.js";
...
import { a as parseGoalCommand, n as formatGoalResumeContinuationPrompt, t as formatGoalContinuationPrompt } from "./commands-goal-q-tfEwnt.js";
...
async function runTui(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-36lYULUj.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-BA1qTGcu.js");
