import { h as getChildLogger, l as shouldLogVerbose, o as logVerbose } from "./globals-BozXJ-QJ.js";
import { C as sleep, T as toWhatsappJid, f as isSelfChatMode, m as normalizeE164, p as jidToE164, r as clamp, v as resolveJidToE164 } from "./utils-BzWe_IKB.js";
import { Qr as resolveChannelGroupRequireMention, Vn as recordSessionMetaFromInbound, Wn as updateLastRoute, Ws as loadConfig, Zr as resolveChannelGroupPolicy, _a as saveMediaBuffer, ii as resolveGroupSessionKey, zn as loadSessionStore } from "./model-selection-BRhJAUKb.js";
import { Lr as resolveIdentityNamePrefix, P as resolveInboundSessionEnvelopeContext, Q as createConnectedChannelStatusPatch, Rr as resolveMessagePrefix, Tt as normalizeMentionText, bt as hasControlCommand, ci as resolveAgentRoute, ct as buildHistoryContextFromEntries, dn as computeBackoff, dt as dispatchReplyWithBufferedBlockDispatcher, fn as sleepWithAbort, gn as parseActivationCommand, hn as normalizeGroupActivation, ht as formatInboundEnvelope, li as resolveInboundLastRouteSessionKey, lt as recordPendingHistoryEntryIfEnabled, mt as resolveInboundDebounceMs, nt as resolveMentionGating, oi as buildAgentSessionKey, or as enqueueSystemEvent, pn as createDedupeCache, pt as createInboundDebouncer, si as deriveLastRoutePolicy, st as createReplyPrefixOptions, t as getReplyFromConfig, tt as issuePairingChallenge, ut as shouldAckReactionForWhatsApp, wt as buildMentionRegexes, xt as shouldComputeCommandAuthorized, yi as finalizeInboundContext } from "./reply-CCXYDkRB.js";
import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-NSiOA8hi.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-CLqmOUrs.js";
import { t as formatCliCommand } from "./command-format-Dl98Vqkn.js";
import { $ as readWebSelfId, G as resolveWhatsAppMediaMaxBytes, U as resolveWhatsAppAccount, q as getWebAuthAgeMs } from "./plugins-7t5A5YJP.js";
...
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-Dx-W2ctQ.js";
import { c as resolveDmGroupAccessWithCommandGate, l as resolveDmGroupAccessWithLists, o as readStoreAllowFromForDmPolicy, u as resolvePinnedMainDmOwnerFromAllowlist } from "./read-only-account-inspect-BYTbLmn-.js";
import { X as formatLocationText, Z as toLocationContext } from "./send-plgDSxi2.js";
import { a as loadWebMedia, d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, m as resolveChunkMode, s as resolveMarkdownTableMode } from "./ir-C3NVthTb.js";
import { r as formatDurationPrecise } from "./format-duration-eQacap7i.js";
import { a as resolveDefaultGroupPolicy, o as resolveOpenProviderRuntimeGroupPolicy, s as warnMissingProviderGroupPolicyFallbackOnce } from "./group-access-DOfbU1MF.js";
import { c as upsertChannelPairingRequest } from "./pairing-store-CREONAb_.js";
import { n as recordChannelActivity } from "./channel-activity-BIpicHYd.js";
import { t as convertMarkdownTables } from "./tables-BmkACGX-.js";
import { r as setActiveWebListener } from "./active-listener-vJQWAMrs.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-DTq7fPS3.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DPizSM5T.js";
