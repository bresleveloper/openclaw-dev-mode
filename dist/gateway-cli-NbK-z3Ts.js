...
import { t as addGatewayRunCommand } from "./run-command-DAgx44zf.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-Bg0u8pha.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-B_UcLD4I.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-Cx2MC-u9.js"));
const wideAreaDnsModuleLoader = createLazyImportLoader(() => import("./widearea-dns-YfeHokvZ.js"));
const healthStyleModuleLoader = createLazyImportLoader(() => import("./terminal-core/health-style.js"));
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-BP8ztV_h.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-DcrB7jsK.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-Ci6jfjvS.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-aETBHVZ_.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-BIYIp1yZ.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayClientRequestErrorJson, formatGatewayTransportErrorJson } = await import("./call-CgIJVeW0.js");
