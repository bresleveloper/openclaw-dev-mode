...
if (!isMainModule({
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		if (!tryHandleRootVersionFastPath(process$1.argv) && !tryHandleRootHelpFastPath(process$1.argv)) import("./run-main-CUkB1mC8.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {
