import { W as consumeRootOptionToken } from "./globals-DtwqVhkV.js";
import { g as resolveStateDir } from "./paths-BfR2LXbA.js";
import { Ft as isAvatarHttpUrl, H as loadConfig, Lt as isPathWithinRoot, Ni as DEFAULT_MODEL, Nt as AVATAR_MAX_BYTES, Pi as DEFAULT_PROVIDER, Pt as isAvatarDataUrl, Sr as resolveDefaultModelForAgent, Vt as resolveAvatarMime, fr as inferUniqueProviderFromConfiguredModels, nr as resolveOpenClawAgentDir, vr as parseModelRef, xr as resolveConfiguredModelRef, zt as isWorkspaceRelativeAvatarPath } from "./auth-profiles-gyYFUuWS.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-Cp0IkEKB.js";
import { S as isCronRunSessionKey, T as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey } from "./session-key-DmlQCuju.js";
import { a as openBoundaryFileSync } from "./openclaw-root-D_NGSHjv.js";
import { N as readSessionTitleFieldsFromTranscript, Q as resolveAgentMainSessionKey, T as normalizeSessionDeliveryFields, Y as resolveFreshSessionTotalTokens, Z as canonicalizeMainSessionAlias, et as resolveMainSessionKey, s as loadSessionStore, st as buildGroupDisplayName } from "./sessions-BzabF1Rs.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-CUF-k9xj.js").then((n) => n.r);
