...
import { a as closePluginStateDatabase } from "./plugin-state-store-D2450Zn3.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-DYVJ88Q_.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-Dd21vDoR.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-DqYs6AIK.js");
