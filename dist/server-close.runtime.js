...
import { a as closePluginStateDatabase } from "./plugin-state-store-CEDDp9UH.js";
...
import { a as isChatAbortControllerEntryAbortable, c as removeChatAbortControllerEntry, r as abortTrackedChatRunById } from "./chat-abort-BIKxT7ef.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-ipiW-5Hb.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-9o12B9B7.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-BDXh0WbA.js");
