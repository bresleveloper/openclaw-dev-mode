...
import { m as restoreTerminalState, p as defaultRuntime } from "./subsystem-NSiOA8hi.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-JN2sbVho.js";
...
import "./daemon-runtime-PDKGe0fy.js";
import { t as runOnboardingWizard } from "./onboarding-CgcrNTjp.js";
import { n as logConfigUpdated } from "./logging-O-a3b82x.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-ChtwRDIB.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-DA24cOGJ.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-B1ItV_Le.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BUdBO9ut.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CnIrModd.js").then((n) => n.i);
