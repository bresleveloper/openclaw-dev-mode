...
async function collectDoctorPreviewNotes(params) {
	...
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-CRYATREO.js");
	...
	if (hasPluginConfig) {
		...
		const { collectContextEngineHostCompatibilityWarnings } = await import("./context-engine-host-compat-BUsOR3LT.js");
