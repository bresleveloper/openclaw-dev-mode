...
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-BxLy-sTD.js";
import "./sdk-setup-tools-BPKYXuhH.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-B2kZVXMm.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-D9VxW-n2.js";
import { r as getBrowserProfileCapabilities } from "./target-id-CFw1QGs2.js";
import { n as normalizeBrowserScreenshot } from "./routes-DFuTMbO7.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BNcUKDMg.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-BoBXTGBc.js");
