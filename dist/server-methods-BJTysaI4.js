...
const loadAgentHandlers = lazyHandlerModule(() => import("./agent-DQNSU5_F.js"), (module) => module.agentHandlers);
...
const loadChatHandlers = lazyHandlerModule(() => import("./chat-Dmt7zI9H.js"), (module) => module.chatHandlers);
...
const loadNativeHookRelayHandlers = lazyHandlerModule(() => import("./native-hook-relay-_dnFD5EU.js"), (module) => module.nativeHookRelayHandlers);
const loadNodePendingHandlers = lazyHandlerModule(() => import("./nodes-pending-BQMyQFHL.js"), (module) => module.nodePendingHandlers);
const loadNodeHandlers = lazyHandlerModule(() => import("./nodes-BXDMCwAA.js"), (module) => module.nodeHandlers);
...
const loadRestartHandlers = lazyHandlerModule(() => import("./restart-Cfwrf5fv.js"), (module) => module.restartHandlers);
...
const loadSessionsHandlers = lazyHandlerModule(() => import("./sessions-DldO1pbZ.js"), (module) => module.sessionsHandlers);
const loadSkillsHandlers = lazyHandlerModule(() => import("./skills-Dh-Ulv43.js"), (module) => module.skillsHandlers);
const loadSystemHandlers = lazyHandlerModule(() => import("./system-BouS6yex.js"), (module) => module.systemHandlers);
const loadTalkHandlers = lazyHandlerModule(() => import("./talk-C4RI9ssO.js"), (module) => module.talkHandlers);
...
const loadToolsEffectiveHandlers = lazyHandlerModule(() => import("./tools-effective-Ay83qiOu.js"), (module) => module.toolsEffectiveHandlers);
const loadToolsInvokeHandlers = lazyHandlerModule(() => import("./tools-invoke-CfIHctqR.js"), (module) => module.toolsInvokeHandlers);
const loadTtsHandlers = lazyHandlerModule(() => import("./tts-CZYY8DhX.js"), (module) => module.ttsHandlers);
const loadUpdateHandlers = lazyHandlerModule(() => import("./update-D3hlBEYB.js"), (module) => module.updateHandlers);
