...
import { b as readStringParam, c as imageResultFromFile, g as readPositiveIntegerParam, l as jsonResult, m as readNonNegativeIntegerParam } from "./common-B2QjWqqG.js";
import { t as callGatewayTool } from "./gateway-BHJLRjIg.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-B5ynlPJm.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-DVoeKmsH.js";
...
import { t as describeImageFile } from "./runtime-BcC1ekjA.js";
import "./param-readers-Cip642Vm.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-CL_mhwVK.js";
import { n as withTimeout } from "./sdk-security-runtime-DUaKWlYv.js";
import { L as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-DjkDekqM.js";
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-XVbBX87b.js";
import "./sdk-setup-tools-CU84qpaS.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-BXyseAYg.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-Wd8qL2QK.js";
import { r as getBrowserProfileCapabilities } from "./target-id-B6aLMcdH.js";
import { n as normalizeBrowserScreenshot } from "./routes-ZcJ4iQoF.js";
import { t as createBrowserRouteDispatcher } from "./dispatcher-DixkStii.js";
import { n as createBrowserControlContext } from "./plugin-enabled-iouzpqpL.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-Dr5kjqjE.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-DT4-xPBv.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-D23pjUHP.js");
