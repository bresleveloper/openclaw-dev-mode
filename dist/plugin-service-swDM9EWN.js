...
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-j0fvyb3s.js";
import "./sdk-setup-tools-rLtPJEcC.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-aN7L97jf.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-DYlYVMH1.js";
import { r as getBrowserProfileCapabilities } from "./target-id-Dc5Lxlxn.js";
import { n as normalizeBrowserScreenshot } from "./routes-B6OUHcu2.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-ykHsVYmm.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-BPytPzBd.js");
