...
import { a as tracePluginLifecyclePhaseAsync, i as tracePluginLifecyclePhase } from "./discovery-DM5vTQts.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-D0z2k_kA.js");
	const { buildPluginSnapshotReport } = await import("./status-BwJFIW6b.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-CF6CMsMM.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-XIowg6BN.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-w_2WgOyK.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-AqMIlO11.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-CdysboSH.js");
