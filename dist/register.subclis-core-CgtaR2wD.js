...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-Btv7XjgK.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-BHdNaJGl.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-C73_TVpt.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-C051Q1V2.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-BpWbu8qS.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-CpFFWg8R.js"),
