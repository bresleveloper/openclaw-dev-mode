...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CrcykudU.js";
...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-BsXKx-Ww.js";
import { a as resetModelCatalogCache, n as loadModelCatalog } from "./model-catalog-CJwDdG-7.js";
import { r as clearCurrentProviderAuthState } from "./model-provider-auth-state-DW_JYm-o.js";
import { i as warmCurrentProviderAuthStateOffMainThread } from "./model-provider-auth-BEZv7x5V.js";
import { d as getActiveEmbeddedRunCount, f as listActiveEmbeddedRunSessionIds, p as listActiveEmbeddedRunSessionKeys } from "./run-state-BZSsRYCZ.js";
import { a as refreshContextWindowCache } from "./context-BDO_A4uo.js";
import { u as getTotalQueueSize } from "./command-queue-DqzpsN4m.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-CfHkKR-M.js";
import { r as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-runtime-DGeRg_-o.js";
import "./agent-bundle-mcp-tools-YySi1utk.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { r as resetDirectoryCache } from "./target-resolver-DzayswaO.js";
import { n as clearSecretsRuntimeSnapshot, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-O2vuhjLQ.js";
import { t as bumpSkillsSnapshotVersion } from "./refresh-state-DHnXO3IV.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Bh2IMLyf.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-BUK2a-7x.js";
import { v as resolveHooksConfig } from "./hooks-GTnJSxqS.js";
import { t as buildGatewayCronService } from "./server-cron-3V1SeHwb.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Dx8JkdBM.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-BRLPT05R.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-BI_KXCQu.js";
import { i as startGatewayCronWithLogging } from "./server-runtime-services-DjL186sV.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-B-QD-l3I.js")).activateSecretsRuntimeSnapshot(snapshot);
}
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BDXh0WbA.js"), import("./gmail-watcher-lifecycle-B3nYSTPz.js")]);
