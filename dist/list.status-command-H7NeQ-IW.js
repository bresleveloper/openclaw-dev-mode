...
import { _ as shortenHomePath, m as resolveUserPath } from "./utils-BApvfmPs.js";
...
import { c as resolveAgentExplicitModelPrimary, d as resolveAgentModelFallbacksOverride } from "./agent-scope-CDZXADgT.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir } from "./agent-scope-config-C3ijpoNo.js";
import { n as resolveDefaultAgentWorkspaceDir } from "./workspace-default-DhGzPxbH.js";
import { a as restoreCurrentPluginMetadataSnapshotState, o as setCurrentPluginMetadataSnapshot, r as getCurrentPluginMetadataSnapshot, t as captureCurrentPluginMetadataSnapshotState } from "./current-plugin-metadata-snapshot-BcIVzXmF.js";
import { r as createConfigIO } from "./io-BJfjPmGW.js";
...
import { u as resolveAuthStorePathForDisplay } from "./runtime-snapshots-BrKHRFr0.js";
import { P as evaluateStoredCredentialEligibility, i as ensureAuthProfileStoreWithoutExternalProfiles, v as loadPersistedAuthProfileStore } from "./store-SfOB_T2S.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-CqVcoNpy.js";
import { A as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-D4NEMgBr.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-DWHvUh-t.js";
import "./profiles-DswMRdru.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-C-fcEbGX.js";
import { _ as resolveConfiguredModelRef, b as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-CKMggJal.js";
import { i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-Df7baLev.js";
import { b as resolveProviderEnvAuthLookupMaps, d as isNonSecretApiKeyMarker, f as isOAuthApiKeyMarker, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-C4s6SbvA.js";
import { h as isCliProvider } from "./model-selection-i8V2iTdL.js";
import { t as resolveEnvApiKey } from "./model-auth-env-W5zTaRQi.js";
import { r as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { h as resolveUsableCustomProviderApiKey, o as getCustomProviderApiKey } from "./model-auth-Bvz14MtI.js";
import "./workspace-DP5mE--D.js";
import { a as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-CZ8RT-Uc.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-ClkVsQjc.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Cmp8hPwu.js";
import { t as maskApiKey } from "./mask-api-key-D2MLa8WN.js";
import { t as loadModelsConfig } from "./load-config-QLVh8Z7c.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CbWJvhJ8.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-BfHiYyO0.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-D7irmf0_.js");
			runtime.log("");
