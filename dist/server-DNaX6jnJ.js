...
import { a as isA2uiPath, i as injectCanvasLiveReload, n as CANVAS_HOST_PATH } from "./a2ui-shared-BOFwFS5N.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-BXyC20yZ.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-DIofgtvj.js");
