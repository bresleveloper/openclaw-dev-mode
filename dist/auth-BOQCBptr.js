...
import { c as loadAuthProfileStoreForRuntime } from "./store-SfOB_T2S.js";
import { a as resolvePluginSetupRegistry, i as resolvePluginSetupProvider } from "./setup-registry-Dw6hQo3K.js";
import { n as resolvePluginProviders } from "./providers.runtime-CNuUkESm.js";
...
import { i as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-DswMRdru.js";
import { n as listProfilesForProvider } from "./profile-list-CtT2BW_g.js";
import { n as clearAuthProfileCooldown } from "./usage-C-fcEbGX.js";
import { o as normalizeProviderId } from "./model-selection-normalize-Df7baLev.js";
import "./workspace-DP5mE--D.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-CH0Wu93I.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-sTwxNMVI.js";
...
import { a as loadValidConfigOrThrow, d as updateConfig, s as resolveKnownAgentId } from "./shared-ClkVsQjc.js";
import { t as isRemoteEnvironment } from "./remote-env-UQ1pRGc-.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-mrkdMse_.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DZMQU2CA.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-jzhiJ8xH.js";
import { r as repairCopilotRuntimePluginInstallForModelSelection } from "./copilot-runtime-plugin-install-BuaB6RTV.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-2C1mLZ5h.js");
			await openUrl(url);
		},
