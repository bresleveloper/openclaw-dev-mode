...
import { d as normalizeMainKey, i as buildAgentMainSessionKey, r as agentSessionKeysMatchByRequestKey, u as normalizeAgentId } from "./session-key-pTKRJb0m.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-DxaN427I.js";
import "./config-A41fTHlt.js";
import "./model-ref-shared-D4KabxN2.js";
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-Pb9MPbeS.js";
...
import "./usage-format-BDhkN63d.js";
...
import { a as parseGoalCommand, n as formatGoalResumeContinuationPrompt, t as formatGoalContinuationPrompt } from "./commands-goal-tMNRMkAI.js";
...
async function runTui(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-Cq28NGVS.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-C-VH79kV.js");
