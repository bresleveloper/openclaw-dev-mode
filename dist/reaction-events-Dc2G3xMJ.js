...
import "./session-binding-runtime-CRLjpksR.js";
...
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTargetWithPersistence } from "./approval-reactions-CJz0AXbY.js";
import { i as resolveMatrixThreadRouting, r as resolveMatrixThreadRootId, t as resolveMatrixInboundRoute } from "./route-BWroC6XX.js";
//#region extensions/matrix/src/matrix/monitor/reaction-events.ts
const loadApprovalReactionAuth = createLazyRuntimeModule(() => import("./approval-reaction-auth-DRV9t9OY.js"));
const loadExecApprovalResolver = createLazyRuntimeModule(() => import("./exec-approval-resolver-DWBNjffq.js"));
