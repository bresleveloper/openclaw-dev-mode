...
import { a as getActivePluginGatewayNodePolicyRegistry } from "./runtime-BQLP_qVr.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./remote-Db-xsuzl.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-CQtFV9Fn.js";
import { i as isNodeCommandAllowed, o as normalizeDeclaredNodeCommands, r as isForegroundRestrictedPluginNodeCommand, s as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-CDDCPmwi.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BeMwLOux.js";
...
import { d as resolveApprovalRequestRecipientConnIds } from "./approval-shared-Cj03d_Lu.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C05p7e--.js");
