...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-BzY68X-a.js";
import "./channel-core-DR2Gpugl.js";
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Crc2p_mM.js"), "matrixChannelRuntime");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-c73JBsW4.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
