...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasFlatLegacyStorageFile || hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-D_vCOvwx.js") : null;
...
async function migrateLegacyIdbSnapshotToSqlite(params) {
	...
	const { readLegacyMatrixIdbSnapshotState } = await import("./idb-persistence-BIE3g0pK.js");
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-D_vCOvwx.js");
