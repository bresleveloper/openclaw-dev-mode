...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send2.components-C4daa-2X.js").then((module) => module.sendDiscordComponentMessage);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-CmjCqdaw.js");
