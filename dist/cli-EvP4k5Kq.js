...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-DF7Hv3jl.js";
import { n as matrixSetupAdapter } from "./setup-core-CY6SYs50.js";
import { t as withResolvedActionClient } from "./client-BrNtxy7u.js";
import { r as resolveMatrixAuthContext } from "./config-DYddD9h-.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-Br76krHV.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BpO3SPlV.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-B9gMhLlM.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-Bi8pvgxo.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BONmm2dI.js");
