...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-JN2sbVho.js").then((n) => n.d);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BBxt0dvj.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-O-a3b82x.js").then((n) => n.r);
	...
	const { applyOnboardingLocalWorkspaceConfig } = await import("./onboard-config-DA24cOGJ.js").then((n) => n.n);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-DlGPC0xJ.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-DEE6NPih.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-BbLEcbZI.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-DCl8qtjE.js").then((n) => n.i);
	...
	if (authChoice === "ollama") {
		const { ensureOllamaModelPulled } = await import("./ollama-setup-B90MXDHs.js").then((n) => n.r);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-D9CdPkuG.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-7t5A5YJP.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-B-gHiyZS.js").then((n) => n.n);
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-CclrSJ9Y.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-BxnGdMdi.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-Coev9pUn.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-B5JccRV0.js");
