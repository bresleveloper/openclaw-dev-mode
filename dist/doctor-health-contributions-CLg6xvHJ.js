...
const loadDoctorCoreChecksModule = async () => await import("./doctor-core-checks-BIUqJ-QA.js");
const loadDoctorStateIntegrityModule = async () => await import("./doctor-state-integrity-CN9oGx7D.js");
const loadHealthCheckRegistryModule = async () => await import("./health-check-registry-BzU8tXic.js");
const loadModelCatalogModule = async () => await import("./model-catalog-B5-rgcvG.js");
const loadModelSelectionModule = async () => await import("./model-selection-B-Q3YQMF.js");
const loadNoteModule = async () => await import("./terminal-core/note.js");
const loadOnboardHelpersModule = async () => await import("./onboard-helpers-C3VZoo6M.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores, maybeRepairCanonicalApiKeyFieldAlias } = await import("./doctor-auth-flat-profiles-ZShv7RVR.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-acme98Sr.js");
	const { maybeRepairLegacyOAuthSidecarProfiles } = await import("./doctor-auth-oauth-sidecar-B8MPn2dc.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-CgtWk_Ji.js");
	const { buildGatewayConnectionDetails } = await import("./call-jEgftwN5.js");
	const { note } = await loadNoteModule();
...
async function runGatewayAuthHealth(ctx) {
	...
	const { resolveGatewayAuth } = await import("./auth-DrfDIbCK.js");
	const { resolveGatewayAuthToken } = await import("./auth-token-resolution-DzLJilC7.js");
	const { note } = await loadNoteModule();
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-DnYPCM0v.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runCoreContributionHealthRepair(ctx, checkIds) {
	if (!ctx.prompter.shouldRepair || checkIds.length === 0) return;
	const { CORE_HEALTH_CHECKS } = await import("./doctor-core-checks-BIUqJ-QA.js");
	const { runDoctorHealthRepairs } = await import("./doctor-repair-flow-llvClMLO.js");
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-w9VdIGfQ.js");
...
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-DnzACdUK.js");
	const { note } = await loadNoteModule();
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-CXQbBSdj.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-Cff-EcW3.js");
...
async function runReleaseConfiguredPluginInstallsHealth(ctx) {
	...
	if (!ctx.prompter.shouldRepair) return;
	const { maybeRunConfiguredPluginInstallReleaseStep } = await import("./release-configured-plugin-installs-CgOkAbTc.js");
	const { note } = await loadNoteModule();
...
async function runCodexSessionRouteHealth(ctx) {
	const { maybeRepairCodexSessionRoutes } = await import("./codex-route-warnings-COdk4EQ9.js");
	const { note } = await loadNoteModule();
...
async function runLegacyCronHealth(ctx) {
	const { maybeRepairLegacyCronStore, noteLegacyWhatsAppCrontabHealthCheck } = await import("./cron-BJvUYBoU.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, maybeRepairSandboxRegistryFiles, noteSandboxScopeWarnings } = await import("./doctor-sandbox-CTM_mT1_.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-DW9zm5mR.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides, noteMacStaleOpenClawUpdateLaunchdJobs } = await import("./doctor-platform-notes-CUUrIB9p.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-BxjcTtb-.js");
...
async function runSecurityHealth(ctx) {
	const { noteInstallPolicyHealth } = await import("./doctor-install-policy-gGF-LDfw.js");
	const { noteSecurityWarnings } = await import("./doctor-security-BQgm2f3_.js");
...
async function collectToolResultCapFindings(cfg) {
	...
	const { collectToolResultCapDoctorIssues, toolResultCapDoctorIssueToHealthFinding } = await import("./doctor-tool-result-cap-advice-D10l09Bu.js");
...
async function collectToolResultCapTargetAdvice(params) {
	...
	const { resolveContextWindowInfo } = await import("./context-window-guard-DuEytTjo.js");
...
async function runToolResultCapHealth(ctx) {
	...
	if (targets.length === 0) return;
	const { buildToolResultCapDoctorAdvice } = await import("./doctor-tool-result-cap-advice-D10l09Bu.js");
	const { note } = await loadNoteModule();
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-C06FGsAH.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-84yGgxaX.js");
	const { note } = await loadNoteModule();
...
async function detectSystemdLingerFindings(ctx) {
	...
	if (!loaded) return [];
	const { isSystemdUserServiceAvailable, readSystemdUserLingerStatus } = await import("./systemd-Cl10Ptob.js");
...
async function hasActiveGatewayExecCredential(ctx, mode = resolveDoctorMode(ctx.cfg)) {
	const { resolveSecretInputRef } = await loadSecretTypesModule();
	const { gatewaySecretInputPathCanWin } = await import("./credentials-secret-inputs-K-nXo0WV.js");
...
async function collectWorkspaceStatusPluginVersionDrift(params) {
	if (params.cfg.gateway?.mode !== "remote") try {
		const { gatherDaemonStatus } = await import("./status.gather-CUU-ze-7.js");
...
async function runWorkspaceStatusHealth(ctx) {
	...
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-6df3lTRV.js");
	noteWorkspaceStatus(ctx.cfg, { pluginVersionDrift });
}
async function runSkillsHealth(ctx) {
	const { maybeRepairSkillReadiness } = await import("./doctor-skills-CfZztFt8.js");
...
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size-Yd_vBnCU.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runHeartbeatTemplateRepairHealth(ctx) {
	const { maybeRepairHeartbeatTemplate } = await import("./doctor-heartbeat-template-repair-SP2imHPy.js");
...
async function runGatewayHealthChecks(ctx) {
	...
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-Bvc7LgCp.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-D9W5dKjU.js");
...
async function collectMemorySearchHealthFindings(ctx) {
	const { noteMemorySearchHealth } = await import("./doctor-memory-search-D9W5dKjU.js");
	const notes = [];
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-CykV4mtB.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-CZwdXH1p.js");
...
async function runWriteConfigHealth(ctx) {
	...
	const { logConfigUpdated } = await import("./logging-7QwYMpC1.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-8CpVwqDz.js");
	const { note } = await loadNoteModule();
	const workspaceDir = resolveAgentWorkspaceDir(ctx.cfg, resolveDefaultAgentId(ctx.cfg));
	...
	return [
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect(ctx) {
					const { collectAuthProfileHealthFindings } = await import("./doctor-auth-CgtWk_Ji.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectLegacyPluginManifestContractMigrations, legacyPluginManifestContractMigrationToHealthFinding } = await import("./doctor-plugin-manifests-CXQbBSdj.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToHealthFinding } = await import("./missing-configured-plugin-install-DNWpZiKt.js");
				...
				async repair(ctx) {
					const { detectConfiguredPluginInstallHealthIssues, configuredPluginInstallIssueToRepairEffect } = await import("./missing-configured-plugin-install-DNWpZiKt.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToHealthFinding } = await import("./doctor-plugin-registry-Cff-EcW3.js");
				...
				async repair(ctx) {
					const { detectPluginRegistryHealthIssues, pluginRegistryIssueToRepairEffect } = await import("./doctor-plugin-registry-Cff-EcW3.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToHealthFinding } = await import("./doctor-state-integrity-CN9oGx7D.js");
				...
				async repair(ctx) {
					const { detectStateIntegrityHealthIssues, stateIntegrityIssueToRepairEffect } = await import("./doctor-state-integrity-CN9oGx7D.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				async detect() {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToHealthFinding } = await import("./doctor-sandbox-CTM_mT1_.js");
					return (await detectLegacySandboxRegistryFileIssues()).map(legacySandboxRegistryInspectionToHealthFinding);
				},
				async repair(ctx) {
					const { detectLegacySandboxRegistryFileIssues, legacySandboxRegistryInspectionToRepairEffect } = await import("./doctor-sandbox-CTM_mT1_.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: [{
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { channelPluginBlockerHitToHealthFinding, scanConfiguredChannelPluginBlockers } = await import("./channel-plugin-blockers-BkjnMUX7.js");
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectChannelPreviewWarningHealthFindings } = await import("./doctor-startup-channel-maintenance-BxjcTtb-.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectWorkspaceStatusHealthFindings } = await import("./doctor-workspace-status-6df3lTRV.js");
					const pluginVersionDrift = await collectWorkspaceStatusPluginVersionDrift({
						cfg: ctx.cfg,
						options: {
							nonInteractive: true,
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect() {
					const { getSkillCuratorDoctorWarning } = await import("./curator-dF1wAgMD.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectHeartbeatTemplateHealthFindings } = await import("./doctor-heartbeat-template-repair-SP2imHPy.js");
		...
		createDoctorHealthContribution({
			...
			healthChecks: {
				...
				defaultEnabled: false,
				async detect(ctx) {
					const { collectDevicePairingHealthFindings } = await import("./doctor-device-pairing-CykV4mtB.js");
