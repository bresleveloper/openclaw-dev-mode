import { A as resolvePreferredOpenClawTmpDir, l as shouldLogVerbose, o as logVerbose } from "./globals-BozXJ-QJ.js";
import { A as resolveApiKeyForProvider, C as normalizeGoogleModelId, ac as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, cc as resolveIMessageAttachmentRoots, d as normalizeProviderId, k as requireApiKey, oc as isInboundPathAllowed, sc as mergeInboundPathRoots } from "./model-selection-BRhJAUKb.js";
import { N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-Dx6t10xJ.js";
import { n as runExec } from "./exec-B1lVds_y.js";
import { xt as normalizeChatType } from "./plugins-7t5A5YJP.js";
import { a as getFileExtension, l as kindFromMime, r as detectMime, s as isAudioFileName } from "./windows-spawn-BAKAvVI9.js";
import { i as formatUncaughtError, n as extractErrorCode, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-Cvi_W98b.js";
import { t as describeImageWithModel } from "./image-DQrHnMco.js";
import { n as fetchWithTimeout } from "./fetch-timeout-Cl2ZWcoD.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Sa6WT-j-.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CxGeWKo4.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-Dx-W2ctQ.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-R9lrAX5y.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-DHPfZjfB.js";
...
//#endregion
export { applyTemplate as S, normalizeMediaUnderstandingChatType as _, resolveAutoImageModel as a, CLI_OUTPUT_MAX_BUFFER as b, buildRandomTempFilePath as c, isAudioAttachment as d, normalizeAttachmentPath as f, resolveTimeoutMs as g, resolveConcurrency as h, normalizeMediaAttachments as i, installUnhandledRejectionHandler as l, resolveAttachmentKind as m, buildProviderRegistry as n, resolveMediaAttachmentLocalRoots as o, normalizeAttachments as p, createMediaAttachmentCache as r, runCapability as s, runAudioTranscription as t, registerUnhandledRejectionHandler as u, resolveMediaUnderstandingScope as v, DEFAULT_IMAGE_MODELS as x, AUTO_IMAGE_KEY_PROVIDERS as y };
