...
const providerIndexCatalogLoader = createLazyImportLoader(() => import("./list.provider-index-catalog-VMwhCaed.js"));
...
async function planAllModelListSources(params) {
	...
	const manifestCatalog = await import("./list.manifest-catalog-C9zFyCZH.js");
	...
	const providerCatalog = await import("./list.provider-catalog-CJAH7idv.js");
