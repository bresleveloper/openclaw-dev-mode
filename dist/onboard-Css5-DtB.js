...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-B6NrUFrh.js";
import { Sn as resolveDefaultSecretProviderAlias, an as writeConfigFile, tn as readConfigFileSnapshot } from "./model-selection-Dmiyt9yA.js";
import { N as isValidEnvSecretRefId } from "./registry-DBb6KIXY.js";
import { t as formatCliCommand } from "./command-format-DgBEhw5P.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-wSGCHqx6.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-VfkpXuRu.js";
...
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-QD4m66NV.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DagurAJX.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CdJvYYPv.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DUQ_ZlwV.js").then((n) => n.i);
