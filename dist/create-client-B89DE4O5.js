...
import { d as writeStorageMeta, l as resolveMatrixStoragePaths, r as maybeMigrateLegacyStorage } from "./storage-BpR511ch.js";
import "./config-DYddD9h-.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-Cgh2XIqk.js"), import("./logging-BsWA-YH1.js")]).then(([sdkModule, loggingModule]) => ({
