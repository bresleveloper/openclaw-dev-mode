...
import "./delegate-Dpkr-t6K.js";
import "./resolve-route-C8eGd9ZF.js";
...
async function ensureConfiguredAcpBindingReady(params) {
	return (await import("./persistent-bindings.lifecycle-Dt2ppz9d.js")).ensureConfiguredAcpBindingReady(params);
}
