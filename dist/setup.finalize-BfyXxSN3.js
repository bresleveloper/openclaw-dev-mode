...
import { o as isSystemdUserServiceAvailable } from "./systemd-Hq_NZE0o.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-BJm9kqLw.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-D5D8E6gG.js";
import { i as hasAuthProfileForProvider } from "./model-config.helpers-Dj_cf-ur.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-DWDVJPjG.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-B8ucEecq.js";
import { h as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-BFvCdatB.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-hl4LoLfP.js");
...
const loadOnboardSearchModule = createLazyRuntimeModule(() => import("./onboard-search-B9UqVNHY.js"));
/**
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const { resolveDefaultModelAuthStatus } = await import("./auth-choice-CNsDX6Uv.js");
