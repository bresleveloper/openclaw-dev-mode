...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-etcZhDYQ.js";
import "./channel-core-DLhjgS4U.js";
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DpL7sOv0.js"), "matrixChannelRuntime");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-Cc1_89x7.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
