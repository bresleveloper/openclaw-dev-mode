...
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-DwQAA5xd.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-ClOBKVMH.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CKJlg6QW.js");
	if (params.argv) {
