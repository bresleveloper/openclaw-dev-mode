import { G as buildAgentMainSessionKey, I as resolvePathViaExistingAncestorSync, O as runExec, Q as resolveAgentIdFromSessionKey, S as ensureAgentWorkspace, U as DEFAULT_AGENT_ID, X as normalizeAgentId, Z as normalizeMainKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeOptionalAccountId, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-DbqKAYVa.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-GBpjI3o0.js";
import { E as truncateUtf16Safe, L as isDevMode, O as createSubsystemLogger, h as normalizeE164, j as defaultRuntime, y as resolveUserPath } from "./logger-CkNFbaGM.js";
import { Ar as resolveSecretInputRef, Dr as hasConfiguredSecretInput, Q as createConfigIO, Yt as CHANNEL_IDS, br as isPidAlive, bt as parseDurationMs, lr as parseBooleanValue, ot as writeConfigFile, q as resolveSecretRefValues, tt as loadConfig, vr as resolveProcessScopedMap, vt as secretRefKey, xr as formatCliCommand, xt as parseByteSize, yr as getProcessStartTime, yt as getBlockedNetworkModeReason } from "./model-selection-DznAVfkT.js";
import { d as getChannelDock, o as normalizeThinkLevel, v as normalizeHyphenSlug } from "./thinking-2FUfxibY.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-No9izpwe.js";
import { t as generateSecureToken } from "./secure-random-D8DfzL9q.js";
import { i as getImageMetadata, m as normalizeMessageChannel, n as buildImageResizeSideGrid, p as listDeliverableMessageChannels, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-A98XpKpY.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-Dcrt35X_.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-BpjtGVAL.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Cd_AwXTT.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-C7DAw-ep.js";
import { n as SsrFBlockedError } from "./proxy-env-DQ-j4IBU.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-yUbrRiuu.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-DkNCrvq2.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-CE9nLZ9c.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BhqobGNC.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BDSDxU8V.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DVuRtm5X.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-mFlFlR9T.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-mFlFlR9T.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
//#endregion
export { resolveCacheTtlMs as $, compileGlobPatterns as $t, isRawApiErrorPayload as A, resolveConversationLabel as At, parseSessionThreadInfo as B, resolveBrowserControlAuth as Bt, isCloudCodeAssistFormatError as C, mergeSessionEntry as Ct, isFailoverErrorMessage as D, resolveExplicitAgentSessionKey as Dt, isFailoverAssistantError as E, canonicalizeMainSessionAlias as Et, isTimeoutErrorMessage as F, registerBrowserRoutes as Ft, readSessionUpdatedAt as G, buildPluginToolGroups as Gt, resolveMirroredTranscriptText as H, trimToUndefined as Ht, ensureSandboxWorkspaceForSession as I, resolveBrowserConfig as It, saveSessionStore as J, mergeAlsoAllowPolicy as Jt, recordSessionMetaFromInbound as K, collectExplicitAllowlist as Kt, resolveSandboxContext as L, resolveProfile as Lt, parseImageDimensionError as M, acquireSessionWriteLock as Mt, parseImageSizeError as N, resolveSessionLockMaxHoldFromTimeout as Nt, isLikelyContextOverflowError as O, resolveMainSessionKey as Ot, sanitizeUserFacingText as P, createBrowserRouteContext as Pt, isCacheEnabled as Q, resolveToolProfilePolicy as Qt, resolveSandboxRuntimeStatus as R, getBridgeAuthForPort as Rt, isBillingAssistantError as S, DEFAULT_RESET_TRIGGERS as St, isContextOverflowError as T, setSessionRuntimeModel as Tt, resolveAndPersistSessionFile as U, resolveSandboxConfigForAgent as Ut, appendAssistantMessageToSessionTranscript as V, resolveGatewayCredentialsFromConfig as Vt, loadSessionStore as W, applyOwnerOnlyToolPolicy as Wt, updateSessionStore as X, expandToolGroups as Xt, updateLastRoute as Y, stripPluginOnlyAllowlist as Yt, updateSessionStoreEntry as Z, normalizeToolName as Zt, formatAssistantErrorText as _, evaluateSessionFreshness as _t, isMessagingToolDuplicateNormalized as a, resolveBootstrapTotalMaxChars as an, normalizeAccountId as at, getApiErrorPayloadFingerprint as b, resolveSessionResetType as bt, extractToolCallsFromAssistant as c, countToolResults as ct, downgradeOpenAIFunctionCallReasoningPairs as d, INPUT_PROVENANCE_KIND_VALUES as dt, matchesAnyGlobPattern as en, deliveryContextFromSession as et, downgradeOpenAIReasoningBlocks as f, applyInputProvenanceToUserMessage as ft, classifyFailoverReasonFromHttpStatus as g, resolveSessionKey as gt, classifyFailoverReason as h, jsonUtf8Bytes as ht, isMessagingToolDuplicate as i, resolveBootstrapPromptTruncationWarningMode as in, normalizeSessionDeliveryFields as it, isTransientHttpError as j, resolveGroupSessionKey as jt, isRateLimitAssistantError as k, deriveSessionMetaPatch as kt, extractToolResultId as l, extractToolCallNames as lt, BILLING_ERROR_USER_MESSAGE as m, normalizeInputProvenance as mt, validateGeminiTurns as n, ensureSessionHeader$1 as nn, mergeDeliveryContext as nt, normalizeTextForComparison as o, sanitizeGoogleTurnOrdering as on, archiveSessionTranscripts as ot, isGoogleModelApi as p, hasInterSessionUserProvenance as pt, resolveSessionStoreEntry as q, expandPolicyWithPluginGroups as qt, pickFallbackThinkingLevel as r, resolveBootstrapMaxChars as rn, normalizeDeliveryContext as rt, sanitizeSessionMessagesImages as s, capArrayByJsonBytes as st, validateAnthropicTurns as t, buildBootstrapContextFiles as tn, deliveryContextKey as tt, sanitizeToolCallIdsForCloudCodeAssist as u, parseInlineDirectives as ut, formatBillingErrorMessage as v, resolveChannelResetConfig as vt, isCompactionFailureError as w, resolveFreshSessionTotalTokens as wt, isAuthAssistantError as x, resolveThreadFlag as xt, formatRawAssistantErrorForUi as y, resolveSessionResetPolicy as yt, extractDeliveryInfo as z, ensureBrowserControlAuth as zt };
