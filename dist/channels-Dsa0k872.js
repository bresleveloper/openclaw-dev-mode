...
import { t as danger } from "./globals-BElpud1m.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-DxnOT4sF.js";
import { a as getBundledChannelSetupPlugin } from "./bundled-CmSYSZ_c.js";
import { r as replaceConfigFile } from "./config-Cc93keN1.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-CWdFCyWd.js";
import "./plugins-Cgf2sDSU.js";
import "./message-channel-CB9y2CYk.js";
import "./logging-DBHEcFUB.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-Bc2VW-3g.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-BvfQ1me5.js";
...
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-Bahovy8i.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-D69jAQ1Z.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-xrXjUJk6.js";
...
import { t as applyAgentBindings } from "./agents.bindings-BtN-pN9j.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-Co6Na8O9.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-rnXdIQVP.js";
import { t as channelsListCommand } from "./list-DMFwtLwk.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BJSX2lcG.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-JEBJvCUB.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-sOgXPP97.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-Si8_E2gG.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-cbKPls0m.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-BEDfFvCP.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-7_MA0EoF.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-CSX5xPok.js");
