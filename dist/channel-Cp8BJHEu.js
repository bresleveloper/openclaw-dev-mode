...
import { l as createScopedDmSecurityResolver, m as mapAllowFromEntries, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-CMg35hQR.js";
import "./string-coerce-runtime-BiZzULo_.js";
import { t as chunkTextForOutbound } from "./text-chunking-nijjGL3g.js";
import { r as describeWebhookAccountSnapshot } from "./account-helpers-DihevCTm.js";
import { n as createStaticReplyToModeResolver } from "./threading-helpers-CMXJIj4M.js";
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-etcZhDYQ.js";
...
import { C as createOpenProviderGroupPolicyWarningCollector, o as buildOpenGroupPolicyRestrictSendersWarning, s as buildOpenGroupPolicyWarning } from "./channel-policy-VIimbh8Q.js";
...
import { d as createDefaultChannelRuntimeState, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DjJ0OuL_.js";
import "./channel-status-CxP0h-5H.js";
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields } from "./extension-shared-nRgeDkoI.js";
...
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-CdYBiSAg.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-8NVdNpxc.js";
import { r as zaloSetupAdapter, t as createZaloSetupWizardProxy } from "./setup-core-BXL7cFqc.js";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-D_dZ8ouD.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-DzxfGOUb.js"));
const zaloSetupWizard = createZaloSetupWizardProxy(async () => (await import("./setup-surface-bDkAZ9aG.js")).zaloSetupWizard);
