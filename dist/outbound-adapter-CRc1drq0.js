...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send2.components-C6k9-Rcg.js").then((module) => module.sendDiscordComponentMessage);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-DeAubm6s.js");
