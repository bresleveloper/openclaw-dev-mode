...
import { c as hasConfiguredSecretInput } from "./types.secrets-lIZQEgMF.js";
...
import { _ as updateSessionStore } from "./store-DJ7wx5_V.js";
...
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-CMg35hQR.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DINDVkoE.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-VIimbh8Q.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-DwVV1XKU.js";
...
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-DjJ0OuL_.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-BuA8YUu8.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-BqM42pW9.js";
import { n as createFeishuSendReceipt } from "./send-result-CMutNJ5w.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-DkSodD7m.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-hxPJ3LCO.js";
import { t as messageActionTargetAliases } from "./security-audit-1LfoJiMo.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-CL2eOHBt.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Dm990wrA.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-CyNe7g8G.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-DqROzcC6.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-BFxXzebx.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-hHL8rWlV.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-VGJ2Z0dC.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-CBPanCm9.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-Dk8Pt931.js");
