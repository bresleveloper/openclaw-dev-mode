...
import { r as isDevMode } from "./globals-BozXJ-QJ.js";
import { Lt as resolveSecretRefValues, On as secretRefKey, in as loadConfig, tn as createConfigIO, un as writeConfigFile } from "./model-selection-CX4C7NZp.js";
...
import { C as stopChromeExtensionRelayServer, E as resolveCdpReachabilityTimeouts, M as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, O as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, S as ensureChromeExtensionRelayServer, _ as appendCdpPath, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_COLOR, k as DEFAULT_AI_SNAPSHOT_MAX_CHARS, l as createTargetViaCdp, m as assertBrowserNavigationAllowed, n as isChromeCdpReady, o as stopOpenClawChrome, p as InvalidBrowserNavigationUrlError, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as fetchJson, w as CDP_JSON_NEW_TIMEOUT_MS, y as fetchOk } from "./chrome-tXGLEhE5.js";
import { i as isLoopbackHost } from "./ws-BeoXlzsZ.js";
import { a as resolveGatewayAuth } from "./auth-32YLiXaF.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-DvlVkCHy.js";
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-Ds-H_wj4.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-lgWRdCyT.js";
import { n as SsrFBlockedError } from "./proxy-env-Ce3yMsLG.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CVsEAuQZ.js";
import { a as saveMediaBuffer, r as ensureMediaDir } from "./store-BCGAnbcB.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BLB1Nxpr.js");
	} catch (err) {
