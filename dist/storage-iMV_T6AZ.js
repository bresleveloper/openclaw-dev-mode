...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CU9LIFzX.js";
...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasFlatLegacyStorageFile || hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-CcnTcnTT.js") : null;
...
async function migrateLegacyIdbSnapshotToSqlite(params) {
	...
	const { readLegacyMatrixIdbSnapshotState } = await import("./idb-persistence-2NcKmACu.js");
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-CcnTcnTT.js");
