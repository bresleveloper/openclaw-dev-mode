import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Byny9-t7.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-0rwJh4WC.js")).planCrestodianCommand)({
		input,
		overview
	});
