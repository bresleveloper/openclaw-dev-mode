...
import { l as createScopedDmSecurityResolver, u as createTopLevelChannelConfigAdapter } from "./channel-config-helpers-CMg35hQR.js";
...
import { h as runStoppablePassiveMonitor, r as buildTrafficStatusSummary, t as buildPassiveChannelStatusSummary } from "./extension-shared-nRgeDkoI.js";
...
import { n as NostrProfileSchema, t as NostrConfigSchema } from "./config-schema-CvYBGqyW.js";
import { a as resolveNostrAccount, c as SimplePool, d as verifyEvent, f as cbc, g as randomBytes, h as hexToBytes, i as resolveDefaultNostrAccountId, l as finalizeEvent, m as secp256k1, n as nostrSetupWizard, o as normalizePubkey, p as base64, r as listNostrAccountIds, s as validatePrivateKey, t as nostrSetupAdapter, u as getPublicKey } from "./setup-surface-CpDO7IYB.js";
import { i as DEFAULT_RELAYS } from "./setup-adapter-CviEnoQP.js";
		...
		start: async () => {
			const bus = await startNostrBus({
				...
				onMessage: async (senderPubkey, text, reply, meta) => {
					...
					const { dispatchInboundDirectDmWithRuntime } = await import("./inbound-direct-dm-runtime-DAHP_UpA.js");
