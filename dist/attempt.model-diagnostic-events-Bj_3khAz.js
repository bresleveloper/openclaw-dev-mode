...
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-D1GWNOpI.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CT4JjmjS.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-fqwcFyP9.js";
...
import { j as getCompactionProvider } from "./registry-CZzZT4dp.js";
import { l as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-Coa-CyIB.js";
import { it as resolveCacheTtlMs, nt as createExpiringMapCache, rt as isCacheEnabled } from "./store-Cvp82S16.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BMKJWjgY.js";
import "./version-Bsehiavt.js";
import { at as redactTranscriptMessage, it as isTranscriptOnlyOpenClawAssistantModel, rt as isTranscriptOnlyOpenClawAssistantMessage$1 } from "./session-accessor-CwhXEUId.js";
import { B as sanitizeProviderReplayHistoryWithPlugin, G as validateProviderReplayTurnsWithPlugin, w as resolveProviderCacheTtlEligibility } from "./provider-runtime-CIKTXkgy.js";
...
import { i as streamSimple } from "./stream-rJVXLNrX.js";
import { at as SettingsManager, s as DefaultResourceLoader } from "./sessions-CZQw0uF9.js";
...
import { n as SUMMARIZATION_OVERHEAD_TOKENS } from "./compaction-planning-BpV11_gP.js";
...
import { y as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-runtime-DGeRg_-o.js";
import { i as getPluginToolMeta } from "./tools-D0RJIgtl.js";
import { a as resolveContextWindowInfo } from "./context-window-guard-C3jorqVU.js";
...
import { r as finalizeToolTerminalPresentation, w as peekAdjustedParamsForToolCall } from "./agent-tools.before-tool-call-Bn4cnw4c.js";
import { g as isReasoningOnlyLengthAssistantTurn } from "./openai-transport-stream-BR-Qo1HB.js";
import { t as log$3 } from "./logger-rC_P-huq.js";
import { c as isAnthropicModelRef, s as isAnthropicFamilyCacheTtlEligible } from "./proxy-BcogMNFw.js";
import { a as resolveEffectiveCompactionMode, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-D4-WKHhs.js";
...
import { m as normalizeAcceptedSessionSpawnResult } from "./delivery-evidence-PoTCvm85.js";
import { i as mergePreparedUserTurnMessageForRuntime, s as restorePreparedUserTurnOperationalMetaForRuntime } from "./user-turn-transcript-x7xWBohS.js";
import { c as sanitizeSessionMessagesImages, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, r as validateGeminiTurns, u as downgradeOpenAIReasoningBlocks, x as sanitizeGoogleTurnOrdering } from "./embedded-agent-helpers-Umilw3Yn.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-DeG5lLFa.js";
import { a as createAnthropicVertexStreamFnForModel } from "./simple-completion-runtime-DqsS2UxT.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-DxlluRQg.js";
import { d as truncateToolResultMessage, f as formatContextLimitTruncationNotice, o as resolveLiveToolResultMaxChars, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS } from "./tool-result-truncation-Lg2AH7Lw.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-PCmQ2TQt.js";
import { r as recordPersistedRuntimeToolSchemaQuarantine, t as clearRecoveredPersistedRuntimeToolSchemaQuarantines } from "./tool-schema-quarantine-health-B6dFX4f2.js";
import { i as shouldAllowProviderOwnedThinkingReplay, n as providerRequiresSignedThinking, r as resolveTranscriptPolicy, t as createAgentToolResultMiddlewareRunner } from "./tool-result-middleware-Dv0C2zsi.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-B-Fjq6qy.js";
import { t as extractSections } from "./post-compaction-context-B9tRRHpp.js";
import { i as computeAdaptiveChunkRatioWithWorker, n as summarizeInStages, r as buildHistoryPrunePlanWithWorker, t as resolveContextWindowTokens$1 } from "./compaction-DYXLgBV6.js";
...
//#endregion
export { setCompactionSafeguardCancelReason as A, assessLastAssistantMessage as B, buildEmbeddedMessageActionDiscoveryInput as C, hasMeaningfulConversationContent as D, buildEmbeddedExtensionFactories as E, isCacheTtlEligibleProvider as F, isZeroUsageEmptyStopAssistantTurn as G, dropThinkingBlocks as H, readLastCacheTtlTimestamp as I, consumeEmbeddedToolSendReceipt as K, logRuntimeToolSchemaQuarantine as L, rotateTranscriptFileAfterCompaction as M, shouldRotateCompactionTranscript as N, isRealConversationMessage as O, dedupeDuplicateUserMessagesForCompaction as P, guardSessionManager as R, validateReplayTurns as S, limitHistoryTurns as T, stripThinkingBlocksFromMessage as U, dropReasoningFromHistory as V, wrapAnthropicStreamWithRecovery as W, prewarmSessionFile as _, normalizeContextTokenBudget as a, normalizeAssistantReplayContent as b, collectCoreBuiltinToolNames as c, applySystemPromptToSession as d, buildEmbeddedSystemPrompt as f, resolveEmbeddedAgentStreamFn as g, resolveEmbeddedAgentBaseStreamFn as h, mapThinkingLevelForProvider as i, rotateTranscriptAfterCompaction as j, consumeCompactionSafeguardCancelReason as k, collectRegisteredToolNames as l, resolveEmbeddedAgentApiKey as m, flushPendingToolResultsAfterIdle as n, AGENT_RESERVED_TOOL_NAMES as o, describeEmbeddedAgentStreamStrategy as p, createPreparedEmbeddedAgentSettingsManager as q, mapThinkingLevel as r, collectAllowedToolNames as s, wrapStreamFnWithDiagnosticModelCallEvents as t, toSessionToolAllowlist as u, trackSessionManagerAccess as v, getHistoryLimitFromSessionKey as w, sanitizeSessionHistory as x, createEmbeddedAgentResourceLoader as y, stripStaleAssistantUsageBeforeLatestCompaction as z };
