import { Ht as normalizeOptionalAccountId, Vt as normalizeAccountId } from "./paths-BPFh8Kvv.js";
import { c as resolveStateDir } from "./paths-DinMprTu.js";
import { O as createSubsystemLogger, z as logVerbose } from "./logger-J22gODrQ.js";
import { Fo as getActivePluginRegistry, Gt as appendAssistantMessageToSessionTranscript, Hn as getChannelDock, Jo as createInternalHookEvent, Kt as resolveMirroredTranscriptText, Lo as getActivePluginRegistryVersion, Vn as normalizeChannelId, Yo as triggerInternalHook, it as isMessagingToolDuplicate, xi as generateSecureUuid, yn as parseInlineDirectives, zn as getChannelPlugin } from "./model-selection-JGO58U_j.js";
import { i as isSilentReplyText } from "./tokens-CXmcg1TD.js";
import { r as parseTelegramTarget } from "./targets-pxSemjXK.js";
import { i as getAgentScopedMediaLocalRoots } from "./fetch-Bob0jLBP.js";
import { d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, l as chunkByParagraph, m as resolveChunkMode, s as resolveMarkdownTableMode, v as parseFenceSpans } from "./ir-BWMK5Aho.js";
import { c as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-CxUqMcTW.js";
...
//#endregion
export { normalizeTargetForProvider as A, isRenderablePayload as C, resolveReplyToMode as D, createReplyToModeFilterForChannel as E, initializeGlobalHookRunner as M, joinPresentTextSegments as N, buildTargetResolverSignature as O, filterMessagingToolMediaDuplicates as S, shouldSuppressReasoningPayload as T, toPluginMessageSentEvent as _, normalizeReplyPayloadsForDelivery as a, applyReplyThreading as b, splitMediaFromOutput as c, toInternalMessagePreprocessedContext as d, toInternalMessageReceivedContext as f, toPluginMessageReceivedEvent as g, toPluginMessageContext as h, normalizeOutboundPayloadsForJson as i, getGlobalHookRunner as j, normalizeChannelTargetInput as k, buildCanonicalSentMessageHookContext as l, toInternalMessageTranscribedContext as m, formatOutboundPayloadLog as n, throwIfAborted as o, toInternalMessageSentContext as p, normalizeOutboundPayloads as r, parseReplyDirectives as s, deliverOutboundPayloads as t, deriveInboundMessageHookContext as u, fireAndForgetHook as v, shouldSuppressMessagingToolReplies as w, filterMessagingToolDuplicates as x, applyReplyTagsToPayload as y };
