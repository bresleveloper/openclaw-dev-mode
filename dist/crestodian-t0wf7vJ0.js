...
import { r as resolveCrestodianOperation } from "./dialogue-BSWDjmGL.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CKHo2beV.js")).runCrestodianTui;
	opts.onReady?.();
