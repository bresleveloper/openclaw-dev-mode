...
import { n as matrixSetupAdapter } from "./setup-core-ClcCgosP.js";
import { t as withResolvedActionClient } from "./client-BEwTH0Yt.js";
import { r as resolveMatrixAuthContext } from "./config-BBFBSv9s.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-bl422WH_.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-Ct-KotAq.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-DnLEqoH7.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-D4boZ-52.js");
