...
import { u as readConfigFileSnapshot } from "./io-DxnOT4sF.js";
...
import { r as resolveLocalControlUiProbeLinks } from "./control-ui-links-Dx0Al90m.js";
...
import { a as stripPendingPluginInstallRecords, i as hasPendingPluginInstallRecords, n as commitConfigWriteWithPendingPluginInstalls, s as unchangedPendingPluginInstallRecordIds } from "./plugins-install-record-commit-Dci_oYIb.js";
import { c as normalizeGatewayTokenInput, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BFvCdatB.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-CKnsNkDG.js";
import { n as applySkipBootstrapConfig, t as applyLocalSetupWorkspaceConfig } from "./onboard-config-BgBC2WhB.js";
...
import { t as runSetupWizard } from "./setup-BbnaVIA1.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-BjhtzAvC.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Dv9fUHHm.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BdjhlIkK.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-xe3N17cn.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-CpuF_G07.js");
