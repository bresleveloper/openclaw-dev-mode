...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-B_QLG8Nq.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-Cf6M1sqf.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-COyuy-1h.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-CFdNIih_.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-CGiEVygv.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-Foh9l5OK.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
