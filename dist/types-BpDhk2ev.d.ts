import { En as SilentReplyConversationType, fn as CliBackendConfig, i as OpenClawConfig, t as ConfigFileSnapshot, vt as TalkProviderConfig } from "./types.openclaw-B5gtuEn_.js";
...
import { N as SessionScope, f as ContextVisibilityMode, k as SessionMaintenanceMode, y as HumanDelayConfig } from "./types.base-DD09OBJd.js";
import { n as SafeBinProfileFixture } from "./exec-safe-bin-policy-profiles-BDyHRwUP.js";
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-CBCgJD1K.js";
import { G as TtsAutoMode, K as TtsConfig, Q as TtsProvider, W as ResolvedTtsPersona, q as TtsMode } from "./types.slack-Bjt70WfQ.js";
import { E as ThinkingLevel, b as StreamFn, f as Model, l as ImageContent$1, n as Api, r as AssistantMessage } from "./types-CFIUY_La.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-BvJnk7Su.js";
import { mt as ZodType } from "./schemas-CkRCGSfd.js";
import { _ as PluginDiagnostic, a as PluginDependencyStatus, d as PluginKind, f as UnifiedModelCatalogEntry, g as PluginConfigUiHint, h as PluginBundleFormat, p as UnifiedModelCatalogKind, s as PluginManifestContracts, t as PluginManifestRecord, v as PluginFormat } from "./manifest-registry-CIZD-9A4.js";
...
import { i as PluginCompatCode } from "./installed-plugin-index-types-DEAxp2Y-.js";
import { n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-CW2n10_A.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-B_apsWds.js";
import { S as ConfigReplaceResult, h as ConfigMutationBase } from "./config-CTd1zbvT.js";
import { v as resolveStateDir } from "./paths-BzImXCBF.js";
import { i as PluginStateSyncKeyedStore, r as PluginStateKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-xAF7b0j2.js";
import { o as SsrFPolicy$1 } from "./ssrf-skjEI_i5.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-BCB9v_aj.js";
import { T as StreamFn$1, f as AgentToolResult, l as AgentTool, s as AgentMessage } from "./types-D0CdrmU4.js";
import { a as SourceReplyDeliveryMode, n as GetReplyOptions, o as TypingController, r as PartialReplyPayload, s as PromptImageOrderEntry, t as BlockReplyContext, u as ReplyPayload } from "./types-C5Sz_b28.js";
import { _ as InboundEventKind, a as SupplementalContextFacts, c as CommandTurnKind, h as PluginHookChannelContext, i as MsgContext, n as InboundSourceModality, r as MentionSource, s as CommandTurnContext, t as FinalizedMsgContext } from "./templating-Bl_fNKHX.js";
import { a as AuthProfileFailureReason, c as OAuthCredential, i as AuthProfileCredential, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential } from "./types-Dd5DQ7z0.js";
import { f as MediaUnderstandingProvider } from "./types-Cc9pD8mj.js";
import { n as UserTurnTranscriptRecorder, r as InputProvenance, t as UserTurnInput } from "./user-turn-transcript.types-DPSAsexh.js";
...
import { D as ChannelOutboundTargetMode, r as ChannelAccountSnapshot } from "./types.core-TwXPgPau.js";
import { P as MessageReceipt } from "./types-TsxybTb_.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { i as WizardPrompter } from "./prompts-QQvLKZMo.js";
import { C as ExecTarget, S as ExecSecurity, c as ExecApprovalDecision, u as ExecApprovalRequestPayload$1, x as ExecMode, y as ExecAsk } from "./exec-approvals-bouecjdj.js";
import { c as PluginApprovalRequestPayload } from "./plugin-approvals-Du2wBIIa.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-B6ktAocG.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin$2 } from "./types.plugin-DeFN_A48.js";
...
import { c as SessionScope$1, l as SessionSystemPromptReport, n as CliSessionBinding, o as SessionContextBudgetStatus, r as GroupKeyResolution, s as SessionEntry } from "./types-r7E6AIEo.js";
import { a as loadSessionStore, c as ResolvedSessionMaintenanceConfigInput, n as updateSessionStore } from "./store-CuBpdzxZ.js";
import { a as TraceLevel, i as ThinkingCatalogEntry, n as ReasoningLevel, o as VerboseLevel, r as ThinkLevel, t as ElevatedLevel } from "./thinking.shared-0bZWY054.js";
import { a as CrestodianOverview, i as CrestodianOperation, n as CrestodianToolOptions, r as CrestodianCommandDeps, t as CrestodianToolDirective } from "./crestodian-tool-LuFL-64B.js";
import { r as AnyAgentTool$2 } from "./common-CZ-od2BP.js";
import { Dt as PluginHookToolKind, Et as PluginHookToolInputKind, Gt as PluginNextTurnInjectionEnqueueResult, J as PluginHookHandlerMap, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolContext, Wt as PluginNextTurnInjection, _n as ReplyDispatchKind, an as PluginHookBeforeToolCallResult, bn as ReplyFollowupAdmissionBarrierTimeoutPolicy, gn as ReplyDispatchBeforeDeliver, ln as PluginHookBeforeAgentStartResult, nt as PluginHookRegistration$1, qt as PluginJsonValue, rn as PluginApprovalResolution, tt as PluginHookName, vn as ReplyDispatchRuntimeInfo, yn as ReplyDispatcher } from "./hook-types-07I6fmma.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-c5mRZYEt.js";
import { a as PluginConversationBindingResolvedEvent$1, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-C6RdJrWx.js";
import { a as SkillUsagePath, i as SkillTelemetrySource, r as SkillSnapshot, t as SkillCommandSpec } from "./types-DKGs3QG0.js";
import { i as ExecAutoReviewer } from "./exec-auto-review-CYFxs7ho.js";
import { g as SandboxFsBridge, i as SandboxToolPolicy, l as SandboxBackendExecSpec, m as SandboxBackendWorkdirValidator, p as SandboxBackendWorkdirValidation } from "./types-34KlOMUq.js";
import { n as FailoverReason, t as EmbeddedContextFile } from "./types-CF0DHR3y.js";
import { t as FallbackAttempt } from "./model-fallback.types-BQxBBoz4.js";
import { n as NormalizedUsage, t as ContextUsage } from "./usage-DjdNXvuF.js";
...
import { M as InternalHookHandler, N as WorkspaceBootstrapFile, P as ensureAgentWorkspace } from "./internal-hooks-CPw2awU0.js";
import { i as ModelCatalogEntry, n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-BMN5J5xk.js";
import { Ai as AuthStorage, Ci as ModelRegistry$1, Dr as ToolDefinition } from "./index-CXBdoXSP.js";
import { n as createSubsystemLogger, s as LogLevel } from "./subsystem-CfQVin8T.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-T4TLMyOa.js";
import { o as resolveStorePath, r as resolveSessionFilePath } from "./session-key-BKCtti5j.js";
import { m as onSessionTranscriptUpdate } from "./transcript-l0v6jqqh.js";
import { n as SilentReplyPromptMode, t as PromptMode } from "./system-prompt.types-DK8-zL3a.js";
import { a as CronJobCreate, c as CronRunStatus, i as CronJob, l as EmbeddedAgentExecutionPhase, o as CronJobPatch, s as CronPayload } from "./store-C6oU5Db4.js";
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-BRTGPzO7.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-nnYPy-eQ.js";
import { o as enqueueSystemEvent } from "./system-events-BLt5iC5_.js";
import { a as runCommandWithTimeout } from "./exec-2Em92hsX.js";
import { s as mediaKindFromMime } from "./constants-DUpDbaN0.js";
import { h as resizeToJpeg, u as getImageMetadata } from "./media-services-BqLZh0ST.js";
import { n as loadWebMedia } from "./web-media-D1aVPCGn.js";
import { n as detectMime } from "./mime-B6baDqNM.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, g as isVoiceCompatibleAudio, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-DXPnCJql.js";
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-DTbLcOj0.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-BOoT2wvR.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-Cq2SJ1Dh.js";
import { n as RuntimeWebFetchMetadata, r as RuntimeWebSearchMetadata } from "./command-secret-gateway-BwsA8umK.js";
import { a as shouldLogVerbose } from "./globals-BL1_NohW.js";
import { t as HookEntry } from "./types-BCpQVPCb.js";
import { a as MediaUnderstandingRuntime } from "./runtime-types-DPx1Rq29.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-CNlzow9l.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-BolvyUuJ.js";
import { n as TimeFormatPreference } from "./date-time-C_aF3jiN.js";
import { n as MemoryMultimodalSettings, t as MemoryMultimodalModality } from "./multimodal-B2zGqeG7.js";
...
import { St as DiagnosticToolTerminalReason, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput, rn as TalkTransport } from "./diagnostic-events-DZL5WAth.js";
import { a as PluginActivationSource } from "./config-state-wJTeQ2cZ.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-CRmlOiro.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-GBnlxbYf.js";
import { s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-CDlOcmN4.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-XyhNJ-iS.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-1YAdKTBx.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { t as hasControlCommand } from "./command-detection-DdxAWsxZ.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-CBi9HFm7.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-CLjicWXV.js";
import { t as buildPairingReply } from "./pairing-messages-B7Di9N62.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-CxQYP8YQ.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-CJNpopl3.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-ioR-uUD8.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-MW9x0Hk2.js";
import { a as PairLoopGuardResult, i as PairLoopGuardConfig } from "./pair-loop-guard-runtime-D5O3zwX9.js";
import { n as createChannelHistoryWindow, t as ChannelHistoryWindow } from "./history-window-BSd8jX-m.js";
import { Br as ConnectParams, Xi as RequestFrame, gi as ErrorShape } from "./schema-DtyqV_v0.js";
import { t as CliDeps } from "./deps.types-BdV6g6qp.js";
import { t as HeartbeatSummary } from "./heartbeat-summary-BdtzV9DM.js";
import { o as TranscriptSourceProvider$2 } from "./provider-types-DFLfNVDW.js";
...
type ReplyBackendQueueMessageOptions = {
  ...
  sourceReplyDeliveryMode?: SourceReplyDeliveryMode; /** Prepared channel turn to merge only at transcript persistence. */
...
declare function prepareProviderRuntimeAuth$1(params: {
  provider: string;
  config?: OpenClawConfig;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
...
declare function formatProviderAuthProfileApiKeyWithPlugin$1(params: {
  provider: string;
  config?: OpenClawConfig;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
...
declare function refreshProviderOAuthCredentialWithPlugin$1(params: {
  provider: string;
  config?: OpenClawConfig;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
...
declare function buildProviderAuthDoctorHintWithPlugin$1(params: {
  provider: string;
  config?: OpenClawConfig;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
...
declare function buildProviderMissingAuthMessageWithPlugin$1(params: {
  provider: string;
  config?: OpenClawConfig;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
...
declare function augmentModelCatalogWithProviderPlugins$1(params: {
  config?: OpenClawConfig;
  workspaceDir?: string;
  env?: NodeJS.ProcessEnv;
...
declare function formatAuthDoctorHint(params: FormatAuthDoctorHintParams): Promise<string>;
//#endregion
...
declare function applySecretRefHeaderSentinels<T extends Model>(model: T, cfg: OpenClawConfig | undefined): T;
/**
...
type RunEmbeddedAgentParams = {
  ...
  crestodianTool?: CrestodianToolOptions; /** Seen bootstrap truncation warning signatures for this session (once mode dedupe). */
...
type PluginWebFetchProviderEntry = WebFetchProviderPlugin$1 & {
  pluginId: string;
};
//#endregion
...
type OpenClawPluginToolFactory$1 = (ctx: OpenClawPluginToolContext) => AnyAgentTool$2 | AnyAgentTool$2[] | null | undefined;
...
declare class ContextEngineRuntimeSettingsUnavailableError extends Error {
  readonly code = "context_engine_runtime_settings_unavailable";
  constructor(message?: string);
}
declare class ContextEngineRuntimeSettingsUnsupportedError extends Error {
...
declare function isToolWrappedWithBeforeToolCallHook(tool: AnyAgentTool$2): boolean;
/** Toggle diagnostic event emission on an existing before_tool_call wrapper. */
declare function setBeforeToolCallDiagnosticsEnabled(tool: AnyAgentTool$2, enabled: boolean): void;
//#endregion
...
type HookContext = {
  ...
  channelId?: string; /** Originating channel for approval delivery routing; mirrors exec approval turn-source fields. */
...
declare function finalizeToolTerminalPresentation(params: {
  toolCallId: string;
  runId?: string;
  result: Awaited<ReturnType<AnyAgentTool$2["execute"]>>;
  isError: boolean;
...
declare function wrapToolWithBeforeToolCallHook(tool: AnyAgentTool$2, ctx?: HookContext, options?: {
...
type CrestodianAgentTurnDirective = CrestodianToolDirective;
...
type WizardPrompterLike = WizardPrompter;
...
type InternalReplySessionOptions = {
  ...
  sessionPromptSourceReplyDeliveryMode?: GetReplyOptions["sourceReplyDeliveryMode"]; /** Marks queued follow-up admission waits on an older owner's delivery barrier. */
  onFollowupAdmissionWaitChange?: (waiting: boolean) => void;
};
type InternalGetReplyOptions = GetReplyOptions & InternalReplySessionOptions & ReplyOptionsWithHeartbeatRunScope;
...
type ChannelPlugin$1 = ChannelPlugin$2;
...
type OpenClawPluginCliCommandDescriptor$1 = OpenClawPluginCliCommandDescriptor;
...
type OpenClawPluginHttpRouteAuth$1 = OpenClawPluginHttpRouteAuth;
type OpenClawPluginHttpRouteHandler$1 = OpenClawPluginHttpRouteHandler;
type OpenClawPluginHttpRouteUpgradeHandler$1 = OpenClawPluginHttpRouteUpgradeHandler;
...
type PluginCliRegistration = {
  ...
  parentPath: string[];
  commands: string[];
  descriptors: OpenClawPluginCliCommandDescriptor$1[];
  source: string;
  rootDir?: string;
};
...
type PluginHttpRouteRegistration$1 = {
  ...
  handleUpgrade?: OpenClawPluginHttpRouteUpgradeHandler$1;
  auth: OpenClawPluginHttpRouteAuth$1;
...
type ChannelPlugin = ChannelPlugin$2;
...
type ProviderPlugin = {
   ...
   */
  normalizeToolSchemas?: (ctx: ProviderNormalizeToolSchemasContext) => AnyAgentTool$2[] | null | undefined;
  /**
...
type OpenClawPluginApi = {
  ...
  registerTool: (tool: AnyAgentTool$2 | OpenClawPluginToolFactory$1, opts?: OpenClawPluginToolOptions) => void;
...
//#endregion
export { OpenClawPluginService as $, AgentCommandIngressOpts as $a, ContextEngineRuntimeSettings as $c, markAuthProfileCooldown as $d, MessagingToolSend as $f, CommandContext as $i, SpeechSynthesisStreamResult as $l, ProviderApplyConfigDefaultsContext as $n, consumePreExecutionBlockedToolCall as $o, SubagentRunParams as $r, buildEmbeddingBatchGroupOptions as $s, ProviderModelSelectedContext as $t, resolveFastModeState as $u, OpenClawPluginDefinition as A, AgentToolResultMiddlewareHarness as Aa, DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR as Ac, hasAvailableAuthForProvider as Ad, resolveProviderAuthAliasMap as Af, DispatchedChannelTurnResult as Ai, TaskRunDetail as Al, ProviderResolvePromptOverlayContext as An, AgentHarnessSupportContext as Ao, GatewayRequestContext as Ar, enforceEmbeddingMaxInputTokens as As, ProviderAuthOptionBag as At, WebFetchProviderContext as Au, OpenClawPluginModule as B, CliBackendExecutionMode as Ba, BootstrapResult as Bc, MissingProviderAuthError as Bd, ProviderThinkingPolicyContext as Bf, resolveEnvelopeFormatOptions as Bi, SpeechListVoicesRequest as Bl, ProviderTransportThinkingLevel as Bn, DeferredPluginToolApproval as Bo, PluginNodeCapabilitySurface as Br, parseEmbedding as Bs, ProviderCatalogResult as Bt, WebSearchProviderToolDefinition as Bu, OpenClawPluginApi as C, CodexAppServerExtensionFactory as Ca, HEARTBEAT_PROMPT as Cc, applyAuthHeaderOverride as Cd, refreshProviderOAuthCredentialWithPlugin as Cf, AssembledChannelTurn as Ci, DetachedTaskFinalizeParams as Cl, ProviderReplaySanitizeMode as Cn, AgentHarnessCompactResult as Co, RealtimeTranscriptionProviderConfig as Cr, resolveRemoteEmbeddingBearerClient as Cs, PluginTranscriptsSourceProviderEntry as Ct, emitAgentEvent as Cu, OpenClawPluginCliRegistrar as D, AgentToolResultMiddleware as Da, ResolvedMemorySearchSyncConfig as Dc, createRuntimeProviderAuthLookup as Dd, resolveAuthProfileOrder as Df, ChannelTurnResult as Di, TaskFlowView as Dl, ProviderResolveAuthProfileIdContext as Dn, AgentHarnessSideQuestionParams as Do, RealtimeTranscriptionSession as Dr, isMissingEmbeddingApiKeyError as Ds, ProviderAuthKind as Dt, PluginWebFetchProviderEntry as Du, OpenClawPluginCliContext as E, CodexAppServerToolResultHandlerResult as Ea, ResolvedMemorySearchConfig as Ec, canUseProfileAsProviderEntryApiKey as Ed, resolveAuthProfileEligibility as Ef, ChannelTurnRecordOptions as Ei, TaskFlowDetail as El, ProviderReplayToolCallIdMode as En, AgentHarnessResultClassification as Eo, RealtimeTranscriptionProviderResolveConfigContext as Er, sanitizeAndNormalizeEmbedding as Es, ProviderAuthDoctorHintContext as Et, rotateAgentEventLifecycleGeneration as Eu, OpenClawPluginHttpRouteHandler as F, CrestodianAssistantPlanner as Fa, ContextEngineFactoryContext as Fc, resolveModelAuthMode as Fd, hasUsableOAuthCredential as Ff, recordChannelBotPairLoopAndCheckSuppression as Fi, resolveEffectiveTtsConfig as Fl, ProviderRuntimeProviderConfig as Fn, isReplaySafeToolCall as Fo, RespondFn as Fr, chunkMarkdown as Fs, ProviderBuiltInModelSuppressionResult as Ft, WebSearchCredentialResolutionSource as Fu, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, CliBackendPreparedExecution as Ga, ContextEngineInfo as Gc, isProviderAuthError as Gd, ProviderExternalAuthProfile as Gf, ReplyDispatcherOptions as Gi, SpeechProviderOverrides as Gl, ProviderWrapStreamFnContext as Gn, getBeforeToolCallPolicyDiagnosticState as Go, RestartRecoveryCandidate as Gr, BatchHttpClientConfig as Gs, ProviderDiscoveryOrder as Gt, GenerateVideoRuntimeResult as Gu, OpenClawPluginNodeHostCommand as H, CliBackendNormalizeConfigContext as Ha, ContextEngine as Hc, ResolvedProviderAuth as Hd, ProviderRuntimeModel as Hf, settleReplyDispatcher as Hi, SpeechProviderConfig as Hl, ProviderUsageAuthToken as Hn, ToolOutcomeObserver as Ho, mintPluginNodeCapabilityToken as Hr, runWithConcurrency as Hs, ProviderCreateStreamFnContext as Ht, WebSearchRuntimeMetadataContext as Hu, OpenClawPluginHttpRouteMatch as I, buildBootstrapContextForFiles as Ia, registerContextEngine as Ic, resolveProviderEntryApiKeyBinding as Id, CLAUDE_CLI_PROFILE_ID as If, EnvelopeFormatOptions as Ii, TTS_AUTO_MODES as Il, ProviderSanitizeReplayHistoryContext as In, AgentRuntimePlan as Io, NodeSession as Ir, cosineSimilarity as Is, ProviderCacheTtlEligibilityContext as It, WebSearchProviderContext as Iu, OpenClawPluginNodeInvokeTransportResult as J, CliBackendSideQuestionToolMode as Ja, ContextEngineProjection as Jc, EnvApiKeyResult as Jd, ProviderResolveExternalOAuthProfilesContext as Jf, createReplyDispatcherWithTyping as Ji, SpeechProviderResolveConfigContext as Jl, SpeechProviderPlugin as Jn, runBeforeToolCallHook as Jo, PluginHttpRouteRegistration as Jr, BatchCompletionResult as Js, ProviderExtraParamsForTransportResult as Jt, resolveAgentTimeoutMs as Ju, OpenClawPluginNodeInvokePolicyContext as K, CliBackendResolveExecutionArgs as Ka, ContextEngineMaintenanceResult as Kc, requireApiKey as Kd, ProviderExternalOAuthProfile as Kf, ReplyDispatcherWithTypingOptions as Ki, SpeechProviderPrepareSynthesisContext as Kl, RealtimeTranscriptionProviderPlugin as Kn, hasBeforeToolCallPolicy as Ko, ChatRunEntry as Kr, buildBatchHeaders as Ks, ProviderDiscoveryResult as Kt, GenerateImageParams as Ku, OpenClawPluginHttpRouteParams as L, resolveBootstrapContextForRun as La, resolveContextEngine as Lc, resolveProviderEntryApiKeyProfileReference as Ld, CODEX_CLI_PROFILE_ID as Lf, formatAgentEnvelope as Li, normalizeTtsAutoMode as Ll, ProviderSystemPromptContributionContext as Ln, BuildAgentRuntimePlanParams as Lo, DEFAULT_PLUGIN_NODE_CAPABILITY_TTL_MS as Lr, ensureDir as Ls, ProviderCapabilities as Lt, WebSearchProviderId as Lu, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentToolResultMiddlewareResult as Ma, appendCronStyleCurrentTimeLine as Mc, hasSyntheticLocalProviderAuthConfig as Md, AuthCredentialReasonCode as Mf, PreparedChannelTurn as Mi, ResolvedTtsConfig as Ml, ProviderResolveUsageAuthContext as Mn, EmbeddedRunAttemptParams as Mo, GatewayRequestHandlerOptions as Mr, MemoryFileEntry as Ms, ProviderBuildMissingAuthMessageContext as Mt, WebFetchProviderPlugin$1 as Mu, OpenClawPluginHostedMediaResolver as N, AgentToolResultMiddlewareRuntime as Na, resolveCronStyleNow as Nc, hasUsableCustomProviderApiKey as Nd, DEFAULT_OAUTH_REFRESH_MARGIN_MS as Nf, RunChannelTurnParams as Ni, ResolvedTtsModelOverrides as Nl, ProviderResolveWebSocketSessionPolicyContext as Nn, EmbeddedRunAttemptResult as No, GatewayRequestHandlers as Nr, buildFileEntry as Ns, ProviderBuildUnknownModelHintContext as Nt, WebFetchProviderToolDefinition as Nu, OpenClawPluginCommandDefinition as O, AgentToolResultMiddlewareContext as Oa, resolveMemorySearchConfig as Oc, getApiKeyForModel as Od, ProviderAuthAliasLookupParams as Of, CommandFacts as Oi, TaskRunAggregateSummary as Ol, ProviderResolveDynamicModelContext as On, AgentHarnessSideQuestionResult as Oo, RealtimeTranscriptionSessionCallbacks as Or, mapBatchEmbeddingsByIndex as Os, ProviderAuthMethod as Ot, PluginWebSearchProviderEntry as Ou, OpenClawPluginHttpRouteAuth as P, OpenClawAgentToolResult as Pa, ContextEngineFactory as Pc, resolveApiKeyForProvider as Pd, TokenExpiryState as Pf, ChannelBotLoopProtectionFacts as Pi, TtsConfigResolutionContext as Pl, ProviderResolvedUsageAuth as Pn, PreemptiveCompactionRoute as Po, GatewayRequestOptions as Pr, buildMultimodalChunkForIndexing as Ps, ProviderBuiltInModelSuppressionContext as Pt, WebFetchRuntimeMetadataContext as Pu, OpenClawPluginSecurityAuditContext as Q, PluginTextTransforms as Qa, ContextEngineRuntimeReasonCode as Qc, markAuthProfileBlockedUntil as Qd, EmbeddedAgentRunMeta as Qf, CommandSessionMetadataChange as Qi, SpeechSynthesisStreamRequest as Ql, VideoGenerationProviderPlugin as Qn, consumeAdjustedParamsForToolCall as Qo, PluginRuntime as Qr, EmbeddingBatchExecutionParams as Qs, ProviderFollowupFallbackRouteResult as Qt, AgentInternalEvent as Qu, OpenClawPluginHttpRouteUpgradeHandler as R, resolveBootstrapFilesForRun as Ra, resolveContextEngineOwnerPluginId as Rc, resolveUsableCustomProviderApiKey as Rd, augmentModelCatalogWithProviderPlugins$1 as Rf, formatInboundEnvelope as Ri, SpeechDirectiveTokenParseContext as Rl, ProviderToolSchemaDiagnostic as Rn, BeforeToolCallFailureDisposition as Ro, NormalizedPluginNodeCapabilityUrl as Rr, listMemoryFiles as Rs, ProviderCatalogContext as Rt, WebSearchProviderPlugin$1 as Ru, OpenClawPluginAgentEventsApi as S, CodexAppServerExtensionContext as Sa, DEFAULT_HEARTBEAT_ACK_MAX_CHARS as Sc, RuntimeProviderAuthLookup as Sd, prepareProviderRuntimeAuth as Sf, AccessFacts as Si, PluginRuntimeTasks as Sl, ProviderReplayPolicyContext as Sn, AgentHarnessCompactParams as So, RealtimeVoiceToolResultOptions as Sr, RemoteEmbeddingProviderId as Ss, PluginTextTransformRegistration as St, AgentEventPayload as Su, OpenClawPluginCliCommandDescriptor as T, CodexAppServerToolResultEvent as Ta, stripHeartbeatToken as Tc, applySecretRefHeaderSentinels as Td, AuthProfileEligibilityReasonCode as Tf, ChannelTurnDroppedHistoryOptions as Ti, DetachedTaskTerminalState as Tl, ProviderReplaySessionState as Tn, AgentHarnessResetParams as To, RealtimeTranscriptionProviderId as Tr, debugEmbeddingsLog as Ts, ProviderAuthContext as Tt, resetAgentEventsForTest as Tu, OpenClawPluginNodeInvokeApprovalDecision as U, CliBackendPlugin$1 as Ua, ContextEngineHostCapability as Uc, formatMissingAuthError as Ud, ProviderRuntimePluginHandle as Uf, DispatchReplyWithBufferedBlockDispatcher$1 as Ui, SpeechProviderConfiguredContext as Ul, ProviderValidateReplayTurnsContext as Un, finalizeToolTerminalPresentation as Uo, normalizePluginNodeCapabilityScopedUrl as Ur, hashText as Us, ProviderDeferSyntheticProfileAuthContext as Ut, SecretInputMode as Uu, OpenClawPluginNodeCliFeatureOptions as V, CliBackendNativeToolMode as Va, CompactResult as Vc, ProviderAuthError as Vd, ProviderThinkingProfile as Vf, finalizeInboundContext as Vi, SpeechModelOverridePolicy as Vl, ProviderTransportTurnState as Vn, HookContext as Vo, buildPluginNodeCapabilityScopedHostUrl as Vr, remapChunkLines as Vs, ProviderCreateEmbeddingProviderContext as Vt, WebSearchProviderToolExecutionContext as Vu, OpenClawPluginNodeInvokePolicy as W, CliBackendPrepareExecutionContext as Wa, ContextEngineHostRequirements as Wc, isMissingProviderAuthError as Wd, ProviderSystemPromptContribution as Wf, DispatchReplyWithDispatcher as Wi, SpeechProviderId as Wl, ProviderWebSocketSessionPolicy as Wn, getBeforeToolCallFailureDisposition as Wo, ChatAbortControllerEntry as Wr, uploadBatchJsonlFile as Ws, ProviderDiscoveryContext as Wt, GenerateVideoParams as Wu, OpenClawPluginRunContextApi as X, CliBundleMcpMode as Xa, ContextEngineRuntimeContext as Xc, calculateAuthProfileCooldownMs as Xd, ProviderSyntheticAuthResult as Xf, InternalGetReplyFromConfig as Xi, SpeechProviderResolveTalkOverridesContext as Xl, UnifiedModelCatalogProviderContext as Xn, isToolWrappedWithBeforeToolCallHook as Xo, PluginRegistryParams as Xr, resolveCompletedBatchResult as Xs, ProviderFetchUsageSnapshotContext as Xt, EmbeddedRunTrigger as Xu, OpenClawPluginReloadRegistration as Y, CliBackendThinkingLevel as Ya, ContextEnginePromptCacheInfo as Yc, resolveEnvApiKey as Yd, ProviderResolveSyntheticAuthContext as Yf, DispatchFromConfigResult as Yi, SpeechProviderResolveTalkConfigContext as Yl, TranscriptSourceProvider as Yn, wrapToolWithBeforeToolCallHook as Yo, PluginRegistry as Yr, resolveBatchCompletionFromStatus as Ys, ProviderFailoverErrorContext as Yt, CurrentInboundPromptContext as Yu, OpenClawPluginSecurityAuditCollector as Z, PluginTextReplacement as Za, ContextEngineRuntimeMode as Zc, clearAuthProfileCooldown as Zd, EmbeddedAgentCompactResult as Zf, InternalGetReplyOptions as Zi, SpeechSynthesisRequest as Zl, UnifiedModelCatalogProviderPlugin as Zn, setBeforeToolCallDiagnosticsEnabled as Zo, CreatePluginRuntimeOptions as Zr, throwIfBatchTerminalFailure as Zs, ProviderFollowupFallbackRouteContext as Zt, RunEmbeddedAgentParams as Zu, MigrationSummary as _, PluginSessionTurnScheduleParams as _a, listMemoryEmbeddingProviders as _c, prepareSimpleCompletionModelForAgent as _d, formatAuthDoctorHint as _f, buildChannelInboundEventContext as _i, RuntimeLogger as _l, ProviderPrepareRuntimeAuthContext as _n, resolveWebSearchToolPolicy as _o, RealtimeVoiceProviderId as _r, estimateUtf8Bytes as _s, PluginRealtimeVoiceProviderEntry as _t, ChannelIngressQueueEnqueueResult as _u, ImageGenerationProviderPlugin as a, PluginRunContextGetParams as aa, extractBatchErrorMessage as ac, formatFastModeStatusValue as ad, isProfileInCooldown as af, resolveChannelTurnDispatchCounts as ai, IngestResult as al, ProviderNormalizeToolSchemasContext as an, EmbeddedAgentQueueMessageOutcome as ao, RealtimeVoiceAudioFormat as ar, MemoryEmbeddingProviderAdapter as as, PluginCommandContext as at, ResolvedProviderRuntimeAuth as au, OpenClawGatewayDiscoveryService as b, PluginToolMetadataRegistration as ba, withProgress as bc, ProviderCredentialPrecedence as bd, buildProviderMissingAuthMessageWithPlugin as bf, finalizeChannelInboundContext as bi, PluginRuntimeTaskFlows as bl, ProviderReasoningOutputModeContext as bn, AgentHarnessAttemptParams as bo, RealtimeVoiceTool as br, createRemoteEmbeddingProvider as bs, PluginSetupAutoEnableProbe as bt, ChannelIngressQueueRecord as bu, MigrationDetection as c, PluginSessionActionContext as ca, DEFAULT_LOCAL_MODEL as cc, EmbeddedBlockChunker as cd, markAuthProfileSuccess as cf, DurableInboundReplyDeliveryResult as ci, TranscriptRewriteReplacement as cl, ProviderPlugin as cn, clearActiveEmbeddedRun as co, RealtimeVoiceBridgeCallbacks as cr, MemoryEmbeddingProviderCreateResult as cs, PluginCommandResult as ct, OpenClawPluginToolContext as cu, MigrationItemKind as d, PluginSessionAttachmentParams as da, isFileMissingError as dc, AgentSimpleCompletionSelection as dd, upsertAuthProfile as df, BuildChannelInboundEventContextParams as di, LlmCompleteCaller as dl, ProviderPluginWizard as dn, EmbeddedAgentQueueMessageOptions as do, RealtimeVoiceBrowserSession as dr, clearMemoryEmbeddingProviders as ds, PluginEmbeddingProvider as dt, TaskRecord as du, CommandHandler as ea, runEmbeddingBatchGroups as ec, FastModeAutoProgressState as ed, markAuthProfileFailure as ef, SubagentRunResult as ei, ContextEngineRuntimeSettingsUnavailableError as el, ProviderModernModelPolicyContext as en, AgentCommandOpts as eo, MessagingToolSourceReplyPayload as ep, ProviderNormalizeConfigContext as er, AgentHarnessTaskRuntimeScope as es, OpenClawPluginServiceContext as et, SpeechSynthesisTarget as eu, MigrationItemStatus as f, PluginSessionAttachmentResult as fa, splitShellArgs as fc, PreparedSimpleCompletionModel as fd, upsertAuthProfileWithLock as ff, BuiltChannelInboundEventContext as fi, LlmCompleteMessage as fl, ProviderPluginWizardModelPicker as fn, getActiveEmbeddedRunCount as fo, RealtimeVoiceBrowserSessionCreateRequest as fr, listRegisteredMemoryEmbeddingProviders as fs, PluginInteractiveHandlerRegistration as ft, TaskStatus as fu, MigrationProviderPreparation as g, PluginSessionSchedulerJobRegistration as ga, getMemoryEmbeddingProvider as gc, prepareSimpleCompletionModel as gd, resolveApiKeyForProfile as gf, FinalizeChannelInboundContextResult as gi, PluginRuntimeCore as gl, ProviderPrepareExtraParamsContext as gn, runEmbeddedAgent as go, RealtimeVoiceProviderConfiguredContext as gr, estimateStructuredEmbeddingInputBytes as gs, PluginRealtimeTranscriptionProviderEntry as gt, ChannelIngressQueueCompletedRecord as gu, MigrationProviderPlugin as h, PluginSessionSchedulerJobHandle as ha, emptyPluginConfigSchema as hc, completeWithPreparedSimpleCompletionModel as hd, refreshOAuthCredentialForRuntime as hf, FinalizeChannelInboundContextParams as hi, LlmCompleteUsage as hl, ProviderPrepareDynamicModelContext as hn, resolveActiveEmbeddedRunSessionId as ho, RealtimeVoiceProviderConfig as hr, withRemoteHttpResponse as hs, PluginLogger as ht, ChannelIngressQueueClaimRef as hu, AgentPromptSurfaceKind as i, PluginControlUiDescriptor as ia, postJsonWithRetry as ic, formatFastModeSourceSuffix as id, getSoonestCooldownExpiry as if, hasVisibleChannelTurnDispatch as ii, IngestBatchResult as il, ProviderNormalizeResolvedModelContext as in, AbortAndDrainEmbeddedAgentRunResult as io, RealtimeVoiceAudioClearReason as ir, MemoryEmbeddingProvider as is, OpenClawPluginSessionWorkflowApi as it, TtsDirectiveParseResult as iu, OpenClawPluginGatewayMethod as j, AgentToolResultMiddlewareOptions as ja, CronStyleNow as jc, hasRuntimeAvailableProviderAuth as jd, resolveProviderIdForAuth as jf, InboundMediaFacts as ji, TaskRunView as jl, ProviderResolveTransportTurnStateContext as jn, CompactEmbeddedAgentSessionParams as jo, GatewayRequestHandler as jr, MemoryChunk as js, ProviderAuthResult as jt, WebFetchProviderId as ju, OpenClawPluginConfigSchema as k, AgentToolResultMiddlewareEvent as ka, resolveMemorySearchSyncConfig as kc, getCustomProviderApiKey as kd, resetProviderAuthAliasMapCacheForTest as kf, ConversationFacts as ki, TaskRunCancelResult as kl, ProviderResolveNonInteractiveApiKeyParams as kn, AgentHarnessSupport as ko, RealtimeTranscriptionSessionCreateRequest as kr, sanitizeEmbeddingCacheHeaders as ks, ProviderAuthMethodNonInteractiveContext as kt, WebFetchCredentialResolutionSource as ku, MigrationItem as l, PluginSessionActionRegistration as la, EmbeddingInput as lc, BootstrapContextRunKind as ld, removeProviderAuthProfilesWithLock as lf, deliverInboundReplyWithMessageSendContext as li, TranscriptRewriteRequest as ll, ProviderPluginCatalog as ln, setActiveEmbeddedRun as lo, RealtimeVoiceBridgeCreateRequest as lr, MemoryEmbeddingProviderIndexIdentity as ls, PluginConfigMigration as lt, OpenClawPluginToolFactory$1 as lu, MigrationProviderContext as m, PluginSessionExtensionRegistration as ma, buildPluginConfigSchema as mc, SimpleCompletionModelOptions as md, listProfilesForProvider as mf, FinalizeChannelInboundContextAsyncParams as mi, LlmCompleteResult as ml, ProviderPreferRuntimeResolvedModelContext as mn, listActiveEmbeddedRunSessionKeys as mo, RealtimeVoiceProviderCapabilities as mr, buildRemoteBaseUrlPolicy as ms, PluginInteractiveRegistration as mt, ChannelIngressQueueClaim as mu, AgentPromptGuidance as n, PluginAgentEventEmitResult as na, ProviderBatchOutputLine as nc, formatFastModeCommandOptions as nd, resolveProfilesUnavailableReason as nf, recordDroppedChannelInboundHistory as ni, ContextEngineSelectionSource as nl, ProviderNonInteractiveApiKeyResult as nn, splitSdkTools as no, HeartbeatToolResponse as np, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as nr, MemoryEmbeddingBatchChunk as ns, OpenClawPluginSessionControlsApi as nt, SpeechVoiceOption as nu, MediaUnderstandingProviderPlugin as o, PluginRunContextPatch as oa, formatUnavailableBatchError as oc, resolveFastModeForElapsed as od, repairOAuthProfileIdMismatch as of, DurableInboundReplyDeliveryOptions as oi, SubagentEndReason as ol, ProviderNormalizeTransportContext as on, abortAndDrainEmbeddedAgentRun as oo, RealtimeVoiceBargeInOptions as or, MemoryEmbeddingProviderCallOptions as os, PluginCommandDiagnosticsSession as ot, OpenClawPluginActiveModelContext as ou, MigrationPlan as p, PluginSessionExtensionProjection as pa, buildJsonPluginConfigSchema as pc, PreparedSimpleCompletionModelForAgent as pd, dedupeProfileIds as pf, ChannelInboundSupplementalResolutionOptions as pi, LlmCompleteParams as pl, ProviderPluginWizardSetup as pn, listActiveEmbeddedRunSessionIds as po, RealtimeVoiceCloseReason as pr, registerMemoryEmbeddingProvider as ps, PluginInteractiveHandlerResult as pt, ChannelIngressQueue as pu, OpenClawPluginNodeInvokePolicyResult as q, CliBackendResolveExecutionArgsContext as qa, ContextEngineOperation as qc, resolveAwsSdkEnvVarName as qd, ProviderResolveExternalAuthProfilesContext as qf, createReplyDispatcher as qi, SpeechProviderPreparedSynthesis as ql, RealtimeVoiceProviderPlugin as qn, requestDeferredPluginToolApproval as qo, ChatRunState as qr, normalizeBatchBaseUrl as qs, ProviderExtraParamsForTransportContext as qt, GenerateImageRuntimeResult as qu, AgentPromptGuidanceEntry as r, PluginAgentEventSubscriptionRegistration as ra, applyEmbeddingBatchOutputLine as rc, formatFastModeCurrentStatus as rd, clearExpiredCooldowns as rf, hasFinalChannelTurnDispatch as ri, ContextEngineSessionTarget as rl, ProviderNormalizeModelIdContext as rn, ProcessToolDefaults as ro, normalizeHeartbeatToolResponse as rp, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as rr, MemoryEmbeddingBatchOptions as rs, OpenClawPluginSessionStateApi as rt, TtsDirectiveOverrides as ru, MigrationApplyResult as s, PluginRuntimeLifecycleRegistration as sa, createLocalEmbeddingProvider as sc, BlockReplyChunking as sd, suggestOAuthProfileIdForLegacyDefault as sf, DurableInboundReplyDeliveryParams as si, SubagentSpawnPreparation as sl, ProviderOAuthProfileIdRepair as sn, abortEmbeddedAgentRun as so, RealtimeVoiceBridge as sr, MemoryEmbeddingProviderCreateOptions as ss, PluginCommandHandler as st, OpenClawPluginHookOptions as su, AGENT_PROMPT_SURFACE_KINDS as t, PluginAgentEventEmitParams as ta, EMBEDDING_BATCH_ENDPOINT as tc, formatFastModeAutoProgressText as td, resolveProfileUnusableUntilForDisplay as tf, kernel_d_exports as ti, ContextEngineRuntimeSettingsUnsupportedError as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, AgentCommandResultMetaOverrides as to, HEARTBEAT_RESPONSE_TOOL_NAME as tp, ProviderResolveConfigApiKeyContext as tr, resolveEmbeddedAgentRuntime as ts, OpenClawPluginSessionApi as tt, SpeechTelephonySynthesisRequest as tu, MigrationItemAction as u, PluginSessionActionResult as ua, hasNonTextEmbeddingParts as uc, ExecToolDefaults as ud, setAuthProfileOrder as uf, BuildChannelInboundEventContextAsyncParams as ui, TranscriptRewriteResult as ul, ProviderPluginDiscovery as un, waitForActiveEmbeddedRuns as uo, RealtimeVoiceBridgeEvent as ur, MemoryEmbeddingProviderRuntime as us, PluginConfigValidation as ut, OpenClawPluginToolOptions as uu, MusicGenerationProviderPlugin as v, PluginSessionTurnUnscheduleByTagParams as va, listRegisteredMemoryEmbeddingProviderAdapters as vc, resolveSimpleCompletionSelectionForAgent as vd, augmentModelCatalogWithProviderPlugins as vf, filterChannelInboundQuoteContext as vi, BoundTaskFlowsRuntime as vl, ProviderPreparedRuntimeAuth as vn, QueuedChatTurnMap as vo, RealtimeVoiceProviderResolveConfigContext as vr, fetchRemoteEmbeddingVectors as vs, PluginRegistrationMode as vt, ChannelIngressQueueFailedRecord as vu, OpenClawPluginChannelRegistration as w, CodexAppServerExtensionRuntime as wa, resolveHeartbeatPrompt as wc, applyLocalNoAuthHeaderOverride as wd, resolveAuthProfileDisplayLabel as wf, ChannelTurnAdmission as wi, DetachedTaskLifecycleRuntime as wl, ProviderReplaySessionEntry as wn, AgentHarnessDeliveryDefaults as wo, RealtimeTranscriptionProviderConfiguredContext as wr, normalizeEmbeddingModelWithPrefixes as ws, ProviderAugmentModelCatalogContext as wt, onAgentEvent as wu, OpenClawPluginAgentApi as x, PluginTrustedToolPolicyRegistration as xa, withProgressTotals as xc, ProviderEntryApiKeyBindingResolution as xd, formatProviderAuthProfileApiKeyWithPlugin as xf, resolveChannelInboundSupplementalContext as xi, PluginRuntimeTaskRuns as xl, ProviderReplayPolicy as xn, AgentHarnessAttemptResult as xo, RealtimeVoiceToolCallEvent as xr, resolveRemoteEmbeddingClient as xs, PluginSpeechProviderEntry as xt, AgentApprovalEventData as xu, OpenClawGatewayDiscoveryAdvertiseContext as y, PluginSessionTurnUnscheduleByTagResult as ya, parseNonNegativeByteSize as yc, ModelAuthMode as yd, buildProviderAuthDoctorHintWithPlugin as yf, filterChannelInboundSupplementalContext as yi, BoundTaskRunsRuntime as yl, ProviderReasoningOutputMode as yn, AgentHarness as yo, RealtimeVoiceRole as yr, RemoteEmbeddingClient as ys, PluginSetupAutoEnableContext as yt, ChannelIngressQueuePruneOptions as yu, OpenClawPluginLifecycleApi as z, CliBackendAuthEpochMode as za, AssembleResult as zc, shouldPreferExplicitConfigApiKeyAuth as zd, ProviderDefaultThinkingPolicyContext as zf, formatInboundFromLabel as zi, SpeechDirectiveTokenParseResult as zl, ProviderTransformSystemPromptContext as zn, BeforeToolCallPolicyDiagnosticState as zo, PLUGIN_NODE_CAPABILITY_PATH_PREFIX as zr, normalizeExtraMemoryPaths as zs, ProviderCatalogOrder as zt, WebSearchProviderSetupContext as zu };