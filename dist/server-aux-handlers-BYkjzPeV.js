...
import { r as resolveSecretRefValue } from "./resolve-C6EqbbNq.js";
...
import { n as getLoadedChannelPlugin } from "./registry-CWdFCyWd.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-Cgf2sDSU.js";
...
import { i as getActiveSecretsRuntimeEnv, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-O2vuhjLQ.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-Bh2IMLyf.js";
...
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-Den5wNfP.js";
...
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-DHi8nqXa.js";
...
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-BVTlE_tw.js";
...
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-CPCxPHT2.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-DT1PLEMb.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-1sWOsWy9.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder })), { cacheRejections: true });
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-y8INNacr.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
