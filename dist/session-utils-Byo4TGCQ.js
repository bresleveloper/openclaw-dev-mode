...
import { Cn as resolveAgentMainSessionKey, Gn as buildGroupDisplayName, Kc as resolveConfiguredModelRef, Kt as normalizeSessionDeliveryFields, Lc as inferUniqueProviderFromConfiguredModels, Oo as loadConfig, Ot as loadSessionStore, Sn as canonicalizeMainSessionAlias, Tn as resolveMainSessionKey, Uc as parseModelRef, bn as resolveFreshSessionTotalTokens, cs as isAvatarHttpUrl, cu as DEFAULT_MODEL, en as readSessionTitleFieldsFromTranscript, fs as isWorkspaceRelativeAvatarPath, kc as resolveOpenClawAgentDir, lu as DEFAULT_PROVIDER, ms as resolveAvatarMime, os as AVATAR_MAX_BYTES, qc as resolveDefaultModelForAgent, ss as isAvatarDataUrl, us as isPathWithinRoot } from "./auth-profiles-CIqoN6FN.js";
...
import { r as openBoundaryFileSync } from "./boundary-file-read-DM07oBuv.js";
import { c as resolveStorePath } from "./paths-B52CESY4.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CgYIAjpL.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-N8VeGFSt.js").then((n) => n.r);
