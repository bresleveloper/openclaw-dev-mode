...
import { t as SessionManager } from "./session-manager-BKz2VYho.js";
...
import { n as appendExactAssistantMessageToSessionTranscript } from "./transcript-B251TSj6.js";
import { i as buildGenericCliContextEngineHostSupport } from "./host-compat-BibWlia2.js";
import { a as finalizeHarnessContextEngineTurn, d as runAgentEndSideEffects, l as waitForDeferredTurnMaintenanceForSession, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance, u as awaitAgentEndSideEffects } from "./context-engine-lifecycle-Bygd-202.js";
...
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-BgsCJ8F9.js";
...
import { r as hashCliReseedPrompt } from "./cli-session-history-CC-Xq6rY.js";
import { i as loadCliSessionHistoryMessages, l as claudeCliSessionTranscriptHasContent, r as loadCliSessionContextEngineMessages, s as buildAgentHookConversationMessages } from "./session-history-DQwdqEjZ.js";
...
async function runCliAgentInternal(params) {
	...
	if (params.cleanupCliLiveSessionOnRunEnd === true) try {
		const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-0Ad4dPRW.js");
