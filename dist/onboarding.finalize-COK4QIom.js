...
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BJ-A8vSB.js";
import { f as restoreTerminalState } from "./subsystem-DEHxNIeh.js";
...
import { r as resolveCliName, t as formatCliCommand } from "./command-format-76HdMaIV.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-XgRedRg8.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-kh3ClclC.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DJQFBZpo.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DJQFBZpo.js");
