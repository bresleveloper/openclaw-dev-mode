...
import { As as resolveCommandResolutionFromArgv, Bs as unwrapKnownDispatchWrapperInvocation, Fr as createBrowserControlContext, Hs as POSIX_INLINE_COMMAND_FLAGS, Ir as startBrowserControlServiceFromConfig, Ms as POSIX_SHELL_WRAPPERS, Oo as loadConfig, Pr as createBrowserRouteDispatcher, Rs as normalizeExecutableToken, Ts as resolvePlannedSegmentArgv, Vs as unwrapKnownShellMultiplexerInvocation, Ws as resolveInlineCommandMatch, Yr as resolveBrowserConfig, _r as writeJsonAtomic, js as resolveExecutableFromPathEnv, or as GATEWAY_CLIENT_MODES, sr as GATEWAY_CLIENT_NAMES, xs as analyzeArgvCommand } from "./auth-profiles-CIqoN6FN.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { i as resolveAgentConfig } from "./agent-scope-BAb0j1gt.js";
import "./utils-DMInpDZe.js";
import { a as sameFileIdentity } from "./boundary-file-read-DM07oBuv.js";
import { i as logWarn } from "./logger-GQFppKMT.js";
import "./exec-DDBrWr4H.js";
import "./github-copilot-token-B_S63apr.js";
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-BD1bOZrq.js";
...
import { r as detectMime } from "./windows-spawn-D2jCT_tt.js";
...
import { n as getMachineDisplayName, t as withTimeout } from "./with-timeout-BkPFXDKx.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BFQyzfY0.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-JIvK4NYP.js";
import { dn as loadOrCreateDeviceIdentity, g as GatewayClient } from "./call-B28h9L2b.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as requestJsonlSocket } from "./exec-approvals-BZxwpxPb.js";
import { n as resolveSystemRunCommandRequest, o as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CPtKcdih.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./arg-split-Co_4JYiE.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-BW2kdKuY.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DhoIhEeS.js";
import "./runtime-guard-dTn-df9-.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D1tp6nTC.js";
import "./systemd-Bh02taAa.js";
import "./service-D6xYLXBx.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DExqFotU.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CpA8Fclk.js";
import { t as parsePort } from "./parse-port-Dek2RgtH.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-Tt47QIJk.js";
