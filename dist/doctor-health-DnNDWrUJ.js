...
async function doctorCommand(runtime, options = {}) {
	...
	const { loadAndMaybeMigrateDoctorConfig } = await import("./doctor-config-flow-C3Yx6u8J.js");
	...
	const { runDoctorHealthContributions } = await import("./doctor-health-contributions-Dn_4QKKu.js");
