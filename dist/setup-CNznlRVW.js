...
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-BWaNCbZU.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-7QwYMpC1.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-BiH4fXtL.js");
