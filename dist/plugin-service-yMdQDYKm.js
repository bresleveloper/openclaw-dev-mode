...
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-Bq1Kc57-.js";
import "./sdk-setup-tools-B170SFC_.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry--3ak8Uut.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-Bw2mGPVH.js";
import { r as getBrowserProfileCapabilities } from "./target-id-DEWLyDmH.js";
import { n as normalizeBrowserScreenshot } from "./routes-BYQWHPh5.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-EHyJk_C6.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-QJEMRiyj.js");
