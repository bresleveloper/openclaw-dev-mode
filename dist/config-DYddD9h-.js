...
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-lIZQEgMF.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-B35YwKq4.js";
import "./ssrf-runtime-CZi-6iMr.js";
import "./retry-runtime-CR3QC2e6.js";
import "./secret-input-runtime-DqNAuUgp.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-BCTlGWOX.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DB8tSKUw.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-BI-sdJxb.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-DcdVNEm4.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-jY1Rqb7I.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-CYzl9PxG.js";
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-BpR511ch.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-Cgh2XIqk.js"), import("./logging-BsWA-YH1.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-8iaBTZ9o.js").then((credentialsReadModule) => ({
