...
import { r as collectCoreInsecureOrDangerousFlags } from "./dangerous-config-flags-current-CWg4eBu2.js";
...
import { r as materializeGatewayAuthSecretRefs, t as canMaterializeGatewayAuthSecretRefsWithoutExec } from "./auth-config-utils-Bi5595EH.js";
...
import { t as collectExecFilesystemPolicyDriftHits } from "./exec-filesystem-policy-CFQi41aF.js";
...
const loadReadOnlyChannelPlugins = createLazyRuntimeModule(() => import("./read-only-AmZJtWKr.js"));
...
const loadPluginMetadataRegistryLoaderModule = createLazyRuntimeModule(() => import("./metadata-registry-loader-BVIq6pM3.js"));
const loadPluginAutoEnableModule = createLazyRuntimeModule(() => import("./plugin-auto-enable-_Owkn67A.js"));
const loadChannelPluginIdsModule = createLazyRuntimeModule(() => import("./channel-plugin-ids-CcmcvRse.js"));
const loadPluginRuntimeModule = createLazyRuntimeModule(() => import("./runtime-C0m-ht_a.js"));
const loadGatewayProbeDeps = createLazyRuntimeModule(() => Promise.all([
	import("./call-jEgftwN5.js"),
	import("./probe-auth-CXYXAq5p.js"),
