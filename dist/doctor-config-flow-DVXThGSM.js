...
import { c as isRecord$1 } from "./utils-BApvfmPs.js";
import { h as parseLegacySecretRefEnvMarker, i as LEGACY_SECRETREF_ENV_MARKER_PREFIX } from "./types.secrets-lIZQEgMF.js";
...
import { i as setPathExistingStrict } from "./path-utils-DK2S_z8g.js";
import { n as discoverConfigSecretTargets } from "./target-registry-BJtwkAs2.js";
import { R as resolveNormalizedProviderModelMaxTokens } from "./io-BJfjPmGW.js";
import { _ as collectConfiguredModelRefs } from "./gateway-startup-speech-providers-CQCz_cL7.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-rTRi0B0q.js";
import { n as formatConfigIssueLines } from "./issue-format-RCKTtsD6.js";
import { r as normalizeTalkSection } from "./talk-Ccvr8ePR.js";
import { c as callGateway } from "./call-Du-jF5Kg.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-Dw6hQo3K.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-BvYxWrkv.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-DT40tvkI.js";
import { c as mergeMissing, r as isLegacyModelsAddCodexMetadataModel } from "./legacy-config-migrations.runtime.models-BwJQP8Xh.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-CkxNd5HF.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CoqTFwPO.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-LoxMl6vE.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-CWFspVTy.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-Di2mqM1z.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-w0eEJysz.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-riY6069F.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-D6Fsq4AG.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-B2LcvO_q.js");
