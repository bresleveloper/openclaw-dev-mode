...
import { n as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-CrcykudU.js";
import { t as cleanupRetainedManagedNpmInstallGenerations } from "./managed-npm-retention-BTuFzcN9.js";
import { o as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CT4JjmjS.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-C3dWg4tn.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-fqwcFyP9.js";
...
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedKeyedAttempt } from "./auth-CrLWKxN2.js";
import { n as resolveGatewayAuth } from "./auth-resolve-NyPBrh8F.js";
import { A as applyConfigOverrides, i as getRuntimeConfig, s as promoteConfigSnapshotToLastKnownGood, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-DxnOT4sF.js";
...
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-BsXKx-Ww.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-Bee8oN7M.js";
import { _ as pinActivePluginSessionExtensionRegistry, b as releasePinnedPluginHttpRouteRegistry, g as pinActivePluginHttpRouteRegistry, h as pinActivePluginChannelRegistry, x as releasePinnedPluginSessionExtensionRegistry, y as releasePinnedPluginChannelRegistry } from "./runtime-BQLP_qVr.js";
...
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-DIVExDuf.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-CHbBJf77.js";
import { s as resolveCronJobsStorePath } from "./store-BehZlprA.js";
import { d as getActiveEmbeddedRunCount, m as resolveActiveEmbeddedRunSessionId } from "./run-state-BZSsRYCZ.js";
...
import { n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-O2vuhjLQ.js";
import { u as setFallbackGatewayContextResolver } from "./server-plugins-5TViMpLp.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Dx8JkdBM.js";
...
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-zJppiM7x.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-C5Rq9COn.js";
import { t as createDeferred } from "./deferred-DJrEoFQk.js";
import { t as createDefaultDeps } from "./deps-CCPete8k.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-CX1WCKcv.js";
...
import { n as resolveAssistantIdentity } from "./assistant-identity-CMgdiIsp.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-DruWzfsQ.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-WZZx7D5Z.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-ez08c4ia.js";
...
function createLazyGatewayCronState(params) {
	...
	let loaded = null;
	let stopped = false;
	const cronStateLoader = createLazyPromiseLoader(() => import("./server-cron-EinuS5ha.js").then(({ buildGatewayCronService }) => {
		loaded = {
...
const getIdentityAvatarModule = createLazyRuntimeModule(() => import("./identity-avatar-FereJIQU.js"));
const getControlUiModule = createLazyRuntimeModule(() => import("./control-ui-wKH2Y9d3.js"));
const getEmbeddingsHttpModule = createLazyRuntimeModule(() => import("./embeddings-http-BsIS3W8n.js"));
const getManagedImageAttachmentsModule = createLazyRuntimeModule(() => import("./managed-image-attachments-BmlxbEn0.js"));
const getModelsHttpModule = createLazyRuntimeModule(() => import("./models-http-zwv5uZgQ.js"));
const getOpenAiHttpModule = createLazyRuntimeModule(() => import("./openai-http-BuL9xaen.js"));
const getOpenResponsesHttpModule = createLazyRuntimeModule(() => import("./openresponses-http-Dve_lHPv.js"));
const getSessionHistoryHttpModule = createLazyRuntimeModule(() => import("./sessions-history-http-5i0J3ayB.js"));
const getSessionKillHttpModule = createLazyRuntimeModule(() => import("./session-kill-http-Bh6Dixoc.js"));
const getToolsInvokeHttpModule = createLazyRuntimeModule(() => import("./tools-invoke-http-CGSBDoyF.js"));
const getPluginNodeCapabilityAuthModule = createLazyRuntimeModule(() => import("./plugin-node-capability-auth-OKHoZulj.js"));
const getHttpAuthUtilsModule = createLazyRuntimeModule(() => import("./http-auth-utils-DD6irBSf.js"));
const getPluginRouteRuntimeScopesModule = createLazyRuntimeModule(() => import("./plugin-route-runtime-scopes-ClqOEJLW.js"));
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-Mdhz6mMk.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-u5bt21pU.js");
...
const loadGatewayModelCatalogModule = createLazyRuntimeModule(() => import("./server-model-catalog-CrrABp4q.js"));
...
const loadGatewayStartupEarlyModule = createLazyRuntimeModule(() => import("./server-startup-early-zwZKHO4r.js"));
const loadGatewayStartupPostAttachModule = createLazyRuntimeModule(() => import("./server-startup-post-attach-DUQoN7gv.js"));
...
const getChannelRuntime = createLazyRuntimeModule(() => import("./runtime-channel-Bce6Y-ME.js").then(({ createRuntimeChannel }) => createRuntimeChannel()));
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-D2raXdQT.js");
...
const loadGatewayPluginBootstrapModule = createLazyRuntimeModule(() => import("./server-plugin-bootstrap-C56MHNi2.js"));
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-D29NZ3Ei.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-B2A0SYZG.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	const startupConfigModulePromise = import("./server-startup-config-Dt5DcdMw.js");
	const loadStartupPluginsModule = createLazyPromise(() => import("./server-startup-plugins-BDJx1iJW.js"), { cacheRejections: true });
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-CbjWinUO.js");
	...
	const { createChannelManager } = await import("./server-channels-ZrJXEw4K.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-DzZ3YHuH.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-Ci-aI6e8.js"), import("./server-runtime-startup-services-C7PB1U_D.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-BYkjzPeV.js"), import("./server-methods-B7266irA.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-BeeI6MVe.js"),
				loadGatewayPluginBootstrapModule(),
				import("./services-BK4gZYIN.js")
			]);
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-CvSlKym0.js"), import("./route-capability-hOkmtBZl.js")]));
		...
		const loadScheduledServicesModule = createLazyPromise(() => import("./server-runtime-services-qQ-IhIcJ.js"), { cacheRejections: true });
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-Dv8utJrf.js");
