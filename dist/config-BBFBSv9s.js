...
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-D73WyWDP.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-D6gArM8P.js"), import("./logging-DjXFNfnd.js")]).then(([sdkModule, loggingModule]) => ({
