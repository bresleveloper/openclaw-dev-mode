...
import { B as MANAGED_MEMORY_DREAMING_CRON_TAG, G as resolveMemoryDeepDreamingConfig, V as MEMORY_DREAMING_SYSTEM_EVENT_TEXT, W as resolveMemoryCorePluginConfig, Y as resolveMemoryDreamingWorkspaces, z as MANAGED_MEMORY_DREAMING_CRON_NAME } from "./dreaming-DFdUxl07.js";
import { l as peekSystemEventEntries } from "./system-events-DNR0hK3x.js";
...
import { n as normalizeTrimmedString, t as includesSystemEventToken } from "./dreaming-shared-CaPXzCyU.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
	...
	const [{ writeDeepDreamingReport }, { appendFallbackNarrativeEntry, generateAndAppendDreamNarrative, runDetachedDreamNarrative }, { runDreamingSweepPhases }, { applyShortTermPromotions, repairShortTermPromotionArtifacts, rankShortTermPromotionCandidates }] = await Promise.all([
		import("./dreaming-markdown-BpnrVeI1.js"),
		import("./dreaming-narrative-BT_Cn33q.js"),
		import("./dreaming-phases-mcI-b4cv.js"),
		import("./short-term-promotion-0P7YMAyY.js")
	]);
