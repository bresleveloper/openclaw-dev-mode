...
const loadAgentHandlers = lazyHandlerModule(() => import("./agent-zRlHGlro.js"), (module) => module.agentHandlers);
...
const loadChatHandlers = lazyHandlerModule(() => import("./chat-EVmbw2v9.js"), (module) => module.chatHandlers);
...
const loadNodePendingHandlers = lazyHandlerModule(() => import("./nodes-pending-D4m6Hvbw.js"), (module) => module.nodePendingHandlers);
const loadNodeHandlers = lazyHandlerModule(() => import("./nodes-BEIngfz1.js"), (module) => module.nodeHandlers);
...
const loadSessionsHandlers = lazyHandlerModule(() => import("./sessions-BDauqVmX.js"), (module) => module.sessionsHandlers);
const loadSkillsHandlers = lazyHandlerModule(() => import("./skills-CAFXN7ls.js"), (module) => module.skillsHandlers);
const loadSystemHandlers = lazyHandlerModule(() => import("./system-T4xh-jn1.js"), (module) => module.systemHandlers);
const loadTalkHandlers = lazyHandlerModule(() => import("./talk-Bn8VfK1E.js"), (module) => module.talkHandlers);
...
const loadToolsEffectiveHandlers = lazyHandlerModule(() => import("./tools-effective-DWSw32BH.js"), (module) => module.toolsEffectiveHandlers);
const loadToolsInvokeHandlers = lazyHandlerModule(() => import("./tools-invoke-DJngq1Hp.js"), (module) => module.toolsInvokeHandlers);
const loadTtsHandlers = lazyHandlerModule(() => import("./tts-CZYY8DhX.js"), (module) => module.ttsHandlers);
const loadUpdateHandlers = lazyHandlerModule(() => import("./update-CFWj9NMp.js"), (module) => module.updateHandlers);
