import { _ as getResolvedLoggerSettings, c as setVerbose, f as colorize, g as getLogger, h as getChildLogger, m as theme, o as logVerbose, p as isRich, r as isDevMode } from "./globals-DtwqVhkV.js";
...
import { a as setConsoleSubsystemFilter, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CkDRqDzV.js";
import "./boolean-DTgd5CzD.js";
import { a as logAcceptedEnvOption, i as isTruthyEnvValue } from "./entry.js";
import { $c as resolveThinkingDefault, $n as isWebchatClient, $t as readSessionPreviewItemsFromTranscript, Br as movePathToTrash, C as normalizeThinkLevel, Ci as ensureGatewayStartupAuth, Cn as resolveAgentMainSessionKey, Co as migrateLegacyConfig, Ct as extractDeliveryInfo, D as supportsXHighThinking, Da as mergeAlsoAllowPolicy, Dt as archiveRemovedSessionTranscripts, Ei as resolveConfiguredSecretInputString, En as resolveMainSessionKeyFromConfig, Fa as resolveCoreToolProfiles, Fi as resolveGatewayAuth, Fr as createBrowserControlContext, Gi as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Hi as readGatewayPasswordEnv, Hr as ensurePortAvailable, Ht as deliveryContextFromSession, I as estimateBase64DecodedBytes, Ic as getModelRefStatus, Ir as startBrowserControlServiceFromConfig, Jc as resolveHooksGmailModel, Ji as createAuthRateLimiter, Jn as isDeliverableMessageChannel, Js as applyMergePatch, Jt as archiveFileOnDisk, Kc as resolveConfiguredModelRef, Ki as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Kt as normalizeSessionDeliveryFields, Lo as writeConfigFile, Ma as PROFILE_OPTIONS, Mc as buildAllowedModelSet, Mi as authorizeHttpGatewayConnect, Mo as readConfigFileSnapshot, Ni as authorizeWsControlUiGatewayConnect, No as readConfigFileSnapshotForWrite, On as snapshotSessionOrigin, Oo as loadConfig, Ot as loadSessionStore, Pa as listCoreToolSections, Pi as isLocalDirectRequest, Po as resolveConfigSnapshotHash, Pr as createBrowserRouteDispatcher, Pt as updateSessionStore, Qi as isLoopbackHost, Qr as rawDataToString, Qt as readSessionMessages, Rc as isCliProvider, Ro as validateConfigObjectWithPlugins, S as normalizeReasoningLevel, Sn as canonicalizeMainSessionAlias, T as normalizeVerboseLevel, Ta as collectExplicitAllowlist, Ti as mergeGatewayTailscaleConfig, Tn as resolveMainSessionKey, To as createConfigIO, Ui as readGatewayTokenEnv, Ur as inspectPortUsage, Vc as normalizeModelSelection, Wc as resolveAllowedModelRef, Wt as mergeDeliveryContext, Xi as isLocalishHost, Xn as isGatewayMessageChannel, Xs as ensureControlUiAllowedOriginsForNonLoopbackBind, Xt as capArrayByJsonBytes, Yi as normalizeRateLimitClientIp, Yn as isGatewayCliClient, Ys as applyLegacyMigrations, Yt as archiveSessionTranscripts, Zc as resolveSubagentConfiguredModelSelection, Zi as isLoopbackAddress, Zt as cleanupArchivedSessionTranscripts, _ as formatThinkingLevels, _r as writeJsonAtomic, aa as resolveGatewayBindHost, an as stripInlineDirectiveTagsForDisplay, ar as GATEWAY_CLIENT_IDS, au as normalizeSecretInput, ca as pickPrimaryTailnetIPv4, cc as buildTalkConfigResponse, cr as hasGatewayClientCap, cs as isAvatarHttpUrl, cu as DEFAULT_MODEL, da as disableTailscaleFunnel, dn as jsonUtf8Bytes, ea as isTrustedProxyAddress, ei as cleanOldMedia, es as parseByteSize, fa as disableTailscaleServe, fi as SsrFBlockedError, ga as getTailnetHostname, gr as readJsonFile, hn as resolveSessionResetPolicy, hr as createAsyncLock, ia as resolveClientIp, ir as GATEWAY_CLIENT_CAPS, ja as resolveToolProfilePolicy, jc as isPidAlive, ji as assertGatewayAuthConfigured, jo as readBestEffortConfig, ko as parseConfigJson5, la as pickPrimaryTailnetIPv6, lc as resolveAgentMaxConcurrent, lr as normalizeGatewayClientMode, ls as isAvatarImageDataUrl, lu as DEFAULT_PROVIDER, ma as enableTailscaleServe, na as normalizeHostHeader, nn as stripEnvelopeFromMessage, oa as resolveGatewayListenHosts, on as stripInlineDirectiveTagsFromMessageForDisplay, or as GATEWAY_CLIENT_MODES, os as AVATAR_MAX_BYTES, pa as enableTailscaleFunnel, pn as evaluateSessionFreshness, pr as cleanStaleLockFiles, ps as looksLikeAvatarPath, qc as resolveDefaultModelForAgent, qi as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, qn as INTERNAL_MESSAGE_CHANNEL, qr as formatPortDiagnostics, ra as pickPrimaryLanIPv4, rn as stripEnvelopeFromMessages, sr as GATEWAY_CLIENT_NAMES, ta as isValidIPv4, tn as resolveSessionTranscriptCandidates, tr as normalizeMessageChannel, ua as safeEqualSecret, uc as resolveSubagentMaxConcurrent, un as normalizeInputProvenance, v as formatXHighModelHint, w as normalizeUsageDisplay, wi as mergeGatewayAuthConfig, wn as resolveExplicitAgentSessionKey, wt as parseSessionThreadInfo, x as normalizeElevatedLevel, xn as setSessionRuntimeModel, yn as mergeSessionEntry, zo as OpenClawSchema } from "./auth-profiles-CIqoN6FN.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BAb0j1gt.js";
import { S as isCronRunSessionKey, T as parseAgentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, w as isSubagentSessionKey, x as isAcpSessionKey } from "./session-key-DmlQCuju.js";
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-DMInpDZe.js";
import { a as sameFileIdentity, i as openVerifiedFileSync, m as matchesSkillFilter, n as openBoundaryFile, r as openBoundaryFileSync, u as isNotFoundPathError } from "./boundary-file-read-DM07oBuv.js";
import { i as logWarn, t as logDebug } from "./logger-GQFppKMT.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-DDBrWr4H.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-DFaOsr5g.js";
...
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-BvA7WhZA.js";
import { t as parseDurationMs } from "./parse-duration-YMNqCAxm.js";
import "./runtime-overrides-CGfXKBb_.js";
import { A as triggerInternalHook, D as clearInternalHooks, O as createInternalHookEvent, b as canonicalizePathVariant, h as createEmptyPluginRegistry, k as registerInternalHook, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, y as canonicalizePathForSecurity } from "./registry-DznR2BDN.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot, w as isTestDefaultMemorySlotDisabled } from "./skills-DZCrHNdp.js";
import { f as hasBinary } from "./frontmatter-D1I3WE8J.js";
import { U as resolveWhatsAppAccount, ct as normalizeWhatsAppTarget, g as buildChannelAccountBindings, lt as resolveChannelDefaultAccountId, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-CjLMQbHJ.js";
import { C as writeFileWithinRoot, m as SafeOpenError, r as detectMime, v as openFileWithinRoot, x as readLocalFileSafely } from "./windows-spawn-D2jCT_tt.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-DnTfDLlu.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-BAfWVs88.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-D6OHuY6d.js";
import "./send-BsspxCzG.js";
import "./send-zGJnEJ2h.js";
import { $ as getCliSessionId, $n as resolveAgentTimeoutMs, $r as markGatewayDraining, $t as unbindThreadBindingsBySessionKey, A as createDefaultDeps, An as extractFileContentFromSource, At as normalizePayloadToSystemText, B as buildHistoryContextFromEntries, Bn as stopSubagentsForRequester, Br as resolveTtsConfig, Bt as closeTrackedBrowserTabsForSessions, C as sanitizeExecApprovalDisplayText, Ct as normalizeHttpWebhookUrl, D as resolveAgentDeliveryPlan, Dn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Dr as resolveAgentIdentity, Dt as normalizeOptionalAgentId, Er as resolveAgentSessionDirs, F as resolveAgentAvatar, Fn as normalizeSendPolicy, Fr as getTtsProvider, Gr as textToSpeech, Hr as resolveTtsProviderOrder, Ht as persistBrowserProxyFiles, In as resolveSendPolicy, Ir as isTtsEnabled, It as buildSafeExternalPrompt, J as dispatchInboundMessage, Jn as listDescendantRunsForRequester, Jt as applyModelOverrideToSessionEntry, Kn as initSubagentRegistry, Kr as OPENAI_TTS_MODELS, Lr as isTtsProviderConfigured, Lt as detectSuspiciousPatterns, Mn as normalizeMimeList, Nn as resolveInputFileLimits, Nr as clearBootstrapSnapshot, Nt as normalizeLegacyDeliveryInput, O as resolveAgentOutboundTarget, On as DEFAULT_INPUT_IMAGE_MIMES, Ot as normalizeOptionalSessionKey, Pr as clearBootstrapSnapshotOnSessionRollover, Q as buildBareSessionResetPrompt, Qr as getTotalQueueSize, Qt as resolveIngressWorkspaceOverrideForSpawnedRun, Rr as resolveTtsApiKey, Rt as getHookType, S as resolveExecApprovalCommandDisplay, Sr as resolveBootstrapWarningSignaturesSeen, St as writeRestartSentinel, T as agentCommandFromIngress, Tr as getAcpSessionManager, Tt as normalizeCronJobPatch, Un as countActiveDescendantRuns, Ur as setTtsEnabled, Ut as resolveSessionAuthProfileOverride, Vr as resolveTtsPrefsPath, Vt as applyBrowserProxyPaths, Wr as setTtsProvider, X as getTotalPendingReplies, Xr as getActiveTaskCount, Xt as parseVerboseOverride, Y as createReplyDispatcher, Yr as enqueueCommandInLane, Yt as applyVerboseOverride, Zt as normalizeSpawnedRunMetadata, _ as handleSlackHttpRequest, _r as getAgentRunContext, _t as formatDoctorNonInteractiveHint, ar as buildOutboundSessionContext, at as resolveOutboundSessionRoute, bt as summarizeRestartSentinel, cr as getActiveEmbeddedRunCount, ct as resolveOutboundTarget, ei as resetAllLanes, en as normalizeGroupActivation, er as resolveAnnounceTargetFromKey, et as setCliSessionId, fr as resolveCronStyleNow, ft as maybeResolveIdLikeTarget, gr as emitAgentEvent, gt as consumeRestartSentinel, h as resolveAgentOutboundIdentity, hn as isSystemEventContextChanged, hr as clearAgentRunContext, ht as runWithModelFallback, i as buildDefaultToolPolicyPipelineSteps, ir as clearSessionQueues, it as ensureOutboundSessionEntry, j as createOutboundSendDeps$1, jn as extractImageContentFromSource, jr as resolveUserTimezone, jt as normalizeRequiredName, k as createOutboundSendDeps, kn as DEFAULT_INPUT_TIMEOUT_MS, kt as normalizeOptionalText, l as loadOpenClawPlugins, lr as waitForActiveEmbeddedRuns, lt as resolveSessionDeliveryTarget, mn as enqueueSystemEvent, mr as buildExecApprovalPendingReplyPayload, n as resolveToolLoopDetectionConfig, ni as waitForActiveTasks, nn as loadProviderUsageSummary, nr as resolveNestedAgentLane, nt as createOpenClawTools, o as getPluginToolMeta, oi as stripHeartbeatToken, on as formatZonedTimestamp, or as runEmbeddedPiAgent, p as buildTelegramExecApprovalButtons, pr as runBeforeToolCallHook, pt as resetDirectoryCache, qr as OPENAI_TTS_VOICES, r as applyToolPolicyPipeline, ri as CommandLane, s as resolvePluginTools, sr as abortEmbeddedPiRun, ti as setCommandLaneConcurrency, tr as readLatestAssistantReply, tt as runCliAgent, u as createPluginRuntime, ur as waitForEmbeddedPiRunEnd, ut as resolveOutboundChannelPlugin, v as readJsonBodyWithLimit, vr as onAgentEvent, vt as formatRestartSentinelMessage, wr as resolveFailoverReasonFromError, wt as normalizeCronJobCreate, xn as setHeartbeatsEnabled, y as requestBodyErrorToText, yn as requestHeartbeatNow, yr as registerAgentRunContext, z as createReplyPrefixOptions, zn as isAbortRequestText, zr as resolveTtsAutoMode, zt as isExternalHookSession } from "./compact-D7FmBOIi.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-B52CESY4.js";
import "./chat-envelope-DZwp6OvC.js";
import "./models-config-CgYIAjpL.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-DlJSUh2B.js";
import { n as getMachineDisplayName } from "./with-timeout-BkPFXDKx.js";
import { M as getGlobalHookRunner, P as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-BBVbYNZl.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, h as isDiagnosticsEnabled } from "./diagnostic-BgzUMGxw.js";
import { C as resolveCronStorePath, S as loadCronStore, u as sendTypingTelegram, w as saveCronStore } from "./send-C30ZEgKY.js";
...
import { n as loadModelCatalog } from "./model-catalog-ABQggSsr.js";
import "./fetch-BNo-TKiW.js";
import { v as registerUnhandledRejectionHandler } from "./audio-transcription-runner-aawySreQ.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DfcVqBbv.js";
import { x as extractTextFromChatContent } from "./image-D8LO-CO5.js";
...
import { a as ToolInputError } from "./target-errors-Cd8b6anp.js";
import { r as isRestartEnabled } from "./commands-CwtsDdaQ.js";
import "./commands-registry-B6Tu3P-e.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-BqCSF78X.js";
...
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-Dxc5qfRZ.js";
import "./prompt-style-DjT2g1_v.js";
import "./pairing-labels-DP2OEfMM.js";
import { r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-1h3uBAK6.js";
import { a as resolveMemorySearchConfig } from "./manager-BrGg7Zo_.js";
...
import { t as formatHelpExamples } from "./help-format-DFZn5_Pb.js";
import { n as withProgress } from "./progress-DD4pMDZr.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C1_d6sO6.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CdXCXztT.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DY2Ax98O.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Bs63XfM1.js";
import { t as readSecretFromFile } from "./secret-file-Bxp5jupj.js";
import { n as inheritOptionFromParent } from "./command-options-NZgZgncj.js";
import { t as WizardCancelledError } from "./prompts-DE_9XKFz.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-8ZGi3uhv.js";
import { t as isWithinDir } from "./path-safety-DZYpIecp.js";
import "./install-safe-path-DmHn2hdl.js";
import "./skill-scanner-BS56h2FJ.js";
import { n as formatConfigIssueLines } from "./issue-format-CBixuceM.js";
import { t as buildChannelAccountSnapshot } from "./status-cevKD8Pl.js";
import "./channels-status-issues-PQD9C42e.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-B7pFEcfP.js";
...
import { u as scheduleDetachedLaunchdRestartHandoff } from "./service-D6xYLXBx.js";
import "./lifecycle-core-DExqFotU.js";
import "./systemd-hints-CpA8Fclk.js";
import { t as parsePort$1 } from "./parse-port-Dek2RgtH.js";
import { c as parseProcCmdline, n as addGatewayServiceCommands, s as isGatewayArgv } from "./daemon-cli-BqDy6Hvf.js";
import { r as probeGateway } from "./probe-auth-DUVIfe-o.js";
import "./diagnostics-Cam18og1.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-qTbCOqOd.js";
import "./table-B-ecKEFu.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-9ojdFC58.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DYRk01vI.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-SITre89c.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BeFlWEMx.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-CNnkhoU1.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-CKtEVbXd.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-Bz1he1q8.js";
import "./onboarding.secret-input-BExBwTwR.js";
import { t as runOnboardingWizard } from "./onboarding-DMnllAyO.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-CsoznyZa.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-CdPC47cx.js";
import { d as coerceFiniteScheduleNumber, f as computeNextRunAtMs, p as computePreviousRunAtMs, t as runGatewayUpdate, u as normalizeStoredCronJobs } from "./update-runner-C3-R1JW0.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-BPNKc-Hy.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-ECqCgB1z.js";
import "./node-service-Flmmt8on.js";
import "./status.update-4V4R32qg.js";
import { t as installSkill } from "./skills-install-DHuLxRrn.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-Ws9pv3DX.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-u8jAZ2R5.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CpVwnDuc.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-BqCSF78X.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CDkrSH7h.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DoXxnK-F.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-BBVbYNZl.js").then((n) => n.n);
