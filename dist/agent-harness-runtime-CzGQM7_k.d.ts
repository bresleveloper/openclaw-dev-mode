...
import { a as SourceReplyDeliveryMode, c as PromptImageOrderEntry } from "./types-Iy-uj5hQ.js";
import { _ as InboundEventKind, h as PluginHookChannelContext } from "./templating-BpD1cfFX.js";
import { s as AuthProfileStore } from "./types-CrmAJw_-.js";
import { o as ChannelAgentTool } from "./types.core-DDKBE3_n.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { P as PluginHookContextWindowSource, X as PluginHookLlmInputEvent, Z as PluginHookLlmOutputEvent, d as PluginHookAgentEndEvent, f as PluginHookBeforeAgentFinalizeEvent, ln as PluginHookBeforeAgentStartResult, u as PluginHookAgentContext } from "./hook-types-mbU3l3kV.js";
import { $i as OpenClawAgentToolResult, Ai as CodexAppServerToolResultEvent, Ba as EmbeddedRunAttemptParams, Di as CodexAppServerExtensionContext, Ha as PreemptiveCompactionRoute, Iu as MessagingToolSend, Ji as AgentToolResultMiddlewareEvent, Ka as AgentRuntimePlan, Ki as AgentToolResultMiddleware, Oi as CodexAppServerExtensionFactory, Tu as ProviderRuntimePluginHandle, Ua as NormalizedUsage, Va as EmbeddedRunAttemptResult, Xs as ContextEngine, Ys as CompactResult, Za as ToolOutcomeObserver, _c as TranscriptRewriteResult, ic as ContextEngineRuntimeContext, ni as ProcessToolDefaults, no as requestDeferredPluginToolApproval, qa as BuildAgentRuntimePlanParams, qi as AgentToolResultMiddlewareContext, ql as EmbeddedRunTrigger, qs as AssembleResult, rc as ContextEnginePromptCacheInfo, sc as ContextEngineRuntimeSettings, uu as ExecToolDefaults, wu as ProviderRuntimeModel } from "./types-BVLQjFJF.js";
...
import { t as ModelAuthMode } from "./model-auth-BhzC3Xml.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-aRDZakgy.js";
import { P as SandboxContext } from "./sandbox-Roeixa4Q.js";
import { c as EmbeddedAgentQueueMessageOptions } from "./runs-CpE0Keno.js";
import { n as ContextEngineHostSupport } from "./host-compat-CwIQScPh.js";
import { t as BundleMcpDiagnostic } from "./bundle-mcp-DABlFCpS.js";
import { n as ToolSearchCatalogToolExecutor, t as ToolSearchCatalogRef } from "./tool-search-Cej-zlwt.js";
