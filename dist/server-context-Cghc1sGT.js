...
function getExtensionRelayModule() {
	modPromise ??= import("./relay-lifecycle-Bu8lzBKl.js");
	return modPromise;
}
//#endregion
...
async function getChromeMcpModule() {
	return await import("./chrome-mcp-IOMk-MrC.js");
}
//#endregion
