...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-CdcbMnzO.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-Ct7SjmwI.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-Bytp7jWx.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-DRTXG00e.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-DwOf6kQK.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-Bul4rq78.js"),
