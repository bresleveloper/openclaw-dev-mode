...
import { $l as resolveOpenClawAgentDir, Bl as listProfilesForProvider, K as SYNTHETIC_DEFAULT_MODEL_REF, Kl as ensureAuthProfileStore, M as resolveEnvApiKey, O as hasUsableCustomProviderApiKey, Tt as resolveAuthProfileOrder, Ul as upsertAuthProfile, X as VENICE_DEFAULT_MODEL_REF, _s as generateChutesPkce, at as isHuggingfacePolicyLocked, bt as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, g as resolveDefaultModelForAgent, gs as exchangeChutesCodeForTokens, hs as CHUTES_AUTHORIZE_ENDPOINT, it as discoverHuggingfaceModels, po as isLoopbackHost, vs as parseOAuthCallbackInput, yt as KILOCODE_DEFAULT_MODEL_REF } from "./model-selection-BRhJAUKb.js";
import { F as toAgentModelListLike, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir } from "./agent-scope-Dx6t10xJ.js";
import { n as loadModelCatalog } from "./model-catalog-R9lrAX5y.js";
import { f as openUrl } from "./onboard-helpers-JN2sbVho.js";
import { t as enablePluginInConfig } from "./enable-BhuxmNo1.js";
import { a as normalizeSecretInputModeInput, c as resolveSecretInputModeForEnvSelection, d as normalizeApiKeyInput, f as validateApiKeyInput, i as ensureApiKeyFromOptionEnvOrPrompt, l as applyDefaultModelChoice, n as createAuthChoiceDefaultModelApplierForMutableState, o as normalizeTokenProviderInput, s as promptSecretRefForOnboarding, t as createAuthChoiceAgentModelNoter, u as ensureModelAllowlistEntry } from "./auth-choice.apply-helpers-De4NYiI7.js";
import { n as applyOpenAICodexModelDefault, t as OPENAI_CODEX_DEFAULT_MODEL } from "./openai-codex-model-default-D_5N6ZnF.js";
import { $ as applyVercelAiGatewayProviderConfig, A as applyMoonshotProviderConfig, At as setXiaomiApiKey, B as applyVeniceConfig, C as applyMistralProviderConfig, Ct as setQianfanApiKey, D as applyModelStudioProviderConfigCn, Dt as setVercelAiGatewayApiKey, E as applyModelStudioProviderConfig, Et as setVeniceApiKey, F as applyQianfanProviderConfig, Ft as MODELSTUDIO_DEFAULT_MODEL_REF, G as applyXiaomiProviderConfig, H as applyXaiConfig, I as applySyntheticConfig, It as MOONSHOT_DEFAULT_MODEL_REF, J as applyLitellmConfig, K as applyZaiConfig, L as applySyntheticProviderConfig, Lt as QIANFAN_DEFAULT_MODEL_REF, M as applyOpenrouterConfig, Mt as writeOAuthCredentials, N as applyOpenrouterProviderConfig, Nt as KIMI_CODING_MODEL_REF, O as applyMoonshotConfig, Ot as setVolcengineApiKey, P as applyQianfanConfig, Pt as MISTRAL_DEFAULT_MODEL_REF, Q as applyVercelAiGatewayConfig, R as applyTogetherConfig, Rt as XAI_DEFAULT_MODEL_REF, S as applyMistralConfig, St as setOpenrouterApiKey, T as applyModelStudioConfigCn, Tt as setTogetherApiKey, U as applyXaiProviderConfig, V as applyVeniceProviderConfig, W as applyXiaomiConfig, X as applyCloudflareAiGatewayConfig, Y as applyLitellmProviderConfig, Z as applyCloudflareAiGatewayProviderConfig, _ as applyHuggingfaceProviderConfig, _t as setModelStudioApiKey, a as OPENCODE_GO_DEFAULT_MODEL_REF, at as XIAOMI_DEFAULT_MODEL_REF, b as applyKimiCodeConfig, bt as setOpencodeGoApiKey, c as applyOpencodeZenProviderConfig, ct as setByteplusApiKey, d as applyMinimaxApiProviderConfig, dt as setHuggingfaceApiKey, et as HUGGINGFACE_DEFAULT_MODEL_REF, f as applyMinimaxApiProviderConfigCn, ft as setKilocodeApiKey, gt as setMistralApiKey, h as applyAuthProfileConfig, ht as setMinimaxApiKey, i as applyOpencodeGoProviderConfig, it as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, j as applyMoonshotProviderConfigCn, jt as setZaiApiKey, k as applyMoonshotConfigCn, kt as setXaiApiKey, l as applyMinimaxApiConfig, lt as setCloudflareAiGatewayConfig, m as applyMinimaxProviderConfig, mt as setLitellmApiKey, n as validateAnthropicSetupToken, nt as OPENROUTER_DEFAULT_MODEL_REF, ot as ZAI_DEFAULT_MODEL_REF, p as applyMinimaxConfig, pt as setKimiCodingApiKey, q as applyZaiProviderConfig, r as applyOpencodeGoConfig, rt as TOGETHER_DEFAULT_MODEL_REF, s as applyOpencodeZenConfig, st as setAnthropicApiKey, t as buildTokenProfileId, tt as LITELLM_DEFAULT_MODEL_REF, u as applyMinimaxApiConfigCn, ut as setGeminiApiKey, v as applyKilocodeConfig, vt as setMoonshotApiKey, w as applyModelStudioConfig, wt as setSyntheticApiKey, x as applyKimiCodeProviderConfig, xt as setOpencodeZenApiKey, y as applyKilocodeProviderConfig, yt as setOpenaiApiKey, z as applyTogetherProviderConfig } from "./auth-token-DdQ_1a8w.js";
import { n as applyAgentDefaultModelPrimary, t as isRemoteEnvironment } from "./oauth-env-CNiRxlZf.js";
import { a as loginOpenAICodexOAuth, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-oFIOdMTJ.js";
import { a as GOOGLE_GEMINI_DEFAULT_MODEL, i as detectZaiEndpoint, n as applyOpenAIConfig, o as applyGoogleGeminiModelDefault, r as applyOpenAIProviderConfig, t as OPENAI_DEFAULT_MODEL } from "./openai-model-default-DOagIr4x.js";
import { r as applyPrimaryModel, s as promptAndConfigureVllm } from "./model-picker-DCl8qtjE.js";
import { i as promptAndConfigureOllama, n as ensureOllamaModelPulled } from "./ollama-setup-B90MXDHs.js";
...
//#endregion
//#region src/commands/auth-choice.apply.ollama.ts
async function applyAuthChoiceOllama(params) {
