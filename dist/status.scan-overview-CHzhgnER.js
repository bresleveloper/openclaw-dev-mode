...
import { m as requireNodeSqlite } from "./openclaw-state-db-CIiPwqG3.js";
...
import { c as MEMORY_INDEX_META_TABLE, l as MEMORY_INDEX_SOURCES_TABLE, o as MEMORY_INDEX_CHUNKS_TABLE } from "./engine-storage-CkR0WZTF.js";
import { t as resolveGatewayAuthTokenSourceConflict } from "./auth-token-source-conflict-BOxA6udN.js";
import "./engine-storage-CBvOJbx2.js";
import { a as isProbeReachable, t as pickGatewaySelfPresence } from "./gateway-presence-Dmh3LOeB.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-CENssPOy.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-CaewtHAY.js"));
const gatewayCallModuleLoader$1 = createLazyImportLoader(() => import("./call-jEgftwN5.js"));
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-BLBbyJRw.js"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-DBCq3aku.js"));
const statusScanRuntimeModuleLoader = createLazyImportLoader(() => import("./status.scan.runtime.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-jEgftwN5.js"));
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./status.summary-D2vxhOqZ.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-CcmcvRse.js"));
const configModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const controlUiLinksModuleLoader = createLazyImportLoader(() => import("./control-ui-links-8u6uaiRr.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-DdjEtGBM.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-BAunZpt2.js"));
