...
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-BbmhFA6e.js";
import "./channel-core-8KkODg2S.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-BGZcwLQe.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-BaucdRTI.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Z5Ho87n2.js"), "matrixChannelRuntime");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BZzC9qXt.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
