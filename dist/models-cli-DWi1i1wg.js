...
import { It as formatUsageWindowSummary, Lt as resolveUsageProviderId, Pt as loadProviderUsageSummary, Vr as resolveModelWithRegistry, a as buildAuthHealthSummary, i as DEFAULT_OAUTH_WARN_MS, ln as describeFailoverError, o as formatRemainingShort, r as maskApiKey, w as runEmbeddedPiAgent } from "./reply-CLjug3BF.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-BJ-A8vSB.js";
...
import { Ci as resolveAuthStorePathForDisplay, Ft as resolveSecretRefString, Mn as parseDurationMs, Ri as DEFAULT_MODEL, Tt as resolveProfileUnusableUntilForDisplay, _i as ensureAuthProfileStore, at as resolveEnvApiKey, c as modelKey, d as normalizeProviderId, di as listProfilesForProvider, f as parseModelRef, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, in as loadConfig, it as resolveAwsSdkEnvVarName, ki as resolveAuthProfileDisplayLabel, ln as setRuntimeConfigSnapshot, mi as upsertAuthProfile, oi as shouldEnableShellEnvFallback, pi as setAuthProfileOrder, r as buildModelAliasIndex, ri as getShellEnvAppliedKeys, rt as resolveApiKeyForProvider, sn as readConfigFileSnapshotForWrite, st as isNonSecretApiKeyMarker, tt as getCustomProviderApiKey, v as resolveModelRefFromString, vt as resolveAuthProfileEligibility, wi as resolveOpenClawAgentDir, yt as resolveAuthProfileOrder, zi as DEFAULT_PROVIDER } from "./model-selection-CX4C7NZp.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-BEpJKGMR.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CrgdtCHd.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DN1_rbg1.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-B22Udz2k.js";
import "./session-cost-usage-B6JvTk-n.js";
import { f as openUrl } from "./onboard-helpers-XgRedRg8.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-dheMMb8l.js";
import "./help-format-AqVUaAli.js";
import { r as withProgressTotals } from "./progress-CcxlwGsg.js";
...
import { t as createClackPrompter } from "./clack-prompter-CFjr85Sv.js";
import "./issue-format-BUpZkSj_.js";
import { t as renderTable } from "./table-D2xP80_9.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BOv3_06U.js";
import { n as redactSecrets } from "./format-BVYvqibA.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-D0l9zM_A.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BtiNpEf6.js";
import { n as logConfigUpdated } from "./logging-cIkvnNzL.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-6us7KNa3.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-CX4C7NZp.js").then((n) => n._t);
