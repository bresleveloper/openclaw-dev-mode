...
import { Ai as hasAmbiguousGatewayAuthModeConfig, Ba as DEFAULT_SANDBOX_IMAGE, Di as resolveConfiguredSecretInputWithFallback, Ec as updateAuthProfileStoreWithLock, Fi as resolveGatewayAuth, Ic as getModelRefStatus, Jc as resolveHooksGmailModel, Ka as resolveBootstrapTotalMaxChars, Kc as resolveConfiguredModelRef, Lo as writeConfigFile, Mo as readConfigFileSnapshot, Ot as loadSessionStore, Qi as isLoopbackHost, Ra as DEFAULT_SANDBOX_BROWSER_IMAGE, Sc as ensureAuthProfileStore, Tn as resolveMainSessionKey, Ui as readGatewayTokenEnv, Un as formatSessionArchiveTimestamp, Ur as inspectPortUsage, Wa as resolveBootstrapMaxChars, Wn as isPrimarySessionTranscriptFileName, Xa as resolveApiKeyForProfile, aa as resolveGatewayBindHost, cu as DEFAULT_MODEL, du as CLAUDE_CLI_PROFILE_ID, fu as CODEX_CLI_PROFILE_ID, l as resolveProfileUnusableUntilForDisplay, lu as DEFAULT_PROVIDER, mc as repairOAuthProfileIdMismatch, pr as cleanStaleLockFiles, qr as formatPortDiagnostics, sl as resolveApiKeyForProvider, xa as resolveSandboxScope } from "./auth-profiles-CIqoN6FN.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-BAb0j1gt.js";
...
import { n as listChannelPlugins } from "./plugins-CjLMQbHJ.js";
import { Er as resolveAgentSessionDirs, Gt as DEFAULT_OAUTH_WARN_MS, Kt as buildAuthHealthSummary, Mr as resolveBootstrapContextForRun, br as analyzeBootstrapBudget, l as loadOpenClawPlugins, qt as formatRemainingShort, xr as buildBootstrapInjectionStats } from "./compact-D7FmBOIi.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-B52CESY4.js";
import { C as resolveCronStorePath, S as loadCronStore, w as saveCronStore } from "./send-C30ZEgKY.js";
import { n as loadModelCatalog } from "./model-catalog-ABQggSsr.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-B28h9L2b.js";
import { u as resolveDmAllowState } from "./pi-tools.policy-BakY2muG.js";
import { g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./arg-split-Co_4JYiE.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DtRM7_DU.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-Dxc5qfRZ.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DjT2g1_v.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-1h3uBAK6.js";
import { a as resolveMemorySearchConfig, i as hasConfiguredMemorySecretInput } from "./manager-BrGg7Zo_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C1_d6sO6.js";
import { t as note$1 } from "./note-V9Ncupme.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-PQD9C42e.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-DhoIhEeS.js";
...
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D1tp6nTC.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-Bh02taAa.js";
import { a as isLaunchAgentLoaded, i as isLaunchAgentListed, n as resolveGatewayService, o as launchAgentPlistExists, s as repairLaunchAgentBootstrap, t as describeGatewayServiceRestart } from "./service-D6xYLXBx.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CpA8Fclk.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-Cam18og1.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DNUQyTN2.js";
import { r as healthCommand } from "./health-CNnkhoU1.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-CKtEVbXd.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-Bz1he1q8.js";
import { t as runGatewayUpdate, u as normalizeStoredCronJobs } from "./update-runner-C3-R1JW0.js";
import { n as logConfigUpdated } from "./logging-DRF_pgYm.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-CIgNtlR3.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-8PtscF3I.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-kucERJ7Z.js";
import { t as formatHealthCheckFailure } from "./health-format-Deh_UaRE.js";
import { n as doctorShellCompletion } from "./doctor-completion-CSMsEEQd.js";
