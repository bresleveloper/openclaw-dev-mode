...
import { s as upsertAuthProfileWithLock } from "./profiles-Bs4Dh6yw.js";
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-EY6njCR-.js";
import "./workspace-BJm9kqLw.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DxcLKNxD.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BcDHEQ9k.js";
import { n as t } from "./i18n-CSQb1QYq.js";
import { n as openUrl } from "./browser-open-B8ucEecq.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-D3ctmDzc.js";
import { t as isRemoteEnvironment } from "./remote-env-n-Ucnq3R.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DgmdmHix.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-gGQJF7pN.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-BbRV0SVs.js");
