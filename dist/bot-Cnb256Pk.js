...
import { g as sanitizeAgentId, h as resolveThreadSessionKeys, i as buildAgentMainSessionKey } from "./session-key-pTKRJb0m.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-C3ijpoNo.js";
import { c as warn, i as logVerbose, o as shouldLogVerbose, t as danger } from "./globals-BWmHKFNH.js";
import { i as getRuntimeConfig } from "./io-BJfjPmGW.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-D93_HOsR.js";
import { t as mutateConfigFile } from "./config-A41fTHlt.js";
import { u as fireAndForgetHook } from "./hook-runner-global-D4fQSLSV.js";
...
import { i as readRecentUserAssistantTextForSession } from "./transcript-BMyCREan.js";
...
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-kwzGSryO.js";
...
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-BM2LYNY0.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BSWTgtc4.js";
import { n as firstDefined } from "./allow-from-o-cfFFcK.js";
import { n as MediaFetchError } from "./fetch-UNNW3Fm6.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-ChiBnsqP.js";
import { t as resolveAckReaction } from "./identity-Bc-uwZ_Y.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-tytC94t4.js";
import { A as resolveTranscriptBackedChannelFinalText, D as resolveChannelStreamingPreviewToolProgress, S as resolveChannelStreamingBlockEnabled, d as isPotentialTruncatedFinal, i as buildChannelProgressDraftLineForEntry, j as selectLongerFinalText, r as buildChannelProgressDraftLine } from "./streaming-DDEnlnFD.js";
...
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-CMg35hQR.js";
import { s as formatReasoningMessage } from "./embedded-agent-utils-B9lC4_IJ.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-Dajvsx8b.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-YspKXCyk.js";
...
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-gLExuKrZ.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, t as CURRENT_MESSAGE_MARKER } from "./mentions-B1EJNjZS.js";
import { n as resolveStoredModelOverride } from "./stored-model-override-tn7a4ACx.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-BUxCG7NI.js";
import { a as isRecoverableTelegramNetworkError, c as isTelegramEditTargetMissingError, h as readTelegramRetryAfterMs, l as isTelegramMessageHasNoTextError, m as isTelegramServerError, p as isTelegramRateLimitError } from "./request-timeouts-CB0H7cNv.js";
...
import "./history-CQ6h-EJb.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-up_QEfXn.js";
import { t as createChannelHistoryWindow } from "./history-window-C9gdatqm.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-BlCHMd5G.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-uQh6I0SL.js";
import "./channel-policy-VIimbh8Q.js";
import "./reply-history-BGORyrel.js";
import { a as patchSessionEntry, i as loadSessionStore, n as getSessionEntry, r as listSessionEntries } from "./session-store-runtime-BlqMkGtn.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-CtUjmohb.js";
import "./approval-reply-runtime-Bn-lq_m4.js";
...
import { t as listSkillCommandsForAgents } from "./chat-commands-CKmd7VIS.js";
import { n as isBtwRequestText } from "./btw-command-DAZ6uZo1.js";
import { t as generateConversationLabel } from "./conversation-label-generator-BQSGncKD.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-De8wsidG.js";
import "./reply-chunking-DDVYtWXI.js";
import { f as runChannelInboundEvent } from "./inbound-reply-dispatch-BwzW5ed1.js";
import { a as resolveChannelDraftStreamingChunking, c as createMessageReceiveContext, i as createChannelProgressDraftCompositor } from "./channel-outbound-BNKGCEf1.js";
...
import "./model-session-runtime-DWOi79G3.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-iTQixAQZ.js";
import "./conversation-runtime-DL6fdg71.js";
import "./agent-runtime-BmugPmWq.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-DVoeKmsH.js";
import "./hook-runtime-CUCMEHpw.js";
import "./markdown-table-runtime-BLr9kTqt.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-DDNd74Nq.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BZpcaBLu.js";
import { n as formatModelsAvailableHeader } from "./commands-models-B1LkyO8_.js";
import "./command-auth-native-FMtoV7Ux.js";
import "./command-primitives-runtime-RaclS8BP.js";
import "./command-status-D23J4OBY.js";
import "./command-detection-B0C6PCEv.js";
import "./command-surface-CdchTutL.js";
import { i as resolveUnmentionedGroupInboundPolicy, l as shouldDebounceTextInbound, o as formatLocationText, r as classifyChannelInboundEvent, s as toLocationContext } from "./channel-inbound-BD86dwuq.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-Bo1DW6IF.js";
import "./channel-mention-gating-CzIPlkc4.js";
import { n as createChannelIngressResolver, o as defineStableChannelIngressIdentity } from "./message-access-CdFJfQ2z.js";
import "./channel-ingress-runtime-DWRe4gJp.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-BhZI8NmU.js";
import { i as readLatestAssistantTextByIdentity, s as resolveSessionTranscriptLegacyFileTarget, t as appendAssistantMirrorMessageByIdentity } from "./session-transcript-runtime-DzxUlAfq.js";
import "./models-provider-runtime-B14jP7ib.js";
import "./skill-commands-runtime-Dch_Dp_8.js";
import "./native-command-config-runtime-CTznHvNP.js";
import { t as mergeTelegramAccountConfig } from "./account-config-BKRZ3sTn.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-DIzB2twI.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-B_OLJQB9.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-Cj8LxtbK.js";
...
import { t as resolveTelegramInlineButtons } from "./button-types-BGJo6wbt.js";
import { c as renderTelegramHtmlText } from "./format-CHihbmMp.js";
import { t as loadTelegramSendModule } from "./send-runtime-DklSJdkw.js";
import { t as TELEGRAM_TEXT_CHUNK_LIMIT } from "./outbound-adapter-C2mgneVl.js";
...
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-C6JxOjWw.js";
import { c as commitTelegramMessageDispatchReplay, f as releaseTelegramMessageDispatchReplay, l as createTelegramMessageDispatchReplayGuard, s as claimTelegramMessageDispatchReplay, u as forgetTelegramMessageDispatchReplay } from "./message-dispatch-dedupe-C6uFvVMh.js";
import { r as cacheSticker } from "./sticker-cache-store-DsngcT6t.js";
import { r as createTelegramThreadBindingManager } from "./thread-bindings-BsYAm5ZR.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-C7HdiXmc.js";
import { t as describeStickerImage } from "./sticker-cache-CT_XCwvn.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-DyNYRrpl.js";
import { A as recordOutboundMessageForPromptContext, B as Bot, F as resolveTelegramClientTimeoutSeconds, H as sequentialize, I as resolveTelegramOutboundClientTimeoutFloorSeconds, M as asTelegramClientFetch, N as createTelegramClientFetch, P as resolveTelegramClientTimeoutMinimumSeconds, R as withTelegramApiErrorLogging, V as apiThrottler, _ as TELEGRAM_RICH_TEXT_LIMIT, a as editMessageTelegram, j as buildInlineKeyboard, v as buildTelegramRichHtml, w as splitTelegramRichMarkdownChunks, y as buildTelegramRichMarkdown, z as getOrCreateAccountThrottler } from "./send-fyju8PqW.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-CNR-dgbp.js";
import { a as buildPluginTelegramMenuCommands, i as buildCappedTelegramMenuCommands, n as resolveTelegramExecApproval, o as syncTelegramMenuCommands, r as createTelegramDraftStream, t as defaultTelegramBotDeps } from "./bot-deps-BF_ALD4f.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-D813xu9L.js";
...
function resolveTelegramScopedTranscriptSession(params) {
	...
	const sessionId = resolveSessionStoreEntry({
		store,
		sessionKey: params.sessionKey
...
function renderTelegramProgressLine(line) {
	...
	if (detail) parts.push(`<code>${escapeTelegramProgressHtml(clipProgressMarkdownText(detail))}</code>`);
	else {
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts, retryDispatchErrors = false, suppressFailureFallback = false }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-BHjqH6Ib.js")).defaultTelegramBotDeps;
...
function withTelegramSessionAccessorDeps(deps) {
	if (!deps.loadSessionStore) return {
		...deps,
		getSessionEntry: deps.getSessionEntry ?? getSessionEntry,
		listSessionEntries: deps.listSessionEntries ?? listSessionEntries
	};
	const listInjectedEntries = (scope = {}) => {
		const storePath = scope.storePath ?? deps.resolveStorePath(void 0, { agentId: scope.agentId });
	...
	return {
		...deps,
		getSessionEntry: deps.getSessionEntry ?? ((scope) => listInjectedEntries(scope).find(({ sessionKey }) => sessionKey === scope.sessionKey)?.entry),
