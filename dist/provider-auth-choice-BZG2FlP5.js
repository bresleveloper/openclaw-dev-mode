...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-D4KabxN2.js";
import "./workspace-DP5mE--D.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-D_D_9_cf.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-sTwxNMVI.js";
import { n as t } from "./i18n-C0k1rM_n.js";
import { n as openUrl } from "./browser-open-D6vrFVUc.js";
import { r as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-pG-7GzQG.js";
import { t as isRemoteEnvironment } from "./remote-env-UQ1pRGc-.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-mrkdMse_.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-DHtl_ERU.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-BASlDJ6w.js");
