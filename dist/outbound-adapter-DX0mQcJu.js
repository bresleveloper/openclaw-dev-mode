...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send2.components-C8lGRBg2.js").then((module) => module.sendDiscordComponentMessage);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-CQEtgwP1.js");
