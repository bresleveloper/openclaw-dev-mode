...
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-CzOMoNnT.js";
import { r as resolveCrestodianOperation } from "./dialogue-nPwj425r.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-DWykEHus.js")).runCrestodianTui;
	opts.onReady?.();
