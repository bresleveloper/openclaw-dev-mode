...
import { m as resolveUserPath, r as clampInt } from "./utils-BApvfmPs.js";
...
import "./clawhub-CzhGuc1t.js";
import { r as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-4yjZ5Paj.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CZE4dDG4.js";
import { c as resolveOfficialExternalPluginId, l as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage } from "./official-external-plugin-catalog-0lYbGRYY.js";
...
import { E as validateConfigObjectWithPlugins, M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, d as readConfigFileSnapshotForWrite, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-BJfjPmGW.js";
...
import "./installed-plugin-index-records-BiW0BXs2.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-DxaN427I.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-BjYy-zVW.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-YCvk6tfT.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-DCFxxcvt.js";
import { t as parseDurationMs } from "./parse-duration-Da6doDTX.js";
import { a as transformConfigFileWithRetry } from "./config-A41fTHlt.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-BUxITaVI.js";
import { g as triggerOpenClawRestart, p as scheduleGatewaySigusr1Restart } from "./restart-D2h2urGo.js";
import { o as normalizeChannelId } from "./registry-B5Y8tTE-.js";
import { n as getActivePluginChannelRegistry } from "./runtime-wIYJz8NY.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BGR46Oie.js";
import { F as resolveGroupSessionKey, _ as updateSessionStore, b as loadSessionStore, et as resolveSessionStoreEntry, s as getSessionEntry } from "./store-DJ7wx5_V.js";
import { a as resolveSessionFilePath, o as resolveSessionFilePathOptions, r as resolveDefaultSessionStorePath } from "./paths-CHZBIGhF.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-DnKj2WmH.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-DleKV4yQ.js";
import { r as isInternalMessageChannel } from "./message-channel-B4LS2Kcc.js";
...
import { g as patchSessionEntry } from "./session-accessor-Dx6KDG0K.js";
import { s as scanSessionTranscriptTree } from "./transcript-tree-3cM1TqAJ.js";
import { s as migrateSessionEntries } from "./session-manager-D5YeJxMM.js";
...
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-utMV3tcI.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-DWqW0PjJ.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-BI3m2RBP.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-Df6f9W0E.js";
import { h as replyRunRegistry } from "./reply-run-registry-BkKh9g6X.js";
import { f as resolveActiveEmbeddedRunSessionId } from "./run-state-rO_N-hh3.js";
import { i as formatEmbeddedAgentQueueFailureSummary, m as queueEmbeddedAgentMessageWithOutcomeAsync, s as isEmbeddedAgentRunActive } from "./runs-DXoQzrw0.js";
import { i as isSilentReplyPayloadText } from "./tokens-Zsy11rTo.js";
import { l as readSessionMessages } from "./session-utils.fs-CuEupzWa.js";
import "./sessions-gBZPP61K.js";
import { t as formatTokenCount } from "./token-format-D942KbWN.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-BMyCREan.js";
...
import { n as formatUsd } from "./usage-format-BDhkN63d.js";
import { r as deriveSessionTitle } from "./session-utils-CWlrm3MP.js";
...
import { r as parseSessionLabel } from "./openclaw-tools-DuRLihay.js";
import { n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-CRFhNm1X.js";
import { D as isRealConversationMessage } from "./attempt.model-diagnostic-events-DLRFJ0nE.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-C4SbQrlb.js";
import { a as clearSessionQueues } from "./queue-DlJx-5Kf.js";
import { o as resolveReplyToMode } from "./reply-threading-J9AZHHNY.js";
import { b as resolveBootstrapTotalMaxChars, v as resolveBootstrapMaxChars } from "./embedded-agent-helpers-D_zioqUQ.js";
import { n as routeReply } from "./route-reply-CZ7BP-Xv.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-CMg35hQR.js";
...
import { a as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus } from "./task-status-access-qAYBeBip.js";
...
import { n as buildThreadingToolContext } from "./agent-runner-utils-CJLj28TH.js";
import { o as markCommandSessionMetadataChanged, r as handleGoalCommand } from "./commands-goal-tMNRMkAI.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-Cfp_egAp.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-CzSygNut.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-B1EJNjZS.js";
...
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTarget } from "./abort-DsGPdXj8.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-DGlhRCyW.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-uQh6I0SL.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-ZDd9OTE7.js";
...
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-B41nRiqc.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-BVZ5cBki.js";
import { i as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-CKmd7VIS.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-Dy7rz44B.js";
import { t as extractBtwQuestion } from "./btw-command-DAZ6uZo1.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-DDNd74Nq.js";
import { r as handleModelsCommand } from "./commands-models-B1LkyO8_.js";
import { r as createExecTool } from "./bash-tools-CSJxwo6I.js";
import { t as runBtwSideQuestion } from "./btw-COqjEzMH.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-BMlJuNM3.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, l as stopWithText$1, o as resolveRequesterSessionKey } from "./shared-3KILQz-Y.js";
import { t as buildToolsMessage } from "./status-BEHwJLtD.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-BSyAMPwa.js";
import { t as runDevModeCommandMemoryFlush } from "./dev-mode-memory-flush-j9yBvG9y.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-GKr9WgkW.js";
import { n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-IT4YDj5c.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-72p9vCOv.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-BpVtgxjd.js";
import { t as buildNpmInstallRecordFields } from "./npm-resolution-CsO8XvKB.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-ClsvRrMQ.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-h7Dq7rqW.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-qK7bZwFD.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-BX1mg7MN.js";
import { r as createPluginInstallLogger, u as resolveFileNpmSpecToLocalPath } from "./plugins-command-helpers-B4rQf4Sa.js";
import { a as resolveInstallConfigMutationPreflights, o as selectInstallMutationWriteOptions, r as persistPluginInstall } from "./plugins-install-persist-BjirsLR_.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-DEGFVt_D.js";
import { n as installPluginFromClawHub } from "./clawhub-BS2MMidi.js";
import { a as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-BNj5UQ_6.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-BKw0_ree.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-CVFZB8AV.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-Bjbhp6Fp.js"));
...
const handleCompactCommand = async (params) => {
	...
	if (isDevMode()) await runDevModeCommandMemoryFlush(params, targetSessionEntry);
	...
	if (isDevMode() && result.ok && result.compacted && !codexNativeCompactionStarted) {
		const greetPrompt = "The session context was just compacted. Briefly greet the user now. Be yourself — use your configured persona, voice, and mood. Keep it to 1-2 sentences. Do not mention compaction, technical details, internal steps, or files.";
		const mutableCtx = params.ctx;
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BcU0NMHK.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-cuvaNfAu.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BuI7QEYm.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-Ls7ZePxM.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-BPaw3YR9.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-DUk-PDo6.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-D7D3HD-e.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-tElqijhz.js"));
