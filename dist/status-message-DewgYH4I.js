...
import { w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-CDZXADgT.js";
...
import { i as resolveSessionLifecycleTimestamps } from "./lifecycle-Bt8jrZbf.js";
import { r as readRecentSessionUsageFromTranscript } from "./session-transcript-readers-B1Z-s_uS.js";
...
import { w as resolveOpenAITextVerbosity } from "./proxy-KRYT2Ssd.js";
import { t as resolveCommitHash } from "./git-commit-DvoYfmyF.js";
import { n as findDecisionReason, s as summarizeDecisionReason } from "./runner.entries-B3Lx6qPP.js";
import { t as formatDurationCompact } from "./format-duration-BrZ-AaEJ.js";
import "./sandbox-yDmlXhAz.js";
import { i as resolveExtraParams } from "./extra-params-s21PGVlz.js";
import { t as resolveChannelModelOverride } from "./model-overrides-CgBDdsJs.js";
import { t as resolveAgentRuntimeLabel } from "./agent-runtime-label-DcYHUvFG.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as resolveSelectedAndActiveModel, t as formatProviderModelRef } from "./model-runtime-BB6gttUw.js";
import { t as resolveActiveFallbackState } from "./fallback-notice-state-D4aSJHJW.js";
...
function buildStatusMessage(args) {
	...
	const selectionConfig = { agents: { defaults: {
	...
	const runtimeLine = `⚙️ Runtime: ${activeModelLabel}${activeAuthLabelValue ? ` · 🔑 ${activeAuthLabelValue}` : ""}`;
	return [
		versionLine,
		args.timeLine,
		args.uptimeLine,
