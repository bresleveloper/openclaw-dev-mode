...
import { a as resolvePluginSetupRegistry, i as resolvePluginSetupProvider } from "./setup-registry-BbNqZjEi.js";
...
import { i as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-Bs4Dh6yw.js";
import { n as listProfilesForProvider } from "./profile-list-DcdGY7PM.js";
import { n as clearAuthProfileCooldown } from "./usage-CJb2EUW2.js";
...
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BcDHEQ9k.js";
...
import { a as loadValidConfigOrThrow, d as updateConfig, s as resolveKnownAgentId } from "./shared-BPNNLkzQ.js";
import { t as isRemoteEnvironment } from "./remote-env-n-Ucnq3R.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DgmdmHix.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-DZMQU2CA.js";
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-DYmU_OM8.js";
import { n as repairCopilotRuntimePluginInstallForModelSelection } from "./copilot-runtime-plugin-install-AFEW34hG.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-C3VZoo6M.js");
			await openUrl(url);
		}),
