...
import { d as toPinoLikeLogger, r as getChildLogger } from "./logger-DPps3u8A.js";
...
import { o as resolveWebCredsBackupPath, s as resolveWebCredsPath, t as assertWebCredsPathRegularFileOrMissing } from "./creds-files-Bri525Zn.js";
import { n as getStatusCode } from "./session-errors-BAj9D2La.js";
import { t as DEFAULT_WHATSAPP_SOCKET_TIMING } from "./socket-timing-nmoE1btQ.js";
import { C as waitForCredsSaveQueueWithTimeout, T as writeWebCredsRawAtomically, l as readCredsJsonRaw, v as resolveDefaultWebAuthDir, w as writeCredsJsonAtomically, x as enqueueCredsSave, y as restoreCredsFromBackupIfNeeded } from "./auth-store-Cmf6GUiW.js";
import { l as fetchLatestBaileysVersion, n as useMultiFileAuthState, r as makeCacheableSignalKeyStore, t as makeWASocket } from "./session.runtime-CjCAauxk.js";
...
async function createWaSocket(printQr, verbose, opts = {}) {
	...
	if (process.env.OPENCLAW_DEV_MODE === "1") try {
		const { attachWaHistoryLogger } = await import("./wa-history-CfXbg--w.js");
