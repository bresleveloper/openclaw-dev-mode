...
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId, r as createQueuedTaskRun, u as startTaskRunByRunId } from "./detached-task-runtime-BFt5Tdox.js";
...
import { u as findActiveSessionTask } from "./openclaw-tools-B3hsrynK.js";
import { t as log$1 } from "./logger-DibNup0x.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-HQtTuEya.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-DnHSVpVA.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInRuntimeTranscript } from "./transcript-rewrite-CO2KuAHs.js";
import { m as resolveContextEngineCapabilities, n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext } from "./attempt.prompt-helpers-D6a_IsDy.js";
...
async function runCoreAgentEndSideEffects(params) {
	try {
		const { runSkillResearchAutoCapture } = await import("./autocapture-t5AateYR.js");
