...
import { d as isValidEnvSecretRefId, g as resolveSecretInputRef, s as coerceSecretRef } from "./types.secrets-lIZQEgMF.js";
...
import { a as isValidFileSecretRefId, i as isValidExecSecretRefId, l as secretRefKey, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage, u as validateExecSecretRefId } from "./ref-contract-BWYV5Pqz.js";
import { a as resolveSecretRefValue, l as resolveSecretProviderIntegrationConfig, s as isPluginIntegrationSecretProviderConfig } from "./resolve-g6T_0Auy.js";
import { n as normalizeAgentModelRefForConfig, t as normalizeAgentModelMapForConfig } from "./model-input-BHKiDwaq.js";
import { T as SecretProviderSchema } from "./zod-schema.core-DGUr-AGH.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-BJtwkAs2.js";
import { c as warn, n as info, r as isDevMode, s as success, t as danger } from "./globals-BWmHKFNH.js";
import { K as AUTO_MANAGED_CONFIG_META_PATHS, S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, u as readConfigFileSnapshot } from "./io-BJfjPmGW.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-GKr9WgkW.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-DQvIc3YE.js");
