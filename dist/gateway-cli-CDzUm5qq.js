...
import { a as setConsoleSubsystemFilter, d as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-D-lLN9nd.js";
import "./boolean-DTgd5CzD.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { Bt as looksLikeAvatarPath, Cn as applyLegacyMigrations, Cr as resolveHooksGmailModel, Er as resolveSubagentConfiguredModelSelection, Ft as isAvatarHttpUrl, G as readConfigFileSnapshotForWrite, H as loadConfig, In as buildTalkConfigResponse, It as isAvatarImageDataUrl, J as writeConfigFile, K as resolveConfigSnapshotHash, L as migrateLegacyConfig, Ln as resolveAgentMaxConcurrent, Ni as DEFAULT_MODEL, Nt as AVATAR_MAX_BYTES, Oi as normalizeSecretInput, Or as resolveThinkingDefault, Pi as DEFAULT_PROVIDER, Rn as resolveSubagentMaxConcurrent, Sn as applyMergePatch, Sr as resolveDefaultModelForAgent, U as parseConfigJson5, W as readConfigFileSnapshot, X as OpenClawSchema, Y as validateConfigObjectWithPlugins, _t as parseByteSize, dr as getModelRefStatus, gr as normalizeModelSelection, gt as parseDurationMs, or as isPidAlive, pr as isCliProvider, sr as buildAllowedModelSet, wn as ensureControlUiAllowedOriginsForNonLoopbackBind, xr as resolveConfiguredModelRef, yr as resolveAllowedModelRef, z as createConfigIO } from "./auth-profiles-gyYFUuWS.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-Cp0IkEKB.js";
import { S as isCronRunSessionKey, T as parseAgentSessionKey, _ as normalizeAccountId$1, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, h as toAgentStoreSessionKey, l as normalizeMainKey, m as toAgentRequestSessionKey, o as classifySessionKeyShape, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, w as isSubagentSessionKey } from "./session-key-DmlQCuju.js";
...
import { a as openBoundaryFileSync, f as isNotFoundPathError, g as matchesSkillFilter, i as openBoundaryFile, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-D_NGSHjv.js";
import { i as logWarn, t as logDebug } from "./logger-lJby90xW.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-9-lXnoNH.js";
...
import { C as clearInternalHooks, E as triggerInternalHook, T as registerInternalHook, h as createEmptyPluginRegistry, t as CHANNEL_IDS, u as getActivePluginRegistry, w as createInternalHookEvent } from "./registry-XwiWGUVE.js";
import { u as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DpwUhr6x.js";
import "./dock-DXYDVeNl.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-CUD3GCdK.js";
import { $ as getCliSessionId, $n as listDescendantRunsForRequester, $r as resetAllLanes, $t as deferGatewayRestartUntilIdle, At as normalizeRequiredName, Bn as normalizeSendPolicy, Br as resolveTtsConfig, Bt as isExternalHookSession, C as resolveAgentDeliveryPlan, Cr as resolveBootstrapWarningSignaturesSeen, Ct as normalizeCronJobCreate, D as createOutboundSendDeps$1, Dr as resolveAgentIdentity, Dt as normalizeOptionalSessionKey, E as createDefaultDeps, Er as resolveAgentSessionDirs, Et as normalizeOptionalAgentId, F as createReplyPrefixOptions, Fn as extractFileContentFromSource, Fr as getTtsProvider, Gn as stopSubagentsForRequester, Gr as textToSpeech, Hr as resolveTtsProviderOrder, Ht as applyBrowserProxyPaths, I as buildHistoryContextFromEntries, In as extractImageContentFromSource, Ir as isTtsEnabled, J as createReplyDispatcher, Jn as countActiveDescendantRuns, Kr as OPENAI_TTS_MODELS, Ln as normalizeMimeList, Lr as isTtsProviderConfigured, Lt as buildSafeExternalPrompt, Mn as DEFAULT_INPUT_IMAGE_MAX_BYTES, Mt as buildDeliveryFromLegacyPayload, Nn as DEFAULT_INPUT_IMAGE_MIMES, Nr as clearBootstrapSnapshot, Nt as hasLegacyDeliveryHints, Ot as normalizeOptionalText, Pn as DEFAULT_INPUT_TIMEOUT_MS, Pr as clearBootstrapSnapshotOnSessionRollover, Pt as stripLegacyDeliveryFields, Q as buildBareSessionResetPrompt, Qr as markGatewayDraining, Qt as consumeGatewaySigusr1RestartAuthorization, Rn as resolveInputFileLimits, Rr as resolveTtsApiKey, Rt as detectSuspiciousPatterns, Sn as isSystemEventContextChanged, St as normalizeHttpWebhookUrl, T as createOutboundSendDeps, Tn as requestHeartbeatNow, Tr as getAcpSessionManager, Tt as inferLegacyName, Ur as setTtsEnabled, Ut as persistBrowserProxyFiles, Vn as resolveSendPolicy, Vr as resolveTtsPrefsPath, Vt as closeTrackedBrowserTabsForSessions, Wn as isAbortRequestText, Wr as setTtsProvider, Wt as resolveSessionAuthProfileOverride, Xt as applyVerboseOverride, Y as getTotalPendingReplies, Yr as getActiveTaskCount, Yt as applyModelOverrideToSessionEntry, Zn as initSubagentRegistry, Zr as getTotalQueueSize, Zt as parseVerboseOverride, _ as requestBodyErrorToText, _r as emitAgentEvent, _t as formatRestartSentinelMessage, a as getPluginToolMeta, ai as stripHeartbeatToken, an as setPreRestartDeferralCheck, ar as runSubagentAnnounceFlow, at as resolveOutboundSessionRoute, br as registerAgentRunContext, c as loadOpenClawPlugins, cn as normalizeGroupActivation, cr as clearSessionQueues, ct as resolveOutboundTarget, dr as abortEmbeddedPiRun, ei as setCommandLaneConcurrency, en as emitGatewayRestart, et as setCliSessionId, fr as getActiveEmbeddedRunCount, ft as resetDirectoryCache, g as readJsonBodyWithLimit, gr as clearAgentRunContext, gt as formatDoctorNonInteractiveHint, h as handleSlackHttpRequest, hr as resolveCronStyleNow, ht as consumeRestartSentinel, in as setGatewaySigusr1RestartPolicy, ir as resolveAgentTimeoutMs, it as ensureOutboundSessionEntry, j as resolveAgentAvatar, jr as resolveUserTimezone, jt as migrateLegacyCronPayload, kt as normalizePayloadToSystemText, l as createPluginRuntime, lr as buildOutboundSessionContext, lt as resolveSessionDeliveryTarget, mn as formatZonedTimestamp, mt as runWithModelFallback, n as applyToolPolicyPipeline, ni as CommandLane, nn as markGatewaySigusr1RestartHandled, nt as createOpenClawTools, o as resolvePluginTools, on as triggerOpenClawRestart, or as resolveAnnounceTargetFromKey, p as resolveAgentOutboundIdentity, pr as waitForEmbeddedPiRunEnd, q as dispatchInboundMessage, qr as OPENAI_TTS_VOICES, r as buildDefaultToolPolicyPipelineSteps, rn as scheduleGatewaySigusr1Restart, sn as unbindThreadBindingsBySessionKey, sr as readLatestAssistantReply, ti as waitForActiveTasks, tn as isGatewaySigusr1RestartExternallyAllowed, tt as runCliAgent, un as loadProviderUsageSummary, ur as runEmbeddedPiAgent, ut as resolveOutboundChannelPlugin, vr as getAgentRunContext, w as resolveAgentOutboundTarget, wt as normalizeCronJobPatch, x as agentCommandFromIngress, xn as enqueueSystemEvent, xt as writeRestartSentinel, yr as onAgentEvent, yt as summarizeRestartSentinel, zr as resolveTtsAutoMode, zt as getHookType } from "./compact-XX-hsoMs.js";
import { i as resolveWhatsAppAccount } from "./accounts-CCmToVwr.js";
import { n as listChannelPlugins, o as normalizeWhatsAppTarget, r as normalizeChannelId, t as getChannelPlugin, v as buildChannelAccountBindings } from "./plugins-BlxnRrWB.js";
import "./logging-DE_Gv8EN.js";
import "./send-FWVmVFhT.js";
import "./send-DX33HORc.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-CurmEH4i.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-BUdkAC0t.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, h as isDiagnosticsEnabled } from "./diagnostic-C4jALEeI.js";
import "./accounts-D9cGmSBd.js";
import { c as detectMime } from "./image-ops-ChuMRt4V.js";
import { b as resolveCronStorePath, x as saveCronStore, y as loadCronStore } from "./send-DX_jC4JY.js";
import "./pi-model-discovery-CUF-k9xj.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CBxyiPG1.js";
import "./pi-embedded-helpers-B5Fkq6oo.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-D8HChyNU.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-CFg6jrp9.js";
import "./chrome-C9-sDY0x.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DUAiX-L-.js";
import { t as safeEqualSecret } from "./secret-equal-BpENUFFz.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-_7OomAtX.js";
import { c as normalizeHostHeader, d as resolveGatewayBindHost, f as resolveGatewayListenHosts, i as isLoopbackHost, l as pickPrimaryLanIPv4, n as isLocalishHost, o as isTrustedProxyAddress, r as isLoopbackAddress, s as isValidIPv4, t as rawDataToString, u as resolveClientIp } from "./ws-skc9U6x4.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-yZ8XbKKh.js";
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-3Ig2duxc.js";
import { f as hasBinary } from "./frontmatter-BXR2CPEl.js";
import "./env-overrides-0y0M3S6P.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-CNI693yM.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BNw7KbKP.js";
import "./paths-SRstzZpm.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-DWAErDjv.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-LFbAe3gQ.js";
import { i as openFileWithinRoot, l as writeFileWithinRoot, s as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-DmQzjIXC.js";
import { n as SsrFBlockedError } from "./proxy-env-BMOu-Lae.js";
import { n as cleanOldMedia } from "./store-CEVnidlh.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-B4ivsR6D.js";
import { t as movePathToTrash } from "./trash-sFfWaYz5.js";
import "./server-middleware-CNN87dgY.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-BukBjuGX.js";
import { $ as resolveExplicitAgentSessionKey, A as cleanupArchivedSessionTranscripts, B as jsonUtf8Bytes, C as mergeDeliveryContext, D as archiveFileOnDisk, F as stripEnvelopeFromMessage, H as evaluateSessionFreshness, I as stripEnvelopeFromMessages, J as mergeSessionEntry, M as readSessionPreviewItemsFromTranscript, O as archiveSessionTranscripts, P as resolveSessionTranscriptCandidates, Q as resolveAgentMainSessionKey, R as stripInlineDirectiveTagsForDisplay, T as normalizeSessionDeliveryFields, W as resolveSessionResetPolicy, X as setSessionRuntimeModel, Z as canonicalizeMainSessionAlias, et as resolveMainSessionKey, j as readSessionMessages, k as capArrayByJsonBytes, n as parseSessionThreadInfo, o as archiveRemovedSessionTranscripts, p as updateSessionStore, rt as snapshotSessionOrigin, s as loadSessionStore, t as extractDeliveryInfo, tt as resolveMainSessionKeyFromConfig, ut as cleanStaleLockFiles, x as deliveryContextFromSession, z as stripInlineDirectiveTagsFromMessageForDisplay } from "./sessions-BzabF1Rs.js";
import "./accounts-B9MZJeQz.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-m-ckvfYo.js";
import { i as normalizeInputProvenance } from "./input-provenance-B1DXZ6MN.js";
import "./chat-envelope-BCgyDMmT.js";
import { o as estimateBase64DecodedBytes } from "./tool-images-DCz3azK8.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-WUzZvd36.js";
...
import { n as loadModelCatalog } from "./model-catalog-Cht1UAhe.js";
import "./fetch-BhsN1WTe.js";
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-Vpl4r9ni.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-NqpaSn2l.js";
import { b as extractTextFromChatContent } from "./image-DP_4KiO7.js";
...
import { a as ToolInputError } from "./target-errors-ChS8lQ-P.js";
import { r as isRestartEnabled } from "./commands-DTZsXlMV.js";
import "./commands-registry-D66o69fc.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-Bnl8KzY4.js";
...
import { n as GATEWAY_AUTH_SURFACE_PATHS, p as isKnownSecretTargetId, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-jWlsdfoA.js";
import "./command-secret-targets-CJcKbZna.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BTGTJOdS.js";
import "./prompt-style-Dnaodfgg.js";
import "./pairing-labels-mfolQ1Hi.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-CuEbXeqv.js";
import { i as resolveMemorySearchConfig } from "./manager-Db4cJ-bt.js";
import { t as formatDocsLink } from "./links-CPpbuTOP.js";
import { n as runCommandWithRuntime } from "./cli-utils-BQZi5I0U.js";
import { t as formatHelpExamples } from "./help-format-D4-SjylN.js";
import { n as withProgress } from "./progress-Dfes2lhw.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BCLAcEcj.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CHxgBHjY.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DWX_ZeY2.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-Bo0ZsuAt.js";
import { n as inheritOptionFromParent } from "./command-options-Dh89_DYm.js";
import { t as WizardCancelledError } from "./prompts-dAMVFUCg.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-Bv5Lxx38.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-B1wh6BzJ.js";
import { t as isWithinDir } from "./path-safety-B9Yv52BJ.js";
import "./install-safe-path-vhpDuA6V.js";
import "./skill-scanner-CyMFsA4G.js";
import { n as formatConfigIssueLines } from "./issue-format-StXK2M5y.js";
import { t as buildChannelAccountSnapshot } from "./status-CxR6l5bw.js";
import "./channels-status-issues-Z0pCwqMK.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-8B4clBIA.js";
...
import "./lifecycle-core-DyBcUGBt.js";
import "./systemd-hints-DV5bUtcT.js";
import { t as parsePort$1 } from "./parse-port-CDgI2w-h.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-D1jDO2n0.js";
import { t as probeGateway } from "./probe-Zr9zZfR2.js";
import "./diagnostics-B19cf4jJ.js";
import "./table-NdG_Wera.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-hPVig5T6.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-ZUkX43bn.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BVe5aq4G.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-3yotq78d.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-RmOQmHys.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-Cjo7QX_h.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BDr8SzIl.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-DPwavNTT.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-C9vji29t.js";
import "./onboarding.secret-input-CRUZgOmd.js";
import { t as runOnboardingWizard } from "./onboarding-CfD9oSNE.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-BVOs5VBt.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-BXu0FH_M.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-DcqyJZKz.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-B4CPGlZ2.js";
import "./node-service-4y_2E5g2.js";
import "./status.update-CxIXZVDE.js";
import { t as installSkill } from "./skills-install-CpGZLip-.js";
import { t as runGatewayUpdate } from "./update-runner-BpgfQgSf.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-cqlwHDOv.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-CoeeKqt0.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-8G0R8C60.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-Bnl8KzY4.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-D9bNYYRE.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-C194SQuq.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-BUdkAC0t.js").then((n) => n.n);
