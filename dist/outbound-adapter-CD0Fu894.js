...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send2.components-BD4EDFme.js").then((module) => module.sendDiscordComponentMessage);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-hRiRFwNC.js");
