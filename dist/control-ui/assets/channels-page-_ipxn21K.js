import{n as e,r as t,t as n}from"./decorate-CUyPCN2p.js";import{f as r,g as i,h as a,m as o}from"./lit-runtime-B2f-BITn.js";import{r as s}from"./i18n-Cb2Gon67.js";import{Ct as c,Fr as l,L as u,Pr as d,Sr as f,St as p,br as m,wt as h}from"./index-CSGke-Z7.js";import{t as g}from"./settings-workspace-DV2kj5Je.js";import{i as _,t as v}from"./config-form-DHjq49u6.js";function y(e){let{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function b(e){let{state:t,callbacks:n,accountId:r}=e,o=y(t),c=(e,r,o={})=>{let{type:s=`text`,placeholder:c,maxLength:l,help:u}=o,d=t.values[e]??``,f=t.fieldErrors[e],p=`nostr-profile-${e}`;return s===`textarea`?i`
  ...
  `}function N(e,t){return t?.[e]?.length??0}function P(e,t){let n=N(e,t);return n<2?a:i`<div class="account-count">Accounts (${n})</div>`}function F(e){let{props:t,discord:n,accountCountLabel:r}=e,o=A(`discord`,t);return M({title:`Discord`,subtitle:`Bot status and channel configuration.`,accountCountLabel:r,statusRows:[{label:s(`common.configured`),value:j(o)},{label:s(`common.running`),value:n?.running?s(`common.yes`):s(`common.no`)},{label:s(`common.lastStart`),value:n?.lastStartAt?m(n.lastStartAt):s(`common.na`)},{label:s(`common.lastProbe`),value:n?.lastProbeAt?m(n.lastProbeAt):s(`common.na`)}],lastError:n?.lastError,secondaryCallout:n?.probe?i`<div class="callout" style="margin-top: 12px;">
      ...
      <button class="btn" @click=${()=>t.onRefresh(!0)}>${s(`common.probe`)}</button>
    </div>`})}function R(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:s(`common.na`)}function z(e){let{props:t,nostr:n,nostrAccounts:r,accountCountLabel:o,profileFormState:c,profileFormCallbacks:l,onEditProfile:u}=e,d=r[0],f=n?.configured??d?.configured??!1,p=n?.running??d?.running??!1,h=n?.publicKey??d?.publicKey,g=n?.lastStartAt??d?.lastStartAt??null,_=n?.lastError??d?.lastError??null,v=r.length>1,y=c!=null,x=e=>{let t=e.publicKey,n=e.profile;return i`
      <div class="account-card">
        ...
        <div class="status-list account-card-status">
          ...
          <div>
            ...
            <span
              >${e.lastInboundAt?m(e.lastInboundAt):s(`common.na`)}</span
            >
          </div>
  ...
  `}function B(e){let{props:t,signal:n,accountCountLabel:r}=e,o=A(`signal`,t);return M({title:`Signal`,subtitle:`signal-cli status and channel configuration.`,accountCountLabel:r,statusRows:[{label:s(`common.configured`),value:j(o)},{label:s(`common.running`),value:n?.running?s(`common.yes`):s(`common.no`)},{label:s(`common.baseUrl`),value:n?.baseUrl??s(`common.na`)},{label:s(`common.lastStart`),value:n?.lastStartAt?m(n.lastStartAt):s(`common.na`)},{label:s(`common.lastProbe`),value:n?.lastProbeAt?m(n.lastProbeAt):s(`common.na`)}],lastError:n?.lastError,secondaryCallout:n?.probe?i`<div class="callout" style="margin-top: 12px;">
    ...
    `:M({title:`Telegram`,subtitle:`Bot status and channel configuration.`,accountCountLabel:o,statusRows:[{label:s(`common.configured`),value:j(l)},{label:s(`common.running`),value:n?.running?s(`common.yes`):s(`common.no`)},{label:s(`common.mode`),value:n?.mode??s(`common.na`)},{label:s(`common.lastStart`),value:n?.lastStartAt?m(n.lastStartAt):s(`common.na`)},{label:s(`common.lastProbe`),value:n?.lastProbeAt?m(n.lastProbeAt):s(`common.na`)}],lastError:n?.lastError,secondaryCallout:n?.probe?i`<div class="callout" style="margin-top: 12px;">
      ...
      <button class="btn" @click=${()=>t.onRefresh(!0)}>${s(`common.probe`)}</button>
    </div>`})}function U(e){let{props:t,whatsapp:n,accountCountLabel:r}=e,o=A(`whatsapp`,t),c=n?.linked===!0,l=t.whatsappQrDataUrl!=null;return M({title:`WhatsApp`,subtitle:`Link WhatsApp Web and monitor connection health.`,accountCountLabel:r,statusRows:[{label:s(`common.configured`),value:j(o)},{label:s(`common.linked`),value:n?.linked?s(`common.yes`):s(`common.no`)},{label:s(`common.running`),value:n?.running?s(`common.yes`):s(`common.no`)},{label:s(`common.connected`),value:n?.connected?s(`common.yes`):s(`common.no`)},{label:s(`common.lastConnect`),value:n?.lastConnectedAt?m(n.lastConnectedAt):s(`common.na`)},{label:s(`common.lastMessage`),value:n?.lastMessageAt?m(n.lastMessageAt):s(`common.na`)},{label:s(`common.authAge`),value:n?.authAgeMs==null?s(`common.na`):f(n.authAgeMs)}],lastError:n?.lastError,extraContent:i`
    ...
    <section class="card" style="margin-top: 18px;">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="muted">
          ${e.lastSuccessAt?m(e.lastSuccessAt):s(`common.na`)}
        </div>
      </div>
      ${h?i`
...
//# sourceMappingURL=channels-page-_ipxn21K.js.map