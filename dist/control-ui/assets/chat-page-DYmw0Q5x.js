...
`)){r+=1;continue}let i=ma(e,r),a=Ea(e,i)?.end??Aa(e,i);if(a===null){r+=1;continue}t+=e.slice(n,r),n=a;let o=ga(e,n);o!==null&&(n=o),r=n}return t+=e.slice(n),t}function Na(e){let t=[];for(let n of e.matchAll(/(^|\n)(```|~~~)[^\n]*\n[\s\S]*?(?:\n\2|$)/g)){let e=(n.index??0)+n[1].length;t.push({start:e,end:e+n[0].length-n[1].length})}for(let n of e.matchAll(/`+[^`]+`+/g)){let e=n.index??0,r=e+n[0].length;t.some(t=>e>=t.start&&r<=t.end)||t.push({start:e,end:r})}return t.sort((e,t)=>e.start-t.start),t}function Pa(e,t){return t.some(t=>e>=t.start&&e<t.end)}var Fa=/<[|｜][^|｜]*[|｜]>/g;function Ia(e,t,n){return n.some(n=>e<n.end&&t>n.start)}function La(e,t){return!!(e&&t&&!/\s/.test(e)&&!/\s/.test(t))}function Ra(e){if(!e||(Fa.lastIndex=0,!Fa.test(e)))return e;Fa.lastIndex=0;let t=Na(e),n=``,r=0;for(let i of e.matchAll(Fa)){let a=i[0],o=i.index??0,s=o+a.length;n+=e.slice(r,o),Pa(o,t)||Ia(o,s,t)?n+=a:La(e[o-1],e[s])&&(n+=` `),r=s}return n+=e.slice(r),n}var za=/<[^<>]*>/g;function Ba(e){return/\s/.test(e)}function Va(e){let t=0;for(;t<e.length;){for(;t<e.length&&Ba(e[t]??``);)t+=1;if(t>=e.length)return!0;let n=t;for(;t<e.length;){let n=e[t]??``;if(Ba(n)||n===`=`)break;if(n===`/`||n===`"`||n===`'`||n===`<`||n===`>`)return!1;t+=1}if(t===n)return!1;for(;t<e.length&&Ba(e[t]??``);)t+=1;if(e[t]!==`=`)continue;for(t+=1;t<e.length&&Ba(e[t]??``);)t+=1;if(t>=e.length)return!1;let r=e[t];if(r===`"`||r===`'`){t+=1;let n=e.indexOf(r,t);if(n===-1)return!1;t=n+1;continue}let i=t;for(;t<e.length&&!Ba(e[t]??``);){let n=e[t]??``;if(n===`"`||n===`'`||n===`<`||n===`>`)return!1;t+=1}if(t===i)return!1}return!0}function Ha(e){if(!e.startsWith(`<`)||!e.endsWith(`>`))return null;let t=e.slice(1,-1).trimStart(),n=!1;if(t.startsWith(`/`)&&(n=!0,t=t.slice(1).trimStart()),!t.toLowerCase().startsWith(`final`))return null;let r=t[5]??``;if(r&&!Ba(r)&&r!==`/`)return null;let i=t.slice(5);if(n)return i.trim().length===0?{isClose:!0,isSelfClosing:!1}:null;let a=i.trimEnd(),o=a.endsWith(`/`);return i=o?a.slice(0,-1):i,Va(i)?{isClose:!1,isSelfClosing:o}:null}function Ua(e){let t=[];for(let n of e.matchAll(za)){let e=n[0],r=Ha(e);r&&t.push({index:n.index??0,text:e,...r})}return t}var Wa=/<\s*\/?\s*(?:(?:antml:|mm:)?(?:think(?:ing)?|thought)|antthinking|final)\b/i,Ga=/<\s*(\/?)\s*(?:(?:antml:|mm:)?(?:think(?:ing)?|thought)|antthinking)\b[^<>]*>/gi;function Ka(e,t){return t===`none`?e:t===`start`?e.trimStart():e.trim()}function qa(e){return e.before.trim().length>0&&e.after.trim().length>0}function Ja(e,t,n){for(let r of e.slice(t).matchAll(Ga))if(!Pa(t+(r.index??0),n)&&r[1]===`/`)return!0;return Ga.lastIndex=0,!1}function Ya(e,t){if(!e||!Wa.test(e))return e;let n=t?.mode??`strict`,r=t?.trim??`both`,i=t?.scope??`all`,a=e,o=Ua(a);Ga.lastIndex=0;let s=Ga.test(a);if(Ga.lastIndex=0,o.length===0&&!s)return e;if(o.length>0){let e=[],t=Na(a);for(let n of o){let r=n.index;e.push({start:r,length:n.text.length,inCode:Pa(r,t)})}for(let t=e.length-1;t>=0;t--){let n=e[t];n.inCode||(a=a.slice(0,n.start)+a.slice(n.start+n.length))}}let c=Na(a);Ga.lastIndex=0;let l=``,u=0,d=0,f;for(let e of a.matchAll(Ga)){let t=e.index??0,n=e[1]===`/`;if(!Pa(t,c)){if(d===0){if(i===`leading`&&!n&&(l+a.slice(u,t)).trim().length>0&&!Ja(a,t+e[0].length,c))return Ka(l+a.slice(u),r);if(n){let n=t+e[0].length,r=a.slice(u,t);qa({before:r,after:a.slice(n)})?l=``:l+=r,u=n;continue}l+=a.slice(u,t),d=1,f=t+e[0].length}else n?(--d,d===0&&(f=void 0)):d+=1;u=t+e[0].length}}(d===0||n===`preserve`)&&(l+=a.slice(u));let p=Ka(l,r);return n===`strict`&&d>0&&!p&&f!==void 0&&a.trim()?Ka(a.slice(f),r):p}var Xa=/<\s*(\/?)\s*relevant[-_]memories\b[^<>]*>/gi,Za=/<\s*\/?\s*relevant[-_]memories\b/i,Qa=/\[\s*\/?\s*TOOL_(?:CALL|RESULT)\s*\]/i,$a=/(?:📊|🛠️|📖|📝|🔍|🔎|⚙️|tool[-_ ]?call|tool[-_ ]?result|function[-_ ]?call)/i,eo=/^(?:>\s*)?(?:⚠️\s*)?(?:📊|🛠️|📖|📝|🔍|🔎|⚙️)\s*(?:Session Status|Exec|Read|Edit|Write|Patch|Search|Open|Click|Find|Screenshot|Update Plan|Tool Call|Tool Result|Function Call|Shell|Command)\s*:/i,to=/^(?:>\s*)?⚠️\s*🛠️\s+\S[\s\S]*\s+\(agent\)`{0,2}\s+failed(?:\s*:.*)?\s*$/i,no=/^(?:>\s*)?🛠️\s*(?:(?:(?:elevated|pty)\b\s*(?:·|,)\s*)+)?(?:`{1,2}\s*\S|(?:run|check|fetch|pull|push|view|show|list|switch|create|merge|rebase|stage|restore|reset|stash|search|find|print|copy|move|remove|install|start|cd|git|pnpm|npm|yarn|bun|node|python|python3|bash|sh)\b)/i,ro=/^(?:>\s*)?(?:tool[-_ ]?call|tool[-_ ]?result|function[-_ ]?call)\s*[:=]/i,io=/<\s*\/?\s*(?:antml:)?(?:tool_call|tool_result|function_calls?|function_response|function|tool_calls|invoke|parameter)\b/i,ao=new Set([`tool_call`,`tool_result`,`function_call`,`function_calls`,`function_response`,`function`,`tool_calls`,`antml:invoke`,`antml:parameter`]),oo=/^(?:\s+[A-Za-z_:][-A-Za-z0-9_:.]*\s*=\s*(?:"[^"]*"|'[^']*'|[^\s"'=<>`]+))*\s*(?:\r?\n\s*)?[[{]/,so=/^\s*(?:\r?\n\s*)?<(?:antml:)?(?:function_call|tool_call|function|invoke|parameters?|arguments?)\b/i,co=/^\s*(?:\r?\n\s*)?<(?:function_call|tool_call)\b/i;function lo(e,t,n){let r=null,i=!1;for(let a=t;a<n;a+=1){let t=e[a];if(r===null){(t===`"`||t===`'`)&&(r=t);continue}if(i){i=!1;continue}if(t===`\\`){i=!0;continue}t===r&&(r=null)}return r!==null}function uo(e,t){if(e[t]!==`<`)return null;let n=t+1;for(;n<e.length&&/\s/.test(e[n]);)n+=1;let r=!1;if(e[n]===`/`)for(r=!0,n+=1;n<e.length&&/\s/.test(e[n]);)n+=1;let i=n;if(!/[A-Za-z_:]/.test(e[n]??``))return null;for(n+=1;n<e.length&&/[A-Za-z0-9_.:-]/.test(e[n]);)n+=1;let a=O(e.slice(i,n));if(!fo(e[n]))return null;let o=n,s=po(e,n);return s===-1?{contentStart:o,end:e.length,isClose:r,isSelfClosing:!1,tagName:a,isTruncated:!0}:{contentStart:o,end:s+1,isClose:r,isSelfClosing:!r&&/\/\s*$/.test(e.slice(n,s)),tagName:a,isTruncated:!1}}function fo(e){return!e||/\s/.test(e)||e===`/`||e===`>`}function po(e,t){let n=null,r=!1;for(let i=t;i<e.length;i+=1){let t=e[i];if(n!==null){if(r){r=!1;continue}if(t===`\\`){r=!0;continue}t===n&&(n=null);continue}if(t===`"`||t===`'`){n=t;continue}if(t===`<`)return-1;if(t===`>`)return i}return-1}function mo(e,t){let n=e.slice(t);return oo.test(n)?`json`:so.test(n)?`xml`:null}function ho(e,t){if(!co.test(e.slice(t)))return!1;let n=t;for(;n<e.length&&/\s/.test(e[n]);)n+=1;let r=wo(e,n);return!r||r.isClose||r.isSelfClosing||r.isTruncated||r.tagName!==`function_call`&&r.tagName!==`tool_call`?!1:oo.test(e.slice(r.end))}function go(e,t,n){if(n.tagName!==`function`||n.isClose||n.isSelfClosing||n.isTruncated||!/\bname\s*=/.test(e.slice(n.contentStart,n.end)))return!1;let r=t-1;for(;r>=0&&(e[r]===` `||e[r]===`	`);)--r;return r<0||e[r]===`
`||e[r]===`\r`||/[.!?:]/.test(e[r])}function _o(e,t,n){let r=t-1;for(;r>=0&&(e[r]===` `||e[r]===`	`);)--r;if(!(r<0||e[r]===`
`||e[r]===`\r`))return!1;let i=n.end;for(;i<e.length&&(e[i]===` `||e[i]===`	`);)i+=1;return i>=e.length||e[i]===`
`||e[i]===`\r`}function vo(e,t){let n=t.end;for(;n<e.length&&(e[n]===` `||e[n]===`	`);)n+=1;return n>=e.length||e[n]===`
`||e[n]===`\r`}function yo(e,t){let n=t.end;for(;n<e.length&&(e[n]===` `||e[n]===`	`);)n+=1;return n<e.length&&e[n]!==`
`&&e[n]!==`\r`}function bo(e){let t=e.length-1;for(;t>=0&&(e[t]===` `||e[t]===`	`);)--t;return t<0||e[t]===`
`||e[t]===`\r`}function xo(e,t,n){if(n===null||n>t)return!1;for(let r=n;r<t;r+=1)if(e[r]!==` `&&e[r]!==`	`&&e[r]!==`
`&&e[r]!==`\r`)return!1;return!0}function So(e,t,n){for(let r=t;r<e.length;r+=1){if(e[r]!==`<`)continue;let t=wo(e,r);if(t){if(t.isClose&&t.tagName===n&&!t.isTruncated)return r;r=Math.max(r,t.end-1)}}return-1}function Co(e,t,n){let r=t;for(;r<e.length&&/\s/.test(e[r]);)r+=1;if(e[r]!==`<`)return null;let i=wo(e,r);return!i||i.isClose||i.tagName!==n?null:i}function wo(e,t){let n=uo(e,t);return n&&ao.has(n.tagName)?n:null}function To(e,t,n){let r=1;for(let i=t;i<e.length;i+=1){if(e[i]!==`<`)continue;let t=uo(e,i);if(!(!t||t.tagName!==n||t.isTruncated)){if(t.isClose){if(--r,r===0)return!0}else t.isSelfClosing||(r+=1);i=Math.max(i,t.end-1)}}return!1}function Eo(e,t){if(t.tagName!==`function`||!/\bname\s*=/.test(e.slice(t.contentStart,t.end)))return!1;let n=t.end;for(;n<e.length&&/\s/.test(e[n]);)n+=1;let r=uo(e,n);return r?.tagName===`parameter`&&!r.isClose}function Do(e,t){return e[t]===`\r`&&e[t+1]===`
`?t+2:e[t]===`
`||e[t]===`\r`?t+1:null}function Oo(e,t,n){return n>t&&e[n-1]===`
`?n-(n-2>=t&&e[n-2]===`\r`?2:1):n>t&&e[n-1]===`\r`?n-1:n}function ko(e,t){let n=t-1;for(;n>=0&&(e[n]===` `||e[n]===`	`);)--n;return n<0||e[n]===`
`||e[n]===`\r`}function Ao(e,t){let n=t;for(;n<e.length&&(e[n]===` `||e[n]===`	`);)n+=1;return n>=e.length||e[n]===`
`||e[n]===`\r`}function jo(e){if(!/<\s*\/?\s*parameter\b/i.test(e))return e;let t=Na(e),n=[],r=``,i=0;for(let a=0;a<e.length;a+=1){if(e[a]!==`<`||Pa(a,t))continue;let o=uo(e,a);if(!(!o||o.isTruncated)){if(o.isClose){let t=n.findLastIndex(e=>e.name===o.tagName);if(t!==-1){let s=n[t];if(s.unwrap){let t=s.trimBoundaryLineBreaks&&ko(e,a)&&Ao(e,o.end)?Oo(e,i,a):a;r+=e.slice(i,t),i=o.end}n.splice(t)}}else if(o.isSelfClosing)o.tagName===`parameter`&&n.length===0&&(r+=e.slice(i,a),i=o.end);else if(To(e,o.end,o.tagName)||Eo(e,o)){let t=o.tagName===`parameter`&&n.length===0,s=!1;if(t){r+=e.slice(i,a),i=o.end;let t=ko(e,a)?Do(e,i):null;t!==null&&(i=t,s=!0)}n.push({name:o.tagName,unwrap:t,trimBoundaryLineBreaks:s})}a=Math.max(a,o.end-1)}}return r+e.slice(i)}function Mo(e,t={}){let n=e;if(!n||!io.test(n))return n;let r=Na(n),i=``,a=0,o=!1,s=0,c=!1,l=0,u=null,d=null,f=new Map;for(let e=0;e<n.length;e+=1){if(n[e]!==`<`||!o&&Pa(e,r))continue;let p=wo(n,e);if(p){if(!o){if(i+=n.slice(a,e),p.isClose){if(p.isTruncated){let t=p.contentStart;i+=n.slice(e,t),a=t,e=Math.max(e,t-1);continue}let t=f.get(p.tagName)??0;t>0&&(i+=n.slice(e,p.end),f.set(p.tagName,t-1)),a=p.end,e=Math.max(e,p.end-1);continue}if(p.isSelfClosing){d=p.end,a=p.end,e=Math.max(e,p.end-1);continue}let r=p.isTruncated?p.contentStart:p.end,m=p.tagName===`function_calls`||p.tagName===`tool_calls`,h=m?So(n,p.end,p.tagName):-1,g=h===-1?null:wo(n,h),_=t.stripFunctionResponseAfterPluralToolCalls===!0&&m&&g!==null&&Co(n,g.end,`function_response`)!==null,v=p.tagName===`tool_call`||p.tagName===`function`||p.tagName===`antml:invoke`||(t.stripFunctionCallsXmlPayloads===!0||_)&&m?mo(n,r):oo.test(n.slice(r))?`json`:null,y=p.tagName!==`function`||go(n,e,p),b=p.tagName===`function_response`?So(n,p.end,p.tagName):-1,x=xo(n,e,d)&&(vo(n,p)||b!==-1||yo(n,p)),S=p.tagName===`function_response`&&(_o(n,e,p)||x||b!==-1&&bo(i)&&vo(n,p));if(!p.isClose&&(v&&y||S)){if(o=!0,s=p.end,c=v===`json`||v===`xml`&&ho(n,r),l=e,u=p.tagName,p.isTruncated){a=n.length;break}}else{let t=p.isTruncated?p.contentStart:p.end;i+=n.slice(e,t),p.isTruncated||f.set(p.tagName,(f.get(p.tagName)??0)+1),a=t,e=Math.max(e,t-1);continue}}else if(p.isClose&&(p.tagName===u||u===`tool_result`&&p.tagName===`tool_call`)&&(!c||!lo(n,s,e))){let e=u;o=!1,c=!1,u=null,e&&(d=p.end)}a=p.end,e=Math.max(e,p.end-1)}}return o?u===`function`&&(i+=n.slice(l)):i+=n.slice(a),jo(i)}function No(e){if(!e||!/minimax:tool_call/i.test(e))return e;let t=Na(e),n=/<invoke\b[^>]*>[\s\S]*?<\/invoke>|<\/?minimax:tool_call>/gi,r=``,i=0;for(let a of e.matchAll(n)){let n=a.index??0;Pa(n,t)||(r+=e.slice(i,n),i=n+a[0].length)}return r+=e.slice(i),r}function Po(e){return/\btool\s*=>\s*["'][A-Za-z_][A-Za-z0-9_.:-]{0,119}["']/i.test(e)&&/\bargs\s*=>/i.test(e)}function Fo(e){return/^\s*[{[]/.test(e)||/\b(?:tool|result|output|content)\s*=>/i.test(e)||/\b(?:tool|result|output|content)\s*:/i.test(e)}function Io(e){if(!e||!Qa.test(e))return e;let t=Na(e),n=``,r=0;for(;r<e.length;){let i=/\[\s*TOOL_(CALL|RESULT)\s*\]/gi.exec(e.slice(r));if(!i?.[0]){n+=e.slice(r);break}let a=i[1]?.toUpperCase(),o=r+(i.index??0),s=o+i[0].length;if(Pa(o,t)){n+=e.slice(r,s),r=s;continue}let c=(a===`RESULT`?/\[\s*\/\s*TOOL_RESULT\s*\]/gi:/\[\s*\/\s*TOOL_CALL\s*\]/gi).exec(e.slice(s)),l=c?.[0]&&!Pa(s+(c.index??0),t)?s+(c.index??0):-1,u=l>=0?l:e.length,d=e.slice(s,u);if(!(a===`RESULT`?Fo(d):Po(d))){n+=e.slice(r,s),r=s;continue}n+=e.slice(r,o),r=l>=0?l+(c?.[0].length??0):e.length}return n}function Lo(e){if(!e||!/\[Tool (?:Call|Result)/i.test(e)&&!/\[Historical context/i.test(e))return e;let t=(e,t,n)=>{let{allowLeadingNewlines:r=!1}=n??{},i=t;for(;i<e.length;){let t=e[i];if(t===` `||t===`	`){i+=1;continue}if(r&&(t===`
...
`&&(o+=1)),i=o}return r+=e.slice(i),r})(e);return n=n.replace(/\[Tool Result for ID[^\]]*\]\n?[\s\S]*?(?=\n*\[Tool |\n*$)/gi,``),n=n.replace(/\[Historical context:[^\]]*\]\n?/gi,``),n.trim()}function Ro(e){if(!e||!Za.test(e))return e;Xa.lastIndex=0;let t=Na(e),n=``,r=0,i=!1;for(let a of e.matchAll(Xa)){let o=a.index??0;if(Pa(o,t))continue;let s=a[1]===`/`;i?s&&(i=!1):(n+=e.slice(r,o),s||(i=!0)),r=o+a[0].length}return i||(n+=e.slice(r)),n}function zo(e){if(!e||!$a.test(e))return e;let t=Na(e),n=``,r=0;for(;r<e.length;){let i=e.indexOf(`
`,r),a=i===-1?e.length:i+1,o=e.slice(r,a),s=(o.endsWith(`
`)?o.slice(0,-1).replace(/\r$/,``):o).trim();!Pa(r,t)&&(eo.test(s)||to.test(s)||no.test(s)||ro.test(s))||(n+=o),r=a}return n}var Bo={delivery:{finalTrim:`both`,stripFunctionResponseAfterPluralToolCalls:!0,reasoningMode:`strict`,reasoningTrim:`both`,stageOrder:`reasoning-last`},"final-answer-delivery":{finalTrim:`both`,stripFunctionResponseAfterPluralToolCalls:!0,reasoningMode:`strict`,reasoningScope:`leading`,reasoningTrim:`both`,stageOrder:`reasoning-last`},history:{finalTrim:`none`,reasoningMode:`strict`,reasoningTrim:`none`,stageOrder:`reasoning-last`},"internal-scaffolding":{finalTrim:`start`,preserveDowngradedToolText:!0,preserveMinimaxToolXml:!0,reasoningMode:`preserve`,reasoningTrim:`start`,stageOrder:`reasoning-first`},"tool-progress":{finalTrim:`both`,stripFunctionCallsXmlPayloads:!0,stripInternalTraceLines:!1,reasoningMode:`strict`,reasoningTrim:`both`,stageOrder:`reasoning-last`}};function Vo(e,t){if(!e)return e;let n=e=>Ya(e,{mode:t.reasoningMode,scope:t.reasoningScope,trim:t.reasoningTrim}),r=e=>t.finalTrim===`none`?e:t.finalTrim===`start`?e.trimStart():e.trim(),i=e=>{let n=e;return t.preserveMinimaxToolXml||(n=No(n)),n=Ra(n),n=Ro(n),n=Mo(n,{stripFunctionCallsXmlPayloads:t.stripFunctionCallsXmlPayloads,stripFunctionResponseAfterPluralToolCalls:t.stripFunctionResponseAfterPluralToolCalls}),t.stripInternalTraceLines!==!1&&(n=zo(n)),n=Io(n),n=Ma(n),t.preserveDowngradedToolText||(n=Lo(n)),n};return t.stageOrder===`reasoning-first`?r(i(n(e))):r(n(i(e)))}function Ho(e,t=`delivery`){return Vo(e,Bo[t])}function Uo(e){return Ho(e,`internal-scaffolding`)}function Wo(e){return Uo(e)}var Go=new WeakMap,Ko=new WeakMap;function qo(e,t){return e===`text`||t===`user`&&e===`input_text`||t===`assistant`&&(e===`input_text`||e===`output_text`)}function Jo(e,t){let n=O(t)===`user`,r=$i(e);return t===`assistant`?Wo(r):n?Tn(ra(r)):ra(r)}function W(e){let t=e,n=typeof t.role==`string`?t.role:``,r=n===`assistant`?ca(e):Qo(e);return r?Jo(r,n):null}function Yo(e){if(!e||typeof e!=`object`)return W(e);let t=e;if(Go.has(t))return Go.get(t)??null;let n=W(e);return Go.set(t,n),n}function Xo(e){let t=e.content,n=[];if(Array.isArray(t))for(let e of t){let t=e;if(t.type===`thinking`&&typeof t.thinking==`string`){let e=t.thinking.trim();e&&n.push(e)}}if(n.length>0)return n.join(`
`);let r=Qo(e);if(!r)return null;let i=ne([...r.matchAll(/<\s*think(?:ing)?\s*>([\s\S]*?)<\s*\/\s*think(?:ing)?\s*>/gi)].map(e=>e[1]??``));return i.length>0?i.join(`
`):null}function Zo(e){if(!e||typeof e!=`object`)return Xo(e);let t=e;if(Ko.has(t))return Ko.get(t)??null;let n=Xo(e);return Ko.set(t,n),n}function Qo(e){let t=e,n=O(t.role),r=t.content;if(typeof r==`string`)return r;if(Array.isArray(r)){let e=r.map(e=>{let t=e;return qo(t.type,n)&&typeof t.text==`string`?t.text:null}).filter(e=>typeof e==`string`);if(e.length>0)return e.join(`
`)}return typeof t.text==`string`?t.text:null}function $o(e){let t=e.trim();if(!t)return``;let n=t.split(/\r?\n/).map(e=>e.trim()).filter(Boolean).map(e=>`_${e}_`);return n.length?[`_Reasoning:_`,...n].join(`
`):``}var es=250;function ts(){return typeof performance<`u`&&typeof performance.now==`function`?performance.now():Date.now()}function ns(e){return Math.max(0,Math.round(e))}function rs(e){if(typeof window>`u`||typeof window.requestAnimationFrame!=`function`){queueMicrotask(e);return}window.requestAnimationFrame(()=>window.requestAnimationFrame(e))}function is(e,t,n){let r=0;return e.filter(e=>!e||typeof e!=`object`||!(`event`in e)||e.event!==t?!0:(r+=1,r<=n))}function as(e,t,n,r){let i={ts:Date.now(),event:t,payload:n};Array.isArray(e.eventLogBuffer)&&(e.eventLogBuffer=[i,...typeof r?.maxBufferedEventsForType==`number`?is(e.eventLogBuffer,t,Math.max(0,r.maxBufferedEventsForType-1)):e.eventLogBuffer].slice(0,es)),r?.console!==!1&&(r?.warn===!0?console.warn:console.debug)(`[openclaw] ${t}`,n)}function os(e,t){Promise.resolve(e.updateComplete).catch(()=>void 0).then(()=>rs(t))}function ss(e){return typeof e==`string`?e:e instanceof Error&&typeof e.message==`string`?e.message:`unknown error`}function cs(e){let t=ss(e.message),n=O(t),r=ee(e.details),i=x(t),a=r?.reason??i?.reason;if(n.startsWith(`pairing required:`)&&a)return`gateway pairing required: ${w(a)}`;if(i&&n!==`pairing required`)return t;let o=r?.approvedRoles?.join(`, `)??`none`,s=r?.requestedRole??`none`,c=r?.approvedScopes?.join(`, `)??`none`,l=r?.requestedScopes?.join(`, `)??`none`;switch(r?.reason){case`scope-upgrade`:return r.approvedScopes||r.requestedScopes?`device scope upgrade requires approval (approved: ${c}; requested: ${l})`:y(e.details);case`role-upgrade`:return r.approvedRoles||r.requestedRole?`device role upgrade requires approval (approved: ${o}; requested: ${s})`:y(e.details);case`metadata-upgrade`:return`device reconnect details changed and require approval`;default:return`gateway pairing required`}}function ls(e){let t=ss(e.message);switch(b(e)){case C.AUTH_TOKEN_MISMATCH:return`gateway token mismatch`;case C.AUTH_UNAUTHORIZED:return`gateway auth failed`;case C.AUTH_RATE_LIMITED:return`too many failed authentication attempts`;case C.PAIRING_REQUIRED:return cs(e);case C.CONTROL_UI_DEVICE_IDENTITY_REQUIRED:return`device identity required (use HTTPS/localhost or allow insecure auth explicitly)`;case C.CONTROL_UI_ORIGIN_NOT_ALLOWED:return`origin not allowed (open the Control UI from the gateway host or allow it in gateway.controlUi.allowedOrigins)`;case C.AUTH_TOKEN_MISSING:return`gateway token missing`;default:break}let n=O(t);return n===`fetch failed`||n===`failed to fetch`||n===`connect failed`?`gateway connect failed`:t}function us(e){return e&&typeof e==`object`?ls(e):ss(e)}var ds=24e4;function fs(e){return typeof e.itemId==`string`&&e.itemId.trim().length>0}function ps(e){return!fs(e)}function ms(e,t){return!t||!e.startsWith(t)?e:e.slice(t.length).trimStart()}function hs(e,t){if(e.length===0&&t.length===0)return[];let n=Math.max(0,e.length-100),r=[...t];for(let t=e.length-1;t>=n;t--){let n=e[t];if(!n||typeof n!=`object`)continue;let i=n;if((typeof i.role==`string`?i.role.toLowerCase():``)!==`user`)continue;let a=W(n);if(!a||!a.trim())continue;let o=typeof n.timestamp==`number`?n.timestamp??0:0;r.push({text:a,ts:o})}r.sort((e,t)=>t.ts-e.ts);let i=[],a=new Set;for(let e of r)a.has(e.text)||(a.add(e.text),i.push(e.text));return i}function gs(e,t){let n=t.trim();if(!n)return;let r=e.chatLocalInputHistoryBySession[e.sessionKey]??[];r[0]?.text!==n&&(e.chatLocalInputHistoryBySession[e.sessionKey]=[{text:n,ts:Date.now()},...r].slice(0,100))}function _s(e){e.chatInputHistorySessionKey=null,e.chatInputHistoryItems=null,e.chatInputHistoryIndex=-1,e.chatDraftBeforeHistory=null}function vs(e,t){e.chatMessage=t,_s(e)}function ys(e){if(e.chatInputHistoryIndex===-1)return!1;if(!Array.isArray(e.chatInputHistoryItems)||e.chatInputHistorySessionKey!==e.sessionKey)return!0;let t=e.chatInputHistoryItems[e.chatInputHistoryIndex];return typeof t!=`string`||t!==e.chatMessage}function bs(e){if(Array.isArray(e.chatInputHistoryItems)&&e.chatInputHistorySessionKey===e.sessionKey)return e.chatInputHistoryItems;let t=hs(e.chatMessages,e.chatLocalInputHistoryBySession[e.sessionKey]??[]);return e.chatInputHistoryItems=t,e.chatInputHistorySessionKey=e.sessionKey,e.chatInputHistoryIndex=-1,e.chatDraftBeforeHistory=e.chatMessage,t}function xs(e,t){let n=bs(e);return n.length===0?!1:t===`up`?e.chatInputHistoryIndex>=n.length-1?!1:(e.chatInputHistoryIndex+=1,e.chatMessage=n[e.chatInputHistoryIndex]??e.chatMessage,!0):e.chatInputHistoryIndex===-1?!1:e.chatInputHistoryIndex===0?(e.chatInputHistoryIndex=-1,e.chatMessage=e.chatDraftBeforeHistory??``,!0):(--e.chatInputHistoryIndex,e.chatMessage=n[e.chatInputHistoryIndex]??e.chatMessage,!0)}function Ss(e,t){ys(e)&&_s(e);let n=e.chatInputHistoryIndex!==-1,r={historyNavigationActiveBefore:n,historyNavigationActiveAfter:n,selectionStart:t.selectionStart,selectionEnd:t.selectionEnd,valueLength:t.valueLength};if(e.chatLoading)return{...r,handled:!1,preventDefault:!1,restoreCaret:null,decision:`blocked:history-loading`};if(t.altKey||t.ctrlKey||t.metaKey||t.shiftKey||t.isComposing||t.keyCode===229)return{...r,handled:!1,preventDefault:!1,restoreCaret:null,decision:`blocked:modifier-or-composition`};if(t.selectionStart!==t.selectionEnd)return{...r,handled:!1,preventDefault:!1,restoreCaret:null,decision:`blocked:selection-range`};if(n){let n=t.key===`ArrowUp`?`up`:`down`,i=xs(e,n),a=e.chatInputHistoryIndex!==-1;return{...r,handled:i,preventDefault:i,restoreCaret:i?n:null,decision:i?n===`up`?`handled:history-up`:`handled:history-down`:`blocked:history-boundary`,historyNavigationActiveAfter:a}}if(t.key===`ArrowDown`)return{...r,handled:!1,preventDefault:!1,restoreCaret:null,decision:`blocked:arrowdown-editing-mode`};if(t.selectionStart!==0)return{...r,handled:!1,preventDefault:!1,restoreCaret:null,decision:`blocked:arrowup-not-at-start`};let i=xs(e,`up`),a=e.chatInputHistoryIndex!==-1;return{...r,handled:i,preventDefault:i,restoreCaret:i?`up`:null,decision:i?`handled:enter-history-up`:`blocked:history-boundary`,historyNavigationActiveAfter:a}}var Cs=50,ws=80,Ts=12e4;function G(e){return typeof e==`string`&&e.trim()||null}function Es(e,t){let n=G(t);if(!n)return null;let r=G(e);if(r){let e=`${r}/`;if(O(n).startsWith(O(e))){let t=n.slice(e.length).trim();if(t)return`${r}/${t}`}return`${r}/${n}`}let i=n.indexOf(`/`);if(i>0){let e=n.slice(0,i).trim(),t=n.slice(i+1).trim();if(e&&t)return`${e}/${t}`}return n}function Ds(e){return Array.isArray(e)?e.map(e=>G(e)).filter(e=>!!e):[]}function Os(e){if(!Array.isArray(e))return[];let t=[];for(let n of e){if(!n||typeof n!=`object`)continue;let e=n,r=G(e.provider),i=G(e.model);if(!r||!i)continue;let a=G(e.reason)?.replace(/_/g,` `)??G(e.code)??(typeof e.status==`number`?`HTTP ${e.status}`:null)??G(e.error)??`error`;t.push({provider:r,model:i,reason:a})}return t}function ks(e){if(!e||typeof e!=`object`)return null;let t=e;if(typeof t.text==`string`)return t.text;let n=t.content;if(!Array.isArray(n))return null;let r=n.map(e=>{if(!e||typeof e!=`object`)return null;let t=e;return t.type===`text`&&typeof t.text==`string`?t.text:null}).filter(e=>!!e);return r.length===0?null:r.join(`
`)}function As(e){if(e==null)return null;if(typeof e==`number`||typeof e==`boolean`)return String(e);let t=ks(e),n;if(typeof e==`string`)n=e;else if(t)n=t;else try{n=JSON.stringify(e,null,2)}catch{n=st(e)}let r=St(n,Ts);return r.truncated?`${r.text}\n\n… truncated (${r.total} chars, showing first ${r.text.length}).`:r.text}function js(e){return e&&typeof e==`object`?e:null}function Ms(e){let t=js(js(e)?.details);if(!t||t.changedModel!==!0)return;if(Object.hasOwn(t,`modelOverride`))return G(t.modelOverride);let n=G(t.model);if(!n)return;let r=G(t.modelProvider);return r?`${r}/${n}`:n}function Ns(e,t){let n=t.result,r=js(js(n)?.details),i=G(r?.sessionKey)??e.sessionKey;if(!ve(e,i,G(r?.agentId)))return;let a=Ms(n);a!==void 0&&e.sessions.setModelOverride(i,a)}function Ps(e){let t=[];return t.push({type:`toolcall`,name:e.name,arguments:e.args??{}}),e.output&&t.push({type:`toolresult`,name:e.name,text:e.output}),{role:`assistant`,toolCallId:e.toolCallId,runId:e.runId,content:t,timestamp:e.startedAt}}function Fs(e){if(e.toolStreamOrder.length<=Cs)return;let t=e.toolStreamOrder.length-Cs,n=e.toolStreamOrder.splice(0,t);for(let t of n)e.toolStreamById.delete(t)}function Is(e){e.chatToolMessages=e.toolStreamOrder.map(t=>e.toolStreamById.get(t)?.message).filter(e=>!!e)}function Ls(e){e.toolStreamSyncTimer!=null&&(clearTimeout(e.toolStreamSyncTimer),e.toolStreamSyncTimer=null),Is(e)}function Rs(e,t=!1){if(t){Ls(e);return}e.toolStreamSyncTimer??=window.setTimeout(()=>Ls(e),ws)}function zs(e){e.toolStreamSyncTimer!=null&&(clearTimeout(e.toolStreamSyncTimer),e.toolStreamSyncTimer=null),e.toolStreamById.clear(),e.toolStreamOrder=[],e.chatToolMessages=[],e.chatStreamSegments=[]}var Bs=5e3,Vs=5*6e4,Hs=8e3;function Us(e){e.compactionClearTimer!=null&&(window.clearTimeout(e.compactionClearTimer),e.compactionClearTimer=null)}function Ws(e,t=Bs,n){e.compactionClearTimer=window.setTimeout(()=>{let t=e.compactionStatus;n?.phase&&t?.phase!==n.phase||n?.runId&&t?.runId!==n.runId||(e.compactionStatus=null,e.compactionClearTimer=null,e.requestUpdate?.())},t)}function Gs(e,t){e.compactionStatus={phase:`complete`,runId:t,startedAt:e.compactionStatus?.startedAt??null,completedAt:Date.now()},Ws(e,Bs,{phase:`complete`,runId:t})}function Ks(e,t){if(!t||t.operation!==`compact`)return;let n=G(t.sessionKey),r=G(t.agentId)??void 0;if(!n||!ve(e,n,r))return;let i=G(t.operationId)??`session-compact:${n}`,a=e;if(t.phase===`start`){Us(a),a.compactionStatus={phase:`active`,runId:i,startedAt:Date.now(),completedAt:null},Ws(a,Vs,{phase:`active`,runId:i});return}if(t.phase===`end`&&!(a.compactionStatus?.runId&&a.compactionStatus.runId!==i)){if(Us(a),t.completed===!0){Gs(a,i);return}a.compactionStatus=null}}function qs(e,t){let n=t.data??{},r=typeof n.phase==`string`?n.phase:``,i=n.completed===!0;if(Us(e),r===`start`){e.compactionStatus={phase:`active`,runId:t.runId,startedAt:Date.now(),completedAt:null},Ws(e,Vs,{phase:`active`,runId:t.runId});return}if(r===`end`){if(n.willRetry===!0&&i){e.compactionStatus={phase:`retrying`,runId:t.runId,startedAt:e.compactionStatus?.startedAt??Date.now(),completedAt:null},Ws(e,Vs,{phase:`retrying`,runId:t.runId});return}if(i){Gs(e,t.runId);return}e.compactionStatus=null}}function Js(e,t){let n=G((t.data??{}).phase);n!==`end`&&n!==`error`||Ys(e,t,{allowSessionScopedWhenIdle:!0}).accepted&&e.compactionStatus?.phase===`retrying`&&(e.compactionStatus.runId&&e.compactionStatus.runId!==t.runId||Gs(e,t.runId))}function Ys(e,t,n){let r=typeof t.sessionKey==`string`?t.sessionKey:void 0;return r&&!ve(e,r,G(t.agentId))?{accepted:!1}:!e.chatRunId&&n?.allowSessionScopedWhenIdle&&r?{accepted:!0,sessionKey:r}:!r&&e.chatRunId&&t.runId!==e.chatRunId||e.chatRunId&&t.runId!==e.chatRunId||!e.chatRunId?{accepted:!1}:{accepted:!0,sessionKey:r}}function Xs(e,t){let n=t.data??{},r=t.stream===`fallback`?`fallback`:G(n.phase);if(t.stream===`lifecycle`&&r!==`fallback`&&r!==`fallback_cleared`||!Ys(e,t,{allowSessionScopedWhenIdle:!0}).accepted)return;let i=Es(n.selectedProvider,n.selectedModel)??Es(n.fromProvider,n.fromModel),a=Es(n.activeProvider,n.activeModel)??Es(n.toProvider,n.toModel),o=Es(n.previousActiveProvider,n.previousActiveModel)??G(n.previousActiveModel);if(!i||!a||r===`fallback`&&i===a)return;let s=G(n.reasonSummary)??G(n.reason),c=(()=>{let e=Ds(n.attemptSummaries);return e.length>0?e:Os(n.attempts).map(e=>`${Es(e.provider,e.model)??`${e.provider}/${e.model}`}: ${e.reason}`)})();e.fallbackClearTimer!=null&&(window.clearTimeout(e.fallbackClearTimer),e.fallbackClearTimer=null),e.fallbackStatus={phase:r===`fallback_cleared`?`cleared`:`active`,selected:i,active:r===`fallback_cleared`?i:a,previous:r===`fallback_cleared`?o??(a===i?void 0:a):void 0,reason:s??void 0,attempts:c,occurredAt:Date.now()},e.fallbackClearTimer=window.setTimeout(()=>{e.fallbackStatus=null,e.fallbackClearTimer=null},Hs)}function Zs(e){if(e.stream!==`item`)return null;let t=e.data??{};if(t.kind!==`preamble`)return null;let n=(typeof t.itemId==`string`&&t.itemId.trim()?t.itemId:typeof t.id==`string`&&t.id.trim()?t.id:null)?.trim(),r=Qs(t.progressText);return!r&&!n?null:{text:r,...n?{itemId:n}:{}}}function Qs(e){if(typeof e!=`string`)return``;let t=br(e).text.trim(),n=t.replace(/^[\s*_`~]+|[\s*_`~]+$/gu,``).trim();return/^NO_REPLY$/iu.test(n)?``:t}function $s(e,t){let n=Zs(t);if(!n)return!1;if(n.itemId&&!n.text.trim())return e.chatStreamSegments=e.chatStreamSegments.filter(e=>e.itemId!==n.itemId),!0;let r=n.itemId?e.chatStreamSegments.findIndex(e=>e.itemId===n.itemId):-1;if(r>=0)return e.chatStreamSegments[r]&&(e.chatStreamSegments=e.chatStreamSegments.map((e,t)=>t===r?{...e,text:n.text}:e)),!0;let i=e.chatStreamSegments[e.chatStreamSegments.length-1];return!n.itemId&&i&&!i.toolCallId&&i.text===n.text||(e.chatStreamSegments=[...e.chatStreamSegments,{text:n.text,ts:Date.now(),...n.itemId?{itemId:n.itemId}:{}}]),!0}function ec(e,t){if(!t)return;let n=typeof t.sessionKey==`string`?t.sessionKey:void 0;if(n&&!ve(e,n,G(t.agentId)))return;if(t.stream===`compaction`){qs(e,t);return}if(t.stream===`lifecycle`){Js(e,t),Xs(e,t);return}if(t.stream===`fallback`){Xs(e,t);return}if($s(e,t)||t.stream!==`tool`)return;let r=t.data??{},i=typeof r.toolCallId==`string`?r.toolCallId:``;if(!i)return;let a=typeof r.name==`string`?r.name:`tool`,o=typeof r.phase==`string`?r.phase:``,s=o===`start`?r.args:void 0,c=o===`update`?As(r.partialResult):o===`result`?As(r.result):void 0;a===`session_status`&&o===`result`&&Ns(e,r);let l=Date.now(),u=e.toolStreamById.get(i);u?(u.name=a,s!==void 0&&(u.args=s),c!==void 0&&(u.output=c||void 0),u.updatedAt=l):(e.chatRunId&&t.runId===e.chatRunId&&e.chatStream&&e.chatStream.trim().length>0&&(e.chatStreamSegments=[...e.chatStreamSegments,{text:e.chatStream,ts:l,toolCallId:i}],e.chatStream=null,e.chatStreamStartedAt=null),u={toolCallId:i,runId:t.runId,sessionKey:n,name:a,args:s,output:c||void 0,startedAt:typeof t.ts==`number`?t.ts:l,updatedAt:l,message:{}},e.toolStreamById.set(i,u),e.toolStreamOrder.push(i)),u.message=Ps(u),Fs(e),Rs(e,o===`result`)}var tc=5e3,nc=new Set([`/stop`,`stop`,`esc`,`abort`,`wait`,`exit`]);function rc(e){return(typeof e==`string`?e.trim():``)||null}function ic(e,t){e.lastError=t,e.chatError=t}function ac(e){return!!(e.chatSending||e.chatRunId)}function oc(e){return e.chatRunId?!0:!!e.sessionsResult?.sessions.some(t=>t.key===e.sessionKey&&Ze(t))}function sc(e){return nc.has(O(e.trim()))}async function cc(e){if(!e.client||!e.connected)return!1;let t=e.chatRunId;try{return await e.client.request(`chat.abort`,{sessionKey:e.sessionKey,...Me(e,e.sessionKey),...t?{runId:t}:{}}),!0}catch(t){return ic(e,us(t)),!1}}async function lc(e,t){let n=e.chatRunId,r=!e.connected&&oc(e);if(!(!e.connected&&!r)){if(t?.preserveDraft||(e.chatMessage=``,_s(e)),r){e.pendingAbort={runId:n,sessionKey:e.sessionKey,...Me(e,e.sessionKey)};return}await cc(e)}}function uc(e){e!=null&&globalThis.clearTimeout(e)}function dc(e){return e.toolStreamById instanceof Map&&Array.isArray(e.toolStreamOrder)&&Array.isArray(e.chatToolMessages)&&Array.isArray(e.chatStreamSegments)}function fc(e){uc(e.chatRunStatusClearTimer),e.chatRunStatusClearTimer=null,e.chatRunStatus=null}function pc(e,t){uc(e.chatRunStatusClearTimer),e.chatRunStatusClearTimer=globalThis.setTimeout(()=>{let n=e.chatRunStatus;n?.phase!==t.phase||n.runId!==t.runId||n.sessionKey!==t.sessionKey||n.occurredAt!==t.occurredAt||(e.chatRunStatus=null,e.chatRunStatusClearTimer=null,xc(e)||e.requestUpdate?.())},tc)}function mc(e){uc(e.compactionClearTimer),e.compactionClearTimer=null,e.compactionStatus&&=null,uc(e.fallbackClearTimer),e.fallbackClearTimer=null,e.fallbackStatus&&=null}function hc(e,t){let n=new Set,r=rc(t.sessionKey)??e.sessionKey;r&&n.add(r),se(e,`global`,r)&&n.add(`global`);for(let t of e.sessionsResult?.sessions??[])se(e,t.key,r)&&n.add(t.key);for(let e of t.sessionKeys??[]){let t=rc(e);t&&n.add(t)}return n}function gc(e,t,n){if(!t.outcome)return;let r=hc(e,t);if(r.size===0)return;let i=t.sessionStatus??(t.outcome===`done`?`done`:`killed`),a={sessionKeys:[...r],runId:t.runId??e.chatRunId??null,status:i,endedAt:n};e.sessionsResult&&=Ae(e.sessionsResult,a),e.sessions?.reconcileRunTerminal(a)}function _c(e,t={}){let n=Date.now(),r=t.runId??e.chatRunId??null,i=rc(t.sessionKey)??e.sessionKey;if((t.clearIndicators??!0)&&mc(e),t.clearChatStream&&(e.chatStream=null,e.chatStreamStartedAt=null),t.clearLocalRun&&(e.chatRunId=null),t.clearSideResultTerminalRuns&&e.chatSideResultTerminalRuns?.clear(),t.clearToolStream&&dc(e)&&zs(e),t.outcome){let a={phase:t.outcome,runId:r,sessionKey:i,occurredAt:n};gc(e,t,n),t.armLocalTerminalReconcile&&(e.lastLocalTerminalReconcile={sessionKey:i,runId:r,phase:t.outcome,sessionStatus:t.sessionStatus??(t.outcome===`done`?`done`:`killed`)}),t.publishRunStatus!==!1&&(e.chatRunStatus=a,pc(e,a))}else t.clearRunStatus&&fc(e);e.requestUpdate?.()}function vc(e){return e.sessionsResult?.sessions.find(t=>se(e,t.key,e.sessionKey))}function yc(e){let t=e.lastLocalTerminalReconcile;if(!t||t.sessionKey!==e.sessionKey)return!1;let n=vc(e);return!n||!Ze(n)?!1:t.runId==null||n.activeRunIds?.length!==1||n.activeRunIds[0]!==t.runId?(e.lastLocalTerminalReconcile=null,!1):(gc(e,{outcome:t.phase,sessionStatus:t.sessionStatus,sessionKey:t.sessionKey,runId:t.runId},Date.now()),e.requestUpdate?.(),!0)}function bc(e,t={}){if(!e.chatRunId&&e.chatStream==null)return yc(e);let n=vc(e);return n?Cc(e,n,t):!1}function xc(e){return e.lastLocalTerminalReconcile!=null&&!e.chatRunId&&e.chatStream==null&&bc(e,{publishRunStatus:!1})}function Sc(e,t,n){return se(e,t,n)}function Cc(e,t,n={}){if(!Sc(e,t.key,e.sessionKey)||!e.chatRunId&&e.chatStream==null||t.hasActiveRun===!0||Ze(t)||t.hasActiveRun!==!1&&t.status===`running`)return!1;let r=t.status!==void 0;return t.hasActiveRun!==!1&&!r?!1:(_c(e,{outcome:t.status===`done`?`done`:`interrupted`,sessionStatus:t.status===`running`||t.status===void 0?`killed`:t.status,runId:e.chatRunId,sessionKey:e.sessionKey,sessionKeys:[t.key],clearLocalRun:!0,clearChatStream:!0,publishRunStatus:n.publishRunStatus}),!0)}var wc=450,Tc=8,Ec=12,Dc=24;function Oc(e,t){return typeof e.querySelector==`function`?e.querySelector(t):null}function K(e,t=!1,n=!1,r={}){e.chatScrollFrame&&cancelAnimationFrame(e.chatScrollFrame),e.chatScrollTimeout!=null&&(clearTimeout(e.chatScrollTimeout),e.chatScrollTimeout=null);let i=()=>{let t=Oc(e,`.chat-thread`);if(t){let e=getComputedStyle(t).overflowY;if(e===`auto`||e===`scroll`||t.scrollHeight-t.clientHeight>1)return t}return document.scrollingElement??document.documentElement};e.updateComplete.then(()=>{e.chatScrollFrame=requestAnimationFrame(()=>{e.chatScrollFrame=null;let a=i();if(!a)return;let o=a.scrollHeight-a.scrollTop-a.clientHeight,s=a.scrollHeight>(e.chatLastScrollHeight??0)+1;e.chatLastScrollHeight=a.scrollHeight;let c=r.contentChanged??r.source!==`resize`,l=_t(e.settings?.chatAutoScroll),u=r.source===`manual`,d=t&&!e.chatHasAutoScrolled;if(!(u||l===`always`||l===`near-bottom`&&(d||!e.chatFollowLocked&&(e.chatUserNearBottom||o<wc)))){(c||r.source===`resize`&&s)&&(e.chatNewMessagesBelow=!0);return}d&&(e.chatHasAutoScrolled=!0),e.chatFollowLocked=!1;let f=n&&(typeof window>`u`||typeof window.matchMedia!=`function`||!window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),p=a.scrollHeight;e.chatProgrammaticScrollTarget=p,e.chatIsProgrammaticScroll=!0,typeof a.scrollTo==`function`?a.scrollTo({top:p,behavior:f?`smooth`:`auto`}):a.scrollTop=p,requestAnimationFrame(()=>{e.chatIsProgrammaticScroll=!1}),e.chatUserNearBottom=!0,e.chatNewMessagesBelow=!1;let m=d?150:120;e.chatScrollTimeout=window.setTimeout(()=>{e.chatScrollTimeout=null;let t=i();if(!t)return;let n=t.scrollHeight-t.scrollTop-t.clientHeight;(u||l===`always`||l===`near-bottom`&&(d||!e.chatFollowLocked&&(e.chatUserNearBottom||n<wc)))&&(e.chatProgrammaticScrollTarget=t.scrollHeight,e.chatIsProgrammaticScroll=!0,t.scrollTop=t.scrollHeight,requestAnimationFrame(()=>{e.chatIsProgrammaticScroll=!1}),e.chatUserNearBottom=!0)},m)})})}function kc(e,t){let n=t.currentTarget;if(!n)return;let r=Math.max(0,n.scrollTop),i=r-e.chatLastScrollTop;e.chatLastScrollTop=r,e.chatLastScrollHeight=n.scrollHeight;let a=i<0,o=i<-12;if(e.chatIsProgrammaticScroll&&!a&&n.scrollTop>=e.chatProgrammaticScrollTarget-n.clientHeight)return;let s=n.scrollHeight-n.scrollTop-n.clientHeight;a&&s>Tc?e.chatFollowLocked=!0:s<=Tc&&(e.chatFollowLocked=!1),e.chatUserNearBottom=!e.chatFollowLocked&&s<wc,!(n.scrollHeight-n.clientHeight>wc)||r<=Dc||e.chatUserNearBottom?e.chatHeaderControlsHidden=!1:i>Ec?e.chatHeaderControlsHidden=!0:o&&(e.chatHeaderControlsHidden=!1),e.chatUserNearBottom&&(e.chatNewMessagesBelow=!1)}function Ac(e){e.chatHasAutoScrolled=!1,e.chatUserNearBottom=!0,e.chatFollowLocked=!1,e.chatLastScrollTop=0,e.chatLastScrollHeight=0,e.chatHeaderControlsHidden=!1,e.chatNewMessagesBelow=!1,e.chatIsProgrammaticScroll=!1,e.chatProgrammaticScrollTarget=0}var jc=20;function Mc(e,t){if(!e.has(t))return;let n=e.get(t);return e.delete(t),e.set(t,n),n}function Nc(e,t,n){for(e.delete(t),e.set(t,n);e.size>jc;){let t=e.keys().next().value;if(typeof t!=`string`)break;e.delete(t)}}function Pc(e,t,n){if(e.has(t))return Mc(e,t);let r=n();return Nc(e,t,r),r}function Fc(e,t){let n=t.agentId?.trim();if(n)return L(n);let r=F(t.sessionKey);return r?L(r.agentId):P(t.sessionKey)?N(e):fe(e)}function Ic(e,t){let n=O(F(t)?.rest??t),r=he(e);return P(t)||n===`main`||n===r?pe:n}function Lc(e,t){return`agent:${Fc(e,t)}:${Ic(e,t.sessionKey)}`}function Rc(e,t,n,r){let i=Lc(t,n);if(r.length===0){e.delete(i);return}Nc(e,i,r.slice(-100))}function zc(e,t,n,r){Rc(e,t,n,[...Mc(e,Lc(t,n))??[],r])}function Bc(e,t,n){return[...Mc(e,Lc(t,n))??[]]}function Vc(e,t,n){e.delete(Lc(t,n))}var Hc=[`toolName`,`tool_name`];function Uc(e){return e&&typeof e==`object`&&!Array.isArray(e)?e:null}function Wc(e,t,n){!n||t.has(n)||(t.add(n),e.push({id:n}))}function Gc(e){return typeof e==`string`&&U(e).toLowerCase()===`tool`}function Kc(e){return Hc.some(t=>!!D(e[t]))}function qc(e){return Array.isArray(e.content)?e.content.filter(e=>!!e&&typeof e==`object`):[]}function Jc(e){return Bn(e.type)||Vn(e.type)}function Yc(e){let t=Uc(e);if(!t)return[];let n=[],r=new Set,i=qc(t),a=Un(t);(Gc(t.role)||Kc(t)||i.some(Jc))&&Wc(n,r,a);for(let e of i)Jc(e)&&Wc(n,r,Un(e)??a);return n}function Xc(e){let t=e;return Array.isArray(t.toolStreamOrder)?t.toolStreamOrder.filter(e=>typeof e==`string`&&e.trim().length>0):[]}function Zc(e){for(let t=e.length-1;t>=0;t--){let n=e[t];if(!(!n||typeof n!=`object`)&&O(n.role)===`user`)return t}return-1}function Qc(e,t){let n=e;if(n.toolStreamById instanceof Map&&Array.isArray(n.toolStreamOrder)&&Array.isArray(n.chatToolMessages)&&Array.isArray(n.chatStreamSegments)){let e=t?.preserveStreamSegments?[...n.chatStreamSegments]:null;zs(n),e&&(n.chatStreamSegments=e)}}function $c(e){let t=e;Array.isArray(t.chatStreamSegments)&&(t.chatStreamSegments=[])}function el(e,t){let n=Xc(t),r=new Set;if(n.length===0)return r;let i=new Set(n),a=new Set;for(let t of e.slice(Zc(e)+1))for(let e of Yc(t))a.add(e.id);for(let e of a)i.has(e)&&r.add(e);return r}function tl(e,t=e,n=Date.now(),r=`current`,i){return{role:`assistant`,content:[{type:`text`,text:e}],timestamp:n,openclawStreamFallback:{replacementText:t,source:r,...i?{itemId:i}:{}}}}function nl(e){if(!e||typeof e!=`object`)return null;let t=e.openclawStreamFallback;if(!t||typeof t!=`object`)return null;let n=t.replacementText;return typeof n==`string`&&n.trim()?n.trim():W(e)?.trim()??null}function rl(e,t){let n=nl(t);if(!n)return!1;let r=t.openclawStreamFallback,i=r&&typeof r==`object`?r.source:void 0,a=r&&typeof r==`object`?r.itemId:void 0;if(i===`segment`&&typeof a==`string`&&a.trim())return!1;let o=W(e)?.trim();return!!(o&&(o===n||o.startsWith(n)))}function il(e,t){return[...e.filter((n,r)=>r<=Zc(e)?!0:!rl(t,n)),t]}function al(e,t){return!e?.trim()||t(e)?null:e}function ol(e,t,n){let r=t.trim();if(!r)return!1;let i=Zc(e)+1;return e.slice(i).some(e=>{if(!e||typeof e!=`object`)return!1;let t=O(e.role);if(t&&t!==`assistant`||t===`assistant`&&n(e))return!1;let i=W(e)?.trim();return!!(i&&(i===r||i.startsWith(r)))})}function sl(e){if(!e||typeof e!=`object`)return null;let t=e.openclawStreamFallback;if(!t||typeof t!=`object`)return null;let n=t.itemId;return typeof n==`string`&&n.trim()?n.trim():null}function cl(e,t){let n=Zc(e)+1;return e.slice(n).some(e=>sl(e)===t)}function ll(e,t){let n=e,r=Xc(e),i=[],a=null,o=Array.isArray(n.chatStreamSegments)?n.chatStreamSegments:[],s=0;for(let e of o){if(!e||typeof e.text!=`string`)continue;let n=typeof e.toolCallId==`string`&&e.toolCallId.trim()?e.toolCallId.trim():null,o=fs(e),c=o&&typeof e.itemId==`string`?e.itemId.trim():void 0,l=o?void 0:r[s];o||(s+=1);let u=ps(e),d=al(u?ms(e.text,a):e.text,t.isHiddenStreamText);d&&i.push({text:d,replacementText:e.text,source:`segment`,timestamp:typeof e.ts==`number`&&Number.isFinite(e.ts)?e.ts:Date.now(),...c?{itemId:c}:{},toolCallId:n??l}),u&&e.text.trim()&&(a=e.text)}if(t.includeCurrent!==!1&&typeof e.chatStream==`string`){let n=al(ms(e.chatStream,a),t.isHiddenStreamText);n&&i.push({text:n,replacementText:e.chatStream,source:`current`,timestamp:e.chatStreamStartedAt??Date.now()})}return i}function ul(e,t){if(typeof e.chatStream!=`string`)return null;let n=e,r=Array.isArray(n.chatStreamSegments)?n.chatStreamSegments:[],i=null;for(let e of r)ps(e)&&typeof e.text==`string`&&e.text.trim()&&(i=e.text);return al(ms(e.chatStream,i),t)}function dl(e,t,n){return t.itemId?cl(e,t.itemId):ol(e,t.replacementText,n)||ol(e,t.text,n)}function fl(e,t){let n=Zc(e)+1;return e.slice(n).some(e=>!e||typeof e!=`object`||O(e.role)!==`assistant`||t(e)?!1:!!W(e)?.trim())}function pl(e,t,n){let r=ll(t,n),i=n.persistCommentary===!0?r:r.filter(e=>!e.itemId);return r.length>0&&(i.length>0||fl(e,n.isHiddenAssistantMessage))&&i.every(t=>dl(e,t,n.isHiddenAssistantMessage))}function ml(e,t){return ll(e,t).length>0}function hl(e,t,n){let r=n?new Set([n]):new Set(Xc(t));if(r.size===0)return-1;let i=Zc(e)+1;for(let t=i;t<e.length;t++)if(Yc(e[t]).some(e=>r.has(e.id)))return t;return-1}function gl(e,t,n){return[...e.slice(0,n),t,...e.slice(n)]}function _l(e,t){let n=Zc(e)+1;for(let r=n;r<e.length;r++){let n=vl(e[r]);if(n!=null&&n>t)return r}return e.length}function vl(e){if(!e||typeof e!=`object`)return null;let t=e.timestamp;if(typeof t==`number`&&Number.isFinite(t))return t;let n=e.ts;return typeof n==`number`&&Number.isFinite(n)?n:null}function yl(e,t,n){let r=e.slice(0,t).toReversed().map(vl).find(e=>e!=null),i=e.slice(t).map(vl).find(e=>e!=null);if(r!=null&&n<=r){let e=r+1;return i!=null&&e>=i?r+(i-r)/2:e}if(i!=null&&n>=i){let e=i-1;return r!=null&&e<=r?r+(i-r)/2:e}return n}function bl(e,t,n){let r=e,i=n.persistCommentary===!0;for(let e of ll(t,n)){if(!i&&e.itemId)continue;let a=n.replacementMessages??[];if(dl([...r,...a],e,n.isHiddenAssistantMessage))continue;let o=e.source===`segment`&&e.toolCallId?hl(r,t,e.toolCallId):-1;if(n.requirePersistedTool&&o<0)continue;let s=o>=0?o:e.source===`segment`?_l(r,e.timestamp):r.length,c=tl(e.text,e.replacementText,yl(r,s,e.timestamp),e.source,e.itemId);r=gl(r,c,s)}return r}function xl(e,t){if(t.size===0)return;let n=e,r=Xc(e);if(n.toolStreamById instanceof Map)for(let e of t)n.toolStreamById.delete(e);if(Array.isArray(n.toolStreamOrder)&&(n.toolStreamOrder=n.toolStreamOrder.filter(e=>typeof e==`string`&&!t.has(e))),Array.isArray(n.chatToolMessages)&&(n.chatToolMessages=n.chatToolMessages.filter(e=>Yc(e).every(e=>!t.has(e.id)))),!Array.isArray(n.chatStreamSegments))return;let i=null,a=0;n.chatStreamSegments=n.chatStreamSegments.flatMap(e=>{let n=typeof e.toolCallId==`string`&&e.toolCallId.trim()?e.toolCallId.trim():null,o=fs(e),s=o?null:r[a]??null;o||(a+=1);let c=n??s,l=typeof e.text==`string`?e.text:``;if(c&&t.has(c))return ps(e)&&l.trim()&&(i=l),[];let u=i&&ps(e)?ms(l,i):l;return[{...e,text:u}]})}var Sl=/^\s*NO_REPLY\s*$/,Cl=`[openclaw] missing tool result in session history; inserted synthetic error result for transcript repair.`,wl=100,Tl=6e4,El=500,Dl=5e3,Ol=new WeakMap,kl=new WeakMap;function Al(e){let t=e,n=(Ol.get(t)??0)+1;return Ol.set(t,n),n}function jl(e,t){return Ol.get(e)===t}function Ml(e,t,n,r){return!jl(e,t)||e.sessionKey!==n?!1:!de(n)||_e(e)===r}function Nl(e){return Sl.test(e)}function Pl(e){if(!e||typeof e!=`object`)return!1;let t=e;if(O(t.role)!==`assistant`)return!1;if(typeof t.text==`string`)return Nl(t.text);let n=W(e);return typeof n==`string`&&Nl(n)}function Fl(e){if(!e||typeof e!=`object`||O(e.role)!==`toolresult`)return!1;let t=W(e);return typeof t==`string`&&t.trim()===Cl}function Il(e){if(typeof e==`string`)return!0;if(!Array.isArray(e))return!1;if(e.length===0)return!0;let t=!1;for(let n of e){if(!n||typeof n!=`object`)return!1;let e=n;if(e.type!==`text`||(t=!0,typeof e.text!=`string`))return!1}return t}function Ll(e){if(!e||typeof e!=`object`)return!1;let t=e;return O(t.role)!==`user`||(Array.isArray(t.MediaPaths)?t.MediaPaths:typeof t.MediaPath==`string`?[t.MediaPath]:[]).some(e=>typeof e==`string`&&e.trim())||!Il(t.content??t.text)?!1:(W(e)?.trim()??``)===``}function Rl(e){return Pi(e).shouldSkip}function zl(e){return Nl(e)||Rl(e)}function Bl(e){return Pl(e)||Li(e)}function Vl(e){return Bl(e)||Fl(e)||Ll(e)}function Hl(e,t,n={}){return bl(e,t,{...n,persistCommentary:Ul(t),isHiddenAssistantMessage:Bl,isHiddenStreamText:zl})}function Ul(e){return e.settings?.chatPersistCommentary===!0}function Wl(e){return!!(e&&typeof e==`object`&&e.__openclaw&&typeof e.__openclaw==`object`)}function Gl(e){if(!e||typeof e!=`object`||Wl(e))return!1;let t=O(e.role);return t===`user`||t===`assistant`}function Kl(e){if(!e||typeof e!=`object`)return null;let t=O(e.role);if(!t)return null;let n=W(e)?.trim();if(n)return`${t}:text:${n}`;try{return`${t}:content:${JSON.stringify(e.content??null)}`}catch{return null}}function ql(e,t,n){let r=vl(n);return r==null?!1:e.some(e=>{if(Kl(e)!==t)return!1;let n=vl(e);return n!=null&&n>=r})}function Jl(e,t){if(t.length===0)return e;if(e.length===0)return t.filter(e=>Gl(e)&&!Vl(e)).length===t.length?t:e;let n=new Map;e.forEach((e,t)=>{let r=Kl(e);r&&n.set(r,t)});let r=-1,i=-1;for(let e=t.length-1;e>=0;e--){let a=Kl(t[e]),o=a?n.get(a):void 0;if(typeof o==`number`){r=e,i=o;break}}if(r<0||i<e.length-1)return e;let a=[];for(let i of t.slice(r+1)){if(!Gl(i)||Vl(i))return e;let t=Kl(i);if(!t||n.has(t))return e;a.push(i)}return a.length>0?[...e,...a]:e}function Yl(e,t,n){if(t===e||t.length<=e.length||e.some((e,n)=>t[n]!==e))return[];let r=[];for(let i of t.slice(e.length)){if(!Gl(i)||Vl(i))return[];let e=Kl(i);if(!e)return[];ql(n,e,i)||r.push(i)}return r}function Xl(e,t){if(!(e instanceof S)||e.gatewayCode!==`UNAVAILABLE`||!e.retryable)return!1;let n=e.details;if(!n||typeof n!=`object`)return!0;let r=n.method;return typeof r!=`string`||r===t}function Zl(e,t){return e instanceof S&&e.gatewayCode===`INVALID_REQUEST`&&e.message.includes(`unknown method: ${t}`)}function Ql(e){let t=typeof e.retryAfterMs==`number`?e.retryAfterMs:El;return Math.min(Math.max(t,100),Dl)}function $l(e){return new Promise(t=>{setTimeout(t,e)})}function eu(e,t){e.lastError=t,e.chatError=t}function tu(e,t,n){if(!de(e.sessionKey)||!P(t))return!0;let r=typeof n==`string`&&n.trim()?L(n):void 0,i=_e(e);return r?i!==void 0&&r===i:i===void 0||i===fe(e)}function nu(e,t,n){return(I(t,e.sessionKey)||P(t)&&de(e.sessionKey))&&tu(e,t,n)}function ru(e){return(typeof e==`string`?e.trim():``)||null}function iu(e,t){let n=e.sessionsResult?.sessions.find(e=>e.key===t);return le(e,t,{rowKind:n?.kind,requireGlobalRowForMainAlias:!0})}function au(e){let t=F(e.sessionKey);return t?.agentId?L(t.agentId):N(e)}function ou(e,t){return P(t)?au(e):iu(e,t)}function su(e){let t=e,n=(kl.get(t)??0)+1;return kl.set(t,n),n}function cu(e,t){return kl.get(e)===t.generation&&e.client===t.client&&e.connected&&e.sessionKey.trim()===t.requestedKey&&ou(e,t.requestedKey)===(t.requestedAgentId??null)}async function lu(e,t,n){try{await Fe(e,{key:t,agentId:P(t)?n:null})}catch{}}async function uu(e,t){if(!e.client||!e.connected)return;let n=e.client,r=e.sessionKey.trim();if(!r)return;let i=su(e),a=ru(e.chatSessionMessageSubscriptionRequestedKey),o=ru(e.chatSessionMessageSubscriptionKey),s=a??o,c=ou(e,r),l=c!==null&&s===r&&(e.chatSessionMessageSubscriptionAgentId??null)!==c,u=s!==null&&s!==r,d=o!==null&&(u||l),f=t?.force===!0||u||l||o===null||a===null;if(!d&&!f)return;let p=()=>cu(e,{generation:i,client:n,requestedKey:r,requestedAgentId:c});try{if(d&&o&&(await Fe(n,{key:o,agentId:P(o)&&e.chatSessionMessageSubscriptionAgentId?e.chatSessionMessageSubscriptionAgentId:null}),p()&&(e.chatSessionMessageSubscriptionKey=null,e.chatSessionMessageSubscriptionRequestedKey=null,e.chatSessionMessageSubscriptionAgentId=null)),!f||!p())return;let t=await e.sessions.subscribeMessages(r,{agentId:c??void 0});if(!p()){let r=ru(e.chatSessionMessageSubscriptionKey)!==t.key,i=P(t.key)&&(e.chatSessionMessageSubscriptionAgentId??null)!==t.agentId;(r||i)&&await lu(n,t.key,t.agentId);return}e.chatSessionMessageSubscriptionRequestedKey=r,e.chatSessionMessageSubscriptionKey=t.key,e.chatSessionMessageSubscriptionAgentId=t.agentId}catch(t){p()&&(e.sessionsError=String(t))}}var du=new WeakMap;function fu(e,t,n,r={}){as(e,`control-ui.chat.history`,{phase:t,durationMs:ns(ts()-n),sessionKey:e.sessionKey,activeRunId:e.chatRunId,...r},{console:!1,maxBufferedEventsForType:30})}function pu(e,t,n,r){e.chatMessagesBySession&&Rc(e.chatMessagesBySession,e,{sessionKey:t,agentId:r},n)}function mu(e){return e.chatRunId?!0:!!e.sessionsResult?.sessions.some(t=>t.key===e.sessionKey&&Ze(t))}function hu(e,t){e.chatMessagesBySession&&Vc(e.chatMessagesBySession,e,{sessionKey:t})}async function gu(e){if(!e.client||!e.connected)return;let t=mu(e);try{await e.sessions.reset(e.sessionKey,Me(e,e.sessionKey)),e.chatMessages=[],hu(e,e.sessionKey),e.chatSideResult=null,e.chatReplyTarget=null,_c(e,{outcome:t?`interrupted`:void 0,sessionStatus:`killed`,runId:e.chatRunId,sessionKey:e.sessionKey,clearLocalRun:!0,clearChatStream:!0,clearToolStream:!0,clearSideResultTerminalRuns:!0,clearRunStatus:!t}),await _u(e)}catch(t){eu(e,String(t))}K(e)}async function _u(e,t={}){if(!e.client||!e.connected)return;let n=e.sessionKey,r=de(n)?_e(e):void 0,i=ut(e,`chat.startup`),a=t.startup===!0&&i!==!1?`chat.startup`:`chat.history`,o=`${a}\0${n}\0${r??``}`,s=du.get(e);if(s?.key===o&&s.client===e.client&&s.messages===e.chatMessages)return s.promise;let c=yu(e,e.client,n,r,a).finally(()=>{du.get(e)?.promise===c&&du.delete(e)});return du.set(e,{client:e.client,key:o,messages:e.chatMessages,promise:c}),c}function vu(e,t,n){if(!t||e.client!==n||!e.connected)return;e.agentsList=t,e.agentsError=null,e.onAgentsList?.(t,n);let r=typeof e.agentsSelectedId==`string`&&e.agentsSelectedId.trim()?L(e.agentsSelectedId):void 0;r&&t.agents.some(e=>L(e.id)===r)||(e.agentsSelectedId=typeof t.defaultId==`string`&&t.defaultId.trim()?t.defaultId:t.agents[0]?.id??null)}async function yu(e,t,n,r,i){let a=Al(e),o=Date.now(),s=ts(),c=e.chatMessages,l=e.chatRunId;fu(e,`start`,s,{requestSessionKey:n,requestAgentId:r,method:i,previousRunId:l}),e.resetChatInputHistoryNavigation?.(),e.chatLoading=!0,eu(e,null);try{let u;for(;;)try{u=await t.request(i,{sessionKey:n,...r?{agentId:r}:{},limit:wl});break}catch(c){if(!Ml(e,a,n,r)){fu(e,`stale`,s,{requestSessionKey:n,requestAgentId:r,previousRunId:l,reason:`request-version`});return}let d=Date.now()-o<Tl;if(i===`chat.startup`&&Zl(c,i)){u=await t.request(`chat.history`,{sessionKey:n,...r?{agentId:r}:{},limit:wl});break}if(d&&Xl(c,i)){if(await $l(Ql(c)),!e.client||!e.connected)return;continue}throw c}if(!Ml(e,a,n,r)){fu(e,`stale`,s,{requestSessionKey:n,requestAgentId:r,previousRunId:l,reason:`apply-version`});return}let d=Array.isArray(u.messages)?u.messages:[];vu(e,u.agentsList,t);let f=d.filter(e=>!Vl(e)),p=Yl(c,e.chatMessages,f);e.chatMessages=Jl(f,c),p.length>0&&(e.chatMessages=[...e.chatMessages,...p]),pu(e,n,e.chatMessages,r),e.currentSessionId=typeof u.sessionInfo?.sessionId==`string`&&u.sessionInfo.sessionId.trim()?u.sessionInfo.sessionId:typeof u.sessionId==`string`&&u.sessionId.trim()?u.sessionId:null,e.reconnectResumeSessionId&&e.reconnectResumeSessionId!==e.currentSessionId&&(e.reconnectResumeSessionId=null),e.chatThinkingLevel=u.sessionInfo?.thinkingLevel??u.thinkingLevel??null,e.chatVerboseLevel=u.verboseLevel??null;let m=!e.chatRunId||e.chatRunId===l;if(m){let t={persistCommentary:Ul(e),isHiddenAssistantMessage:Bl,isHiddenStreamText:zl},i=ml(e,t),a=pl(e.chatMessages,e,t),o=Xc(e),c=el(e.chatMessages,e),u=o.length>0&&o.every(e=>c.has(e)),p=c.size>0,m=o.length===0||u;if(!i||a)m?Qc(e):(xl(e,c),$c(e)),e.chatStream=null,e.chatStreamStartedAt=null,fu(e,`stream-reset`,s,{requestSessionKey:n,requestAgentId:r,previousRunId:l,messageCount:d.length,visibleMessageCount:f.length});else if(!e.chatRunId)e.chatMessages=Hl(e.chatMessages,e),Qc(e),e.chatStream=null,e.chatStreamStartedAt=null;else if(u)e.chatMessages=Hl(e.chatMessages,e,{includeCurrent:!1}),e.chatStream=ul(e,t.isHiddenStreamText),e.chatStream===null&&(e.chatStreamStartedAt=null),Qc(e);else if(p){let n=ul(e,t.isHiddenStreamText);e.chatMessages=Hl(e.chatMessages,e,{includeCurrent:!1,requirePersistedTool:!0}),e.chatStream=n,e.chatStream===null&&(e.chatStreamStartedAt=null),xl(e,c)}}return fu(e,`applied`,s,{requestSessionKey:n,requestAgentId:r,previousRunId:l,messageCount:d.length,visibleMessageCount:f.length,resetStream:m}),u}catch(t){if(!Ml(e,a,n,r)){fu(e,`stale`,s,{requestSessionKey:n,requestAgentId:r,previousRunId:l,reason:`error-version`});return}fu(e,`error`,s,{requestSessionKey:n,requestAgentId:r,previousRunId:l}),ke(t)?(e.chatMessages=[],e.chatThinkingLevel=null,e.chatVerboseLevel=null,eu(e,qe(`existing chat history`))):eu(e,String(t))}finally{jl(e,a)&&(e.chatLoading=!1)}}var bu=new Map;function xu(e){if(!(typeof URL>`u`||typeof URL.createObjectURL!=`function`))return URL.createObjectURL(e)}function Su(e){!e||typeof URL>`u`||typeof URL.revokeObjectURL!=`function`||URL.revokeObjectURL(e)}function Cu(e){Su(bu.get(e.attachment.id)?.previewUrl);let t=xu(e.file)??e.attachment.previewUrl;return bu.set(e.attachment.id,{dataUrl:e.dataUrl,...t?{previewUrl:t}:{}}),{...e.attachment,...t?{previewUrl:t}:{}}}function wu(e){return e.dataUrl??bu.get(e.id)?.dataUrl??null}function Tu(e){return e.previewUrl??bu.get(e.id)?.previewUrl??e.dataUrl??null}function Eu(e){let{dataUrl:t,...n}=e;return n}function Du(e){return e.map(Eu)}function Ou(e){let t=bu.get(e);t&&(Su(t.previewUrl),bu.delete(e))}function ku(e=[]){for(let t of e)Ou(t.id)}function Au(e){let t=bu.get(e);if(t){if(t.previewUrl){bu.set(e,{previewUrl:t.previewUrl});return}bu.delete(e)}}function ju(e=[]){for(let t of e)Au(t.id)}var Mu=`openclaw.control.chatComposer.v1:`,Nu=20,Pu=50,Fu=200,Iu=`Model selection was interrupted. Review and retry when ready.`;function Lu(e){let t=e?.trim()||`default`;return`${Mu}${encodeURIComponent(t).slice(0,240)}`}function Ru(e){let t=e.hello?.snapshot;if(!t||typeof t!=`object`)return;let n=t.sessionDefaults;if(!n||typeof n!=`object`)return;let r=n.defaultAgentId;return typeof r==`string`&&r.trim()?r.trim():void 0}function zu(e,t){let n=F(t);return L(n?n.agentId:e.assistantAgentId?.trim()||e.agentsList?.defaultId?.trim()||Ru(e)||`main`)}function Bu(e,t){return`${t}\u0000agent:${zu(e,t)}`}function Vu(e,t){let n=e.getItem(t);if(!n)return{version:1,sessions:{}};try{let e=JSON.parse(n);if(!e||e.version!==1||!e.sessions||typeof e.sessions!=`object`)return{version:1,sessions:{}};let t={};for(let[n,r]of Object.entries(e.sessions)){let e=Yu(r);e&&(t[n]=e)}return{version:1,sessions:t}}catch{return{version:1,sessions:{}}}}function Hu(e,t,n){let r=Object.entries(n.sessions).toSorted((e,t)=>t[1].updatedAt-e[1].updatedAt).slice(0,Nu);if(r.length===0){e.removeItem(t);return}e.setItem(t,JSON.stringify({version:1,sessions:Object.fromEntries(r)}))}function q(e){return typeof e==`string`&&e.trim()?e:void 0}function Uu(e){return typeof e==`boolean`?e:void 0}function Wu(e){if(!e||typeof e!=`object`||Array.isArray(e))return null;let t=e,n=q(t.id),r=q(t.mimeType);if(!n||!r)return null;let i={id:n,mimeType:r},a=q(t.fileName);a&&(i.fileName=a),typeof t.sizeBytes==`number`&&Number.isFinite(t.sizeBytes)&&(i.sizeBytes=t.sizeBytes);let o=q(t.dataUrl);return o&&(i.dataUrl=o),i}function Gu(e){let t=wu(e);return t?{id:e.id,mimeType:e.mimeType,...e.fileName?{fileName:e.fileName}:{},...typeof e.sizeBytes==`number`?{sizeBytes:e.sizeBytes}:{},dataUrl:t}:null}function Ku(e){if(!e||typeof e!=`object`||Array.isArray(e))return;let t=e,n=q(t.proposalId);if(!n)return;let r=q(t.agentId);return{proposalId:n,...r?{agentId:L(r)}:{}}}function qu(e){let t=q(e.id),n=typeof e.text==`string`?e.text:``;if(!t||!n.trim()&&!e.attachments?.length||e.pendingRunId||e.sendState===`sending`)return null;let r=e.attachments?.map(Gu)??[];if(e.attachments?.length&&r.some(e=>e===null))return null;let i=e.sendState===`failed`||e.sendState===`waiting-reconnect`||e.sendState===`waiting-model`?e.sendState:void 0,a=Ku(e.skillWorkshopRevision);return{id:t,text:n,createdAt:typeof e.createdAt==`number`&&Number.isFinite(e.createdAt)?e.createdAt:Date.now(),...e.kind===`queued`||e.kind===`steered`?{kind:e.kind}:{},...r.length?{attachments:r}:{},...typeof e.refreshSessions==`boolean`?{refreshSessions:e.refreshSessions}:{},...e.localCommandArgs?{localCommandArgs:e.localCommandArgs}:{},...e.localCommandName?{localCommandName:e.localCommandName}:{},...e.sessionKey?{sessionKey:e.sessionKey}:{},...e.agentId?{agentId:e.agentId}:{},...a?{skillWorkshopRevision:a}:{},...i?{sendState:i}:{},...e.sendError?{sendError:e.sendError}:{},...e.sendRunId?{sendRunId:e.sendRunId}:{},...typeof e.sendAttempts==`number`&&Number.isFinite(e.sendAttempts)?{sendAttempts:e.sendAttempts}:{}}}function Ju(e){if(!e||typeof e!=`object`||Array.isArray(e))return null;let t=e,n=q(t.id),r=typeof t.text==`string`?t.text:``,i=typeof t.createdAt==`number`&&Number.isFinite(t.createdAt)?t.createdAt:Date.now();if(!n||!r.trim()&&!Array.isArray(t.attachments))return null;let a=Array.isArray(t.attachments)?t.attachments.map(Wu).filter(e=>e!==null):[],o={id:n,text:r,createdAt:i};(t.kind===`queued`||t.kind===`steered`)&&(o.kind=t.kind),a.length&&(o.attachments=a);let s=Uu(t.refreshSessions);s!==void 0&&(o.refreshSessions=s),t.sendState===`failed`||t.sendState===`waiting-reconnect`?o.sendState=t.sendState:t.sendState===`waiting-model`&&(o.sendState=`failed`,o.sendError=Iu);let c=q(t.sendError);c&&(o.sendError=c);let l=q(t.sendRunId);l&&(o.sendRunId=l),typeof t.sendAttempts==`number`&&Number.isFinite(t.sendAttempts)&&(o.sendAttempts=t.sendAttempts);let u=q(t.localCommandArgs);u&&(o.localCommandArgs=u);let d=q(t.localCommandName);d&&(o.localCommandName=d);let f=q(t.sessionKey);f&&(o.sessionKey=f);let p=q(t.agentId);p&&(o.agentId=L(p));let m=Ku(t.skillWorkshopRevision);return m&&(o.skillWorkshopRevision=m),o}function Yu(e){if(!e||typeof e!=`object`||Array.isArray(e))return null;let t=e,n=typeof t.draft==`string`?t.draft:void 0,r=Array.isArray(t.queue)?t.queue.slice(0,Pu).map(Ju).filter(e=>e!==null):void 0;return!n&&(!r||r.length===0)?null:{...n?{draft:n}:{},...r&&r.length>0?{queue:r}:{},updatedAt:typeof t.updatedAt==`number`&&Number.isFinite(t.updatedAt)?t.updatedAt:Date.now()}}function Xu(e,t){let n=j();if(!n)return null;try{let r=Lu(e.settings?.gatewayUrl),i=Bu(e,t),a=Yu(Vu(n,r).sessions[i]);return a?{draft:a.draft??``,queue:a.queue??[]}:null}catch{return null}}function Zu(e,t=e.sessionKey){let n=j();if(!(!n||!t.trim()))try{let r=Lu(e.settings?.gatewayUrl),i=Vu(n,r),a=Bu(e,t),o=e.chatMessage,s=e.chatQueue.slice(0,Pu).map(qu).filter(e=>e!==null);!o&&s.length===0?delete i.sessions[a]:i.sessions[a]={...o?{draft:o}:{},...s.length>0?{queue:s}:{},updatedAt:Date.now()},Hu(n,r,i)}catch{}}function Qu(e,t,n){let r=j();if(!(!r||!t.trim()||!n.trim()))try{let i=Lu(e.settings?.gatewayUrl),a=Vu(r,i),o=Bu(e,t),s=Yu(a.sessions[o]);if(!s?.queue?.length)return;let c=s.queue.filter(e=>e.id!==n);!s.draft&&c.length===0?delete a.sessions[o]:a.sessions[o]={...s.draft?{draft:s.draft}:{},...c.length?{queue:c}:{},updatedAt:Date.now()},Hu(r,i,a)}catch{}}function $u(e,t,n){let r=j();if(!(!r||!t.trim()))try{let i=Lu(e.settings?.gatewayUrl),a=Vu(r,i),o=Bu(e,t),s=Yu(a.sessions[o]),c=n.slice(0,Pu).map(qu).filter(e=>e!==null);!s?.draft&&c.length===0?delete a.sessions[o]:a.sessions[o]={...s?.draft?{draft:s.draft}:{},...c.length?{queue:c}:{},updatedAt:Date.now()},Hu(r,i,a)}catch{}}function ed(e,t={}){let n=Xu(e,t.sessionKey??e.sessionKey);return n?((!t.preserveCurrent||!e.chatMessage)&&(e.chatMessage=n.draft),(!t.preserveCurrent&&n.queue.length>0||e.chatQueue.length===0)&&(e.chatQueue=n.queue),!0):!1}var td=class{constructor(e,t){this.getState=t,this.timer=null,this.ready=!1,this.lastPersisted=null,e.addController(this)}hostDisconnected(){this.stop()}start(){let e=this.getState();e&&(this.ready=!0,this.lastPersisted=this.snapshot(e))}stop(){this.persistNow(),this.ready=!1,this.clearTimer()}restore(e={}){let t=this.getState();if(!t)return!1;let n=ed(t,e);return this.lastPersisted=this.snapshot(t),n}schedule(){this.persist(!1)}persistNow(){this.persist(!0)}persistChangedState(){let e=this.getState();this.lastPersisted?.chatQueue!==e?.chatQueue&&this.persistNow()}persist(e){let t=this.getState();if(!(!this.ready||!t||this.isUnchanged(t))){if(this.clearTimer(),!e){this.timer=globalThis.setTimeout(()=>this.persistNow(),Fu);return}Zu(t),this.lastPersisted=this.snapshot(t)}}clearTimer(){this.timer!==null&&(globalThis.clearTimeout(this.timer),this.timer=null)}isUnchanged(e){let t=this.lastPersisted;return!!(t&&t.sessionKey===e.sessionKey&&t.chatMessage===e.chatMessage&&t.chatQueue===e.chatQueue)}snapshot(e){return{sessionKey:e.sessionKey,chatMessage:e.chatMessage,chatQueue:e.chatQueue}}};function nd(e,t,n,r,i){let a=t.trim(),o=!!(n&&n.length>0);if(!a&&!o)return null;let s={id:v(),text:a,createdAt:Date.now(),attachments:o?Du(n??[]):void 0,refreshSessions:r,localCommandArgs:i?.args,localCommandName:i?.name,sessionKey:e.sessionKey,agentId:De(e,e.sessionKey)};return e.chatQueue=[...e.chatQueue,s],s}function rd(e,t,n,r){let i=t.trim(),a=!!(r&&r.length>0);!i&&!a||(e.chatQueue=[...e.chatQueue,{id:v(),text:i,createdAt:Date.now(),kind:`steered`,attachments:a?Du(r??[]):void 0,pendingRunId:n}])}function id(e,t){return t===e.sessionKey?e.chatQueue:e.chatQueueBySession?.[t]??[]}function ad(e,t,n){if(t===e.sessionKey){e.chatQueue=n;return}let r={...e.chatQueueBySession};n.length>0?r[t]=n:delete r[t],e.chatQueueBySession=r,e.requestUpdate?.()}function od(e,t,n){return sd(e,e.sessionKey,t,n)}function sd(e,t,n,r){let i=null;return ad(e,t,id(e,t).map(e=>e.id===n?(i=r(e),i):e)),i}function cd(e,t){$u(e,t,id(e,t))}function ld(e,t,n=e.sessionKey){let r=id(e,n),i=r.find(e=>e.id===t)??null;return ad(e,n,r.filter(e=>e.id!==t)),i}function ud(e,t,n){return ld(e,t)??(n?ld(e,t,n):null)}function dd(e,t){if(!t?.length)return t?[]:void 0;let n=new Set((e.chatAttachments??[]).map(e=>e.id));return t.filter(e=>!n.has(e.id))}function fd(e,t){let n=e.chatQueue.filter(e=>e.id===t);e.chatQueue=e.chatQueue.filter(e=>e.id!==t);for(let t of n)ku(dd(e,t.attachments))}function pd(e,t){if(!t)return;let n=e.chatQueue.filter(e=>e.pendingRunId===t);e.chatQueue=e.chatQueue.filter(e=>e.pendingRunId!==t);for(let t of n)ku(dd(e,t.attachments))}function md(e){let t=e=>{let t=!1,n=e.map(e=>!e.sendRunId||e.sendState!==`sending`?e:(t=!0,{...e,sendState:`waiting-reconnect`}));return{changed:t,queue:n}},n=t(e.chatQueue);n.changed&&(e.chatQueue=n.queue);let r=!1,i={...e.chatQueueBySession};for(let[e,n]of Object.entries(i)){let a=t(n);a.changed&&(r=!0,i[e]=a.queue)}r&&(e.chatQueueBySession=i)}var hd=1500;function gd(){return{entries:[],nextEntryId:1,userEntryId:null,userEntryAwaitingFinal:!1,userEntryAwaitingFinalStartedAtMs:null,assistantEntryId:null}}function _d(e,t){let n=t.text;if(t.final?n.trim()===``:n===``)return e;let r=t.nowMs??Date.now();if(t.role===`assistant`){let i=bd(e,`user`,r);return vd(i,t.role,i.assistantEntryId,n,t.final,r)}let i=e.userEntryId,a=i!==null&&xd(e,i,n,t.final,r),o=i===null||a?bd(e,`assistant`,r):e;return vd(a&&i!==null?{...bd(o,`user`,r),userEntryId:null,userEntryAwaitingFinal:!1,userEntryAwaitingFinalStartedAtMs:null}:o,t.role,a?null:i,n,t.final,r)}function vd(e,t,n,r,i,a){if(n===null){let n=`rt-${e.nextEntryId}`,o=[...e.entries,{id:n,role:t,text:r.trimStart(),isStreaming:!i}].slice(-60);return yd({...e,entries:o,nextEntryId:e.nextEntryId+1},t,n,i,a)}let o=e.entries.findIndex(e=>e.id===n);if(o===-1)return vd(e,t,null,r,i,a);let s=e.entries[o],c=Sd(s.text,r,i),l=s.text===c&&s.isStreaming===!i?e.entries:e.entries.map((e,t)=>t===o?{...e,text:c,isStreaming:!i}:e);return yd({...e,entries:l},t,n,i,a)}function yd(e,t,n,r,i){return t===`user`?{...e,userEntryId:r?null:n,userEntryAwaitingFinal:!1,userEntryAwaitingFinalStartedAtMs:null}:{...e,assistantEntryId:r?null:n}}function bd(e,t,n=Date.now()){let r=t===`user`?e.userEntryId:e.assistantEntryId;if(r===null)return e;let i=e.entries.map(e=>e.id===r&&e.isStreaming?{...e,isStreaming:!1}:e);return t===`user`?{...e,entries:i,userEntryAwaitingFinal:!0,userEntryAwaitingFinalStartedAtMs:n}:{...e,entries:i,assistantEntryId:null}}function xd(e,t,n,r,i){let a=e.entries.find(e=>e.id===t);if(!a||a.isStreaming)return!1;let o=a.text;return!(o.trim()===``||n.trim()===``||n[0]&&/\s/.test(n[0])||n===o||n.startsWith(o)||o.endsWith(n)||r&&e.userEntryAwaitingFinal&&(e.userEntryAwaitingFinalStartedAtMs===null?1/0:i-e.userEntryAwaitingFinalStartedAtMs)<=hd&&Cd(o,n))}function Sd(e,t,n){if(e.trim()===``)return t.trimStart();if(t===``||t===e||e.endsWith(t))return e;if(t.startsWith(e))return t;if(t[0]&&/\s/.test(t[0]))return`${e}${t}`;if(n&&Cd(e,t))return t;let r=Dd(e,t),i=r>0?t.slice(r):t;return i===``?e:`${e}${r>0||!Od(e,i)?``:` `}${i}`}function Cd(e,t){let n=wd(e),r=wd(t);if(n.length===0||r.length===0||n[0]!==r[0])return!1;if(n.length>1&&r.length>1&&n[1]===r[1])return!0;let i=Td(e),a=Td(t),o=Ed(i,a),s=Math.min(i.length,a.length);return o>=6&&o/Math.max(1,s)>=.45}function wd(e){return[...e.toLowerCase().matchAll(/[\p{L}\p{N}]+/gu)].map(e=>e[0])}function Td(e){return e.toLowerCase().replace(/\s+/g,` `).trim()}function Ed(e,t){let n=Math.min(e.length,t.length),r=0;for(;r<n&&e[r]===t[r];)r+=1;return r}function Dd(e,t){let n=e.toLowerCase(),r=t.toLowerCase(),i=Math.min(n.length,r.length);for(let e=i;e>=3;--e)if(n.endsWith(r.slice(0,e)))return e;return 0}function Od(e,t){let n=e.at(-1),r=t[0];return!n||!r||/\s/.test(n)||/\s/.test(r)?!1:/[\p{L}\p{N}.!?,:;)\]}"'’”]/u.test(n)&&/[\p{L}\p{N}]/u.test(r)}function kd(){let e=globalThis.navigator?.mediaDevices;if(!e?.enumerateDevices)throw Error(A(`chat.composer.microphoneListUnsupported`));return e}function Ad(e){let t=[],n=new Set;for(let r of e){let e=r.deviceId.trim();r.kind!==`audioinput`||!e||e==="default"||n.has(e)||(n.add(e),t.push({deviceId:e,label:r.label.trim()||A(`chat.composer.microphoneFallback`,{number:String(t.length+1)})}))}return t}function jd(e){let t=e instanceof DOMException?e.name:``;return A(t===`NotAllowedError`?`chat.composer.microphonePermissionBlocked`:t===`NotFoundError`?`chat.composer.microphoneNoneFound`:t===`NotReadableError`?`chat.composer.microphoneBusy`:t===`InvalidStateError`?`chat.composer.microphonePageInactive`:`chat.composer.microphoneAccessFailed`)}async function Md(e){let t,n;try{t=kd(),n=await t.enumerateDevices()}catch(e){return{devices:[],warning:jd(e)}}let r=n.filter(e=>e.kind===`audioinput`),i=r.length===0||r.some(e=>!e.deviceId||!e.label);if(!e||!i||!t.getUserMedia)return{devices:Ad(n),warning:null};try{return(await t.getUserMedia({audio:!0})).getTracks().forEach(e=>e.stop()),n=await t.enumerateDevices(),{devices:Ad(n),warning:null}}catch(e){return{devices:Ad(n),warning:jd(e)}}}function Nd(e,t=!0){let n=e?.trim();return n?{...t===!0?{}:t,deviceId:{exact:n}}:t}async function Pd(e,t=!0){let n=globalThis.navigator?.mediaDevices;if(!n?.getUserMedia)throw Error(A(`chat.composer.realtimeTalkRequiresMicrophone`));try{return await n.getUserMedia({audio:Nd(e,t)})}catch(t){throw e?.trim()&&t instanceof DOMException&&t.name===`OverconstrainedError`?Error(A(`chat.composer.selectedMicrophoneUnavailable`),{cause:t}):t}}function Fd(e){let t=D(e);if(t)return t===`webrtc-sdp`?`webrtc`:t===`json-pcm-websocket`?`provider-websocket`:t}function Id(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n){let i=e.subarray(r,r+n);t+=String.fromCharCode(...i)}return btoa(t)}function Ld(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e+=1)n[e]=t.charCodeAt(e);return n}function Rd(e){let t=new Uint8Array(e.length*2),n=new DataView(t.buffer);for(let t=0;t<e.length;t+=1){let r=Math.max(-1,Math.min(1,e[t]??0));n.setInt16(t*2,r<0?r*32768:r*32767,!0)}return t}function zd(e){let t=new DataView(e.buffer,e.byteOffset,e.byteLength),n=new Float32Array(Math.floor(e.byteLength/2));for(let e=0;e<n.length;e+=1)n[e]=t.getInt16(e*2,!0)/32768;return n}var Bd=class{constructor(){this.playhead=0,this.sources=new Set}get queuedUntil(){return this.playhead}get isPlaying(){return this.sources.size>0}play(e,t,n){if(!t)return;let r=zd(Ld(e));if(r.length===0)return;let i=t.createBuffer(1,r.length,n);i.getChannelData(0).set(r);let a=t.createBufferSource();this.sources.add(a),a.addEventListener(`ended`,()=>this.sources.delete(a)),a.buffer=i,a.connect(t.destination);let o=Math.max(t.currentTime,this.playhead);a.start(o),this.playhead=o+i.duration}stop(e){for(let e of this.sources)try{e.stop()}catch{}this.sources.clear(),this.playhead=e?.currentTime??0}},Vd=`openclaw_agent_consult`,Hd=[`status`,`steer`,`cancel`,`followup`];function Ud(e){let t=E(e);return Hd.includes(t)?t:void 0}var Wd=[/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:please\s+)?(?:cancel|cancle|abort)(?:\s+(?:that|this|it|the\s+(?:check|run|task|work)))?(?:\s*[.!?])?$/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:please\s+)?(?:never mind|nevermind|forget it|kill it|end that)(?:\s*[.!?])?$/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:please\s+)?stop(?:\s+(?:that|this|it|the\s+(?:check|run|task|work)))?(?:\s*[.!?])?$/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:can|could|would)\s+you\s+(?:please\s+)?(?:cancel|cancle|stop|abort)(?:\s+(?:that|this|it|the\s+(?:check|run|task|work)))?(?:\s*[.!?])?$/,/^(?:(?:ok|okay|alright|all right|actually)[,\s]+)?(?:can|could|would)\s+(?:we|you)\s+(?:just\s+)?(?:cancel|cancle|stop|abort)(?:\s+(?:that|this|it|the\s+(?:check|run|task|work)))?(?:\s*[.!?])?$/,/\b(?:cancel|cancle|stop|abort)\s+(?:that|this|it|the\s+(?:check|run|task|work))\b/],Gd=[/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:status|progress|update)(?:\s*[.!?])?$/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:give me|what'?s|any)\s+(?:an?\s+)?update(?:\s*[.!?])?$/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(where are we|what'?s happening|what (?:are you|is it) doing|what'?s it doing|how (?:is|are) (?:it|you|that|this) going|how'?s it going|are you still working|is it done|did it finish)(\b|[.!?])/],Kd=[/^(after that|when you'?re done|when it'?s done|next|then|also|one more thing|follow up)(\b|[,.!?])/],qd=[/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:please\s+)?update\s+\S/,/^(?:actually|instead|change|switch|focus|use|try|prefer|make|do|check|look at|go with|redirect|steer|tell it to)\b/,/^(?:can|could|would)\s+you\s+(?:actually\s+)?(?:change|switch|focus|use|try|prefer|make|do|check|look at|go with|redirect|steer)\b/,/\b(?:instead|not that|rather than|change that|switch to|focus on|use the|try the|go with|tell it to)\b/],Jd=[/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:please\s+)?stop\s+(?:using|doing|checking|looking at|focusing on|trying)\b/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:can|could|would)\s+(?:you|we)\s+(?:please\s+)?stop\s+(?:using|doing|checking|looking at|focusing on|trying)\b/,/^(?:(?:ok|okay|alright|all right)[,\s]+)?(?:please\s+)?stop\s+(?:that|this|it|the\s+(?:check|run|task|work))\s+from\b/];function Yd(e,t){return t.some(t=>t.test(e))}function Xd(e){return/\b(?:don'?t|do\s+not|not|never)\s+(?:please\s+)?(?:cancel|cancle|stop|abort|kill|end)\b/.test(e)||/\bstop\s+(?:it|that|this)\s+from\b/.test(e)}function Zd(e){let t=Ud(e.mode);if(t)return{mode:t,confidence:`high`,reason:`explicit_mode`,shouldAutoControl:!0};let n=e.text.trim().toLowerCase();return Yd(n,Jd)?{mode:`steer`,confidence:`medium`,reason:`steer_command`,shouldAutoControl:!0}:!Xd(n)&&Yd(n,Wd)?{mode:`cancel`,confidence:`high`,reason:`cancel_safety`,shouldAutoControl:!0}:Yd(n,Gd)?{mode:`status`,confidence:`high`,reason:`status_query`,shouldAutoControl:!0}:Yd(n,Kd)?{mode:`followup`,confidence:`high`,reason:`followup_marker`,shouldAutoControl:!0}:Yd(n,qd)?{mode:`steer`,confidence:`medium`,reason:`steer_command`,shouldAutoControl:!0}:{mode:`status`,confidence:`low`,reason:`safe_default`,shouldAutoControl:!1}}function Qd(e){return Zd({text:e}).shouldAutoControl}function $d(e){let t=ef(e),n=t&&typeof t==`object`&&!Array.isArray(t)?t:{},r=D(n.text)??D(n.message)??D(n.request)??D(n.query);if(!r)throw Error(`text required`);return{text:r,mode:Ud(n.mode)??Zd({text:r}).mode}}function ef(e){if(typeof e!=`string`)return e;let t=e.trim();if(!t)return{};try{return JSON.parse(t)}catch{return{text:t}}}function tf(e){return[`Internal OpenClaw voice control result.`,`Do not call openclaw_agent_consult or any other tool for this message.`,`Speak this exact OpenClaw status to the voice call, without adding, removing, or rephrasing words.`,`Status: ${JSON.stringify(e)}`].join(`
`)}function nf(e=`Cancelled the active OpenClaw run.`){return{status:`cancelled`,message:e}}function rf(e,t){let n=0,r=0,i,a=of(e,t);return r=>{if(!e.callbacks.onTalkEvent)return;let s=o(r);n+=1,e.callbacks.onTalkEvent({id:`${a}:${n}`,type:r.type,sessionId:a,turnId:s,captureId:r.captureId,seq:n,timestamp:new Date().toISOString(),mode:`realtime`,transport:t.transport,brain:`agent-consult`,provider:t.provider,final:r.final,callId:r.callId,itemId:r.itemId,parentId:r.parentId,payload:r.payload??null}),(r.type===`turn.ended`||r.type===`turn.cancelled`||r.type===`session.replaced`||r.type===`session.closed`)&&(i=void 0)};function o(e){return e.type===`turn.started`||af(e.type)?(i=e.turnId??i??`turn-${++r}`,i):e.turnId}}function af(e){return e===`turn.ended`||e===`turn.cancelled`||e.startsWith(`input.audio.`)||e.startsWith(`transcript.`)||e.startsWith(`output.`)||e.startsWith(`tool.`)}function of(e,t){let n=t.sessionId;return typeof n==`string`&&n.trim()?n.trim():`relaySessionId`in t&&t.relaySessionId.trim()?t.relaySessionId:`${e.sessionKey}:${t.provider}:${t.transport}`}var sf=500;function cf(e){if(!e||typeof e!=`object`)return``;let t=e;return typeof t.text==`string`?t.text:(Array.isArray(t.content)?t.content:[]).map(e=>{if(!e||typeof e!=`object`)return``;let t=e;return t.type===`text`&&typeof t.text==`string`?t.text:``}).filter(Boolean).join(`

`).trim()}function lf(e){if(!e)return;let t=e.error?.trim();if(e.status===`error`)return Error(t||`OpenClaw tool call failed`);if(e.status!==`timeout`||e.pendingError)return;let n=e.stopReason?.trim(),r=e.timeoutPhase?.trim(),i=e.livenessState?.trim();if(e.endedAt!==void 0||t!==void 0||e.aborted===!0||i!==void 0&&i.length>0||e.yielded===!0||n!==void 0&&n.length>0||r===`preflight`||r===`provider`||r===`post_turn`||e.providerStarted===!0)return Error(t||`OpenClaw tool call timed out`)}function uf(e){return new Promise((t,n)=>{if(e.signal?.aborted){n(new DOMException(`OpenClaw tool call aborted`,`AbortError`));return}let r=window.setTimeout(()=>{u(Error(`OpenClaw tool call timed out`))},e.timeoutMs),i=!1,a=!1,o,s=()=>{u(new DOMException(`OpenClaw tool call aborted`,`AbortError`))};e.signal?.addEventListener(`abort`,s,{once:!0});let c=()=>void 0,l=e=>{i||(i=!0,f(),t(e))},u=e=>{i||(i=!0,f(),n(e))},d=()=>{a||(a=!0,e.client.request(`agent.wait`,{runId:e.runId,timeoutMs:e.timeoutMs}).then(e=>{if(i)return;let t=lf(e);if(t){u(t);return}e?.status!==`timeout`&&(o=window.setTimeout(()=>{l(`OpenClaw finished with no text.`)},sf))}).catch(e=>{u(e instanceof Error?e:Error(String(e)))}))};c=e.client.addEventListener(t=>{if(t.event!==`chat`)return;let n=t.payload;if(!(!n||n.runId!==e.runId))if(df(e.emitTalkEvent,n),n.state===`final`){let e=cf(n.message);if(e){l(e);return}d()}else n.state===`aborted`?u(new DOMException(n.errorMessage??`OpenClaw tool call aborted`,`AbortError`)):n.state===`error`&&u(Error(n.errorMessage??`OpenClaw tool call failed`))});function f(){window.clearTimeout(r),o!==void 0&&window.clearTimeout(o),e.signal?.removeEventListener(`abort`,s),c()}})}function df(e,t){if(!e||t.stream!==`tool`)return;let n=t.data&&typeof t.data==`object`?t.data:{},r=typeof n.phase==`string`?n.phase:void 0,i=typeof n.name==`string`?n.name:void 0;e({type:`tool.progress`,callId:typeof n.toolCallId==`string`?n.toolCallId:void 0,payload:{runId:t.runId,...i?{name:i}:{},...r?{phase:r}:{}}})}async function ff(e){let t=e.text.trim();if(!t)return;let n=e.sessionId&&e.sessionId.trim()?e.ctx.client.request(`talk.session.steer`,{sessionId:e.sessionId,sessionKey:e.ctx.sessionKey,text:t,...e.mode?{mode:e.mode}:{}}):e.ctx.client.request(`talk.client.steer`,{sessionKey:e.ctx.sessionKey,text:t,...e.mode?{mode:e.mode}:{}});try{let t=await n;e.onControlResult?.(t),mf(t,e.speakControlResult,e.suppressSpeechForModes),e.emitTalkEvent?.({type:`tool.progress`,payload:{name:`openclaw_agent_control`,result:t},final:t&&typeof t==`object`&&`mode`in t?t.mode===`status`||t.mode===`cancel`:void 0})}catch(t){e.emitTalkEvent?.({type:`tool.error`,payload:{message:t instanceof Error?t.message:String(t)},final:!0})}}async function pf(e){try{let t=$d(e.args),n=e.sessionId&&e.sessionId.trim()?await e.ctx.client.request(`talk.session.steer`,{sessionId:e.sessionId,sessionKey:e.ctx.sessionKey,text:t.text,mode:t.mode}):await e.ctx.client.request(`talk.client.steer`,{sessionKey:e.ctx.sessionKey,text:t.text,mode:t.mode});e.emitTalkEvent?.({type:`tool.progress`,callId:e.callId,payload:{name:`openclaw_agent_control`,result:n},final:n&&typeof n==`object`&&`mode`in n?n.mode===`status`||n.mode===`cancel`:void 0}),e.submit(e.callId,n)}catch(t){let n=t instanceof Error?t.message:String(t);e.emitTalkEvent?.({type:`tool.error`,callId:e.callId,payload:{message:n},final:!0}),e.submit(e.callId,{error:n})}}function mf(e,t,n){if(!t||!e||typeof e!=`object`)return;let r=e,i=typeof r.mode==`string`?r.mode:void 0;if(i&&n?.includes(i))return;let a=typeof r.message==`string`?r.message.trim():``;(r.speak===!0&&r.suppress!==!0||r.ok===!0&&i===`steer`&&r.suppress===!0)&&a&&t(tf(a))}async function hf(e){let{ctx:t,callId:n,submit:r}=e;t.callbacks.onStatus?.(`thinking`);let i,a=!1,o=!1,s=e=>{o||(o=!0,r(n,e))},c=()=>{e.submitAbortResult!==!1&&s(nf())},l=()=>{a=!0,i&&t.client.request(`chat.abort`,{sessionKey:t.sessionKey,runId:i})};if(e.signal?.aborted){c();return}e.signal?.addEventListener(`abort`,l,{once:!0});try{let r=typeof e.args==`string`?JSON.parse(e.args||`{}`):e.args??{},a=await t.client.request(`talk.client.toolCall`,{sessionKey:t.sessionKey,callId:n,name:Vd,args:r,...e.relaySessionId?{relaySessionId:e.relaySessionId}:{}});if(i=a.runId??a.idempotencyKey,!i)throw Error(`OpenClaw realtime tool call did not return a run id`);if(e.signal?.aborted){l(),c();return}s({result:await uf({client:t.client,runId:i,timeoutMs:12e4,emitTalkEvent:e.emitTalkEvent,signal:e.signal})})}catch(t){if(a||e.signal?.aborted||gf(t)){c();return}s({error:t instanceof Error?t.message:String(t)})}finally{e.signal?.removeEventListener(`abort`,l),!a&&!e.signal?.aborted&&t.callbacks.onStatus?.(`listening`)}}function gf(e){return typeof DOMException<`u`&&e instanceof DOMException&&e.name===`AbortError`}var _f=.02,vf=.08,yf=2,bf=class{constructor(e,t){this.session=e,this.ctx=t,this.media=null,this.inputContext=null,this.outputContext=null,this.inputSource=null,this.inputProcessor=null,this.unsubscribe=null,this.closed=!1,this.outputQueue=new Bd,this.consultAbortControllers=new Map,this.completedToolCalls=new Set,this.cancelRequestedForPlayback=!1,this.speechFramesDuringPlayback=0}async start(){if(!navigator.mediaDevices?.getUserMedia)throw Error(`Realtime Talk requires browser microphone access`);if(this.session.audio.inputEncoding!==`pcm16`||this.session.audio.outputEncoding!==`pcm16`)throw Error(`Gateway-relay realtime Talk currently requires PCM16 audio`);this.closed=!1,this.unsubscribe=this.ctx.client.addEventListener(e=>{e.event===`talk.event`&&this.handleRelayEvent(e.payload)}),this.media=await Pd(this.ctx.inputDeviceId,{autoGainControl:!0,echoCancellation:!0,noiseSuppression:!0}),this.inputContext=new AudioContext({sampleRate:this.session.audio.inputSampleRateHz}),this.outputContext=new AudioContext({sampleRate:this.session.audio.outputSampleRateHz}),this.startMicrophonePump()}stop(){let e=this.closed;this.stopLocal(),e||this.ctx.client.request(`talk.session.close`,{sessionId:this.session.relaySessionId}).catch(()=>void 0)}stopLocal(){this.closed=!0,this.unsubscribe?.(),this.unsubscribe=null,this.inputProcessor?.disconnect(),this.inputProcessor=null,this.inputSource?.disconnect(),this.inputSource=null,this.abortConsults(),this.media?.getTracks().forEach(e=>e.stop()),this.media=null,this.stopOutput(),this.inputContext?.close(),this.inputContext=null,this.outputContext?.close(),this.outputContext=null}startMicrophonePump(){!this.media||!this.inputContext||(this.inputSource=this.inputContext.createMediaStreamSource(this.media),this.inputProcessor=this.inputContext.createScriptProcessor(4096,1,1),this.inputProcessor.onaudioprocess=e=>{if(this.closed)return;let t=e.inputBuffer.getChannelData(0),n=Rd(t);this.detectBargeInSpeech(t)&&this.cancelOutputForBargeIn(),this.ctx.client.request(`talk.session.appendAudio`,{sessionId:this.session.relaySessionId,audioBase64:Id(n),timestamp:Math.round((this.inputContext?.currentTime??0)*1e3)}).catch(e=>{this.closed||(this.ctx.callbacks.onStatus?.(`error`,e instanceof Error?e.message:String(e)),this.stop())})},this.inputSource.connect(this.inputProcessor),this.inputProcessor.connect(this.inputContext.destination))}handleRelayEvent(e){if(!(e.relaySessionId!==this.session.relaySessionId||this.closed))switch(e.talkEvent&&this.ctx.callbacks.onTalkEvent?.(e.talkEvent),e.type){case`ready`:this.ctx.callbacks.onStatus?.(`listening`);return;case`audio`:e.audioBase64&&(this.cancelRequestedForPlayback=!1,this.speechFramesDuringPlayback=0,this.playPcm16(e.audioBase64));return;case`clear`:this.stopOutput();return;case`mark`:this.scheduleMarkAck();return;case`transcript`:e.role&&e.text&&this.ctx.callbacks.onTranscript?.({role:e.role,text:e.text,final:e.final??!1});return;case`toolCall`:this.handleToolCall(e);return;case`toolResult`:this.isFinalToolResult(e)&&this.completeToolCall(e.callId);return;case`error`:this.lastRelayError=e.message??`Realtime relay failed`,this.ctx.callbacks.onStatus?.(`error`,this.lastRelayError);return;case`close`:this.abortConsults(),this.closed||(this.ctx.callbacks.onStatus?.(e.reason===`error`?`error`:`idle`,e.reason===`error`?this.lastRelayError??`Realtime relay closed`:void 0),this.stopLocal());default:}}playPcm16(e){this.outputQueue.play(e,this.outputContext,this.session.audio.outputSampleRateHz)}stopOutput(){this.outputQueue.stop(this.outputContext),this.speechFramesDuringPlayback=0}scheduleMarkAck(){let e=Math.max(0,Math.ceil(((this.outputQueue.queuedUntil||this.outputContext?.currentTime||0)-(this.outputContext?.currentTime??0))*1e3));window.setTimeout(()=>{},e)}async handleToolCall(e){let t=e.callId?.trim(),n=e.name?.trim();if(!t||!n)return;if(n===`openclaw_agent_control`){await pf({ctx:this.ctx,callId:t,args:e.args??{},sessionId:this.session.relaySessionId,submit:(e,t)=>this.submitToolResult(e,t)});return}if(n!==`openclaw_agent_consult`){this.submitToolResult(t,{error:`Tool "${n}" not available in browser Talk`});return}let r=new AbortController;this.consultAbortControllers.set(t,r);try{e.forced&&this.submitToolResult(t,{status:`working`,tool:Vd,message:`Tell the person briefly that you are checking, then wait for the final OpenClaw result before answering with the actual result.`},{willContinue:!0}),await hf({ctx:this.ctx,callId:t,args:e.args??{},relaySessionId:this.session.relaySessionId,signal:r.signal,submit:(e,t)=>this.submitToolResult(e,t)})}finally{this.consultAbortControllers.delete(t)}}submitToolResult(e,t,n){this.completedToolCalls.has(e)||this.ctx.client.request(`talk.session.submitToolResult`,{sessionId:this.session.relaySessionId,callId:e,result:t,...n?{options:n}:{}})}completeToolCall(e){let t=e?.trim();t&&(this.completedToolCalls.add(t),this.consultAbortControllers.get(t)?.abort(),this.consultAbortControllers.delete(t))}isFinalToolResult(e){let t=e.talkEvent;return!(t?.type===`tool.progress`||t?.type===`tool.result`&&t.final===!1)}cancelOutputForBargeIn(){!this.outputQueue.isPlaying||this.cancelRequestedForPlayback||(this.cancelRequestedForPlayback=!0,this.stopOutput(),this.ctx.client.request(`talk.session.cancelOutput`,{sessionId:this.session.relaySessionId,reason:`barge-in`}))}abortConsults(){for(let e of this.consultAbortControllers.values())e.abort();this.consultAbortControllers.clear()}detectBargeInSpeech(e){if(!this.outputQueue.isPlaying||this.cancelRequestedForPlayback||e.length===0)return this.speechFramesDuringPlayback=0,!1;let t=0,n=0;for(let r of e)n=Math.max(n,Math.abs(r)),t+=r*r;return Math.sqrt(t/e.length)>=_f&&n>=vf?this.speechFramesDuringPlayback+=1:this.speechFramesDuringPlayback=0,this.speechFramesDuringPlayback>=yf}},xf=`generativelanguage.googleapis.com`,Sf=/^\/ws\/google\.ai\.generativelanguage\.v[0-9a-z]+\.GenerativeService\.BidiGenerateContent(?:Constrained)?$/;function Cf(e){let t;try{t=new URL(e.websocketUrl)}catch{throw Error(`Invalid Google Live WebSocket URL`)}if(t.protocol!==`wss:`)throw Error(`Google Live WebSocket URL must use wss://`);if(t.hostname.toLowerCase()!==xf)throw Error(`Untrusted Google Live WebSocket host`);if(t.username||t.password)throw Error(`Google Live WebSocket URL must not include credentials`);if(!Sf.test(t.pathname))throw Error(`Untrusted Google Live WebSocket path`);return t.search=``,t.searchParams.set(`access_token`,e.clientSecret),t.toString()}var wf=class{constructor(e,t){this.session=e,this.ctx=t,this.ws=null,this.media=null,this.inputContext=null,this.outputContext=null,this.inputSource=null,this.inputProcessor=null,this.closed=!1,this.pendingCalls=new Map,this.consultAbortControllers=new Set,this.outputQueue=new Bd,this.emitTalkEvent=rf(t,e)}async start(){if(!navigator.mediaDevices?.getUserMedia||typeof WebSocket>`u`)throw Error(`Realtime Talk requires browser WebSocket and microphone access`);if(this.session.protocol!==`google-live-bidi`)throw Error(`Unsupported realtime WebSocket protocol: ${this.session.protocol}`);let e=Cf(this.session);this.closed=!1,this.media=await Pd(this.ctx.inputDeviceId),this.inputContext=new AudioContext({sampleRate:this.session.audio.inputSampleRateHz}),this.outputContext=new AudioContext({sampleRate:this.session.audio.outputSampleRateHz}),this.ws=new WebSocket(e),this.ws.binaryType=`arraybuffer`,this.ws.addEventListener(`open`,()=>{this.closed||(this.send(this.session.initialMessage??{setup:{}}),this.startMicrophonePump())}),this.ws.addEventListener(`message`,e=>{this.handleMessage(e.data)}),this.ws.addEventListener(`close`,()=>{this.closed||this.ctx.callbacks.onStatus?.(`error`,`Realtime connection closed`)}),this.ws.addEventListener(`error`,()=>{this.closed||this.ctx.callbacks.onStatus?.(`error`,`Realtime connection failed`)})}stop(){this.closed||this.emitTalkEvent({type:`session.closed`,final:!0}),this.closed=!0;for(let e of this.consultAbortControllers)e.abort();this.consultAbortControllers.clear(),this.pendingCalls.clear(),this.inputProcessor?.disconnect(),this.inputProcessor=null,this.inputSource?.disconnect(),this.inputSource=null,this.media?.getTracks().forEach(e=>e.stop()),this.media=null,this.stopOutput(),this.inputContext?.close(),this.inputContext=null,this.outputContext?.close(),this.outputContext=null,this.ws?.close(),this.ws=null}startMicrophonePump(){this.closed||!this.media||!this.inputContext||(this.inputSource=this.inputContext.createMediaStreamSource(this.media),this.inputProcessor=this.inputContext.createScriptProcessor(4096,1,1),this.inputProcessor.onaudioprocess=e=>{if(this.ws?.readyState!==WebSocket.OPEN)return;let t=Rd(e.inputBuffer.getChannelData(0));this.send({realtimeInput:{audio:{data:Id(t),mimeType:`audio/pcm;rate=${this.inputContext?.sampleRate??16e3}`}}})},this.inputSource.connect(this.inputProcessor),this.inputProcessor.connect(this.inputContext.destination))}send(e){!this.closed&&this.ws?.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify(e))}async handleMessage(e){if(this.closed)return;let t;try{t=JSON.parse(await Tf(e))}catch{return}if(this.closed)return;t.setupComplete&&(this.ctx.callbacks.onStatus?.(`listening`),this.emitTalkEvent({type:`session.ready`}));let n=t.serverContent;n?.interrupted&&(this.stopOutput(),this.emitTalkEvent({type:`turn.cancelled`,final:!0,payload:{reason:`provider-interrupted`}})),n?.inputTranscription?.text&&(this.ctx.callbacks.onTranscript?.({role:`user`,text:n.inputTranscription.text,final:n.inputTranscription.finished??!1}),this.emitTalkEvent({type:n.inputTranscription.finished?`transcript.done`:`transcript.delta`,final:n.inputTranscription.finished??!1,payload:{role:`user`,text:n.inputTranscription.text}}),n.inputTranscription.finished&&this.consultAbortControllers.size>0&&Qd(n.inputTranscription.text)&&ff({ctx:this.ctx,text:n.inputTranscription.text,emitTalkEvent:this.emitTalkEvent,onControlResult:e=>this.stopOutputForSuppressedControl(e),speakControlResult:e=>this.sendControlSpeechMessage(e),suppressSpeechForModes:[`cancel`]})),n?.outputTranscription?.text&&(this.ctx.callbacks.onTranscript?.({role:`assistant`,text:n.outputTranscription.text,final:n.outputTranscription.finished??!1}),this.emitTalkEvent({type:n.outputTranscription.finished?`output.text.done`:`output.text.delta`,final:n.outputTranscription.finished??!1,payload:{text:n.outputTranscription.text}}));for(let e of n?.modelTurn?.parts??[])e.inlineData?.data?(this.emitTalkEvent({type:`output.audio.delta`,payload:{byteLength:Ld(e.inlineData.data).byteLength,mimeType:e.inlineData.mimeType}}),this.playPcm16(e.inlineData.data)):!e.thought&&typeof e.text==`string`&&e.text.trim()&&(this.ctx.callbacks.onTranscript?.({role:`assistant`,text:e.text,final:n?.turnComplete??!1}),this.emitTalkEvent({type:n?.turnComplete?`output.text.done`:`output.text.delta`,final:n?.turnComplete??!1,payload:{text:e.text}}));n?.turnComplete&&this.emitTalkEvent({type:`turn.ended`,final:!0});for(let e of t.toolCall?.functionCalls??[])this.handleToolCall(e)}playPcm16(e){this.outputQueue.play(e,this.outputContext,this.session.audio.outputSampleRateHz)}stopOutput(){this.outputQueue.stop(this.outputContext)}async handleToolCall(e){let t=e.name?.trim(),n=e.id?.trim();if(!t||!n)return;if(this.pendingCalls.set(n,{name:t,args:e.args??{}}),this.emitTalkEvent({type:`tool.call`,callId:n,payload:{name:t,args:e.args??{}}}),t===`openclaw_agent_control`){await pf({ctx:this.createActiveContext(),callId:n,args:e.args??{},emitTalkEvent:this.emitTalkEvent,submit:(e,t)=>this.submitToolResult(e,t)});return}if(t!==`openclaw_agent_consult`)return;let r=new AbortController;this.consultAbortControllers.add(r);try{await hf({ctx:this.createActiveContext(),callId:n,args:e.args??{},signal:r.signal,emitTalkEvent:this.emitTalkEvent,submit:(e,t)=>this.submitToolResult(e,t)})}finally{this.consultAbortControllers.delete(r)}}createActiveContext(){return{...this.ctx,callbacks:{onStatus:(e,t)=>{this.closed||this.ctx.callbacks.onStatus?.(e,t)},onTranscript:e=>{this.closed||this.ctx.callbacks.onTranscript?.(e)},onTalkEvent:e=>{this.closed||this.ctx.callbacks.onTalkEvent?.(e)}}}}submitToolResult(e,t){let n=this.pendingCalls.get(e);n&&(this.pendingCalls.delete(e),this.send({toolResponse:{functionResponses:[{id:e,name:n.name,scheduling:`WHEN_IDLE`,response:t&&typeof t==`object`&&!Array.isArray(t)?t:{output:t}}]}}))}sendControlSpeechMessage(e){this.stopOutput(),this.send({clientContent:{turns:[{role:`user`,parts:[{text:e}]}],turnComplete:!0}})}stopOutputForSuppressedControl(e){if(!e||typeof e!=`object`)return;let t=e;t.ok===!0&&(t.mode===`cancel`||t.suppress===!0&&t.mode!==`steer`)&&this.stopOutput()}};async function Tf(e){let t=e;return typeof t==`string`?t:(typeof Blob<`u`&&t instanceof Blob&&(t=await t.arrayBuffer()),Ef(t)?new TextDecoder().decode(new Uint8Array(t)):ArrayBuffer.isView(t)?new TextDecoder().decode(new Uint8Array(t.buffer,t.byteOffset,t.byteLength)):String(t))}function Ef(e){return e instanceof ArrayBuffer||Object.prototype.toString.call(e)===`[object ArrayBuffer]`}var Df=Symbol(`cancelledSetup`),Of=class{constructor(e,t){this.session=e,this.ctx=t,this.peer=null,this.channel=null,this.media=null,this.audio=null,this.closed=!1,this.responseActive=!1,this.responseCreateInFlight=!1,this.responseCreatePending=!1,this.toolBuffers=new Map,this.consultAbortControllers=new Set,this.emitTalkEvent=rf(t,e)}async start(){if(!navigator.mediaDevices?.getUserMedia||typeof RTCPeerConnection>`u`)throw Error(`Realtime Talk requires browser WebRTC and microphone access`);this.closed=!1;let e=new RTCPeerConnection;this.peer=e,this.audio=document.createElement(`audio`),this.audio.autoplay=!0,this.audio.style.display=`none`,document.body.append(this.audio),e.addEventListener(`track`,e=>{this.audio&&(this.audio.srcObject=e.streams[0])});let t=await this.awaitSetupStep(e,Pd(this.ctx.inputDeviceId));if(t===Df)return;if(!this.isCurrentPeer(e)){t.getTracks().forEach(e=>e.stop());return}this.media=t;for(let n of t.getAudioTracks())e.addTrack(n,t);let n=e.createDataChannel(`oai-events`);if(!this.isCurrentPeer(e)){n.close();return}this.channel=n,n.addEventListener(`open`,()=>{this.ctx.callbacks.onStatus?.(`listening`),this.emitTalkEvent({type:`session.ready`})}),n.addEventListener(`message`,e=>this.handleRealtimeEvent(e.data)),e.addEventListener(`connectionstatechange`,()=>{this.closed||(this.peer?.connectionState===`failed`||this.peer?.connectionState===`closed`)&&this.ctx.callbacks.onStatus?.(`error`,`Realtime connection closed`)});let r=await this.awaitSetupStep(e,e.createOffer());if(r===Df||!this.isCurrentPeer(e)||await this.awaitSetupStep(e,e.setLocalDescription(r))===Df||!this.isCurrentPeer(e))return;let i=await this.awaitSetupStep(e,fetch(this.session.offerUrl??`https://api.openai.com/v1/realtime/calls`,{method:`POST`,body:r.sdp,headers:{...this.session.offerHeaders,Authorization:`Bearer ${this.session.clientSecret}`,"Content-Type":`application/sdp`}}));if(i===Df||!this.isCurrentPeer(e))return;if(!i.ok)throw Error(`Realtime WebRTC setup failed (${i.status})`);let a=await this.awaitSetupStep(e,i.text());a!==Df&&this.isCurrentPeer(e)&&await this.awaitSetupStep(e,e.setRemoteDescription({type:`answer`,sdp:a}))}isCurrentPeer(e){return!this.closed&&this.peer===e}async awaitSetupStep(e,t){try{return await t}catch(t){if(!this.isCurrentPeer(e))return Df;throw t}}stop(){this.closed||this.emitTalkEvent({type:`session.closed`,final:!0}),this.closed=!0,this.channel?.close(),this.channel=null,this.peer?.close(),this.peer=null,this.media?.getTracks().forEach(e=>e.stop()),this.media=null,this.audio?.remove(),this.audio=null;for(let e of this.consultAbortControllers)e.abort();this.consultAbortControllers.clear(),this.toolBuffers.clear(),this.responseActive=!1,this.responseCreateInFlight=!1,this.responseCreatePending=!1}send(e){this.channel?.readyState===`open`&&this.channel.send(JSON.stringify(e))}handleRealtimeEvent(e){if(this.closed)return;let t;try{t=JSON.parse(String(e))}catch{return}switch(t.type){case`conversation.item.input_audio_transcription.completed`:t.transcript&&(this.ctx.callbacks.onTranscript?.({role:`user`,text:t.transcript,final:!0}),this.emitTalkEvent({type:`transcript.done`,final:!0,itemId:t.item_id,payload:{role:`user`,text:t.transcript}}),this.consultAbortControllers.size>0&&Qd(t.transcript)&&ff({ctx:this.ctx,text:t.transcript,emitTalkEvent:this.emitTalkEvent,onControlResult:e=>this.interruptSuppressedControlResponse(e),speakControlResult:e=>this.sendControlSpeechMessage(e),suppressSpeechForModes:[`cancel`]}));return;case`conversation.output_transcript.delta`:case`response.output_text.delta`:case`response.audio_transcript.delta`:case`response.output_audio_transcript.delta`:this.emitAssistantTranscript(t,!1);return;case`response.output_text.done`:case`response.audio_transcript.done`:case`response.output_audio_transcript.done`:this.emitAssistantTranscript(t,!0);return;case`response.function_call_arguments.delta`:this.bufferToolDelta(t);return;case`response.function_call_arguments.done`:this.handleToolCall(t);return;case`input_audio_buffer.speech_started`:this.ctx.callbacks.onStatus?.(`listening`,`Speech detected`),this.emitTalkEvent({type:`turn.started`,payload:{source:t.type}});return;case`input_audio_buffer.speech_stopped`:this.ctx.callbacks.onStatus?.(`thinking`,`Processing speech`),this.emitTalkEvent({type:`input.audio.committed`,final:!0});return;case`response.created`:this.responseActive=!0,this.responseCreateInFlight=!1,this.ctx.callbacks.onStatus?.(`thinking`,`Generating response`);return;case`response.cancelled`:case`response.done`:this.responseActive=!1,this.responseCreateInFlight=!1,this.ctx.callbacks.onStatus?.(`listening`,this.extractResponseStatus(t)),this.emitTalkEvent({type:`turn.ended`,final:!0,payload:{status:t.response?.status??(t.type===`response.cancelled`?`cancelled`:`completed`)}}),this.flushPendingResponseCreate();return;case`error`:this.responseCreateInFlight=!1,this.ctx.callbacks.onStatus?.(`error`,this.extractErrorDetail(t.error)),this.emitTalkEvent({type:`session.error`,final:!0,payload:{message:this.extractErrorDetail(t.error)}});default:}}extractResponseStatus(e){let t=e.response?.status;return t&&t!==`completed`?`Response ${t}`:void 0}emitAssistantTranscript(e,t){let n=t?e.transcript??e.text:e.delta;n&&(this.ctx.callbacks.onTranscript?.({role:`assistant`,text:n,final:t}),this.emitTalkEvent({type:t?`output.text.done`:`output.text.delta`,final:t,itemId:e.item_id,payload:{text:n}}))}extractErrorDetail(e){if(!e||typeof e!=`object`)return`Realtime provider error`;let t=e,n=typeof t.message==`string`?t.message.trim():``,r=typeof t.code==`string`?t.code.trim():``,i=typeof t.type==`string`?t.type.trim():``;return n||r||i||`Realtime provider error`}bufferToolDelta(e){let t=e.item_id??`unknown`,n=this.toolBuffers.get(t);if(n){n.args+=e.delta??``;return}this.toolBuffers.set(t,{name:e.name??``,callId:e.call_id??``,args:e.delta??``})}async handleToolCall(e){let t=e.item_id??`unknown`,n=this.toolBuffers.get(t);this.toolBuffers.delete(t);let r=n?.name||e.name||``,i=n?.callId||e.call_id||``;if(!i)return;if(r===`openclaw_agent_control`){await pf({ctx:this.ctx,callId:i,args:n?.args||e.arguments||`{}`,emitTalkEvent:this.emitTalkEvent,submit:(e,t)=>this.submitToolResult(e,t)});return}if(r!==`openclaw_agent_consult`)return;this.emitTalkEvent({type:`tool.call`,callId:i,itemId:t,payload:{name:r,args:n?.args||e.arguments||`{}`}});let a=new AbortController;this.consultAbortControllers.add(a);try{await hf({ctx:this.ctx,callId:i,args:n?.args||e.arguments||`{}`,signal:a.signal,emitTalkEvent:this.emitTalkEvent,submit:(e,t)=>this.submitToolResult(e,t)})}finally{this.consultAbortControllers.delete(a)}}submitToolResult(e,t){this.send({type:`conversation.item.create`,item:{type:`function_call_output`,call_id:e,output:JSON.stringify(t)}}),this.requestResponseCreate()}sendControlSpeechMessage(e){this.responseActive&&this.send({type:`response.cancel`}),this.send({type:`conversation.item.create`,item:{type:`message`,role:`user`,content:[{type:`input_text`,text:e}]}}),this.requestResponseCreate()}interruptSuppressedControlResponse(e){if(!this.responseActive||!e||typeof e!=`object`)return;let t=e;t.ok===!0&&(t.mode===`cancel`||t.suppress===!0&&t.mode!==`steer`)&&this.send({type:`response.cancel`})}requestResponseCreate(){if(this.responseActive||this.responseCreateInFlight){this.responseCreatePending=!0;return}this.responseCreatePending=!1,this.responseCreateInFlight=!0,this.send({type:`response.create`})}flushPendingResponseCreate(){this.responseCreatePending&&(this.responseCreatePending=!1,this.requestResponseCreate())}};function kf(e){if(typeof e!=`string`)return;let t=Fd(e);if(t===`webrtc`||t===`provider-websocket`||t===`gateway-relay`||t===`managed-room`)return t}function Af(e,t){let n=jf(e);if(n===`webrtc`)return new Of(e,t);if(n===`provider-websocket`)return new wf(e,t);if(n===`gateway-relay`)return new bf(e,t);if(n===`managed-room`)throw Error(`Managed-room realtime Talk sessions are not available in this UI yet`);let r=e.transport??`unknown`;throw Error(`Unsupported realtime Talk transport: ${r}`)}function jf(e){return Fd(e.transport)??`webrtc`}function Mf(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var Nf=class{constructor(e,t,n={},r={},i={}){this.client=e,this.sessionKey=t,this.callbacks=n,this.options=r,this.localOptions=i,this.transport=null,this.closed=!1}async start(){this.closed=!1,this.callbacks.onStatus?.(`connecting`);let e=await this.createSession();this.closed||(this.transport=Af(e,{client:this.client,sessionKey:this.sessionKey,callbacks:this.callbacks,inputDeviceId:this.localOptions.inputDeviceId,consultThinkingLevel:e.consultThinkingLevel,consultFastMode:e.consultFastMode}),await this.transport.start())}async createSession(){try{return await this.client.request(`talk.client.create`,Mf({sessionKey:this.sessionKey,...this.options}))}catch(e){let t=this.options.transport;if(!t){let n;try{n=await this.client.request(`talk.config`,{})}catch{throw e}if(!n.config||typeof n.config!=`object`)throw e;let r=n.config?.talk?.realtime?.transport;if(r!==void 0&&(t=kf(r),!t))throw e}if(t&&t!==`gateway-relay`)throw e;try{return await this.client.request(`talk.session.create`,Mf({sessionKey:this.sessionKey,...this.options,mode:`realtime`,transport:t??`gateway-relay`,brain:`agent-consult`}))}catch{throw e}}}stop(){this.closed=!0,this.callbacks.onStatus?.(`idle`),this.transport?.stop(),this.transport=null}},Pf=new Map;function Ff(e){return e.settings.gatewayUrl.trim()}function If(e){let t=Ff(e);if(Pf.has(t))return Pf.get(t)??``;let n=e.realtimeTalkInputDeviceId.trim();return Pf.set(t,n),n}function Lf(){return{model:``,voice:``,vadThreshold:``}}function Rf(e=``){return{realtimeTalkActive:!1,realtimeTalkStatus:`idle`,realtimeTalkDetail:null,realtimeTalkConversation:[],realtimeTalkOptions:Lf(),realtimeTalkInputDevices:[],realtimeTalkInputDeviceId:e,realtimeTalkInputLoading:!1,realtimeTalkInputError:null,realtimeTalkInputRefreshId:0,realtimeTalkSession:null,realtimeTalkConversationState:gd()}}function zf(e){e.realtimeTalkConversationState=gd(),e.realtimeTalkConversation=[]}function Bf(e){e.realtimeTalkStatus===`error`&&(e.realtimeTalkSession?.stop(),e.realtimeTalkSession=null,e.realtimeTalkActive=!1,e.realtimeTalkStatus=`idle`,e.realtimeTalkDetail=null,e.resetRealtimeTalkConversation())}async function Vf(e,t){let n=++e.realtimeTalkInputRefreshId;e.realtimeTalkInputLoading=!0,e.realtimeTalkInputError=null,e.requestUpdate();try{let r=await Md(t);if(n!==e.realtimeTalkInputRefreshId)return;e.realtimeTalkInputDevices=r.devices,e.realtimeTalkInputDeviceId=If(e),e.realtimeTalkInputError=t&&r.warning===null&&e.realtimeTalkInputDeviceId.length>0&&r.devices.length>0&&!r.devices.some(t=>t.deviceId===e.realtimeTalkInputDeviceId)?A(`chat.composer.selectedMicrophoneUnavailable`):r.warning}catch(t){if(n!==e.realtimeTalkInputRefreshId)return;e.realtimeTalkInputDevices=[],e.realtimeTalkInputError=t instanceof Error?t.message:String(t)}finally{n===e.realtimeTalkInputRefreshId&&(e.realtimeTalkInputLoading=!1,e.requestUpdate())}}function Hf(e){e.resetRealtimeTalkConversation=()=>{zf(e)},e.updateRealtimeTalkOptions=t=>{e.realtimeTalkOptions={...e.realtimeTalkOptions,...t},e.requestUpdate()},e.refreshRealtimeTalkInputs=(t=!1)=>Vf(e,t),e.selectRealtimeTalkInput=t=>{let n=t.trim();Pf.set(Ff(e),n),e.realtimeTalkInputDeviceId=n,e.settings={...e.settings,realtimeTalkInputDeviceId:n||void 0},ot(e.settings),e.realtimeTalkInputError=null,e.requestUpdate()},e.toggleRealtimeTalk=async()=>{if(e.realtimeTalkSession){e.realtimeTalkSession.stop(),e.realtimeTalkSession=null,e.realtimeTalkActive=!1,e.realtimeTalkStatus=`idle`,e.realtimeTalkDetail=null,e.resetRealtimeTalkConversation(),e.requestUpdate();return}if(!e.client||!e.connected){e.lastError=`Gateway not connected`,e.chatError=e.lastError,e.requestUpdate();return}let t=If(e)||void 0,n=e.realtimeTalkOptions,r={model:n.model.trim()||void 0,voice:n.voice.trim()||void 0,vadThreshold:Number(n.vadThreshold)||void 0};e.realtimeTalkInputDeviceId=t??``,e.realtimeTalkActive=!0,e.realtimeTalkStatus=`connecting`,e.realtimeTalkDetail=null,e.resetRealtimeTalkConversation();let i=new Nf(e.client,e.sessionKey,{onStatus:(t,n)=>{e.realtimeTalkStatus=t,e.realtimeTalkDetail=n??null,e.realtimeTalkActive=t!==`idle`,e.requestUpdate()},onTranscript:t=>{e.realtimeTalkConversationState=_d(e.realtimeTalkConversationState,t),e.realtimeTalkConversation=e.realtimeTalkConversationState.entries,e.requestUpdate()}},r,{inputDeviceId:t});e.realtimeTalkSession=i;try{await i.start()}catch(t){i.stop(),e.realtimeTalkSession=null,e.realtimeTalkActive=!1,e.realtimeTalkStatus=`error`,e.realtimeTalkDetail=t instanceof Error?t.message:String(t),e.requestUpdate()}}}function J(e){if(e==null)return;let t;return t=typeof e==`string`?D(e)??``:typeof e==`number`||typeof e==`boolean`||typeof e==`bigint`?D(String(e))??``:typeof e==`symbol`||typeof e==`function`?D(e.toString())??``:JSON.stringify(e),t||void 0}function Uf(e,t){let n=E(J(e.action)),r=J(e.path),i=J(e.value);return n?t.formatKnownAction(n,r)||Jf(n,{path:r,value:i}):void 0}var Wf=e=>Uf(e,{formatKnownAction:(e,t)=>{if(e===`show`||e===`get`)return t?`${e} ${t}`:e}}),Gf=e=>Uf(e,{formatKnownAction:(e,t)=>{if(e===`show`||e===`get`)return t?`${e} ${t}`:e}}),Kf=e=>Uf(e,{formatKnownAction:(e,t)=>{if(e===`list`)return`list`;if(e===`show`||e===`get`||e===`enable`||e===`disable`)return t?`${e} ${t}`:e}}),qf=e=>Uf(e,{formatKnownAction:e=>{if(e===`show`||e===`reset`)return e}});function Jf(e,t){return e===`unset`?t.path?`${e} ${t.path}`:e:e===`set`&&t.path?t.value?`${e} ${t.path}=${t.value}`:`${e} ${t.path}`:e}var Yf={config:Wf,mcp:Gf,plugins:Kf,debug:qf,queue:e=>{let t=J(e.mode),n=J(e.debounce),r=J(e.cap),i=J(e.drop),a=[];return t&&a.push(t),n&&a.push(`debounce:${n}`),r&&a.push(`cap:${r}`),i&&a.push(`drop:${i}`),a.length>0?a.join(` `):void 0},exec:e=>{let t=J(e.host),n=J(e.security),r=J(e.ask),i=J(e.node),a=[];return t&&a.push(`host=${t}`),n&&a.push(`security=${n}`),r&&a.push(`ask=${r}`),i&&a.push(`node=${i}`),a.length>0?a.join(` `):void 0}};[`off`,`minimal`,`low`,`medium`,`high`,`xhigh`,`adaptive`,`max`,`ultra`].join(`|`);var Xf=[`off`,`minimal`,`low`,`medium`,`high`,`xhigh`,`adaptive`,`max`];function Zf(e){let t=e.trim(),n=t.toLowerCase();return n===`list`||n===`status`||/\s/u.test(t)}function Y(e){let t=(e.textAliases??(e.textAlias?[e.textAlias]:[])).map(e=>e.trim()).filter(Boolean),n=e.scope??(e.nativeName?t.length?`both`:`native`:`text`),r=e.acceptsArgs??!!e.args?.length,i=e.argsParsing??(e.args?.length?`positional`:`none`);return{key:e.key,nativeName:e.nativeName,nativeAliases:e.nativeAliases?ne(e.nativeAliases):void 0,nativeProviders:e.nativeProviders?ne(e.nativeProviders):void 0,description:e.description,acceptsArgs:r,args:e.args,argsParsing:i,formatArgs:e.formatArgs,argsMenu:e.argsMenu,textAliases:t,scope:n,category:e.category,tier:e.tier}}function Qf(e,t,...n){let r=e.find(e=>e.key===t);if(!r)throw Error(`registerAlias: unknown command key: ${t}`);let i=new Set;for(let e of r.textAliases){let t=E(e);t&&i.add(t)}for(let e of n){let t=e.trim();if(!t)continue;let n=E(t);n&&(i.has(n)||(i.add(n),r.textAliases.push(t)))}}function $f(e){let t=new Set,n=new Set,r=new Set;for(let i of e){if(t.has(i.key))throw Error(`Duplicate command key: ${i.key}`);t.add(i.key);let e=i.nativeName?.trim();if(i.scope===`text`){if(e)throw Error(`Text-only command has native name: ${i.key}`);if(i.nativeAliases?.length)throw Error(`Text-only command has native aliases: ${i.key}`);if(i.textAliases.length===0)throw Error(`Text-only command missing text alias: ${i.key}`)}else if(e)for(let t of[e,...i.nativeAliases??[]]){let e=E(t)??``;if(n.has(e))throw Error(`Duplicate native command: ${t}`);n.add(e)}else throw Error(`Native command missing native name: ${i.key}`);if(i.scope===`native`&&i.textAliases.length>0)throw Error(`Native-only command has text aliases: ${i.key}`);for(let e of i.textAliases){if(!e.startsWith(`/`))throw Error(`Command alias missing leading '/': ${e}`);let t=E(e)??``;if(r.has(t))throw Error(`Duplicate command alias: ${e}`);r.add(t)}}}function ep(e={}){let t=e.listThinkingLevels??(()=>Xf),n=(e,n,r,i)=>[`default`,...t(e,n,r,i).filter(e=>e!=="default")],r=[Y({key:`help`,nativeName:`help`,description:`Show available commands.`,textAlias:`/help`,category:`status`,tier:`essential`}),Y({key:`commands`,nativeName:`commands`,description:`List all slash commands.`,textAlias:`/commands`,category:`status`,tier:`power`}),Y({key:`tools`,nativeName:`tools`,description:`List available runtime tools.`,textAlias:`/tools`,category:`status`,args:[{name:`mode`,description:`compact or verbose`,type:`string`,choices:[`compact`,`verbose`]}],argsMenu:`auto`,tier:`standard`}),Y({key:`skill`,nativeName:`skill`,description:`Run a skill by name.`,textAlias:`/skill`,category:`tools`,tier:`standard`,args:[{name:`name`,description:`Skill name`,type:`string`,required:!0},{name:`input`,description:`Skill input`,type:`string`,captureRemaining:!0}]}),Y({key:`learn`,nativeName:`learn`,description:`Draft a reusable skill from recent work or named sources.`,textAlias:`/learn`,category:`tools`,tier:`standard`,acceptsArgs:!0,args:[{name:`request`,description:`Sources and requirements for the skill draft`,type:`string`,captureRemaining:!0}]}),Y({key:`status`,nativeName:`status`,description:`Show current status.`,textAlias:`/status`,category:`status`,tier:`essential`,acceptsArgs:!0}),Y({key:`goal`,nativeName:`goal`,description:`Show or control the current goal.`,textAlias:`/goal`,category:`status`,tier:`standard`,acceptsArgs:!0,args:[{name:`action`,description:`status, start, edit, pause, resume, complete, block, clear`,type:`string`,choices:[`status`,`start`,`edit`,`pause`,`resume`,`complete`,`block`,`clear`]},{name:`text`,description:`Goal objective or note`,type:`string`,captureRemaining:!0}]}),Y({key:`diagnostics`,nativeName:`diagnostics`,description:`Explain Gateway diagnostics and Codex feedback upload options.`,textAlias:`/diagnostics`,acceptsArgs:!0,category:`status`,tier:`standard`,args:[{name:`note`,description:`Optional note for Codex feedback upload`,type:`string`,captureRemaining:!0}]}),Y({key:`login`,nativeName:`login`,nativeProviders:[`telegram`],description:`Pair Codex login.`,textAlias:`/login`,category:`management`,tier:`standard`,args:[{name:`provider`,description:`Provider to pair`,type:`string`,choices:[`codex`,`openai`]}]}),Y({key:`crestodian`,description:`Run the Crestodian setup and repair helper.`,textAlias:`/crestodian`,acceptsArgs:!0,scope:`text`,category:`management`,tier:`essential`}),Y({key:`tasks`,nativeName:`tasks`,description:`List background tasks for this session.`,textAlias:`/tasks`,category:`status`,tier:`standard`}),Y({key:`allowlist`,description:`List/add/remove allowlist entries.`,textAlias:`/allowlist`,acceptsArgs:!0,scope:`text`,category:`management`,tier:`power`}),Y({key:`approve`,nativeName:`approve`,description:`Approve or deny exec requests.`,textAlias:`/approve`,acceptsArgs:!0,category:`management`,tier:`power`}),Y({key:`context`,nativeName:`context`,description:`Explain how context is built and used.`,textAlias:`/context`,acceptsArgs:!0,category:`status`,tier:`standard`}),Y({key:`btw`,nativeName:`btw`,nativeAliases:[`side`],description:`Ask a side question without changing future session context.`,textAliases:[`/btw`,`/side`],acceptsArgs:!0,category:`tools`,tier:`standard`}),Y({key:`export-session`,nativeName:`export-session`,description:`Export current session to HTML file with full system prompt.`,textAliases:[`/export-session`,`/export`],acceptsArgs:!0,category:`status`,tier:`essential`,args:[{name:`path`,description:`Output path (default: workspace)`,type:`string`,required:!1}]}),Y({key:`export-trajectory`,nativeName:`export-trajectory`,description:`Export a JSONL trajectory bundle for the active session.`,textAliases:[`/export-trajectory`,`/trajectory`],acceptsArgs:!0,category:`status`,tier:`essential`,args:[{name:`path`,description:`Output directory (default: workspace)`,type:`string`,required:!1}]}),Y({key:`tts`,nativeName:`tts`,description:`Control text-to-speech (TTS).`,textAlias:`/tts`,category:`media`,tier:`standard`,args:[{name:`action`,description:`TTS action`,type:`string`,choices:[{value:`on`,label:`On`},{value:`off`,label:`Off`},{value:`status`,label:`Status`},{value:`provider`,label:`Provider`},{value:`limit`,label:`Limit`},{value:`summary`,label:`Summary`},{value:`audio`,label:`Audio`},{value:`help`,label:`Help`}]},{name:`value`,description:`Provider, limit, or text`,type:`string`,captureRemaining:!0}],argsMenu:{arg:`action`,title:`TTS Actions:
...
`)}\n\n${e}`:`> **${n}:** ${r}\n\n${e}`}function mg(e){return e.replace(/([\\`*_{}[\]()#+\-.!|>])/g,`\\$1`)}var hg=lg,gg=`openclaw.control.assistant.v1`;function _g(e){let t=JSON.parse(e),n=Object.create(null);if(t.avatars&&typeof t.avatars==`object`&&!Array.isArray(t.avatars))for(let[e,r]of Object.entries(t.avatars)){let t=D(e),i=D(r);t&&i&&(n[t]=i)}let r=D(t.avatar),i=D(t.agentId);return r&&i&&!Object.hasOwn(n,i)&&(n[i]=r),{avatars:n,legacyAvatar:i?null:r??null}}function vg(e,t){if(Object.keys(t).length===0){e?.removeItem(gg);return}e?.setItem(gg,JSON.stringify({avatars:t}))}function yg(e){let t=D(e?.agentId);if(!t)return{avatar:null};let n=k();try{let e=n?.getItem(gg);if(!e)return{avatar:null};let{avatars:r,legacyAvatar:i}=_g(e);return!Object.hasOwn(r,t)&&i&&(r[t]=i,vg(n,r)),{avatar:Object.hasOwn(r,t)?r[t]:null,agentId:t}}catch{return{avatar:null}}}async function bg(e,t){let n=await e.request(`agent.identity.get`,t?.trim()?{sessionKey:t.trim()}:{});if(!n)return null;let r=Ct(n),i=yg({agentId:r.agentId}).avatar;return i?{...r,avatar:i,avatarSource:i,avatarStatus:`data`,avatarReason:null}:r}function xg(e){if(!e||typeof e!=`object`)return null;let t=e;if(t.kind!==`btw`)return null;let n=D(t.runId),r=D(t.sessionKey),i=D(t.question),a=D(t.text);if(!(n&&r&&i&&a))return null;let o=D(t.agentId);return{kind:`btw`,runId:n,sessionKey:r,...o?{agentId:o}:{},question:i,text:a,isError:t.isError===!0,ts:typeof t.ts==`number`&&Number.isFinite(t.ts)?t.ts:Date.now()}}function Sg(e,t){e.lastError=t,e.chatError=t}function Cg(e,t){return nu(e,t.sessionKey,t.agentId)}function wg(e){return e===`final`||e===`aborted`||e===`error`}function Tg(e,t){return!!(t&&e&&e.runId!==t)}function Eg(e,t){let n=t.message==null?null:W(t.message);if(typeof t.deltaText==`string`){if(t.replace===!0)return t.deltaText;if(e===null)return typeof n==`string`?n:t.deltaText;if(typeof n==`string`){let r=n.length-t.deltaText.length;if(r!==e.length||n.slice(0,r)!==e)return n}return`${e}${t.deltaText}`}return typeof n==`string`?n:null}function Dg(e,t){if(!e||typeof e!=`object`)return null;let n=e,r=n.role;if(typeof r==`string`){if((t.roleCaseSensitive?r:O(r))!==`assistant`)return null}else if(t.roleRequirement===`required`)return null;return t.requireContentArray?Array.isArray(n.content)?n:null:!(`content`in n)&&!(t.allowTextField&&`text`in n)?null:n}function Og(e){return Dg(e,{roleRequirement:`required`,roleCaseSensitive:!0,requireContentArray:!0})}function kg(e){return Dg(e,{roleRequirement:`optional`,allowTextField:!0})}function Ag(e){let t=kg(e.message);if(t&&!Bl(t))return t;let n=e.errorMessage?.trim();return n?{role:`assistant`,content:[{type:`text`,text:n.startsWith(`⚠️`)||n.startsWith(`Error:`)?n:`Error: ${n}`}],timestamp:Date.now()}:null}function jg(e,t,n,r){e.chatMessagesBySession&&zc(e.chatMessagesBySession,e,{sessionKey:t,agentId:r},n)}function Mg(e,t){if(!t)return null;let n=e.chatRunId!==null,r=Cg(e,t),i=e.chatRunId!==null&&typeof t.runId==`string`&&t.runId===e.chatRunId;if(!r&&!i){if(t.state===`final`){let n=kg(t.message);if(n&&!Bl(n)){let r=P(t.sessionKey)?t.agentId??fe(e):t.agentId;jg(e,t.sessionKey,n,r)}}return null}if(!e.chatRunId&&r&&typeof t.runId==`string`&&(e.chatRunId=t.runId,e.chatStreamStartedAt??=Date.now()),e.chatRunId&&t.runId!==e.chatRunId){if(t.state===`final`){let n=kg(t.message);return n&&!Bl(n)?(e.chatMessages=[...e.chatMessages,n],null):`final`}return null}let a=t.runId??e.chatRunId,o=(o,s)=>_c(e,{outcome:o,sessionStatus:s,runId:a,sessionKey:e.sessionKey,sessionKeys:r?[e.sessionKey,t.sessionKey]:[],clearLocalRun:!0,clearChatStream:!0,armLocalTerminalReconcile:n&&i});if(t.state===`delta`){let n=Eg(e.chatStream,t);typeof n==`string`&&!Nl(n)&&!Li(t.message)&&(e.chatStream=n)}else if(t.state===`final`){let n=kg(t.message);n&&!Bl(n)?(ml(e,{includeCurrent:!1,isHiddenStreamText:zl})&&(e.chatMessages=Hl(e.chatMessages,e,{includeCurrent:!1}),$c(e)),e.chatMessages=il(e.chatMessages,n)):e.chatMessages=Hl(e.chatMessages,e),o(`done`,`done`)}else if(t.state===`aborted`){let n=Og(t.message);n&&!Bl(n)?(e.chatMessages=Hl(e.chatMessages,e,{replacementMessages:[n],includeCurrent:!1}),e.chatMessages=il(e.chatMessages,n)):e.chatMessages=Hl(e.chatMessages,e),o(`interrupted`,`killed`)}else if(t.state===`error`){let r=n?kg(t.message):null,i=r&&!Bl(r)?r:null;if(i)e.chatMessages=Hl(e.chatMessages,e,{replacementMessages:[i]}),e.chatMessages=il(e.chatMessages,i);else{let r=n?Ag(t):null;n&&(e.chatMessages=Hl(e.chatMessages,e)),r&&(e.chatMessages=il(e.chatMessages,r))}o(`interrupted`,`failed`),Sg(e,t.errorMessage??`chat error`)}return t.state}function Ng(e,t){if(wg(t?.state)&&typeof t?.runId==`string`&&e.chatSideResultTerminalRuns?.has(t.runId)===!0)return e.chatSideResultTerminalRuns.delete(t.runId),null;let n=e.chatRunId,r=Mg(e,t);return wg(r)&&!Tg(t,n)&&pd(e,t?.runId),r}function Pg(e,t){let n=xg(t);return!n||!nu(e,n.sessionKey,n.agentId)?!1:(e.chatSideResult=n,e.chatSideResultTerminalRuns?.add(n.runId),!0)}function Fg(e){let t=D(e.sessionKey)?.toLowerCase(),n=t===`global`?null:ce(e.sessionKey),r=Me(e,e.sessionKey).agentId,i=L(e.assistantAgentId??e.agentsList?.defaultId??e.agentsList?.agents?.[0]?.id??`main`);return t===`global`?r??i:n??r??i}function Ig(e){e?.browserSearchTimer&&(globalThis.clearTimeout(e.browserSearchTimer),e.browserSearchTimer=null)}function Lg(e){Ig(e.sessionWorkspaceState)}function Rg(e){let t=e.sessionKey,n=Fg(e),r=e.sessionWorkspaceState;if(r?.sessionKey===t&&r.agentId===n)return r;Ig(r);let i={activeId:null,agentId:n,browserPath:``,browserSearch:``,browserSearchTimer:null,collapsed:!0,error:null,list:null,loading:!1,pendingReload:!1,requestId:0,sessionKey:t};return e.sessionWorkspaceState=i,i}function zg(e){return Rg(e)}function Bg(e){e.requestUpdate?.()}function Vg(e){let t=e.match(/\.([a-z0-9_-]+)$/i)?.[1]?.toLowerCase()??``;return t===`yml`?`yaml`:t}function Hg(e,t){return/\.(?:md|markdown|mdx)$/i.test(e)?t:`# ${e}\n\n\`\`\`${Vg(e)}\n${t}\n\`\`\``}function Ug(e){return e.split(/[\\/]/).findLast(e=>e)??e}function Wg(e,t){if(!e)return t;let n=e.includes(`\\`)&&!e.includes(`/`)?`\\`:`/`,r=e.replace(/[\\/]+$/,``),i=t.replace(/^[\\/]+/,``).replaceAll(/[\\/]/g,n);return r?`${r}${n}${i}`:`${n}${i}`}function Gg(e){let{data:t,encoding:n,mimeType:r,title:i,url:a}=e;if(n===`base64`&&t&&r.startsWith(`image/`))return{kind:`image`,title:i,src:`data:${r};base64,${t}`,mimeType:r,rawText:a??null};if(n===`base64`&&t&&r===`application/json`){let e=globalThis.atob(t);return{kind:`markdown`,content:`# ${i}\n\n\`\`\`json\n${e}\n\`\`\``,rawText:e}}if(n===`base64`&&t&&r.startsWith(`text/`)){let e=globalThis.atob(t);return{kind:`markdown`,content:`# ${i}\n\n\`\`\`\n${e}\n\`\`\``,rawText:e}}if(a){let e=`# ${i}\n\n[Open artifact](${a})`;return{kind:`markdown`,content:e,rawText:e}}let o=`# ${i}\n\nArtifact download is not previewable in the sidebar.`;return{kind:`markdown`,content:o,rawText:o}}function Kg(e,t,n=!1){if(!e.client||!e.connected)return;if(t.loading){n&&(t.pendingReload=!0);return}let r=t.requestId+1;t.requestId=r,t.loading=!0,t.error=null,n&&(t.list=null),t.pendingReload=!1;let i=e.sessionKey,a=t.agentId;(async()=>{try{let n=await e.sessions.listFiles(i,{path:t.browserSearch?``:t.browserPath,search:t.browserSearch,agentId:a}),o=await e.client?.request(`artifacts.list`,{sessionKey:i,...a?{agentId:a}:{}}),s=zg(e);if(s!==t||s.requestId!==r)return;let c=n?.files??[],l=o?.artifacts??[],u=n?.browser?.entries??[];s.list={sessionKey:i,...n?.root?{root:n.root}:{},files:c,...n?.browser?{browser:n.browser}:{},artifacts:l},s.activeId&&!c.some(e=>`file:${e.path}`===s.activeId)&&!u.some(e=>`file:${e.path}`===s.activeId)&&!l.some(e=>`artifact:${e.id}`===s.activeId)&&(s.activeId=null)}catch(n){let i=zg(e);i===t&&i.requestId===r&&(i.error=String(n))}finally{let n=zg(e);if(n===t&&n.requestId===r){n.loading=!1;let t=n.pendingReload;n.pendingReload=!1,t&&Kg(e,n,!0)}Bg(e)}})()}function qg(e,t,n){t.activeId=n;let r=e.sessionWorkspaceOpenRequest,i={agentId:t.agentId,id:(r?.id??0)+1,itemId:n,sessionKey:e.sessionKey};return e.sessionWorkspaceOpenRequest=i,i}function Jg(e,t){let n=e.sessionWorkspaceOpenRequest,r=zg(e);return n?.id===t.id&&n.agentId===Fg(e)&&n.itemId===t.itemId&&n.sessionKey===e.sessionKey&&r?.agentId===t.agentId&&r.activeId===t.itemId}function Yg(e,t,n,r,i,a){let o=qg(e,t,n);(async()=>{if(!(!e.client||!e.connected)){t.error=null;try{let n=await r(o),s=n==null?null:i(n);if(!s){Jg(e,o)&&(t.error=a,Bg(e));return}Jg(e,o)&&e.handleOpenSidebar(s)}catch(n){Jg(e,o)&&(t.error=String(n))}finally{Bg(e)}}})()}function Xg(e,t,n,r={}){Yg(e,t,`file:${n}`,t=>e.sessions.getFile(t.sessionKey,r.requestPath??n,{agentId:t.agentId}),e=>{let t=e.file;if(!t||typeof t.content!=`string`)return null;let i=t.name||Ug(n);return/\.(?:md|markdown|mdx)$/i.test(i)&&r.line==null?{kind:`markdown`,content:Hg(i,t.content),rawText:t.content}:{kind:`file`,path:t.workspacePath||t.path||n,name:i,content:t.content,root:e.root??null,language:Vg(i),line:r.line??null,rawText:t.content}},`Failed to load ${n}`)}function Zg(e,t){Xg(e,Rg(e),t.path,{line:t.line})}function Qg(e,t){let n=Rg(e);Ig(n);let r=t.replaceAll(`\\`,`/`),i=r.lastIndexOf(`/`);n.collapsed=!1,n.browserPath=i>0?r.slice(0,i):``,n.browserSearch=``,n.activeId=`file:${t}`,Kg(e,n,!0),Bg(e)}function $g(e,t,n){Yg(e,t,`artifact:${n}`,t=>e.client.request(`artifacts.download`,{sessionKey:t.sessionKey,artifactId:n,...t.agentId?{agentId:t.agentId}:{}}),e=>e.artifact?Gg({data:e.data,encoding:e.encoding,mimeType:e.artifact.mimeType??``,title:e.artifact.title,url:e.url}):null,`Failed to load artifact ${n}`)}function e_(e){let t=Rg(e);return!t.collapsed&&e.connected&&e.agentsList&&!t.loading&&!t.error&&t.list?.sessionKey!==e.sessionKey&&Kg(e,t),{collapsed:t.collapsed,sessionKey:e.sessionKey,list:t.list?.sessionKey===e.sessionKey?t.list:null,loading:t.loading,error:t.error,activeId:t.activeId,onToggleCollapsed:()=>{t.collapsed=!t.collapsed,!t.collapsed&&t.list?.sessionKey!==e.sessionKey&&Kg(e,t),Bg(e)},onRefresh:()=>Kg(e,t,!0),onBrowsePath:n=>{Ig(t),t.browserPath=n,t.browserSearch=``,Kg(e,t,!0)},onCopyPath:e=>{Re(e)},onOpenFile:(n,r)=>{let i=r===`workspace`?{requestPath:Wg(t.list?.root,n)}:{};Xg(e,t,n,i)},onSearch:n=>{t.browserSearch=n,Ig(t),t.browserSearchTimer=globalThis.setTimeout(()=>{t.browserSearchTimer=null,Kg(e,t,!0)},160)},onOpenArtifact:n=>$g(e,t,n),onToggleTerminal:e.terminalAvailable?()=>{window.dispatchEvent(new CustomEvent(`openclaw:terminal-toggle`,{detail:{dock:`right`,open:!0}}))}:void 0}}function t_(e){let t=e.size;return typeof t!=`number`||!Number.isFinite(t)||t<0?``:t>=1024*1024?`${(t/(1024*1024)).toFixed(1).replace(/\.0$/,``)} MB`:t>=1024?`${(t/1024).toFixed(1).replace(/\.0$/,``)} KB`:`${t} B`}function n_(e){return t_({size:e.sizeBytes})}function r_(e,t){return t===c?c:s`
          ...
          <div class="chat-workspace-rail__list" role="list">
            ${t.map(t=>{let n=t_(t);return s`
                ...
                >
                  ...
                  >
                    <span class="chat-workspace-rail__file-icon">${R.fileText}</span>
      ...
      <section class="chat-workspace-rail__browser">
        <div class="chat-workspace-rail__browser-tools">
          <label class="chat-workspace-rail__search">
            <span class="chat-workspace-rail__search-icon" aria-hidden="true">${R.search}</span>
            <input
              type="search"
        ...
        <div class="chat-workspace-rail__list chat-workspace-rail__list--browser" role="list">
          ${!o?.search&&n!=null?s`
                ...
                >
                  ...
                  >
                    <span class="chat-workspace-rail__file-icon">${R.folder}</span>
                    <span class="chat-workspace-rail__file-main">
          ...
          ${t.length===0?s`<div class="chat-workspace-rail__state">
                ${o?.search?A(`chat.workspaceFiles.noSearchResults`):A(`chat.workspaceFiles.noBrowserFiles`)}
                  ...
                  >
                    ...
                    >
                      <span class="chat-workspace-rail__file-icon"
                        >${t.kind===`directory`?R.folder:R.fileText}</span
                      >
                      <span class="chat-workspace-rail__file-main">
                        <openclaw-tooltip .content=${t.path||t.name}>
  ...
  `}var J_=/\p{Script=Hebrew}|\p{Script=Arabic}|\p{Script=Syriac}|\p{Script=Thaana}|\p{Script=Nko}|\p{Script=Samaritan}|\p{Script=Mandaic}|\p{Script=Adlam}|\p{Script=Phoenician}|\p{Script=Lydian}/u;function Y_(e,t=/[\s\p{P}\p{S}]/u){if(!e)return`ltr`;for(let n of e)if(!t.test(n))return J_.test(n)?`rtl`:`ltr`;return`ltr`}function X_(e,t){let n=Z_(e,t);if(!n)return;let r=new Blob([n],{type:`text/markdown`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`chat-${t}-${Date.now()}.md`,a.click(),URL.revokeObjectURL(i)}function Z_(e,t){let n=Array.isArray(e)?e:[];if(n.length===0)return null;let r=[`# Chat with ${t}`,``];for(let e of n){let n=e,i=n.role===`user`?`You`:n.role===`assistant`?t:`Tool`,a=Yo(e)??``,o=M(n.timestamp)??``;r.push(`## ${i}${o?` (${o})`:``}`,``,a,``)}return r.join(`
`)}var Q_=5e3,$_=8e3,ev=.85,tv=.9,nv=[`a[href]`,`button`,`input`,`select`,`textarea`,`summary`,`[contenteditable='true']`,`[role='button']`,`[role='listbox']`,`[role='option']`].join(`,`),rv=`image/*,audio/*,application/pdf,text/*,.csv,.json,.md,.txt,.zip,.doc,.docx,.xls,.xlsx,.ppt,.pptx`;function iv(){return{slashMenuOpen:!1,slashMenuItems:[],slashMenuIndex:0,slashMenuMode:`command`,slashMenuCommand:null,slashMenuArgItems:[],slashMenuExpanded:!1,slashCommandRefreshPending:!1,composerComposing:!1,composingDraft:null,composerInputIntentKey:null,pendingClearedSubmittedDraft:null,goalExpandedId:null}}var av=new Map;function ov(e){let t=av.get(e);if(t)return t;let n=iv();return av.set(e,n),n}function sv(e){return e?.phase===`done`||e?.phase===`interrupted`}function cv(e,t,n){return e.sessionKey===t&&!e.pendingRunId&&(e.sendState===`sending`||e.sendState===`waiting-model`)&&(n==null||e.sendRunId!==n.runId)}function lv(e){return`${e.currentAgentId}\u0000${e.sessionKey}`}function X(e,t){e.getDraft?.()===t||e.draft===t||e.onDraftChange(t)}function uv(e,t){e.composerInputIntentKey=t}function dv(e,t){return e.composerInputIntentKey===t?(e.composerInputIntentKey=null,!0):!1}function fv(e,t){e.pendingClearedSubmittedDraft?.key===t&&(e.pendingClearedSubmittedDraft=null)}function pv(e){return e.inputType===`insertFromPaste`||e.inputType===`insertFromDrop`}function mv(e,t,n,r,i){let a=i.pendingClearedSubmittedDraft;return!a||e.value!==a.value||r||pv(t)?!1:(e.value=n,vv(e),!0)}function hv(e){if(e){av.delete(e);return}av.clear();for(let e of wv.values())clearInterval(e);wv.clear()}var gv=new WeakMap;function _v(e){e.style.overflowY=e.scrollHeight>e.clientHeight?`auto`:`hidden`}function vv(e){e.style.overflowY=`hidden`,e.style.height=`auto`,e.style.height=`${Math.min(e.scrollHeight,150)}px`,_v(e)}function yv(e){if(typeof ResizeObserver!=`function`||gv.has(e))return;let t=new ResizeObserver(()=>_v(e));t.observe(e),gv.set(e,t)}function bv(e){gv.get(e)?.disconnect(),gv.delete(e)}function xv(e){queueMicrotask(()=>{e.isConnected&&vv(e)})}function Sv(e,t){if(!t||e.defaultPrevented)return;let n=e.target,r=e.currentTarget;!(n instanceof Element)||!(r instanceof HTMLElement)||n.closest(nv)||r.querySelector(`.agent-chat__composer-combobox > textarea`)?.focus({preventScroll:!0})}function Cv(e,t){requestAnimationFrame(()=>{if(document.activeElement!==e)return;vv(e);let n=t===`up`?0:e.value.length;e.selectionStart=n,e.selectionEnd=n})}var wv=new Map;function Tv(e){let t=wv.get(e);t!==void 0&&(clearInterval(t),wv.delete(e))}function Ev(e){let t=null;return n=>{if(t&&=(Tv(t),null),!(n instanceof HTMLElement)||e.status!==`active`)return;t=n;let r=setInterval(()=>{if(!n.isConnected){Tv(n);return}n.textContent=Rt(zt(e,Date.now()))},1e3);wv.set(n,r)}}function Dv(e){return s`
  ...
  `}function Ov(e,t,n){if(!t)return c;let r=Rt(zt(t,Date.now())),i=Mt(t),a=e.goalExpandedId===t.id,o=n.canAct&&!!n.onGoalCommand,l=t.status===`paused`||t.status===`blocked`||t.status===`usage_limited`||t.status===`budget_limited`;return s`
    ...
    >
      <div class="agent-chat__goal-row">
        <span class="agent-chat__goal-icon">${R.target}</span>
        ...
        <span class="agent-chat__goal-actions">
          ${o&&n.onGoalEdit&&t.status!==`complete`?Dv({className:`agent-chat__goal-edit`,label:`Edit goal`,icon:R.penLine,onClick:()=>n.onGoalEdit?.(t)}):c}
          ${o&&t.status===`active`?Dv({className:`agent-chat__goal-pause`,label:`Pause goal`,icon:R.pause,onClick:()=>n.onGoalCommand?.(`/goal pause`)}):c}
          ${o&&l?Dv({className:`agent-chat__goal-resume`,label:`Resume goal`,icon:R.play,onClick:()=>n.onGoalCommand?.(`/goal resume`)}):c}
          ${o?Dv({className:`agent-chat__goal-clear`,label:`Clear goal`,icon:R.trash,onClick:()=>n.onGoalCommand?.(`/goal clear`)}):c}
          <button
          ...
          >
            ${a?R.chevronDown:R.chevronRight}
          </button>
        </span>
      </div>
      ${a?s`
  ...
  `}function dy(e,t=`In progress`){if(!e||e.phase!==`in-progress`&&Date.now()-e.occurredAt>=5e3)return c;let n=e.phase===`in-progress`?t:e.phase===`done`?`Done`:`Interrupted`,r=e.phase===`in-progress`?R.loader:e.phase===`done`?R.check:R.stop;return s`
    <span
  ...
  `}function my(e){return e&&typeof e==`object`?e:null}function hy(e,t){let n=e?.[t];return typeof n==`number`&&Number.isFinite(n)&&n>=0?n:void 0}function gy(e){if(!e?.length)return null;for(let t=e.length-1;t>=0;--t){let n=my(e[t]);if(n?.role===`user`)return null;if(n?.role!==`assistant`)continue;let r=my(n.cost),i=my(my(n.usage)?.cost),a={provider:typeof n.provider==`string`&&n.provider.trim()||null,model:(typeof n.responseModel==`string`?n.responseModel.trim():``)||(typeof n.model==`string`?n.model.trim():``)||null};for(let e of[`input`,`output`,`cacheRead`,`cacheWrite`]){let t=hy(r,e)??hy(i,e);t!==void 0&&(a[e]=t)}if([a.input,a.output,a.cacheRead,a.cacheWrite].some(e=>e!=null))return a}return null}function _y(e){let t=e.trim().replace(/^#/,``);return/^[0-9a-fA-F]{6}$/.test(t)?[Number.parseInt(t.slice(0,2),16),Number.parseInt(t.slice(2,4),16),Number.parseInt(t.slice(4,6),16)]:null}var vy=null;function yy(){if(vy)return vy;let e=getComputedStyle(document.documentElement),t=e.getPropertyValue(`--warn`).trim()||`#f59e0b`,n=e.getPropertyValue(`--danger`).trim()||`#ef4444`;return vy={warnHex:t,dangerHex:n,warnRgb:_y(t)??[245,158,11],dangerRgb:_y(n)??[239,68,68]},vy}function by(e,t){let n=e?.totalTokens,r=e?.contextTokens??t??0;if(typeof n!=`number`||!Number.isFinite(n)||n<0||!r)return null;let i=e?.totalTokensFresh===!1,a=n/r,o=Math.min(Math.round(a*100),100),s=!i&&a>=ev,c={used:n,limit:r,input:Number.isFinite(e?.inputTokens)?e?.inputTokens??null:null,output:Number.isFinite(e?.outputTokens)?e?.outputTokens??null:null,cost:typeof e?.estimatedCostUsd==`number`&&Number.isFinite(e.estimatedCostUsd)&&e.estimatedCostUsd>=0?e.estimatedCostUsd:null,provider:e?.modelProvider?.trim()||null,model:e?.model?.trim()||null};if(!s)return{pct:o,...c,detail:`${i?`~`:``}${B(n)} / ${B(r)}`,color:`var(--muted)`,bg:`color-mix(in srgb, var(--muted) 8%, transparent)`,warning:s,compactRecommended:!1,approximate:i};let{warnRgb:l,dangerRgb:u}=yy(),[d,f,p]=l,[m,h,g]=u,_=Math.min(Math.max((a-.85)/.1,0),1),v=Math.round(d+(m-d)*_),y=Math.round(f+(h-f)*_),b=Math.round(p+(g-p)*_),x=`rgb(${v}, ${y}, ${b})`,S=`rgba(${v}, ${y}, ${b}, ${.08+.08*_})`;return{pct:o,...c,detail:`${B(n)} / ${B(r)}`,color:x,bg:S,warning:s,compactRecommended:a>=tv,approximate:i}}var xy=6.5,Sy=2*Math.PI*xy;function Cy(e,t,n={}){let r=by(e,t),i=n.providerQuota?q_(n.providerQuota):``;if(!r&&(i===``||i===c))return c;let a=!!(r?.compactRecommended&&n.onCompact),o=n.compactDisabled===!0||n.compactBusy===!0,l=r?A(`chat.composer.contextUsage.summary`,{used:`${r.approximate?`~`:``}${B(r.used)}`,limit:B(r.limit),pct:`${r.approximate?`~`:``}${r.pct}`}):A(`chat.usageRemaining`),u=r?`${r.approximate?`~`:``}${r.pct}%`:null,d=r?Sy*(1-r.pct/100):Sy,f=r?gy(n.messages):null,p=f?.provider??r?.provider,m=f?.model??r?.model,h=e=>e===null?A(`usage.common.emptyValue`):B(e),g=(e,t)=>t===void 0?c:s`
    ...
    >
      ...
      ${a?s`
            ...
            >
              ${n.compactBusy?R.loader:R.minimize}
      ...
      >
        ...
        ${e.replyTarget?s`
              <div class="chat-reply-preview">
                <span class="chat-reply-preview__icon">${R.messageSquare}</span>
...
`)}function vx(e){let t=e.currentTarget,n=(t?.closest(`.chat-tool-card__raw`))?.querySelector(`.chat-tool-card__raw-body`);if(!t||!n)return;let r=t.getAttribute(`aria-expanded`)===`true`;t.setAttribute(`aria-expanded`,String(!r)),n.hidden=r}function yx(e){let t=e.sandbox??``,n=e.src??``;return u(`${t}\u0000${n}\u0000${e.height??``}`,s`
  ...
  `}function xx(e,t){return{kind:`markdown`,content:e,...t?.rawText?{rawText:t.rawText}:{},...t?.fullMessageRequest?{fullMessageRequest:t.fullMessageRequest}:{}}}function Sx(e,t,n){return e.kind!==`canvas`||e.render!==`url`||!e.viewId||!e.url?null:{kind:`canvas`,docId:e.viewId,entryUrl:e.url,...e.title?{title:e.title}:{},...e.preferredHeight?{preferredHeight:e.preferredHeight}:{},...t?{rawText:t}:{},...n?.fullMessageRequest?{fullMessageRequest:n.fullMessageRequest}:{}}}function Cx(e,t){!t||e.messageId}function wx(e){return s`
    <div class="chat-tool-card__raw">
      ...
      >
        ...
        <span class="chat-tool-card__raw-toggle-icon">${R.chevronDown}</span>
      </button>
  ...
  `}function Tx(e){let{label:t,text:n}=e,r=Qt(n)?`markdown-block-art`:``;return s`
    <div class="chat-tool-card__block">
      <div class="chat-tool-card__block-header">
        <span class="chat-tool-card__block-icon">${R.zap}</span>
              ...
              ${f?s`
                    <div class="chat-tool-card__actions">
                      <openclaw-tooltip content="Open in the side panel">
                        ...
                        >
                          <span class="chat-tool-card__action-icon">${R.panelRightOpen}</span>
                        </button>
                      </openclaw-tooltip>
                    </div>
                  `:c}
  ...
  `}function jx(e){return R[e]??R.zap}var Mx=new Map,Nx=new Map,Px=new Map,Fx=5e3,Ix=3e4,Lx=0;function Rx(e){let t=new Date(e);if(!Number.isFinite(t.getTime()))return{label:`Unknown date`,title:`Unknown date`,dateTime:``};let n=Qe();return{label:t.toLocaleString([],{...n,month:`short`,day:`numeric`,year:`numeric`,hour:`numeric`,minute:`2-digit`}),title:t.toLocaleString([],{...n,weekday:`long`,month:`long`,day:`numeric`,year:`numeric`,hour:`numeric`,minute:`2-digit`,second:`2-digit`,timeZoneName:`short`}),dateTime:t.toISOString()}}function zx(e,t=!1){let n=Rx(e);return s`
    <time
      ...
      <div class="chat-group tool chat-group--activity">
        ...
        <div class="chat-group-messages">
          <div class="chat-activity-group ${l?`is-open`:``}">
            ...
            >
              <span class="chat-activity-group__icon">${a?R.x:R.activity}</span>
  ...
  `,i=e=>VS(e.displayUrl)?g(WS(e.displayUrl,t).then(t=>t?r(e,t):c),c):r(e,e.displayUrl);return s` <div class="chat-message-images">${e.map(e=>i(e))}</div> `}function MS(e){return e?s`
    <div class="chat-reply-pill">
      <span class="chat-reply-pill__icon">${R.messageSquare}</span>
      ...
      ${e.map(e=>s`
          ...
          >
            <div class="chat-assistant-attachment-card__header">
              <span class="chat-assistant-attachment-card__icon">${R.alertTriangle}</span>
  ...
  `}function PS(e){let t=e.trim();return/^\/(?:__openclaw__|media|api\/chat\/media\/outgoing)\//.test(t)?!1:FS(t)||t.startsWith(`file://`)||t.startsWith(`~`)||t.startsWith(`/`)||/^[a-zA-Z]:[\\/]/.test(t)}function FS(e){let t=/^media:\/\/inbound\/([^/?#]+)$/i.exec(e.trim());if(!t?.[1])return!1;try{let e=decodeURIComponent(t[1]);return e!==`.`&&e!==`..`&&!e.includes(`/`)&&!e.includes(`\\`)&&!e.includes(`\0`)}catch{return!1}}function IS(e){let t=e.trim();if(!PS(t)||FS(t))return null;if(t.startsWith(`file://`))try{let e=new URL(t),n=decodeURIComponent(e.pathname);return/^\/[a-zA-Z]:\//.test(n)?n.slice(1):n}catch{return null}return t.startsWith(`~`)?null:t}function LS(e){let t=new Set;for(let n of e){let e=RS(n.trim()),r=e.match(/^(\/Users\/[^/]+|\/home\/[^/]+)(?:\/|$)/);if(r?.[1]){t.add(r[1]);continue}let i=e.match(/^([a-z]:\/Users\/[^/]+)(?:\/|$)/i);i?.[1]&&t.add(i[1])}return[...t]}function RS(e){let t=e.replace(/\\/g,`/`).replace(/\/+$/,``);return/^\/[a-zA-Z]:\//.test(t)&&(t=t.slice(1)),/^[a-zA-Z]:\//.test(t)?t.toLowerCase():t}function zS(e,t){if(FS(e))return!0;let n=IS(e),r=n?[RS(n)]:e.trim().startsWith(`~`)?LS(t).map(t=>RS(e.trim().replace(/^~(?=$|[\\/])/,t))):[];return r.length===0?!1:t.some(e=>{let t=RS(e.trim());return t.length>0&&r.some(e=>e===t||e.startsWith(`${t}/`))})}function BS(e,t,n){if(!PS(e))return e;let r=t&&t!==`/`?t.endsWith(`/`)?t.slice(0,-1):t:``,i=new URLSearchParams({source:e}),a=n?.trim();return a&&i.set(`mediaTicket`,a),`${r}/__openclaw__/assistant-media?${i.toString()}`}function VS(e){let t=e.trim();if(t.startsWith(`/api/chat/media/outgoing/`))return!0;try{let e=new URL(t,window.location.origin);return e.origin===window.location.origin&&e.pathname.startsWith(`/api/chat/media/outgoing/`)}catch{return!1}}function HS(e){try{let t=new URL(e,window.location.origin).pathname.split(`/`)[5];return t?decodeURIComponent(t):null}catch{return null}}function US(e,t){return e.startsWith(`/`)?`${t&&t!==`/`?t.endsWith(`/`)?t.slice(0,-1):t:``}${e}`:e}async function WS(e,t){let n=t?.authToken?.trim()??``,r=US(e,t?.basePath),i=`${r}::${n}`,a=Yx.get(i);if(a)return a;let o=Xx.get(i);if(o&&Date.now()-o<Zx)return null;let s=Jx.get(i);return s||(s=(async()=>{let t=HS(e),a=new Headers({Accept:`image/*`});n&&a.set(`Authorization`,`Bearer ${n}`),t&&a.set(`x-openclaw-requester-session-key`,t);let o=await fetch(r,{method:`GET`,headers:a,credentials:`same-origin`});if(!o.ok)return Xx.set(i,Date.now()),null;let s=await o.blob();if(!s.type.startsWith(`image/`))return Xx.set(i,Date.now()),null;let c=URL.createObjectURL(s);return Yx.set(i,c),Xx.delete(i),c})().finally(()=>{Jx.delete(i)}),Jx.set(i,s)),s}function GS(e,t){let n=BS(e,t);return`${n}${n.includes(`?`)?`&`:`?`}meta=1`}function KS(e){let t=Nx.get(e);t&&(clearTimeout(t),Nx.delete(e))}function qS(e,t,n){if(KS(e),t.status!==`available`||!t.mediaTicket||!t.mediaTicketExpiresAt||!n)return;let r=Math.max(0,t.mediaTicketExpiresAt-Date.now()-Ix),i=setTimeout(()=>{Nx.delete(e);let r=Mx.get(e);r?.status!==`available`||r.mediaTicket!==t.mediaTicket||(qx(e),n())},r);Nx.set(e,i)}function JS(e,t,n,r,i){if(!PS(e))return{status:`available`};if(!zS(e,t))return{status:`unavailable`,reason:`Outside allowed folders`,checkedAt:Date.now()};let a=r?.trim()??``,o=`${n??``}::${a}::${e}`,s=Mx.get(o);if(s){let e=Date.now();if(s.status===`unavailable`&&e-s.checkedAt>=Fx)qx(o);else if(s.status===`available`&&s.mediaTicket&&(!s.mediaTicketExpiresAt||s.mediaTicketExpiresAt-e<=Ix))qx(o);else return qS(o,s,i),s}if(KS(o),Kx(o,{status:`checking`}),typeof fetch==`function`){let t=new Headers({Accept:`application/json`});a&&t.set(`Authorization`,`Bearer ${a}`),fetch(GS(e,n),{method:`GET`,headers:t,credentials:`same-origin`}).then(async e=>{let t=await e.json().catch(()=>null);if(t?.available===!0){let e=t.mediaTicket?.trim(),n=Date.parse(t.mediaTicketExpiresAt??``);if(e&&!Number.isFinite(n)){KS(o),Kx(o,{status:`unavailable`,reason:`Attachment unavailable`,checkedAt:Date.now()});return}let r={status:`available`,...e?{mediaTicket:e,mediaTicketExpiresAt:n}:{}};Kx(o,r),qS(o,r,i)}else KS(o),Kx(o,{status:`unavailable`,reason:t?.reason?.trim()||`Attachment unavailable`,checkedAt:Date.now()})}).catch(()=>{KS(o),Kx(o,{status:`unavailable`,reason:`Attachment unavailable`,checkedAt:Date.now()})}).finally(()=>{i?.()})}return{status:`checking`}}function YS(e){return s`
    <div class="chat-assistant-attachment-card chat-assistant-attachment-card--blocked">
      <div class="chat-assistant-attachment-card__header">
        <span class="chat-assistant-attachment-card__icon">${e.kind===`image`?R.image:e.kind===`audio`?R.mic:e.kind===`video`?R.monitor:R.paperclip}</span>
    ...
    <div class="chat-assistant-attachments">
      ${e.map(({attachment:e})=>{let o=JS(e.url,t,n,r,i),l=o.status===`available`?BS(e.url,n,o.mediaTicket):null;return e.kind===`image`?l?s`
          ...
          <div class="chat-assistant-attachment-card">
            <span class="chat-assistant-attachment-card__icon">${R.paperclip}</span>
            <a
              class="chat-assistant-attachment-card__link"
              href=${l}
              target="_blank"
...
...(truncated)...`)))}}function iC(e,t,n){return s`
    ...
    ${be(e.markdown)}
  `}function aC(e,t,n,r){let a=e,o=typeof a.role==`string`?a.role:`unknown`,l=U(o),u=mi(e),d=U(u.role)===`tool`,f=ei(e),p=n.showToolCalls??!0?lb(e,t):[],m=p.length>0,h={localMediaPreviewRoots:n.localMediaPreviewRoots??[],basePath:n.basePath,authToken:n.assistantAttachmentAuthToken,onRequestUpdate:n.onRequestUpdate};fS(t,e,n.onRequestUpdate);let g=AS(oS(e),h),_=g.length>0,v=lS(e),y=v.length>0,b=nC(u),x=[...u.content.filter(e=>e.type===`attachment`),...pS(e)],S=u.content.filter(e=>e.type===`canvas`),C=n.showReasoning&&o===`assistant`?Zo(e):null,w=b?.trim()?b:null,ee=C?$o(C):null,T=w,te={codeBlockChrome:o===`user`?`none`:`copy`,fileLinks:!0},E=T&&!n.isStreaming?$S(T):null,D=[`chat-bubble`,d?`chat-bubble--tool-shell`:``,n.isStreaming?`streaming`:``,`fade-in`].filter(Boolean).join(` `),O=m&&(n.showToolCalls??!0);if(!T&&!O&&!_&&!y&&x.length===0&&S.length===0&&!u.replyTarget)return c;let ne=`toolmsg:${t}`,k=n.isToolMessageExpanded?.(ne)??!1,A=[...new Set(p.map(e=>e.name))],j=p.length===1?p[0]:null,re=p.some(Xy)&&n.turnSucceeded!==!0,M=j?en({name:j.name,args:j.args,detailMode:`explain`}):null,ie=!re&&j&&M?Dx(j,M.detail):void 0,ae=re?M?M.label:A.length<=3?A.join(`, `):`${A.slice(0,2).join(`, `)} +${A.length-2} more`:ie?!T&&!_?ie:j?.outputText?.trim()?`output`:void 0:A.length<=3?A.join(`, `):`${A.slice(0,2).join(`, `)} +${A.length-2} more`,oe=T?ab(T)??``:``,N=re?`Tool error`:M&&!T&&!_?M.label:`Tool output`,se=nb(N)??N,P=ib(ae,se),F=M?jx(M.icon):R.zap,ce=l===`assistant`&&S.length>0?s`${S.map(e=>s`${bx(e.preview,`chat_message`,{onOpenSidebar:r,rawText:e.rawText??null,canvasPluginSurfaceUrl:n.canvasPluginSurfaceUrl,embedSandboxMode:n.embedSandboxMode??`scripts`})}
    ...
    <div class="agent-chat__talk-input-setting">
      <div class="agent-chat__talk-input-control">
        ...
        ${e.onRealtimeTalkInputRefresh?s`
              <openclaw-tooltip .content=${a}>
                ...
                >
                  ${e.realtimeTalkInputLoading?R.loader:R.refresh}
                </button>
              </openclaw-tooltip>
            `:c}
      </div>
      ${e.realtimeTalkInputLoading?s`
            <div
              ...
              aria-live="polite"
            >
              <span class="agent-chat__talk-input-spinner" aria-hidden="true">${R.loader}</span>
  ...
  `}var mC=[`chat.welcome.suggestions.whatCanYouDo`,`chat.welcome.suggestions.summarizeRecentSessions`,`chat.welcome.suggestions.configureChannel`,`chat.welcome.suggestions.checkSystemHealth`];function hC(e){return yt(e.assistantAvatarUrl,{identity:{avatar:e.assistantAvatar??void 0,avatarUrl:e.assistantAvatarUrl??void 0}})}function gC(e){return hC(e)??Se(e.assistantAvatar)}function _C(e){let t=e.assistantName||`Assistant`,n=hC(e),r=n?null:Se(e.assistantAvatar),i=Tt(e.basePath??``);return s`
  ...
  `:c}function LC(e){return TC(e).searchOpen}function RC(e,t){let n=TC(e);n.searchOpen=!n.searchOpen,n.searchOpen||(n.searchQuery=``),t()}function zC(e,t){let n=TC(e.paneId),r=EC(e.sessionKey),i=$e({name:e.userName??null,avatar:e.userAvatar??null}),a=Array.isArray(e.messages)?e.messages:[],o=[];for(let e of r.indices){let t=a[e];if(!t)continue;let n=OC(t),r=typeof t.role==`string`?t.role:`unknown`;o.push({index:e,text:n,role:r})}return o.length===0?c:s`
  ...
  `}var QC=new WeakMap;function $C(e,t){let n=QC.get(e);(!n||n.sessionKey!==t)&&(n={sessionKey:t},QC.set(e,n));let r=n;return{delete:()=>{r.draft=void 0},get:()=>r.draft,set:e=>{r.draft=e}}}var ew={anthropic:`Anthropic`,google:`Google`,"github-copilot":`GitHub`,openai:`OpenAI`,opencode:`OpenCode`,openrouter:`OpenRouter`},tw={"google-gemini-cli":`google`,"opencode-go":`opencode`,"opencode-zen":`opencode`};function nw(e){let t=z(e);return tw[t]??t}var rw=new Set(`abacus.alibaba.amp.antigravity.augment.bedrock.chutes.claude.clawrouter.codebuff.codex.commandcode.copilot.crof.crossmodel.cursor.deepgram.deepseek.devin.doubao.elevenlabs.factory.gemini.grok.groq.jetbrains.kilo.kimi.kiro.litellm.llmproxy.manus.mimo.minimax.mistral.ollama.opencode.opencodego.openrouter.perplexity.poe.qoder.sakana.stepfun.synthetic.t3chat.venice.vertexai.warp.windsurf.zai.zed`.split(`.`)),iw={anthropic:`claude`,"amazon-bedrock":`bedrock`,"aws-bedrock":`bedrock`,google:`gemini`,"google-gemini-cli":`gemini`,"github-copilot":`copilot`,openai:`codex`,"opencode-go":`opencodego`,"opencode-zen":`opencode`,xai:`grok`,"vertex-ai":`vertexai`,"z-ai":`zai`};function aw(e){return ew[e]||ow(e)}function ow(e){return e.split(/[-_]+/u).filter(Boolean).map(e=>`${e.charAt(0).toUpperCase()}${e.slice(1)}`).join(` `)}function sw(e){let t=z(e),n=iw[t]??t;return rw.has(n)?n:null}function cw(e){let t=sw(e);return t?s`
    <span
      class="chat-controls__provider-icon"
      data-provider-icon=${t}
      style=${`--provider-icon-url: url("${Ue(`provider-icons/ProviderIcon-${t}.svg`)}")`}
      aria-hidden="true"
    ></span>
  `:s`
      <span
  ...
  `}function ww(e){let t=nt(e.settings.chatSendShortcut);return s`
    <label class="chat-settings-popover__preference">
      <span>${A(`chat.sendShortcut`)}</span>
      <select
        data-chat-send-shortcut="true"
        .value=${t}
        @change=${t=>{e.onSettingsChange({...e.settings,chatSendShortcut:nt(t.currentTarget.value)})}}
      >
  ...
  `}function Ew(e){let t=e.sessionsResult;if(!t?.sessions)return 0;let n=L(F(e.sessionKey)?.agentId??e.agentsList?.defaultId??`main`),r=L(e.agentsList?.defaultId??`main`);return t.sessions.filter(t=>oe(t.key)&&t.key!==e.sessionKey&&me(t.key,n,r)).length}function Dw(e){let t=e.hideCronSessions,n=t?Ew(e):0,r=e.onboarding,i=e.onboarding?!1:e.settings.chatShowThinking,a=e.onboarding?!0:e.settings.chatShowToolCalls,o=e.settings.chatPersistCommentary===!0,c=A(r?`chat.onboardingDisabled`:`chat.thinkingToggle`),l=A(r?`chat.onboardingDisabled`:`chat.toolCallsToggle`),u=A(r?`chat.onboardingDisabled`:`chat.commentaryToggle`),d=!e.connected||e.manualRefreshInFlight||e.loading||e.sending||e.stream!==null||!!e.runId,f=t?n>0?A(`chat.showCronSessionsHidden`,{count:String(n)}):A(`chat.showCronSessions`):A(`chat.hideCronSessions`),p=e.settingsOpen,m=A(`chat.settings`),h=`chat-composer-settings-popover-${encodeURIComponent(e.paneId)}`;return s`
    <div class="chat-settings-popover-wrapper">
      <openclaw-tooltip .content=${m}>
        ...
        >
          <span class="chat-settings-chip__icon">${R.settings}</span>
        </button>
      </openclaw-tooltip>
      <div
        id=${h}
  ...
  `}var Ow=`.chat-controls__inline-select[open], .context-usage details[open], .agent-chat__talk-select[open], .agent-chat__attach-menu[open]`,kw=`.agent-chat__composer-combobox > textarea`,Aw=`input, textarea, select, [contenteditable]:not([contenteditable='false']), [role='combobox'], [role='listbox'], [role='textbox']`,jw=`a[href], button, summary, [role='button'], [role='checkbox'], [role='link'], [role='radio'], [role='switch']`,Mw=`dialog[open], [aria-modal='true']`,Nw=`Start a new session after the active run or queued messages finish.`,Pw=`Session list is still refreshing. Try New Chat again in a moment.`,Fw=`New Chat could not create a new session. Try again in a moment.`;function Iw(e,t){return e.composedPath().some(e=>e instanceof Element&&e.matches(t))}var $=class extends d{constructor(...e){super(...e),this.paneId=`single`,this.sessionKey=``,this.active=!1,this.chrome=`none`,this.chatState=new K_(this),this.connectedClient=null,this.connectionGeneration=0,this.nativeDraftCleanup=null,this.unreadPatchGuard=new sn,this.handleCommandPaletteSlashCommand=e=>{let t=this.state;t&&(t.handleChatDraftChange(e.endsWith(` `)?e:`${e} `),t.requestUpdate?.())},this.createSession=async()=>{let e=this.state;if(!e||!e.client||!e.connected)return!1;if(!u_(e))return e.lastError=Nw,e.chatError=e.lastError,e.requestUpdate?.(),!1;if(e.sessionsLoading)return e.lastError=Pw,e.chatError=e.lastError,e.requestUpdate?.(),!1;e.lastError=null,e.chatError=null;let t=e.sessionKey,n=await this.context.sessions.create({currentSessionKey:t,agentId:Me(e,t).agentId??ce(t)});return!n||e.sessionKey!==t||!u_(e)?(n||(e.lastError=e.sessionsError??(e.sessionsLoading?Pw:Fw),e.chatError=e.lastError,e.requestUpdate?.()),!1):(this.chatState.captureCreatedSessionComposer(n),this.onPaneSessionChange?.(this.paneId,n),!0)},this.handlePaneFocus=()=>{this.onFocusPane?.(this.paneId)},this.handleDocumentKeydown=e=>{if(this.active&&!e.defaultPrevented&&!e.isComposing&&!e.metaKey&&!e.ctrlKey&&!e.altKey&&e.key.length===1&&!Iw(e,Aw)&&!(e.key===` `&&Iw(e,jw))&&!document.querySelector(Mw)){let e=this.querySelector(kw);e&&!e.disabled&&!e.readOnly&&e.focus({preventScroll:!0})}if(e.defaultPrevented||e.key!==`Escape`)return;let t=this.state;if(!t)return;let n=this.querySelectorAll(Ow);if(n.length>0){e.preventDefault(),n.forEach(e=>{e.open=!1});return}t.chatMobileControlsOpen&&(e.preventDefault(),t.setChatMobileControlsOpen(!1,{restoreFocus:!0}))},this.handleDocumentPointerdown=e=>{let t=this.state;if(!t)return;let n=e.composedPath(),r=!1;if(this.querySelectorAll(Ow).forEach(e=>{n.includes(e)||(e.open=!1,r=!0)}),r&&t.requestUpdate(),!t.chatMobileControlsOpen)return;let i=this.querySelector(`.chat-settings-popover-wrapper`)??this.querySelector(`.chat-mobile-controls-wrapper`);i&&n.includes(i)||t.setChatMobileControlsOpen(!1)}}markSessionRead(e){let t=this.state;if(!t?.connected||!e||!this.unreadPatchGuard.shouldPatch(t.sessionKey,e.unread))return;let n=F(e.key)?.agentId??x_(t),r=t.sessionKey;this.context.sessions.patch(e.key,{unread:!1},{agentId:n}).catch(()=>{this.unreadPatchGuard.patchFailed(r)})}setPaneSessionKey(e){let t=this.state;if(!t)return null;let n=Je(e,this.context.gateway.snapshot.hello);return n?(t.sessionKey=n,n):null}applyActiveSessionBindings(){let e=this.state;if(!e||!this.active||!this.sessionKey.trim())return;let t=e.sessionKey;v_(e,t),this.context.gateway.setSessionKey(t);let n=F(t)?.agentId;n&&this.context.agentSelection.set(n)}switchPaneSession(e){let t=this.state;if(!t)return;let n=t.sessionKey,r=t.sessionsResult,i=t.sessionsResult?.sessions.find(t=>t.key===e),a=ae(e,i);y_(t,e),this.markSessionRead(i),n!==e&&t.announceSessionSwitch?.(e,a),t.loadAssistantIdentity(),Ai(t),A_(t).finally(()=>t.requestUpdate?.()),uu(t);let o=_u(t);t.requestUpdate();let s=()=>{t.sessionKey===e&&(t.requestUpdate(),K(t,!0))};o.then(s,s),o.then(()=>this.sendPendingSkillWorkshopRevision(e),()=>this.sendPendingSkillWorkshopRevision(e)),yh(t,e,o,b_(t),r,()=>void hg(t))}announceCommandPaletteTarget(e){this.dispatchEvent(new CustomEvent(xe,{bubbles:!0,composed:!0,detail:{owner:this,onSlashCommand:e}}))}syncActiveBindings(){if(this.nativeDraftCleanup?.(),this.nativeDraftCleanup=null,!this.active){this.announceCommandPaletteTarget(null);return}this.announceCommandPaletteTarget(this.handleCommandPaletteSlashCommand),this.applyActiveSessionBindings(),this.nativeDraftCleanup=this.context.nativeChatDrafts.subscribe(e=>{let t=this.state;!t||!this.active||(t.handleChatDraftChange(e),t.requestUpdate?.())}),this.sendPendingSkillWorkshopRevision(this.sessionKey)}sendPendingSkillWorkshopRevision(e){let t=this.state;if(!this.active||!t||!t.connected||t.sessionKey!==e)return;let n=this.context.skillWorkshopRevision.consume(e);n&&t.handleSendChat(n.instructions,{restoreDraft:!0,skillWorkshopRevision:{proposalId:n.proposalId,agentId:n.proposalAgentId}}).catch(e=>{t.lastError=e instanceof Error?e.message:String(e),t.chatError=t.lastError,t.requestUpdate?.()})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.addEventListener(`pointerdown`,this.handlePaneFocus),this.addEventListener(`focusin`,this.handlePaneFocus),document.addEventListener(`keydown`,this.handleDocumentKeydown,!0),document.addEventListener(`pointerdown`,this.handleDocumentPointerdown,!0);let e=this.chatState;e.addCleanup(()=>{document.removeEventListener(`keydown`,this.handleDocumentKeydown,!0),document.removeEventListener(`pointerdown`,this.handleDocumentPointerdown,!0),this.removeEventListener(`pointerdown`,this.handlePaneFocus),this.removeEventListener(`focusin`,this.handlePaneFocus)});let t=U_(this.context,e.requestUpdate,this);t.createChatSession=async()=>{await this.createSession()},t.exportCurrentChat=()=>X_(t.chatMessages,t.assistantName),t.refreshCurrentSessionTools=async()=>{await t.onModelChanged?.(),t.requestUpdate?.()},t.refreshCurrentChat=async()=>{await N_(t),t.requestUpdate?.()},this.state=t,e.attach(t);let n=globalThis.navigator?.mediaDevices;if(n?.addEventListener){let r=()=>void t.refreshRealtimeTalkInputs();n.addEventListener(`devicechange`,r),e.addCleanup(()=>n.removeEventListener(`devicechange`,r))}this.sessionKey&&this.setPaneSessionKey(this.sessionKey),e.restoreComposer({preserveCurrent:!0}),this.draft!==void 0&&this.state.handleChatDraftChange(this.draft),e.startComposerPersistence(),e.addCleanup(this.context.gateway.subscribe(e=>{this.applyGatewaySnapshot(e)})),e.addCleanup(this.context.gateway.subscribeEvents(e=>{let t=this.state;t&&W_(t,e)})),this.applyApplicationConfig(this.context.config.current),e.addCleanup(this.context.config.subscribe(e=>{this.applyApplicationConfig(e)})),this.applySessionsState(this.context.sessions.state),e.addCleanup(this.context.sessions.subscribe(e=>{this.applySessionsState(e)})),this.applyGatewaySnapshot(this.context.gateway.snapshot)}willUpdate(e){if(e.has(`sessionKey`)&&this.state){let e=Je(this.sessionKey,this.context.gateway.snapshot.hello);e&&e!==this.state.sessionKey&&this.switchPaneSession(e),this.chatState.restoreCreatedSessionComposer(e)}(e.has(`active`)||e.has(`sessionKey`))&&this.syncActiveBindings(),e.has(`draft`)&&this.draft!==void 0&&this.state&&this.draft!==this.state.chatMessage&&this.state.handleChatDraftChange(this.draft)}updated(){let e=this.querySelector(`.chat-pane__session-select`);e&&this.state&&e.value!==this.state.sessionKey&&(e.value=this.state.sessionKey)}disconnectedCallback(){this.nativeDraftCleanup?.(),this.nativeDraftCleanup=null,this.announceCommandPaletteTarget(null),XC(this.paneId),this.state=void 0,this.connectedClient=null,super.disconnectedCallback()}applySessionsState(e){let t=this.state;if(!t)return;let n=e.deletedSessions.some(({key:e,agentId:n})=>ve({agentsList:this.context.agents.state.agentsList,hello:this.context.gateway.snapshot.hello,sessionKey:t.sessionKey},e,n));for(let{key:n}of e.deletedSessions)Vc(t.chatMessagesBySession,t,{sessionKey:n});t.sessionsResult=e.result,t.sessionsResultAgentId=e.agentId,t.sessionsLoading=e.loading,t.sessionsError=e.error;let r=e.result?.sessions.find(e=>I(e.key,t.sessionKey));if(r&&(t.selectedChatSessionArchived=r.archived===!0,this.markSessionRead(r)),n){let e=F(t.sessionKey)?.agentId??this.context.agentSelection.state.selectedId??`main`;this.onPaneSessionChange?.(this.paneId,ue({agentId:e,mainKey:he({agentsList:this.context.agents.state.agentsList,hello:this.context.gateway.snapshot.hello})}));return}xc(t)||t.requestUpdate?.()}applyApplicationConfig(e){let t=this.state;if(!t)return;let n=t.terminalAvailable;t.terminalAvailable=e.terminalEnabled&&t.connected&&gt(t.hello?.auth??null)&&ut(this.context.gateway.snapshot,`terminal.open`)===!0,!(!(t.localMediaPreviewRoots.length!==e.localMediaPreviewRoots.length||t.localMediaPreviewRoots.some((t,n)=>t!==e.localMediaPreviewRoots[n]))&&t.terminalAvailable===n&&t.embedSandboxMode===e.embedSandboxMode&&t.allowExternalEmbedUrls===e.allowExternalEmbedUrls&&t.chatMessageMaxWidth===e.chatMessageMaxWidth)&&(t.localMediaPreviewRoots=e.localMediaPreviewRoots,t.embedSandboxMode=e.embedSandboxMode,t.allowExternalEmbedUrls=e.allowExternalEmbedUrls,t.chatMessageMaxWidth=e.chatMessageMaxWidth,t.requestUpdate?.())}applyGatewaySnapshot(e){let t=this.state;if(!t)return;let n=t.connected,r=this.connectedClient!==e.client;t.client=e.client,t.connected=e.connected,t.hello=e.hello,t.terminalAvailable=this.context.config.current.terminalEnabled&&e.connected&&gt(e.hello?.auth??null)&&ut(e,`terminal.open`)===!0,t.assistantAgentId=e.assistantAgentId;let i=this.sessionKey.trim(),a=i?Je(i,e.hello):null;if(i&&a&&a!==i){this.onPaneSessionChange?.(this.paneId,a,{replace:!0}),t.requestUpdate?.();return}if(t.assistantName=this.context.config.current.assistantIdentity.name,!e.connected){if(n){this.connectionGeneration+=1;let e=typeof t.currentSessionId==`string`?t.currentSessionId.trim():``;e&&(t.reconnectResumeSessionId=e),md(t)}this.connectedClient=null,t.realtimeTalkSession?.stop(),t.realtimeTalkSession=null,t.realtimeTalkActive=!1,t.realtimeTalkStatus=`idle`,t.resetToolStream(),t.requestUpdate?.();return}if(r&&e.client){let n=e.client,r=++this.connectionGeneration,i=t.sessionKey,a=this.context.agents.state.agentsList,o=()=>this.connectionGeneration===r&&this.connectedClient===n&&t.client===n&&t.connected,s=async()=>{if(!o())return;let e=this.context.agents.state.agentsList;e===a&&(e=await this.context.agents.ensureList()),o()&&(e&&vu(t,e,n),t.requestUpdate?.(),t.sessionKey===i&&this.sendPendingSkillWorkshopRevision(i))};this.connectedClient=n,uu(t,{force:!0}),ug(t),N_(t,{startup:!0,awaitHistory:!0}).finally(()=>{s()}),j_(t).finally(()=>t.requestUpdate?.()),t.loadAssistantIdentity()}t.requestUpdate?.()}renderPaneHeader(e){if(this.chrome!==`pane`)return null;let t=e.sessionsResult?.sessions??[],n=t.find(t=>t.key===e.sessionKey)?t:[{key:e.sessionKey},...t];return s`
    ...
    `}render(){let e=this.state;if(!e)return s`<main class="app-shell app-shell--booting" aria-busy="true"></main>`;let t=x_(e),n=this.context.agents.state.agentsList?.agents.find(e=>e.id===t)?.model?.primary,r=e.selectedChatSessionArchived||e.sessionsResult?.sessions.some(t=>t.archived===!0&&I(t.key,e.sessionKey))===!0,i=e.connected?r?A(`chat.archivedSessionDisabled`):null:A(`chat.disconnected`),a=gt(this.context.gateway.snapshot.hello?.auth??null),o={paneId:this.paneId,sessionKey:e.sessionKey,onSessionKeyChange:e=>{this.onPaneSessionChange?.(this.paneId,e)},thinkingLevel:e.chatThinkingLevel,autoExpandToolCalls:e.chatVerboseLevel===`full`,showThinking:e.settings.chatShowThinking,showToolCalls:e.settings.chatShowToolCalls,loading:e.chatLoading,sending:e.chatSending,canAbort:oc(e),runStatus:e.chatRunStatus,compactionStatus:e.compactionStatus,fallbackStatus:e.fallbackStatus,messages:e.chatMessages,sideResult:e.chatSideResult,toolMessages:e.chatToolMessages,streamSegments:e.chatStreamSegments,stream:e.chatStream,streamStartedAt:e.chatStreamStartedAt,assistantAvatarUrl:S_(e),sendShortcut:e.settings.chatSendShortcut,draft:e.chatMessage,queue:e.chatQueue,realtimeTalkActive:e.realtimeTalkActive,realtimeTalkStatus:e.realtimeTalkStatus,realtimeTalkDetail:e.realtimeTalkDetail,realtimeTalkConversation:e.realtimeTalkConversation,connected:e.connected,canSend:e.connected&&!r,disabledReason:i,error:e.lastError,sessions:e.sessionsResult,providerQuota:{basePath:e.basePath,modelAuthStatusResult:e.modelAuthStatusResult},composerControls:Dw({paneId:this.paneId,agentsList:e.agentsList,connected:e.connected,hideCronSessions:e.sessionsHideCron,loading:e.chatLoading,manualRefreshInFlight:e.chatManualRefreshInFlight,model:{activeRunId:e.chatRunId,agentDefaultModel:n,connected:e.connected,draftScope:e,gatewayAvailable:!!e.client,loading:e.chatLoading,modelCatalog:e.chatModelCatalog,modelOverrides:e.sessions.state.modelOverrides,modelSwitching:!!e.chatModelSwitchPromises[e.sessionKey],modelsLoading:e.chatModelsLoading,sending:e.chatSending,sessionKey:e.sessionKey,sessionsResult:e.sessionsResult,stream:e.chatStream,onRequestUpdate:()=>e.requestUpdate?.(),onFastModeSelect:(t,n)=>Sh(e,t,n),onModelSelect:(t,n)=>Ch(e,t,n),onThinkingSelect:(t,n)=>wh(e,t,n)},onboarding:e.onboarding,runId:e.chatRunId,sending:e.chatSending,settings:e.settings,settingsOpen:e.chatMobileControlsOpen,sessionKey:e.sessionKey,sessionsResult:e.sessionsResult,stream:e.chatStream,realtimeTalkOptions:e.realtimeTalkOptions,realtimeTalkInputDevices:e.realtimeTalkInputDevices,realtimeTalkInputDeviceId:e.realtimeTalkInputDeviceId,realtimeTalkInputLoading:e.realtimeTalkInputLoading,realtimeTalkInputError:e.realtimeTalkInputError,canOpenRealtimeTalkSettings:a,onRefresh:()=>d_(e),onRealtimeTalkInputRefresh:()=>void e.refreshRealtimeTalkInputs(!0),onRealtimeTalkInputSelect:e.selectRealtimeTalkInput,onRealtimeTalkOptionsChange:e.updateRealtimeTalkOptions,onOpenRealtimeTalkSettings:()=>{a&&this.context.navigate(`communications`,{search:`?section=talk`})},onSettingsChange:e.applySettings,onSettingsOpenChange:(t,n)=>{e.setChatMobileControlsOpen(t,n),t&&e.refreshRealtimeTalkInputs(!1)},onToggleCronSessions:()=>{e.sessionsHideCron=!e.sessionsHideCron,e.requestUpdate?.()},onOpenSplitView:this.onOpenSplitView}),sessionWorkspace:e_(e),onOpenWorkspaceFile:t=>Zg(e,t),onRevealWorkspaceFile:t=>Qg(e,t),onRefresh:()=>{e.chatSideResult=null,e.resetToolStream(),N_(e,{awaitHistory:!0,scheduleScroll:!1})},onChatScroll:e.handleChatScroll,getDraft:()=>e.chatMessage,onDraftChange:e.handleChatDraftChange,onRequestUpdate:e.requestUpdate,onHistoryKeydown:e.handleChatInputHistoryKey,onSlashIntent:()=>w_(e),showNewMessages:e.chatNewMessagesBelow&&!e.chatManualRefreshInFlight,onScrollToBottom:e.scrollToBottom,attachments:e.chatAttachments,onAttachmentsChange:t=>{e.chatAttachments=t,e.requestUpdate?.()},onSend:()=>void e.handleSendChat(),onCompact:()=>void e.handleSendChat(`/compact`),onOpenSessionCheckpoints:()=>{let t=new URLSearchParams({session:e.sessionKey});r&&t.set(`showArchived`,`1`),this.context.navigate(`sessions`,{search:`?${t.toString()}`})},onToggleRealtimeTalk:()=>void e.toggleRealtimeTalk(),onDismissError:()=>{p_(e),e.requestUpdate?.()},onDismissRealtimeTalkError:()=>{Bf(e),e.requestUpdate?.()},onAbort:()=>void e.handleAbortChat({preserveDraft:!0}),onQueueRemove:e.removeQueuedMessage,onQueueRetry:t=>void e.retryQueuedChatMessage(t),onQueueSteer:t=>void e.steerQueuedChatMessage(t),onGoalCommand:t=>void e.handleSendChat(t),onDismissSideResult:()=>{e.chatSideResult=null,e.requestUpdate?.()},replyTarget:e.chatReplyTarget??null,onClearReply:()=>{e.chatReplyTarget=null,e.requestUpdate?.()},onSetReply:t=>{e.chatReplyTarget=t,e.requestUpdate?.()},onNewSession:()=>void this.createSession(),onClearHistory:()=>void gu(e),agentsList:e.agentsList,currentAgentId:t,fullMessageAgentId:Me(e,e.sessionKey).agentId,onAgentChange:e=>{let t=ue({agentId:e});this.onPaneSessionChange?.(this.paneId,t)},onSessionSelect:e=>{this.onPaneSessionChange?.(this.paneId,e)},onLoadSidebarFullMessage:async t=>!e.client||!e.connected?null:e.client.request(`chat.message.get`,{sessionKey:t.sessionKey,...t.agentId?{agentId:t.agentId}:{},messageId:t.messageId,maxChars:Ey}),sidebarOpen:e.sidebarOpen,sidebarContent:e.sidebarContent,splitRatio:e.splitRatio,canvasPluginSurfaceUrl:e.hello?.pluginSurfaceUrls?.canvas??null,onOpenSidebar:e.handleOpenSidebar,onCloseSidebar:e.handleCloseSidebar,onSplitRatioChange:e.handleSplitRatioChange,assistantName:e.assistantName,assistantAvatar:e.assistantAvatar,userName:e.userName,userAvatar:e.userAvatar,localMediaPreviewRoots:e.localMediaPreviewRoots,embedSandboxMode:e.embedSandboxMode,allowExternalEmbedUrls:e.allowExternalEmbedUrls,chatMessageMaxWidth:e.chatMessageMaxWidth,assistantAttachmentAuthToken:f_(e),onAssistantAttachmentLoaded:()=>e.scrollToBottom(),basePath:e.basePath};return s`${this.renderPaneHeader(e)}${ZC(o)}`}};r([n({context:t,subscribe:!1})],$.prototype,`context`,void 0),r([m({attribute:!1})],$.prototype,`paneId`,void 0),r([m({attribute:!1})],$.prototype,`sessionKey`,void 0),r([m({attribute:!1})],$.prototype,`active`,void 0),r([m({attribute:!1})],$.prototype,`chrome`,void 0),r([m({attribute:!1})],$.prototype,`draft`,void 0),r([m({attribute:!1})],$.prototype,`onFocusPane`,void 0),r([m({attribute:!1})],$.prototype,`onPaneSessionChange`,void 0),r([m({attribute:!1})],$.prototype,`onSplitRight`,void 0),r([m({attribute:!1})],$.prototype,`onSplitDown`,void 0),r([m({attribute:!1})],$.prototype,`onClosePane`,void 0),r([m({attribute:!1})],$.prototype,`onOpenSplitView`,void 0),customElements.get(`openclaw-chat-pane`)||customElements.define(`openclaw-chat-pane`,$);var Lw=.3;function Rw(e,t,n){let r=(t-e.left)/e.width,i=(n-e.top)/e.height,a=r<=Lw?{edge:`left`,distance:r}:1-r<=Lw?{edge:`right`,distance:1-r}:null,o=i<=Lw?{edge:`up`,distance:i}:1-i<=Lw?{edge:`down`,distance:1-i}:null,s=a&&o?a.distance<=o.distance?a:o:a??o;return s?{kind:`edge`,edge:s.edge}:{kind:`center`}}function zw(e,t){let n={left:e.left,top:e.top,width:e.width,height:e.height};return t.kind===`center`?n:t.edge===`left`?{...n,width:e.width/2}:t.edge===`right`?{...n,left:e.left+e.width/2,width:e.width/2}:t.edge===`up`?{...n,height:e.height/2}:{...n,top:e.top+e.height/2,height:e.height/2}}var Bw=`(max-width: 1099px)`,Vw=class extends d{constructor(...e){super(...e),this.narrow=!1,this.dropIndicator=null,this.mediaQuery=null,this.dragDepth=0,this.dragFrame=0,this.pendingDragOver=null,this.handleViewportChange=e=>{this.narrow=e.matches,e.matches&&this.clearDropIndicator()},this.handleDragEnter=e=>{this.narrow||!ht(e.dataTransfer)||(this.dragDepth+=1)},this.handleDragOver=e=>{if(this.narrow||!ht(e.dataTransfer))return;e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`copy`);let t=(e.target instanceof Element?e.target:null)?.closest(`openclaw-chat-pane`);!t||!this.contains(t)||(this.pendingDragOver={pane:t,x:e.clientX,y:e.clientY},!this.dragFrame&&(this.dragFrame=window.requestAnimationFrame(()=>{this.dragFrame=0;let e=this.pendingDragOver;if(this.pendingDragOver=null,!e||this.narrow||!this.isConnected)return;let t=this.resolveDropIndicator(e.pane,e.x,e.y);if(!t)return;let n=this.dropIndicator;n?.paneId===t.paneId&&n.zone.kind===t.zone.kind&&(t.zone.kind===`center`||n.zone.kind===`edge`&&n.zone.edge===t.zone.edge)||(this.dropIndicator=t)})))},this.handleDragLeave=e=>{this.narrow||!ht(e.dataTransfer)||(this.dragDepth=Math.max(0,this.dragDepth-1),this.dragDepth===0&&this.clearDropIndicator())},this.handleDrop=e=>{if(this.narrow||!ht(e.dataTransfer))return;e.preventDefault();let t=ft(e.dataTransfer),n=(e.target instanceof Element?e.target:null)?.closest(`openclaw-chat-pane`),r=(n&&this.contains(n)?this.resolveDropIndicator(n,e.clientX,e.clientY):null)??this.dropIndicator;this.clearDropIndicator(),t&&r&&this.applySessionDrop(t,r.paneId,r.zone)},this.handleWindowDragEnd=()=>{this.clearDropIndicator()},this.handleFocusPane=e=>{let t=this.layout;if(!t||t.activePaneId===e)return;let n=lt(t,e)?.pane;n&&(this.persistLayout(We(t,e)),this.updateRoute(n.sessionKey,!0))},this.handlePaneSessionChange=(e,t,n)=>{let r=t.trim();if(!r)return;let i=this.layout;if(!i){this.updateRoute(r,n?.replace);return}let a=lt(i,e)?.pane;!a||a.sessionKey===r||(this.persistLayout(Te(i,e,r)),i.activePaneId===e&&this.updateRoute(r,n?.replace))},this.openSplitView=()=>{let e=this.data?.sessionKey?.trim();e&&this.persistLayout(He(e))},this.handleSplitRight=e=>{let t=this.layout,n=t?lt(t,e)?.pane:null;!t||!n||this.persistLayout(ye(t,e,n.sessionKey,`right`))},this.handleSplitDown=e=>{let t=this.layout,n=t?lt(t,e)?.pane:null;!t||!n||this.persistLayout(ye(t,e,n.sessionKey,`down`))},this.handleClosePane=e=>{let t=this.layout;if(!t)return;let n=ct(t).find(t=>t.id!==e),r=we(t,e);if(this.persistLayout(r),!r&&n){this.updateRoute(n.sessionKey,!0);return}if(r){let e=lt(r,r.activePaneId)?.pane;e&&this.updateRoute(e.sessionKey,!0)}}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.layout=dt().chatSplitLayout,this.mediaQuery=window.matchMedia(Bw),this.narrow=this.mediaQuery.matches,this.mediaQuery.addEventListener(`change`,this.handleViewportChange),this.addEventListener(`dragenter`,this.handleDragEnter),this.addEventListener(`dragover`,this.handleDragOver),this.addEventListener(`dragleave`,this.handleDragLeave),this.addEventListener(`drop`,this.handleDrop),window.addEventListener(`dragend`,this.handleWindowDragEnd),this.syncRouteToActivePane()}disconnectedCallback(){this.mediaQuery?.removeEventListener(`change`,this.handleViewportChange),this.mediaQuery=null,this.removeEventListener(`dragenter`,this.handleDragEnter),this.removeEventListener(`dragover`,this.handleDragOver),this.removeEventListener(`dragleave`,this.handleDragLeave),this.removeEventListener(`drop`,this.handleDrop),window.removeEventListener(`dragend`,this.handleWindowDragEnd),this.clearDropIndicator(),super.disconnectedCallback()}updated(e){e.has(`data`)&&this.syncRouteToActivePane()}clearDropIndicator(){this.dragDepth=0,this.clearDropPreview()}clearDropPreview(){this.pendingDragOver=null,this.dragFrame&&=(window.cancelAnimationFrame(this.dragFrame),0),this.dropIndicator=null}resolveDropIndicator(e,t,n){let r=e.paneId,i=this.querySelector(`.chat-split-view__drop-container`);if(!r||!i)return null;let a=e.getBoundingClientRect(),o=Rw(a,t,n),s=zw(a,o),c=i.getBoundingClientRect();return{paneId:r,zone:o,rect:{left:s.left-c.left,top:s.top-c.top,width:s.width,height:s.height}}}syncRouteToActivePane(){let e=this.layout,t=this.data?.sessionKey?.trim();if(!e||!t)return;let n=lt(e,e.activePaneId)?.pane;!n||n.sessionKey===t||this.persistLayout(Te(e,n.id,t))}persistLayout(e){this.layout=e,pt({chatSplitLayout:e})}updateRoute(e,t=!1){if(this.data?.sessionKey===e)return;let n={search:Xe(e)};t?this.context.replace(`chat`,n):this.context.navigate(`chat`,n)}applySessionDrop(e,t,n){let r=e.trim();if(!r)return;let i=this.layout;if(!i){if(n.kind===`center`){this.updateRoute(r);return}let e=this.data?.sessionKey?.trim();if(!e)return;let t=ye(Ce(e),`p1`,r,n.edge);this.persistLayout(t),this.updateRoute(r,!0);return}let a=lt(i,t)?.pane;if(a){if(n.kind===`center`){if(a.sessionKey===r)return;let e=We(i,t);this.persistLayout(Te(e,t,r)),this.updateRoute(r,!0);return}this.persistLayout(ye(i,t,r,n.edge)),this.updateRoute(r,!0)}}renderPane(e,t,n){let r=!this.narrow;return s`
      ...
      ></openclaw-chat-pane>
    `}renderSplitLayout(e){if(this.narrow){let t=lt(e,e.activePaneId)?.pane;return t?s`<div class="chat-split-view chat-split-view--narrow">
        ...
        ${l(e.columns,e=>e.id,(t,n)=>s`
              ...
              ${l(t.panes,e=>e.id,(n,r)=>s`
                  ...
                  ${r<t.panes.length-1?s`
                        <resizable-divider
                          ...
                          .maxRatio=${.85}
                          .label=${A(`nav.resize`)}
                          @resize=${e=>{let n=this.layout;n&&this.persistLayout(Be(n,t.id,r,e.detail.splitRatio))}}
                        ></resizable-divider>
                      `:c}
                `)}
            </div>
            ${n<e.columns.length-1?s`
                  <resizable-divider
                    ...
                    .maxRatio=${.85}
                    .label=${A(`nav.resize`)}
                    @resize=${e=>{let t=this.layout;t&&this.persistLayout(Le(t,n,e.detail.splitRatio))}}
                  ></resizable-divider>
                `:c}
          `)}
      </div>
...
//# sourceMappingURL=chat-page-DYmw0Q5x.js.map