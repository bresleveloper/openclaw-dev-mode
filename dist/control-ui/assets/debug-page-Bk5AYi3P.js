import{n as e,r as t,t as n}from"./decorate-CUyPCN2p.js";import{f as r,g as i,h as a,m as o}from"./lit-runtime-B2f-BITn.js";import{r as s}from"./i18n-Cb2Gon67.js";import{Fr as c,Pr as l,pr as u}from"./index-DMlQdn8s.js";import{t as d}from"./settings-workspace-BdKXKfXa.js";import{i as f}from"./presenter-TTfHKEn1.js";async function p(e){let[t,n,r,i]=await Promise.all([e.request(`status`,{}),e.request(`health`,{}),e.request(`models.list`,{}),e.request(`last-heartbeat`,{})]),a=r;return{status:t,health:n,models:Array.isArray(a?.models)?a.models:[],heartbeat:i}}function m(e){let t=(e.status&&typeof e.status==`object`?e.status.securityAudit:null)?.summary??null,n=t?.critical??0,r=t?.warn??0,o=t?.info??0,c=n>0?`danger`:r>0?`warn`:`success`,l=n>0?s(`debug.security.critical`,{count:String(n)}):r>0?s(`debug.security.warnings`,{count:String(r)}):s(`debug.security.noCriticalIssues`);return i`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-page-Bk5AYi3P.js.map