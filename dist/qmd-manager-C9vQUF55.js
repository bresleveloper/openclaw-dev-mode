...
import { i as resolveAgentContextLimits, o as resolveAgentWorkspaceDir } from "./agent-scope-config-C3ijpoNo.js";
import { o as withFileLock } from "./file-lock-BOaqUSu6.js";
import { g as isSessionArchiveArtifactName } from "./paths-CHZBIGhF.js";
import "./error-runtime-Ck1CsJM-.js";
import "./number-runtime-DBLVDypr.js";
import "./string-coerce-runtime-BiZzULo_.js";
import { n as resolveMemorySearchSyncConfig } from "./memory-search-QpW93KPi.js";
import { t as isFileMissingError } from "./fs-utils-B-YGVvwo.js";
import { a as buildMemoryReadResult, o as buildMemoryReadResultFromSlice } from "./read-file-Ct9Hg2Gy.js";
import { r as requireNodeSqlite } from "./engine-storage-w3HufW5O.js";
import { t as formatSessionTranscriptMemoryHitKey } from "./session-transcript-memory-hit-CHBzXaEo.js";
import "./session-transcript-hit-BQOodQYD.js";
import "./memory-core-host-engine-foundation-D7lLvz3U.js";
import { a as deriveQmdScopeChannel, c as parseQmdQueryJson, g as resolveSessionIdentityForTranscriptFile, i as runCliCommand, l as buildSessionEntry, n as resolveCliSpawnInvocation, o as deriveQmdScopeChatType, s as isQmdScopeAllowed, v as listSessionTranscriptCorpusEntriesForAgent } from "./engine-qmd-De-fqp5-.js";
...
import { a as replaceQmdSessionArtifactMappings, i as refreshQmdSessionArtifactDocIds, n as copyQmdSessionArtifactHit, o as resolveQmdSessionArtifactIdentity, t as attachQmdSessionArtifactHit } from "./qmd-session-artifacts-CLqGLyaZ.js";
...
var QmdMemoryManager = class QmdMemoryManager {
	...
	async search(query, opts) {
		...
		const runSearchAttempt = async (allowMissingCollectionRepair) => {
			try {
				...
				const collectionGroups = await this.resolveCollectionSearchGroups(collectionNames, searchSignal);
	...
	*/
	...
	async resolveCollectionSearchGroups(collectionNames, signal) {
		if (collectionNames.length <= 1) return [collectionNames];
		if (!await this.supportsQmdMultiCollectionFilters(signal)) return collectionNames.map((collectionName) => [collectionName]);
		return this.groupCollectionNamesBySource(collectionNames);
	}
	async supportsQmdMultiCollectionFilters(signal) {
