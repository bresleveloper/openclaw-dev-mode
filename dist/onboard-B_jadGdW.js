...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-D-lLN9nd.js";
import { J as writeConfigFile, W as readConfigFileSnapshot, dt as resolveDefaultSecretProviderAlias } from "./auth-profiles-gyYFUuWS.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-BTGTJOdS.js";
...
import "./daemon-runtime-CakxZ6WR.js";
import { t as runOnboardingWizard } from "./onboarding-CfD9oSNE.js";
import { n as logConfigUpdated } from "./logging-C2FUa2rZ.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-D7bxrKC0.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-DeRnlqfh.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CMTfnQn9.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-D5MrECIK.js");
