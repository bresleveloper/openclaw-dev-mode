import { i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot, xn as SilentReplyConversationType } from "./types.openclaw-DlpCUWMr.js";
...
import { M as SessionScope, O as SessionMaintenanceMode, d as ContextVisibilityMode, v as HumanDelayConfig } from "./types.base-iHeWRS8q.js";
import { n as SafeBinProfileFixture } from "./exec-safe-bin-policy-profiles-BDyHRwUP.js";
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-DoY4arSR.js";
import { G as TtsAutoMode, K as TtsConfig, Q as TtsProvider, W as ResolvedTtsPersona, q as TtsMode } from "./types.slack-BSLTSdV_.js";
...
import { d as PluginKind, f as UnifiedModelCatalogEntry, g as PluginConfigUiHint, p as UnifiedModelCatalogKind, t as PluginManifestRecord } from "./manifest-registry-CggWNHxH.js";
...
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-BxnQPgbt.js";
import { C as ConfigReplaceResult, g as ConfigMutationBase } from "./config-pQGEMvNZ.js";
import { y as resolveStateDir } from "./paths-CK6A9fMe.js";
...
import { T as StreamFn$1, f as AgentToolResult, l as AgentTool, s as AgentMessage } from "./types-BoFHdU9q.js";
import { a as SourceReplyDeliveryMode, c as PromptImageOrderEntry, f as ReplyPayload, l as InputProvenance, n as GetReplyOptions, o as TypingController, r as PartialReplyPayload, s as UserTurnTranscriptRecorder } from "./types-Iy-uj5hQ.js";
import { _ as InboundEventKind, a as SupplementalContextFacts, c as CommandTurnKind, h as PluginHookChannelContext, i as MsgContext, n as InboundSourceModality, r as MentionSource, s as CommandTurnContext, t as FinalizedMsgContext } from "./templating-BpD1cfFX.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-CrmAJw_-.js";
import { f as MediaUnderstandingProvider } from "./types-D-xgL_hR.js";
...
import { P as MessageReceipt } from "./types-DZwAbntc.js";
...
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-BRIWiS6p.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin$1 } from "./types.plugin-DvEuFaxA.js";
...
import { a as SessionContextBudgetStatus, c as SessionSystemPromptReport, n as GroupKeyResolution, o as SessionEntry, s as SessionScope$1, t as CliSessionBinding } from "./types-DP8esrTo.js";
import { i as updateSessionStore, l as ResolvedSessionMaintenanceConfig, s as loadSessionStore } from "./store-D2lD_QnZ.js";
import { d as ElevatedLevel, f as ReasoningLevel, g as VerboseLevel, h as TraceLevel, m as ThinkingCatalogEntry, p as ThinkLevel, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-BMJ8ysZi.js";
import { Dt as PluginHookToolKind, Et as PluginHookToolInputKind, Gt as PluginNextTurnInjectionEnqueueResult, J as PluginHookHandlerMap, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolContext, Wt as PluginNextTurnInjection, _n as ReplyDispatchKind, an as PluginHookBeforeToolCallResult, bn as ReplyFollowupAdmissionBarrierTimeoutPolicy, gn as ReplyDispatchBeforeDeliver, ln as PluginHookBeforeAgentStartResult, qt as PluginJsonValue, rn as PluginApprovalResolution, tt as PluginHookName, vn as ReplyDispatchRuntimeInfo, yn as ReplyDispatcher } from "./hook-types-mbU3l3kV.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-c5mRZYEt.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-BOz_kKQY.js";
import { a as TaskDeliveryStatus, c as TaskRegistrySummary, d as TaskScopeKind, f as TaskStatus, h as CommandQueueEnqueueFn, i as TaskDeliveryState, l as TaskRuntime, m as TaskTerminalOutcome, n as TaskFlowRecord, o as TaskNotifyPolicy, p as TaskStatusCounts, r as TaskFlowStatus, s as TaskRecord, t as JsonValue, u as TaskRuntimeCounts } from "./task-flow-registry.types-CGz1aL_i.js";
import { i as SkillTelemetrySource, r as SkillSnapshot, t as SkillCommandSpec } from "./types-B7pcFEbF.js";
...
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-Ctf-VgEf.js";
import { s as LogLevel } from "./subsystem-CfQVin8T.js";
import { C as ResolvedProviderAuth } from "./model-auth-BhzC3Xml.js";
import { o as resolveStorePath, r as resolveSessionFilePath } from "./session-key-BnNHyho2.js";
import { f as onSessionTranscriptUpdate } from "./transcript-CwQkmMRa.js";
...
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-CYVkDIRy.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-DTAnsFzV.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-BkI8s6up.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-DNPT8TUY.js";
import { n as RuntimeWebFetchMetadata, r as RuntimeWebSearchMetadata } from "./command-secret-gateway-d7G7jcmR.js";
import { n as GatewayRequestHandler, x as SecretInputMode } from "./types-BS4MjsWH.js";
...
import { a as MediaUnderstandingRuntime } from "./runtime-types-LGCrtPqi.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-DHBi6CBi.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-C4PorYFR.js";
...
import { Zt as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-DCf7gQeN.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-CeYpI1qR.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-GmM3s96o.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-CP24VeFn.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-FI7LL6Rl.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-COpdgu2t.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { t as hasControlCommand } from "./command-detection-BaUoItW1.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-JwuqbTcr.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-Ncxvaeri.js";
import { t as buildPairingReply } from "./pairing-messages-D1OSWkEr.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-z36RwvYN.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-Bz3CMczW.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-BLGooXMz.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-wEvjBKPL.js";
...
//#endregion
export { OpenClawPluginService as $, getBeforeToolCallPolicyDiagnosticState as $a, SpeechProviderPreparedSynthesis as $c, OpenClawAgentToolResult as $i, formatFastModeAutoProgressText as $l, PluginRuntime as $n, BatchHttpClientConfig as $o, CommandSessionMetadataChange as $r, ContextEngineInfo as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, AgentHarnessCompactParams as Aa, DetachedTaskFinalizeParams as Ac, CodexAppServerToolResultEvent as Ai, WebFetchProviderPlugin as Al, ProviderResolvePromptOverlayContext as An, RemoteEmbeddingProviderId as Ao, ConversationFacts as Ar, DEFAULT_HEARTBEAT_ACK_MAX_CHARS as As, ProviderAuthOptionBag as At, ProviderResolveExternalOAuthProfilesContext as Au, OpenClawPluginModule as B, EmbeddedRunAttemptParams as Ba, TtsConfigResolutionContext as Bc, CliBackendResolveExecutionArgsContext as Bi, WebSearchRuntimeMetadataContext as Bl, ProviderTransportTurnState as Bn, MemoryFileEntry as Bo, formatInboundFromLabel as Br, appendCronStyleCurrentTimeLine as Bs, ProviderCatalogResult as Bt, normalizeHeartbeatToolResponse as Bu, OpenClawPluginApi as C, RealtimeTranscriptionProviderResolveConfigContext as Ca, PluginRuntimeCore as Cc, PluginSessionTurnUnscheduleByTagParams as Ci, ChannelIngressQueuePruneOptions as Cl, ProviderReplaySanitizeMode as Cn, withRemoteHttpResponse as Co, AccessFacts as Cr, emptyPluginConfigSchema as Cs, PluginTranscriptsSourceProviderEntry as Ct, ProviderThinkingProfile as Cu, OpenClawPluginCliRegistrar as D, AgentHarness as Da, PluginRuntimeTaskFlows as Dc, CodexAppServerExtensionContext as Di, WebFetchCredentialResolutionSource as Dl, ProviderResolveAuthProfileIdContext as Dn, RemoteEmbeddingClient as Do, ChannelTurnRecordOptions as Dr, parseNonNegativeByteSize as Ds, ProviderAuthKind as Dt, ProviderExternalAuthProfile as Du, OpenClawPluginCliContext as E, RealtimeTranscriptionSessionCreateRequest as Ea, BoundTaskRunsRuntime as Ec, PluginTrustedToolPolicyRegistration as Ei, PluginWebSearchProviderEntry as El, ProviderReplayToolCallIdMode as En, fetchRemoteEmbeddingVectors as Eo, ChannelTurnDroppedHistoryOptions as Er, listRegisteredMemoryEmbeddingProviderAdapters as Es, ProviderAuthDoctorHintContext as Et, ProviderSystemPromptContribution as Eu, OpenClawPluginHttpRouteHandler as F, AgentHarnessSideQuestionParams as Fa, TaskRunCancelResult as Fc, CliBackendNormalizeConfigContext as Fi, WebSearchProviderId as Fl, ProviderRuntimeProviderConfig as Fn, isMissingEmbeddingApiKeyError as Fo, ChannelBotLoopProtectionFacts as Fr, ResolvedMemorySearchSyncConfig as Fs, ProviderBuiltInModelSuppressionResult as Ft, EmbeddedAgentRunResult as Fu, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, isReplaySafeToolCall as Ga, SpeechDirectiveTokenParseResult as Gc, PluginTextTransforms as Gi, resolveAgentTimeoutMs as Gl, RealtimeTranscriptionProviderPlugin as Gn, ensureDir as Go, DispatchReplyWithDispatcher as Gr, resolveContextEngine as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, PreemptiveCompactionRoute as Ha, TTS_AUTO_MODES as Hc, CliBackendThinkingLevel as Hi, GenerateVideoRuntimeResult as Hl, ProviderValidateReplayTurnsContext as Hn, buildMultimodalChunkForIndexing as Ho, finalizeInboundContext as Hr, ContextEngineFactory as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, AgentHarnessSideQuestionResult as Ia, TaskRunDetail as Ic, CliBackendPlugin as Ii, WebSearchProviderPlugin as Il, ProviderSanitizeReplayHistoryContext as In, mapBatchEmbeddingsByIndex as Io, recordChannelBotPairLoopAndCheckSuppression as Ir, resolveMemorySearchConfig as Is, ProviderCacheTtlEligibilityContext as It, MessagingToolSend as Iu, OpenClawPluginNodeInvokeTransportResult as J, BeforeToolCallPolicyDiagnosticState as Ja, SpeechProviderConfig as Jc, AgentToolResultMiddlewareEvent as Ji, RunEmbeddedAgentParams as Jl, TranscriptSourceProvider as Jn, parseEmbedding as Jo, createReplyDispatcher as Jr, BootstrapResult as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, AgentRuntimePlan as Ka, SpeechListVoicesRequest as Kc, AgentToolResultMiddleware as Ki, CurrentInboundPromptContext as Kl, RealtimeVoiceProviderPlugin as Kn, listMemoryFiles as Ko, ReplyDispatcherOptions as Kr, resolveContextEngineOwnerPluginId as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, AgentHarnessSupport as La, TaskRunView as Lc, CliBackendPrepareExecutionContext as Li, WebSearchProviderSetupContext as Ll, ProviderSystemPromptContributionContext as Ln, sanitizeEmbeddingCacheHeaders as Lo, EnvelopeFormatOptions as Lr, resolveMemorySearchSyncConfig as Ls, ProviderCapabilities as Lt, MessagingToolSourceReplyPayload as Lu, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessDeliveryDefaults as Ma, TaskFlowDetail as Mc, CliBackendAuthEpochMode as Mi, WebFetchRuntimeMetadataContext as Ml, ProviderResolveUsageAuthContext as Mn, normalizeEmbeddingModelWithPrefixes as Mo, InboundMediaFacts as Mr, resolveHeartbeatPrompt as Ms, ProviderBuildMissingAuthMessageContext as Mt, ProviderSyntheticAuthResult as Mu, OpenClawPluginHostedMediaResolver as N, AgentHarnessResetParams as Na, TaskFlowView as Nc, CliBackendExecutionMode as Ni, WebSearchCredentialResolutionSource as Nl, ProviderResolveWebSocketSessionPolicyContext as Nn, debugEmbeddingsLog as No, PreparedChannelTurn as Nr, stripHeartbeatToken as Ns, ProviderBuildUnknownModelHintContext as Nt, EmbeddedAgentCompactResult as Nu, OpenClawPluginCommandDefinition as O, AgentHarnessAttemptParams as Oa, PluginRuntimeTaskRuns as Oc, CodexAppServerExtensionFactory as Oi, WebFetchProviderContext as Ol, ProviderResolveDynamicModelContext as On, createRemoteEmbeddingProvider as Oo, ChannelTurnResult as Or, withProgress as Os, ProviderAuthMethod as Ot, ProviderExternalOAuthProfile as Ou, OpenClawPluginHttpRouteAuth as P, AgentHarnessResultClassification as Pa, TaskRunAggregateSummary as Pc, CliBackendNativeToolMode as Pi, WebSearchProviderContext as Pl, ProviderResolvedUsageAuth as Pn, sanitizeAndNormalizeEmbedding as Po, RunChannelTurnParams as Pr, ResolvedMemorySearchConfig as Ps, ProviderBuiltInModelSuppressionContext as Pt, EmbeddedAgentRunMeta as Pu, OpenClawPluginSecurityAuditContext as Q, finalizeToolTerminalPresentation as Qa, SpeechProviderPrepareSynthesisContext as Qc, AgentToolResultMiddlewareRuntime as Qi, FastModeAutoProgressState as Ql, CreatePluginRuntimeOptions as Qn, uploadBatchJsonlFile as Qo, InternalGetReplyOptions as Qr, ContextEngineHostRequirements as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, AgentHarnessSupportContext as Ra, ResolvedTtsConfig as Rc, CliBackendPreparedExecution as Ri, WebSearchProviderToolDefinition as Rl, ProviderToolSchemaDiagnostic as Rn, enforceEmbeddingMaxInputTokens as Ro, formatAgentEnvelope as Rr, DEFAULT_AGENT_COMPACTION_RESERVE_TOKENS_FLOOR as Rs, ProviderCatalogContext as Rt, HEARTBEAT_RESPONSE_TOOL_NAME as Ru, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionProviderId as Sa, LlmCompleteUsage as Sc, PluginSessionTurnScheduleParams as Si, ChannelIngressQueueFailedRecord as Sl, ProviderReplayPolicyContext as Sn, buildRemoteBaseUrlPolicy as So, resolveChannelInboundSupplementalContext as Sr, buildPluginConfigSchema as Ss, PluginTextTransformRegistration as St, ProviderThinkingPolicyContext as Su, OpenClawPluginCliCommandDescriptor as T, RealtimeTranscriptionSessionCallbacks as Ta, BoundTaskFlowsRuntime as Tc, PluginToolMetadataRegistration as Ti, PluginWebFetchProviderEntry as Tl, ProviderReplaySessionState as Tn, estimateUtf8Bytes as To, ChannelTurnAdmission as Tr, listMemoryEmbeddingProviders as Ts, ProviderAuthContext as Tt, ProviderRuntimePluginHandle as Tu, OpenClawPluginNodeInvokeApprovalDecision as U, NormalizedUsage as Ua, normalizeTtsAutoMode as Uc, CliBundleMcpMode as Ui, GenerateImageParams as Ul, ProviderWebSocketSessionPolicy as Un, chunkMarkdown as Uo, settleReplyDispatcher as Ur, ContextEngineFactoryContext as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, EmbeddedRunAttemptResult as Va, resolveEffectiveTtsConfig as Vc, CliBackendSideQuestionToolMode as Vi, GenerateVideoParams as Vl, ProviderUsageAuthToken as Vn, buildFileEntry as Vo, resolveEnvelopeFormatOptions as Vr, resolveCronStyleNow as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, normalizeUsage as Wa, SpeechDirectiveTokenParseContext as Wc, PluginTextReplacement as Wi, GenerateImageRuntimeResult as Wl, ProviderWrapStreamFnContext as Wn, cosineSimilarity as Wo, DispatchReplyWithBufferedBlockDispatcher$1 as Wr, registerContextEngine as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, HookContext as Xa, SpeechProviderId as Xc, AgentToolResultMiddlewareOptions as Xi, AgentInternalEvent as Xl, UnifiedModelCatalogProviderPlugin as Xn, runWithConcurrency as Xo, DispatchFromConfigResult as Xr, ContextEngine as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, DeferredPluginToolApproval as Ya, SpeechProviderConfiguredContext as Yc, AgentToolResultMiddlewareHarness as Yi, PromptMode as Yl, UnifiedModelCatalogProviderContext as Yn, remapChunkLines as Yo, createReplyDispatcherWithTyping as Yr, CompactResult as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, ToolOutcomeObserver as Za, SpeechProviderOverrides as Zc, AgentToolResultMiddlewareResult as Zi, resolveFastModeState as Zl, VideoGenerationProviderPlugin as Zn, hashText as Zo, InternalGetReplyFromConfig as Zr, ContextEngineHostCapability as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, RealtimeVoiceTool as _a, TranscriptRewriteResult as _c, PluginSessionAttachmentResult as _i, ChannelIngressQueue as _l, ProviderPrepareRuntimeAuthContext as _n, MemoryEmbeddingProviderIndexIdentity as _o, FinalizeChannelInboundContextResult as _r, EmbeddingInput as _s, PluginRealtimeVoiceProviderEntry as _t, prepareSimpleCompletionModelForAgent as _u, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeCallbacks as aa, ContextEngineRuntimeMode as ac, ProviderResolveConfigApiKeyContext as ai, SpeechSynthesisStreamResult as al, ProviderNormalizeToolSchemasContext as an, wrapToolWithBeforeToolCallHook as ao, hasVisibleChannelTurnDispatch as ar, throwIfBatchTerminalFailure as as, PluginCommandContext as at, BlockReplyChunking as au, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderConfig as ba, LlmCompleteParams as bc, PluginSessionSchedulerJobHandle as bi, ChannelIngressQueueCompletedRecord as bl, ProviderReasoningOutputModeContext as bn, listRegisteredMemoryEmbeddingProviders as bo, filterChannelInboundSupplementalContext as br, splitShellArgs as bs, PluginSetupAutoEnableProbe as bt, provider_runtime_d_exports as bu, MigrationDetection as c, RealtimeVoiceBrowserSession as ca, ContextEngineRuntimeSettingsUnavailableError as cc, PluginAgentEventSubscriptionRegistration as ci, SpeechVoiceOption as cl, ProviderPlugin as cn, AgentHarnessTaskRuntimeScope as co, DurableInboundReplyDeliveryParams as cr, runEmbeddingBatchGroups as cs, PluginCommandResult as ct, ClientToolDefinition as cu, MigrationItemKind as d, RealtimeVoiceProviderCapabilities as da, IngestBatchResult as dc, PluginRunContextPatch as di, ResolvedProviderRuntimeAuth as dl, ProviderPluginWizard as dn, MemoryEmbeddingBatchOptions as do, BuildChannelInboundEventContextAsyncParams as dr, applyEmbeddingBatchOutputLine as ds, PluginEmbeddingProvider as dt, AgentSimpleCompletionSelection as du, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as ea, ContextEngineMaintenanceResult as ec, CommandContext as ei, SpeechProviderResolveConfigContext as el, ProviderModernModelPolicyContext as en, hasBeforeToolCallPolicy as eo, SubagentRunParams as er, buildBatchHeaders as es, OpenClawPluginServiceContext as et, formatFastModeCommandOptions as eu, MigrationItemStatus as f, RealtimeVoiceProviderConfig as fa, IngestResult as fc, PluginRuntimeLifecycleRegistration as fi, OpenClawPluginActiveModelContext as fl, ProviderPluginWizardModelPicker as fn, MemoryEmbeddingProvider as fo, BuildChannelInboundEventContextParams as fr, postJsonWithRetry as fs, PluginInteractiveHandlerRegistration as ft, PreparedSimpleCompletionModel as fu, MigrationProviderPreparation as g, RealtimeVoiceRole as ga, TranscriptRewriteRequest as gc, PluginSessionAttachmentParams as gi, OpenClawPluginToolOptions as gl, ProviderPrepareExtraParamsContext as gn, MemoryEmbeddingProviderCreateResult as go, FinalizeChannelInboundContextParams as gr, DEFAULT_LOCAL_MODEL as gs, PluginRealtimeTranscriptionProviderEntry as gt, prepareSimpleCompletionModel as gu, MigrationProviderPlugin as h, RealtimeVoiceProviderResolveConfigContext as ha, TranscriptRewriteReplacement as hc, PluginSessionActionResult as hi, OpenClawPluginToolFactory as hl, ProviderPrepareDynamicModelContext as hn, MemoryEmbeddingProviderCreateOptions as ho, FinalizeChannelInboundContextAsyncParams as hr, createLocalEmbeddingProvider as hs, PluginLogger as ht, completeWithPreparedSimpleCompletionModel as hu, AgentPromptSurfaceKind as i, RealtimeVoiceBridge as ia, ContextEngineRuntimeContext as ic, ProviderNormalizeConfigContext as ii, SpeechSynthesisStreamRequest as il, ProviderNormalizeResolvedModelContext as in, setBeforeToolCallDiagnosticsEnabled as io, hasFinalChannelTurnDispatch as ir, resolveCompletedBatchResult as is, OpenClawPluginSessionWorkflowApi as it, resolveFastModeForElapsed as iu, OpenClawPluginGatewayMethod as j, AgentHarnessCompactResult as ja, DetachedTaskLifecycleRuntime as jc, CodexAppServerToolResultHandlerResult as ji, WebFetchProviderToolDefinition as jl, ProviderResolveTransportTurnStateContext as jn, resolveRemoteEmbeddingBearerClient as jo, DispatchedChannelTurnResult as jr, HEARTBEAT_PROMPT as js, ProviderAuthResult as jt, ProviderResolveSyntheticAuthContext as ju, OpenClawPluginConfigSchema as k, AgentHarnessAttemptResult as ka, PluginRuntimeTasks as kc, CodexAppServerExtensionRuntime as ki, WebFetchProviderId as kl, ProviderResolveNonInteractiveApiKeyParams as kn, resolveRemoteEmbeddingClient as ko, CommandFacts as kr, withProgressTotals as ks, ProviderAuthMethodNonInteractiveContext as kt, ProviderResolveExternalAuthProfilesContext as ku, MigrationItem as l, RealtimeVoiceBrowserSessionCreateRequest as la, ContextEngineRuntimeSettingsUnsupportedError as lc, PluginControlUiDescriptor as li, TtsDirectiveOverrides as ll, ProviderPluginCatalog as ln, resolveEmbeddedAgentRuntime as lo, DurableInboundReplyDeliveryResult as lr, EMBEDDING_BATCH_ENDPOINT as ls, PluginConfigMigration as lt, ExecElevatedDefaults as lu, MigrationProviderContext as m, RealtimeVoiceProviderId as ma, SubagentSpawnPreparation as mc, PluginSessionActionRegistration as mi, OpenClawPluginToolContext as ml, ProviderPreferRuntimeResolvedModelContext as mn, MemoryEmbeddingProviderCallOptions as mo, ChannelInboundSupplementalResolutionOptions as mr, formatUnavailableBatchError as ms, PluginInteractiveRegistration as mt, SimpleCompletionModelOptions as mu, AgentPromptGuidance as n, RealtimeVoiceAudioFormat as na, ContextEngineProjection as nc, ProcessToolDefaults as ni, SpeechProviderResolveTalkOverridesContext as nl, ProviderNonInteractiveApiKeyResult as nn, requestDeferredPluginToolApproval as no, kernel_d_exports as nr, BatchCompletionResult as ns, OpenClawPluginSessionControlsApi as nt, formatFastModeSourceSuffix as nu, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBridgeCreateRequest as oa, ContextEngineRuntimeReasonCode as oc, PluginAgentEventEmitParams as oi, SpeechSynthesisTarget as ol, ProviderNormalizeTransportContext as on, consumeAdjustedParamsForToolCall as oo, resolveChannelTurnDispatchCounts as or, EmbeddingBatchExecutionParams as os, PluginCommandDiagnosticsSession as ot, EmbeddedBlockChunker as ou, MigrationPlan as p, RealtimeVoiceProviderConfiguredContext as pa, SubagentEndReason as pc, PluginSessionActionContext as pi, OpenClawPluginHookOptions as pl, ProviderPluginWizardSetup as pn, MemoryEmbeddingProviderAdapter as po, BuiltChannelInboundEventContext as pr, extractBatchErrorMessage as ps, PluginInteractiveHandlerResult as pt, PreparedSimpleCompletionModelForAgent as pu, OpenClawPluginNodeInvokePolicyResult as q, BuildAgentRuntimePlanParams as qa, SpeechModelOverridePolicy as qc, AgentToolResultMiddlewareContext as qi, EmbeddedRunTrigger as ql, SpeechProviderPlugin as qn, normalizeExtraMemoryPaths as qo, ReplyDispatcherWithTypingOptions as qr, AssembleResult as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeVoiceBargeInOptions as ra, ContextEnginePromptCacheInfo as rc, ProviderApplyConfigDefaultsContext as ri, SpeechSynthesisRequest as rl, ProviderNormalizeModelIdContext as rn, runBeforeToolCallHook as ro, recordDroppedChannelInboundHistory as rr, resolveBatchCompletionFromStatus as rs, OpenClawPluginSessionStateApi as rt, formatFastModeStatusValue as ru, MigrationApplyResult as s, RealtimeVoiceBridgeEvent as sa, ContextEngineRuntimeSettings as sc, PluginAgentEventEmitResult as si, SpeechTelephonySynthesisRequest as sl, ProviderOAuthProfileIdRepair as sn, consumePreExecutionBlockedToolCall as so, DurableInboundReplyDeliveryOptions as sr, buildEmbeddingBatchGroupOptions as ss, PluginCommandHandler as st, AgentStreamParams as su, AGENT_PROMPT_SURFACE_KINDS as t, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as ta, ContextEngineOperation as tc, CommandHandler as ti, SpeechProviderResolveTalkConfigContext as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, isToolWrappedWithBeforeToolCallHook as to, SubagentRunResult as tr, normalizeBatchBaseUrl as ts, OpenClawPluginSessionApi as tt, formatFastModeCurrentStatus as tu, MigrationItemAction as u, RealtimeVoiceCloseReason as ua, ContextEngineSelectionSource as uc, PluginRunContextGetParams as ui, TtsDirectiveParseResult as ul, ProviderPluginDiscovery as un, MemoryEmbeddingBatchChunk as uo, deliverInboundReplyWithMessageSendContext as ur, ProviderBatchOutputLine as us, PluginConfigValidation as ut, ExecToolDefaults as uu, MusicGenerationProviderPlugin as v, RealtimeVoiceToolCallEvent as va, LlmCompleteCaller as vc, PluginSessionExtensionProjection as vi, ChannelIngressQueueClaim as vl, ProviderPreparedRuntimeAuth as vn, MemoryEmbeddingProviderRuntime as vo, buildChannelInboundEventContext as vr, hasNonTextEmbeddingParts as vs, PluginRegistrationMode as vt, resolveSimpleCompletionSelectionForAgent as vu, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSession as wa, RuntimeLogger as wc, PluginSessionTurnUnscheduleByTagResult as wi, ChannelIngressQueueRecord as wl, ProviderReplaySessionEntry as wn, estimateStructuredEmbeddingInputBytes as wo, AssembledChannelTurn as wr, getMemoryEmbeddingProvider as ws, ProviderAugmentModelCatalogContext as wt, ProviderRuntimeModel as wu, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderConfiguredContext as xa, LlmCompleteResult as xc, PluginSessionSchedulerJobRegistration as xi, ChannelIngressQueueEnqueueResult as xl, ProviderReplayPolicy as xn, registerMemoryEmbeddingProvider as xo, finalizeChannelInboundContext as xr, buildJsonPluginConfigSchema as xs, PluginSpeechProviderEntry as xt, ProviderDefaultThinkingPolicyContext as xu, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeVoiceToolResultOptions as ya, LlmCompleteMessage as yc, PluginSessionExtensionRegistration as yi, ChannelIngressQueueClaimRef as yl, ProviderReasoningOutputMode as yn, clearMemoryEmbeddingProviders as yo, filterChannelInboundQuoteContext as yr, isFileMissingError as ys, PluginSetupAutoEnableContext as yt, augmentModelCatalogWithProviderPlugins as yu, OpenClawPluginLifecycleApi as z, CompactEmbeddedAgentSessionParams as za, ResolvedTtsModelOverrides as zc, CliBackendResolveExecutionArgs as zi, WebSearchProviderToolExecutionContext as zl, ProviderTransformSystemPromptContext as zn, MemoryChunk as zo, formatInboundEnvelope as zr, CronStyleNow as zs, ProviderCatalogOrder as zt, HeartbeatToolResponse as zu };