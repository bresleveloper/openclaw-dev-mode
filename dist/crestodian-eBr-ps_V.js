...
import { r as resolveCrestodianOperation } from "./dialogue-CgkwF8Ct.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-CibmrPbM.js")).runCrestodianTui;
	opts.onReady?.();
