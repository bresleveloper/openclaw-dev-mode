...
import { a as isApprovalMethod } from "./method-scopes-D5SEXRvS.js";
import "./message-channel-B4LS2Kcc.js";
import { t as createApprovalNativeRouteReporter } from "./approval-native-route-coordinator-DQ9zWIi2.js";
import { t as buildChannelApprovalNativeTargetKey } from "./approval-native-target-key-CG6wL2cf.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-CLasR81w.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = createApprovalNativeRouteReporter({
		...
		requestGateway: async (method, params) => {
			const { callGatewayLeastPrivilege } = await import("./call-CgIJVeW0.js");
