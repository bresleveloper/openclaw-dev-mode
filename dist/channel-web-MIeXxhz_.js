import { h as getChildLogger, l as shouldLogVerbose, o as logVerbose } from "./globals-DtwqVhkV.js";
import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-CkDRqDzV.js";
import { At as recordSessionMetaFromInbound, Bn as resolveChannelGroupRequireMention, Kn as resolveGroupSessionKey, Nt as updateLastRoute, Oo as loadConfig, Ot as loadSessionStore, ni as saveMediaBuffer, zn as resolveChannelGroupPolicy } from "./auth-profiles-CIqoN6FN.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-DmlQCuju.js";
import { S as sleep, _ as resolveJidToE164, d as isSelfChatMode, f as jidToE164, n as clamp, p as normalizeE164, w as toWhatsappJid } from "./utils-DMInpDZe.js";
import { $ as readWebSelfId, G as resolveWhatsAppMediaMaxBytes, U as resolveWhatsAppAccount, q as getWebAuthAgeMs } from "./plugins-CjLMQbHJ.js";
import { Ar as resolveMessagePrefix, B as buildHistoryContextFromEntries, Cn as buildAgentSessionKey, En as resolveInboundLastRouteSessionKey, G as createInboundDebouncer, H as shouldAckReactionForWhatsApp, Hn as normalizeMentionText, K as resolveInboundDebounceMs, Ln as hasControlCommand, M as createConnectedChannelStatusPatch, N as issuePairingChallenge, P as resolveMentionGating, Pn as finalizeInboundContext, Rn as shouldComputeCommandAuthorized, Tn as resolveAgentRoute, U as dispatchReplyWithBufferedBlockDispatcher, V as recordPendingHistoryEntryIfEnabled, Vn as buildMentionRegexes, Z as getReplyFromConfig, b as resolveInboundSessionEnvelopeContext, en as normalizeGroupActivation, kr as resolveIdentityNamePrefix, mn as enqueueSystemEvent, q as formatInboundEnvelope, rr as createDedupeCache, tn as parseActivationCommand, wn as deriveLastRoutePolicy, z as createReplyPrefixOptions } from "./compact-D7FmBOIi.js";
import { c as resolveStorePath } from "./paths-B52CESY4.js";
import { X as formatLocationText, Z as toLocationContext } from "./send-C30ZEgKY.js";
import { i as getAgentScopedMediaLocalRoots } from "./fetch-BNo-TKiW.js";
import { v as registerUnhandledRejectionHandler } from "./audio-transcription-runner-aawySreQ.js";
import { a as loadWebMedia, d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, m as resolveChunkMode, s as resolveMarkdownTableMode } from "./ir-D7O7NHen.js";
import { f as computeBackoff, p as sleepWithAbort } from "./session-utils-Byo4TGCQ.js";
import { d as resolveDmGroupAccessWithCommandGate, f as resolveDmGroupAccessWithLists, l as readStoreAllowFromForDmPolicy, p as resolvePinnedMainDmOwnerFromAllowlist } from "./pi-tools.policy-BakY2muG.js";
import { a as resolveDefaultGroupPolicy, o as resolveOpenProviderRuntimeGroupPolicy, s as warnMissingProviderGroupPolicyFallbackOnce } from "./group-access-Du4DfpHm.js";
import { c as upsertChannelPairingRequest } from "./pairing-store-afyqjg4D.js";
import { r as formatDurationPrecise } from "./format-duration-D_oqO5zg.js";
import { n as recordChannelActivity } from "./channel-activity-5EA8FJ8k.js";
import { t as convertMarkdownTables } from "./tables-gTnrqBY-.js";
import { r as setActiveWebListener } from "./active-listener-BSF9n-Lf.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-CM_K_7AE.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DL7MZo5k.js";
