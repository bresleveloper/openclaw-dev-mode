...
import { a as applySessionPatchProjection } from "./session-accessor-CwhXEUId.js";
...
import { t as buildAllowedModelSet } from "./model-selection-CFL1kjzt.js";
...
import { c as clearSessionGoal, d as getSessionGoal, l as createSessionGoal, m as updateSessionGoalStatus, p as updateSessionGoalObjective, u as formatSessionGoalStatus } from "./sessions-BIAJdhW6.js";
import { o as readSessionMessagesAsync } from "./session-transcript-readers-QQhnqU33.js";
import { r as ensureContextWindowCacheLoaded } from "./context-BDO_A4uo.js";
import { a as getSessionDefaults, c as listSessionsFromStoreAsync, d as migrateAndPruneGatewaySessionStoreKey, g as resolveGatewaySessionStoreTarget, o as listAgentsForGateway, t as buildGatewaySessionInfo, u as loadSessionEntry, x as resolveSessionModelRef } from "./session-utils-D5cDecWw.js";
import { D as setEmbeddedPluginApprovalBroker, E as clearEmbeddedPluginApprovalBroker, T as EmbeddedPluginApprovalBroker, k as setEmbeddedMode } from "./agent-tools.before-tool-call-Bn4cnw4c.js";
...
import { t as loadGatewayModelCatalog } from "./server-model-catalog-BRLPT05R.js";
import { a as parseGoalCommand } from "./commands-goal-q-tfEwnt.js";
...
import { o as isChatStopCommandText } from "./chat-abort-BIKxT7ef.js";
import { c as performGatewaySessionReset } from "./session-reset-service-ipiW-5Hb.js";
...
import { c as resolveEffectiveChatHistoryMaxChars, r as augmentChatHistoryWithCanvasBlocks, s as projectRecentChatDisplayMessages } from "./session-transcript-path-BUNSgVrg.js";
...
import { i as projectSessionsPatchEntry, n as createGatewaySession } from "./session-create-service-CJvh7RSi.js";
...
var EmbeddedTuiBackend = class {
	...
	start() {
		...
		this.ready = (async () => {
			const { runSessionStartupMigration } = await import("./startup-migration-CZ_feWXp.js");
	...
	async runBtwTurn(params) {
		...
		const { runBtwSideQuestion } = await import("./btw-DKUAfVw4.js");
