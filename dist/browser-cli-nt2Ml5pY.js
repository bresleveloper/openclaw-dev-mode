...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-PpOLP1AX.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-Bq_0oYM4.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-CEWf4fgb.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-qD430l3-.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-XNUfO1VX.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-3kgZiC8z.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
