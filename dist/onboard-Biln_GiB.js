...
import { d as defaultRuntime, f as restoreTerminalState } from "./subsystem-DEHxNIeh.js";
import { Dn as resolveDefaultSecretProviderAlias, on as readConfigFileSnapshot, un as writeConfigFile } from "./model-selection-CX4C7NZp.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-XgRedRg8.js";
...
import "./daemon-runtime-d8cwMM7i.js";
import { t as runOnboardingWizard } from "./onboarding-Uga8P_D4.js";
import { n as logConfigUpdated } from "./logging-cIkvnNzL.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-C3q-9qzI.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-B8fGTvNg.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CVzZ7iEx.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-qhQiUbav.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-D84R7SAL.js").then((n) => n.i);
