...
import { n as loadInstalledPluginIndexInstallRecordsSync } from "./installed-plugin-index-record-reader-CZE4dDG4.js";
import { t as cleanupRetainedManagedNpmInstallGenerations } from "./managed-npm-retention-C4LuZ0gC.js";
import { o as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BcIVzXmF.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-C3dWg4tn.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-Dp5LgxH6.js";
...
import { c as buildRateLimitIdentityKey, l as createAuthRateLimiter, o as AUTH_RATE_LIMIT_SCOPE_NODE_REAPPROVAL } from "./auth-rate-limit-4qIaaC6p.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedKeyedAttempt } from "./auth-C2Z6iDLc.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DgsdN2lA.js";
import { A as applyConfigOverrides, i as getRuntimeConfig, s as promoteConfigSnapshotToLastKnownGood, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-BJfjPmGW.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-DGxp2V0Z.js";
...
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-D2h2urGo.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-GU0xMVCi.js";
import { b as releasePinnedPluginSessionExtensionRegistry, g as pinActivePluginSessionExtensionRegistry, h as pinActivePluginHttpRouteRegistry, m as pinActivePluginChannelRegistry, v as releasePinnedPluginChannelRegistry, y as releasePinnedPluginHttpRouteRegistry } from "./runtime-wIYJz8NY.js";
...
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-qqZxicAD.js";
import { a as enqueueSystemEvent } from "./system-events-DNR0hK3x.js";
import { C as stopDiagnosticHeartbeat, S as startDiagnosticHeartbeat } from "./diagnostic-CnUHR4SG.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-Dj7CYXPD.js";
import { o as resolveCronJobsStorePath } from "./store-DXF66QL3.js";
import { f as resolveActiveEmbeddedRunSessionId, l as getActiveEmbeddedRunCount } from "./run-state-rO_N-hh3.js";
...
import { n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-DnfU3-5B.js";
import { s as setFallbackGatewayContextResolver } from "./server-plugins-C69qrB_N.js";
...
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DTs5KzeP.js";
...
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-UD7Od6QM.js";
import { t as createDefaultDeps } from "./deps-B92jeXR9.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-BrhLjURO.js";
...
import { n as resolveAssistantIdentity } from "./assistant-identity-BJOaexsg.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-bGXNRoZQ.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-tvnBb9Me.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-DoQIyDw-.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DmHLb7R7.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-bCubYo8o.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-DGz_mhnU.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-Bh66qtov.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-tleH69KM.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-C90030Cn.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-DgX4xmbZ.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-B-hdlYpY.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-Qli4I4RQ.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DUhq45mN.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-C8fuLab5.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-Do1xqE87.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-C5Vq-khz.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-01OmgU2d.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-8ijzGtIW.js");
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-BjS3a9kY.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-C8tCfb8_.js");
...
const loadGatewayModelCatalogModule = async () => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-BYDoMu1R.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-BggWePNF.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-CEQDIThy.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-6MlbUYOI.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-DxgD2VDa.js");
...
const loadGatewayPluginBootstrapModule = async () => {
	gatewayPluginBootstrapModulePromise ??= import("./server-plugin-bootstrap-DdAftSrh.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-kuk_4Inj.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-Dga4TY5x.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	const startupConfigModulePromise = import("./server-startup-config-DLr8TjAL.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-DcldYdDL.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-CuBauL0B.js");
	...
	const { createChannelManager } = await import("./server-channels-BlUYE3bN.js");
	...
	const createCloseHandler = () => async (optsValue) => {
		...
		await createGatewayCloseHandler({
			...
			markMainSessionsAbortedForRestart: async ({ sessionKeys, sessionIds, activeRuns, reason, isActiveRun }) => {
				...
				const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-CIXObXE7.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-BLi1nHLN.js"), import("./server-runtime-startup-services-CcqlJupS.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-BEeY9vqa.js"), import("./server-methods-CuOkiXWX.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table--p3xErsl.js"),
				loadGatewayPluginBootstrapModule(),
				import("./services-sVD5IS2U.js")
			]);
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-C1EuXDOL.js"), import("./route-capability-Br-EZr5i.js")]));
		...
		const loadScheduledServicesModule = () => {
			scheduledServicesModulePromise ??= import("./server-runtime-services-mxcDvI7v.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-CkCptHfB.js");
