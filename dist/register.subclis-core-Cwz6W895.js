...
async function registerGatewayRunOnly(program) {
	const { addGatewayRunCommand } = await import("./run-command-BtGFkZtX.js");
...
const entrySpecs = [
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./gateway-cli-NbK-z3Ts.js"),
		...
		{
			commandNames: ["models"],
			loadModule: () => import("./models-cli-DcefDSj4.js"),
			exportName: "registerModelsCli"
		},
		{
			commandNames: ["infer", "capability"],
			loadModule: () => import("./capability-cli-CdMatV6A.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		},
		{
			...
			loadModule: () => import("./tui-cli-BhdSwAXU.js"),
	...
	...defineImportedProgramCommandGroupSpecs([
		...
		{
			commandNames: ["update"],
			loadModule: () => import("./update-cli-DP-R5Acr.js"),
