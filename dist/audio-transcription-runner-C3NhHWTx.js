import { O as runExec, mt as resolveAgentModelPrimaryValue, pt as resolveAgentModelFallbackValues } from "./run-with-concurrency-DbqKAYVa.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-CkNFbaGM.js";
import { A as requireApiKey, c as normalizeProviderId, dt as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, ft as isInboundPathAllowed, gr as resolveOpenClawAgentDir, h as normalizeGoogleModelId, j as resolveApiKeyForProvider, mt as resolveIMessageAttachmentRoots, pt as mergeInboundPathRoots, tt as loadConfig } from "./model-selection-DznAVfkT.js";
import { x as normalizeChatType } from "./plugins-No9izpwe.js";
import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./image-ops-A98XpKpY.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-DdQH9EFt.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-D4Fz2WQK.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BNgFcHwW.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DkwqBBRz.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-D32RNcUC.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-D-7DrjOS.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-JOZQBjr4.js").then((n) => n.r);
