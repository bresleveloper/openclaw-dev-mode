...
async function collectDoctorPreviewNotes(params) {
	...
	const { collectActiveToolSchemaProjectionWarnings } = await import("./active-tool-schema-warnings-Bj_UScFS.js");
	...
	if (hasPluginConfig) {
		...
		const { collectContextEngineHostCompatibilityWarnings } = await import("./context-engine-host-compat-BNuZudQt.js");
