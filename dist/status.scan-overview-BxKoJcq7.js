...
import { p as requireNodeSqlite } from "./openclaw-state-db-gblCDNfo.js";
...
import { c as MEMORY_INDEX_META_TABLE, l as MEMORY_INDEX_SOURCES_TABLE, o as MEMORY_INDEX_CHUNKS_TABLE } from "./engine-storage-w3HufW5O.js";
...
import { a as isProbeReachable, t as pickGatewaySelfPresence } from "./gateway-presence-SlzIZP2c.js";
import { existsSync } from "node:fs";
//#region src/commands/status.scan.shared.ts
const gatewayProbeModuleLoader = createLazyImportLoader(() => import("./status.gateway-probe-BWYyHA2M.js"));
const probeGatewayModuleLoader = createLazyImportLoader(() => import("./probe-D_lRGFE_.js"));
const gatewayCallModuleLoader$1 = createLazyImportLoader(() => import("./call-CgIJVeW0.js"));
...
const statusAgentLocalModuleLoader = createLazyImportLoader(() => import("./status.agent-local-CdFpBBpE.js"));
const statusUpdateModuleLoader = createLazyImportLoader(() => import("./status.update-CuaZsuD2.js"));
const statusScanRuntimeModuleLoader = createLazyImportLoader(() => import("./status.scan.runtime.js"));
const gatewayCallModuleLoader = createLazyImportLoader(() => import("./call-CgIJVeW0.js"));
const statusSummaryModuleLoader = createLazyImportLoader(() => import("./status.summary-Cdm2MHhE.js"));
const channelPluginIdsModuleLoader = createLazyImportLoader(() => import("./channel-plugin-ids-BY20bSXF.js"));
const configModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const commandConfigResolutionModuleLoader = createLazyImportLoader(() => import("./command-config-resolution-CpWOSrzs.js"));
const commandSecretTargetsModuleLoader = createLazyImportLoader(() => import("./command-secret-targets-CDWpMESA.js"));
