...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-DGWkfKgY.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-D_mNJirl.js";
...
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-CRMtbwLa.js";
...
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-D5700t6V.js";
...
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-Cr4btUgB.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CcL-QGmc.js";
import { b as extractTextFromChatContent } from "./image-DM37TgiW.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-DpDXATtv.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-Do03om9O.js";
...
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BOmFSnyy.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-CF_aCv7c.js";
...
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-CAcPxDmS.js";
import "./node-service-By6so7OC.js";
import "./status.update-CPTVOEDL.js";
import { t as installSkill } from "./skills-install-uKSRmGS8.js";
import { t as runGatewayUpdate } from "./update-runner-DlB3vKQV.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CAhAd5Ny.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-D4QBw9Wc.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-D_mNJirl.js").then((n) => n.n);
