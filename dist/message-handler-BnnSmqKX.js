...
import { a as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING, r as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, s as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, t as AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN } from "./auth-rate-limit-4qIaaC6p.js";
import { a as hasForwardedRequestHeaders, c as withSerializedRateLimitAttempt, i as authorizeWsControlUiGatewayConnect, l as checkBrowserOrigin, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-C2Z6iDLc.js";
...
import { c as buildDeviceAuthPayloadV3, l as normalizeDeviceMetadataForAuth, s as buildDeviceAuthPayload } from "./client-C8-EgcVB.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-B4LS2Kcc.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-Cg-HKypD.js";
import { mn as errorShape, pn as ErrorCodes } from "./schema-Ctppm7Dp.js";
import { F as validateConnectParams, Pt as validateRequestFrame, t as formatValidationErrors } from "./src-CSp7rUPX.js";
...
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-CSTswe9T.js";
...
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-CsqLpOVt.js";
import { n as logWs, t as formatForLog } from "./ws-log-UD7Od6QM.js";
...
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-Cr2NsSKp.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Bp5l7wzu.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-DsMt4SeL.js";
import { r as upsertPresence } from "./system-presence-CuBjoJgh.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-bGXNRoZQ.js";
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			const dispatch = (async () => {
				const { handleGatewayRequest } = await import("./server-methods-BNtyIGw3.js");
