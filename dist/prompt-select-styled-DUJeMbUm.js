import { _ as getResolvedLoggerSettings } from "./globals-DtwqVhkV.js";
...
import { $n as updateAuthProfileStoreWithLock, Cr as resolveHooksGmailModel, Ii as CLAUDE_CLI_PROFILE_ID, J as writeConfigFile, Li as CODEX_CLI_PROFILE_ID, Ni as DEFAULT_MODEL, Pi as DEFAULT_PROVIDER, Vn as repairOAuthProfileIdMismatch, W as readConfigFileSnapshot, Yn as ensureAuthProfileStore, d as resolveApiKeyForProfile, dr as getModelRefStatus, ft as secretRefKey, l as resolveProfileUnusableUntilForDisplay, li as resolveApiKeyForProvider, x as resolveSecretRefValues, xr as resolveConfiguredModelRef } from "./auth-profiles-gyYFUuWS.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-Cp0IkEKB.js";
import { T as parseAgentSessionKey } from "./session-key-DmlQCuju.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-DMInpDZe.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-D_NGSHjv.js";
...
import { Er as resolveAgentSessionDirs, Jt as formatRemainingShort, Kt as DEFAULT_OAUTH_WARN_MS, Mr as resolveBootstrapContextForRun, Sr as buildBootstrapInjectionStats, c as loadOpenClawPlugins, qt as buildAuthHealthSummary, xr as analyzeBootstrapBudget } from "./compact-XX-hsoMs.js";
import { n as listChannelPlugins } from "./plugins-BlxnRrWB.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-B5Fkq6oo.js";
import { E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-D8HChyNU.js";
import { d as resolveGatewayBindHost, i as isLoopbackHost } from "./ws-skc9U6x4.js";
import { a as resolveGatewayAuth } from "./auth-yZ8XbKKh.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-BSzjfW8d.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-B4ivsR6D.js";
import { at as formatSessionArchiveTimestamp, et as resolveMainSessionKey, ot as isPrimarySessionTranscriptFileName, s as loadSessionStore, ut as cleanStaleLockFiles } from "./sessions-BzabF1Rs.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-m-ckvfYo.js";
import { n as loadModelCatalog } from "./model-catalog-Cht1UAhe.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-CT_1cdY_.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-CYqcYC09.js";
import { g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./arg-split-BfILNQc-.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BLDNT59_.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-BTGTJOdS.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Dnaodfgg.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-CuEbXeqv.js";
import { i as resolveMemorySearchConfig, r as hasConfiguredMemorySecretInput } from "./manager-Db4cJ-bt.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BCLAcEcj.js";
import { t as note$1 } from "./note-C1niKQJi.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-Z0pCwqMK.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-DtFOsxdB.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CakxZ6WR.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-Bzk-rTVx.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-D433hbaR.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-C3EJt_cG.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-DV5bUtcT.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-B19cf4jJ.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-mK_hRpci.js";
import { r as healthCommand } from "./health-Cjo7QX_h.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-BDr8SzIl.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-DPwavNTT.js";
import { t as runGatewayUpdate } from "./update-runner-BpgfQgSf.js";
import { n as logConfigUpdated } from "./logging-C2FUa2rZ.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-C3XUYJYg.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CYnuCCVs.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DMutfzjg.js";
import { t as formatHealthCheckFailure } from "./health-format-BZVLLayG.js";
import { n as doctorShellCompletion } from "./doctor-completion-CUahNwRG.js";
