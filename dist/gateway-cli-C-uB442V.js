...
import { t as addGatewayRunCommand } from "./run-command-UMmo578a.js";
...
const gatewayStatusModuleLoader = createLazyImportLoader(() => import("./gateway-status-D2ieCs81.js"));
const gatewayHealthModuleLoader = createLazyImportLoader(() => import("./health-xe3N17cn.js"));
const bonjourDiscoveryModuleLoader = createLazyImportLoader(() => import("./bonjour-discovery-DMgVbgrh.js"));
...
const usageFormatModuleLoader = createLazyImportLoader(() => import("./usage-format-PkyxlSl0.js"));
const stabilityBundleModuleLoader = createLazyImportLoader(() => import("./diagnostic-stability-bundle-LM_vurql.js"));
const supportExportModuleLoader = createLazyImportLoader(() => import("./diagnostic-support-export-B9P6em9R.js"));
const daemonStatusGatherModuleLoader = createLazyImportLoader(() => import("./status.gather-CUU-ze-7.js"));
...
async function callGatewayCli(method, opts, params) {
	return (await import("./call-0zZ3mpvX.js")).callGatewayCli(method, opts, params);
}
async function runGatewayCommand(action, label, opts) {
	try {
		...
		if (opts?.json) {
			const { formatGatewayClientRequestErrorJson, formatGatewayTransportErrorJson } = await import("./call-jEgftwN5.js");
