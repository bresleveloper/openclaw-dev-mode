...
import { A as formatPermissionDetail, M as inspectPathPermissions, N as safeStat, Nn as INCLUDE_KEY, ht as normalizeNetworkMode, j as formatPermissionRemediation, mt as isDangerousNetworkMode, qt as normalizeTrustedSafeBinDirs, z as createConfigIO } from "./auth-profiles-gyYFUuWS.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, d as resolveDefaultAgentId } from "./agent-scope-Cp0IkEKB.js";
import { c as normalizeAgentId } from "./session-key-DmlQCuju.js";
...
import { d as normalizePluginsConfig } from "./manifest-registry-DpwUhr6x.js";
import { n as MANIFEST_KEY } from "./legacy-names-0WCuHQSf.js";
import { l as normalizeStringEntries } from "./dock-DXYDVeNl.js";
import { n as listChannelPlugins } from "./plugins-BlxnRrWB.js";
import { C as resolveToolProfilePolicy, f as resolveSandboxConfigForAgent, k as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, l as execDockerRaw, m as resolveSandboxToolPolicyForAgent, u as getBlockedBindReason } from "./sandbox-D8HChyNU.js";
import { a as resolveGatewayAuth } from "./auth-yZ8XbKKh.js";
import { n as resolveGatewayCredentialsFromConfig, t as isGatewaySecretRefUnavailableError } from "./credentials-7d4YYpl4.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, i as resolveBrowserConfig } from "./server-context-3Ig2duxc.js";
import { i as loadWorkspaceSkillEntries } from "./skills-BNw7KbKP.js";
import { r as resolveMergedSafeBinProfileFixtures, t as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-D4f1Abfw.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-DTZsXlMV.js";
import { t as buildGatewayConnectionDetails } from "./call-CT_1cdY_.js";
import { i as readChannelAllowFromStore } from "./pairing-store-DhJ-pAR5.js";
import { _ as hasResolvedCredentialValue, g as hasConfiguredUnavailableCredentialStatus, h as inspectReadOnlyChannelAccount, l as resolveDmAllowState, n as isToolAllowedByPolicies, o as pickSandboxToolPolicy } from "./pi-tools.policy-CYqcYC09.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-D1pQDA-D.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-BlItimC2.js";
...
import { t as scanDirectoryWithSummary } from "./skill-scanner-CyMFsA4G.js";
import { t as probeGateway } from "./probe-Zr9zZfR2.js";
import { r as resolveNodeCommandAllowlist, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-DcqyJZKz.js";
import { c as normalizeTelegramAllowFromEntry, s as isNumericTelegramUserId, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-CJZghzYD.js";
