...
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-D4rA0xDW.js";
...
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-X29fV6Lv.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-BE7Qrb83.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DZflpOom.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CU9LIFzX.js";
import { a as resolveMatrixAccountConfig } from "./account-config-A97QpkoS.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BpZzbojd.js";
...
import { t as formatMatrixErrorMessage } from "./errors-Br49yrzd.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-DgEXzcbP.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-DKDuZ0gk.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-DFuFETLx.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-DWrmvgD2.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CU-AV7VK.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-BhInEH8O.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-DFGjTJZ7.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-W9L6CjMJ.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DNVqdOTk.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-dx5XEQX5.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-07uM52SI.js"));
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-B7ZyDVGP.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
