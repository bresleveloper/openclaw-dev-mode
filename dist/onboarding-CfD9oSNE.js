...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-BTGTJOdS.js").then((n) => n.d);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BgjHXzX7.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-C2FUa2rZ.js").then((n) => n.r);
	...
	const { applyOnboardingLocalWorkspaceConfig } = await import("./onboard-config-DeRnlqfh.js").then((n) => n.n);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-CWfEyMMl.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-CGpPkLde.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-CB_DdXzY.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-Du14sPWg.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-DVZVGTMw.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-BlxnRrWB.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-kd_nFr_N.js").then((n) => n.n);
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-BvhvIeLN.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-DBmJMOi1.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-B2n7VvSj.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-rPyWRoH0.js");
