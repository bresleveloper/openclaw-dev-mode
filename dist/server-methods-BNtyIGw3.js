...
const loadAgentHandlers = lazyHandlerModule(() => import("./agent-CxIMq4qk.js"), (module) => module.agentHandlers);
...
const loadChatHandlers = lazyHandlerModule(() => import("./chat-D5lYAYzn.js"), (module) => module.chatHandlers);
...
const loadNodePendingHandlers = lazyHandlerModule(() => import("./nodes-pending-CLKaQQQq.js"), (module) => module.nodePendingHandlers);
const loadNodeHandlers = lazyHandlerModule(() => import("./nodes-CAXp0vHs.js"), (module) => module.nodeHandlers);
...
const loadSessionsHandlers = lazyHandlerModule(() => import("./sessions-4FcticXQ.js"), (module) => module.sessionsHandlers);
const loadSkillsHandlers = lazyHandlerModule(() => import("./skills-BIgPxFWm.js"), (module) => module.skillsHandlers);
const loadSystemHandlers = lazyHandlerModule(() => import("./system-Dl42l6zb.js"), (module) => module.systemHandlers);
const loadTalkHandlers = lazyHandlerModule(() => import("./talk-BEoHIoMy.js"), (module) => module.talkHandlers);
...
const loadToolsEffectiveHandlers = lazyHandlerModule(() => import("./tools-effective-B2Y1HX_u.js"), (module) => module.toolsEffectiveHandlers);
const loadToolsInvokeHandlers = lazyHandlerModule(() => import("./tools-invoke-DwOpGAun.js"), (module) => module.toolsInvokeHandlers);
const loadTtsHandlers = lazyHandlerModule(() => import("./tts-CZYY8DhX.js"), (module) => module.ttsHandlers);
const loadUpdateHandlers = lazyHandlerModule(() => import("./update-CtZ2vOts.js"), (module) => module.updateHandlers);
