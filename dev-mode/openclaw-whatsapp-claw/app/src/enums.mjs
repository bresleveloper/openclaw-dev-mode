/**
 * Typed string constants for the WhatsApp Claw panel app.
 *
 * JS mirror of `extensions/whatsapp/src/dev-mode/openclaw-whatsapp-claw.enums.ts`.
 * Keep the two files in sync — same keys, same string values.
 *
